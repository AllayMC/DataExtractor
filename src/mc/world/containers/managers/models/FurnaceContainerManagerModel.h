...
public:
    ...
    // vIndex: 6, symbol: ?getItemCopies@FurnaceContainerManagerModel@@UEBA?AV?$vector@VItemStack@@V?$allocator@VItemStack@@@std@@@std@@XZ
    ...
    MCAPI FurnaceContainerManagerModel(class HashedString const &, ::ContainerType, ::BlockActorType, ::ContainerID, class Player &, class BlockPos const &);
