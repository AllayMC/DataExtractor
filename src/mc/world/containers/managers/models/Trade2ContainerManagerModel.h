...
public:
    ...
    // vIndex: 6, symbol: ?getItemCopies@Trade2ContainerManagerModel@@UEBA?AV?$vector@VItemStack@@V?$allocator@VItemStack@@@std@@@std@@XZ
    ...
    MCAPI Trade2ContainerManagerModel(::ContainerID, class Player &, struct ActorUniqueID const &);
