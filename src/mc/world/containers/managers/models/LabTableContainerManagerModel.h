...
public:
    ...
    // vIndex: 6, symbol: ?getItemCopies@LabTableContainerManagerModel@@UEBA?AV?$vector@VItemStack@@V?$allocator@VItemStack@@@std@@@std@@XZ
    ...
    MCAPI static int32_t const INPUT_SLOTS;
