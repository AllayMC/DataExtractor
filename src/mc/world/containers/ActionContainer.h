...
public:
    ...
    // symbol: ?data@ActionContainer@npc@@QEBAAEBV?$vector@V?$variant@UCommandAction@npc@@UUrlAction@2@@std@@V?$allocator@V?$variant@UCommandAction@npc@@UUrlAction@2@@std@@@2@@std@@XZ
    ...
    // symbol: ?reset@ActionContainer@npc@@QEAAX$$QEAV?$vector@V?$variant@UCommandAction@npc@@UUrlAction@2@@std@@V?$allocator@V?$variant@UCommandAction@npc@@UUrlAction@2@@std@@@2@@std@@@Z
