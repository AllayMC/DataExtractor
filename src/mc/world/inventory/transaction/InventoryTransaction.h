...
public:
    ...
    MCAPI std::function<::InventoryTransactionError (class Player &, class InventoryAction const &, bool)> getVerifyFunction(class InventorySource const &) const;
    ...
    MCAPI static class Bedrock::Result<class InventoryTransaction, std::error_code> deserialize(class ReadOnlyBinaryStream &);
...
private:
    ...
    MCAPI static class BidirectionalUnorderedMap<::InventoryTransactionError, std::string> const inventoryTransactionErrorMap;
