...
public:
    ...
    // vIndex: 5, symbol: ?_read@ItemStackRequestActionTransferBase@@MEAA?AV?$Result@XVerror_code@std@@@Bedrock@@AEAVReadOnlyBinaryStream@@@Z
