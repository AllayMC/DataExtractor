...
public:
    ...
    MCAPI void _handleLegacyTransactionRequest(class TypedClientNetId<struct ItemStackLegacyRequestIdTag, int, 0> const &, std::vector<std::pair<::ContainerEnumName, std::vector<uchar, std::allocator<uchar>>>> const &);
    ...
    MCAPI void _filterStrings(class TypedClientNetId<struct ItemStackRequestIdTag, int, 0>, std::vector<std::string> const &, ::TextProcessingEventOrigin const &);
