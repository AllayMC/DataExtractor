...
public:
    ...
    // vIndex: 5, symbol: ?_read@ItemStackRequestActionCraftRecipeAuto@@UEAA?AV?$Result@XVerror_code@std@@@Bedrock@@AEAVReadOnlyBinaryStream@@@Z
    ...
    MCAPI static class Bedrock::Result<std::unique_ptr<class ItemStackRequestAction>, std::error_code> read(class ReadOnlyBinaryStream &);
