...
public:
    ...
    ItemStackRequestActionCraftNonImplemented_DEPRECATEDASKTYLAING& operator=(ItemStackRequestActionCraftNonImplemented_DEPRECATEDASKTYLAING const &) = delete;
    ItemStackRequestActionCraftNonImplemented_DEPRECATEDASKTYLAING(ItemStackRequestActionCraftNonImplemented_DEPRECATEDASKTYLAING const &) = delete;
...
public:
    ...
    // vIndex: 4, symbol: ?_write@ItemStackRequestActionCraftNonImplemented_DEPRECATEDASKTYLAING@@MEBAXAEAVBinaryStream@@@Z
    virtual void _write(class BinaryStream &) const;

    // vIndex: 5, symbol: ?_read@ItemStackRequestActionCraftNonImplemented_DEPRECATEDASKTYLAING@@MEAA?AV?$Result@XVerror_code@std@@@Bedrock@@AEAVReadOnlyBinaryStream@@@Z
