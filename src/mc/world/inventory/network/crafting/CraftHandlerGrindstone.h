...
public:
    ...
    // vIndex: 4, symbol: ?_handleCraftAction@CraftHandlerGrindstone@@MEAA?AW4ItemStackNetResult@@AEBVItemStackRequestActionCraftBase@@@Z
    ...
    MCAPI static std::pair<class ItemStack, struct ItemStackNetIdVariant> getResultItem(class ItemStack const &, class ItemStack const &);
