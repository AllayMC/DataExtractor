...
public:
    ...
    // vIndex: 2, symbol: ?isItemAllowedInSlot@CartographyInputContainerValidation@@UEBA_NAEBVContainerScreenContext@@HAEBVItemStackBase@@H@Z
    ...
    // vIndex: 8, symbol: ?getContainerOffset@CartographyInputContainerValidation@@UEBAHAEBVContainerScreenContext@@@Z
