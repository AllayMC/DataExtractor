...
public:
    ...
    // vIndex: 2, symbol: ?isItemAllowedInSlot@GrindstoneAdditionalContainerValidation@@UEBA_NAEBVContainerScreenContext@@HAEBVItemStackBase@@H@Z
    ...
    // vIndex: 8, symbol: ?getContainerOffset@GrindstoneAdditionalContainerValidation@@UEBAHAEBVContainerScreenContext@@@Z
