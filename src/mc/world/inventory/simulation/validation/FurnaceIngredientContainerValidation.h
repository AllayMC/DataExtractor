...
public:
    ...
    FurnaceIngredientContainerValidation& operator=(FurnaceIngredientContainerValidation const &) = delete;
    FurnaceIngredientContainerValidation(FurnaceIngredientContainerValidation const &) = delete;
