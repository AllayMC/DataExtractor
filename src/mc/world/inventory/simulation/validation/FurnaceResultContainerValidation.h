...
public:
    ...
    FurnaceResultContainerValidation& operator=(FurnaceResultContainerValidation const &) = delete;
    FurnaceResultContainerValidation(FurnaceResultContainerValidation const &) = delete;
