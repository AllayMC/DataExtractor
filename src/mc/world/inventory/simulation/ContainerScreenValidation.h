...
public:
    ...
    // vIndex: 1, symbol: ?tryCraft@ContainerScreenValidation@@UEAA?AUContainerValidationResult@@V?$unique_ptr@UContainerValidationCraftInputs@@U?$default_delete@UContainerValidationCraftInputs@@@std@@@std@@@Z
    virtual struct ContainerValidationResult tryCraft(std::unique_ptr<struct ContainerValidationCraftInputs>);

    // vIndex: 2, symbol: ?getCraftResults@ContainerScreenValidation@@UEAA?AUContainerValidationCraftResult@@V?$unique_ptr@UContainerValidationCraftInputs@@U?$default_delete@UContainerValidationCraftInputs@@@std@@@std@@@Z
    ...
    MCAPI ContainerScreenValidation(class ContainerScreenContext const &, ::ContainerValidationCaller, std::unordered_map<::ContainerEnumName,std::shared_ptr<class Container>>);
    ...
    MCAPI struct ContainerValidationResult tryTransfer(struct ContainerValidationSlotData const &, struct ContainerValidationSlotData const &, int32_t, bool);
    ...
    MCAPI static std::unique_ptr<class ContainerScreenValidation> makeContainerScreenValidation(class ContainerScreenContext const &, ::ContainerValidationCaller, std::unordered_map<::ContainerEnumName,std::shared_ptr<class Container>>);
    ...
    MCAPI struct ContainerValidationResult _tryTransferSpecial(struct ContainerValidationSlotData const &, int32_t, ::ContainerScreenRequestActionType);
