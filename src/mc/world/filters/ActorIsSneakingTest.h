...
public:
    ...
    ActorIsSneakingTest& operator=(ActorIsSneakingTest const &) = delete;
    ActorIsSneakingTest(ActorIsSneakingTest const &) = delete;
...
public:
    ...
    // vIndex: 2, symbol: ?evaluate@ActorIsSneakingTest@@UEBA_NAEBUFilterContext@@@Z
    virtual bool evaluate(struct FilterContext const &) const;

    // vIndex: 3, symbol: ?finalizeParsedValue@FilterTest@@UEAAXAEAVIWorldRegistriesProvider@@@Z
    virtual void finalizeParsedValue(class IWorldRegistriesProvider &);

    // vIndex: 4, symbol: ?getName@ActorIsSneakingTest@@UEBA?AV?$basic_string_view@DU?$char_traits@D@std@@@std@@XZ
    ...
    // symbol: ??1ActorIsSneakingTest@@UEAA@XZ
    MCVAPI ~ActorIsSneakingTest();
