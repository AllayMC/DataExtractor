...
public:
    ...
    ActorIsMovingTest& operator=(ActorIsMovingTest const &) = delete;
    ActorIsMovingTest(ActorIsMovingTest const &) = delete;
...
public:
    ...
    // symbol: ??1ActorIsMovingTest@@UEAA@XZ
    MCVAPI ~ActorIsMovingTest();
