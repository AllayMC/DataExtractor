...
public:
    ...
    ActorHasTargetTest& operator=(ActorHasTargetTest const &) = delete;
    ActorHasTargetTest(ActorHasTargetTest const &) = delete;
...
public:
    ...
    // symbol: ??1ActorHasTargetTest@@UEAA@XZ
    MCVAPI ~ActorHasTargetTest();
