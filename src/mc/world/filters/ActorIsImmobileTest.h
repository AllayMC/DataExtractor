...
public:
    ...
    ActorIsImmobileTest& operator=(ActorIsImmobileTest const &) = delete;
    ActorIsImmobileTest(ActorIsImmobileTest const &) = delete;
...
public:
    ...
    // symbol: ??1ActorIsImmobileTest@@UEAA@XZ
    MCVAPI ~ActorIsImmobileTest();
