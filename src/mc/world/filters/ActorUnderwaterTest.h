...
public:
    ...
    ActorUnderwaterTest& operator=(ActorUnderwaterTest const &) = delete;
    ActorUnderwaterTest(ActorUnderwaterTest const &) = delete;
...
public:
    ...
    // symbol: ??1ActorUnderwaterTest@@UEAA@XZ
    MCVAPI ~ActorUnderwaterTest();
