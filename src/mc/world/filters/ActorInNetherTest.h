...
public:
    ...
    ActorInNetherTest& operator=(ActorInNetherTest const &) = delete;
    ActorInNetherTest(ActorInNetherTest const &) = delete;
...
public:
    ...
    // symbol: ??1ActorInNetherTest@@UEAA@XZ
    MCVAPI ~ActorInNetherTest();
