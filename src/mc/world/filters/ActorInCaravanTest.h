...
public:
    ...
    ActorInCaravanTest& operator=(ActorInCaravanTest const &) = delete;
    ActorInCaravanTest(ActorInCaravanTest const &) = delete;
...
public:
    ...
    // symbol: ??1ActorInCaravanTest@@UEAA@XZ
    MCVAPI ~ActorInCaravanTest();
