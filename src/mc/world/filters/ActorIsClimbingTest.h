...
public:
    ...
    ActorIsClimbingTest& operator=(ActorIsClimbingTest const &) = delete;
    ActorIsClimbingTest(ActorIsClimbingTest const &) = delete;
...
public:
    ...
    // symbol: ??1ActorIsClimbingTest@@UEAA@XZ
    MCVAPI ~ActorIsClimbingTest();
