...
public:
    ...
    ActorIsLeashedTest& operator=(ActorIsLeashedTest const &) = delete;
    ActorIsLeashedTest(ActorIsLeashedTest const &) = delete;
...
public:
    ...
    // symbol: ??1ActorIsLeashedTest@@UEAA@XZ
    MCVAPI ~ActorIsLeashedTest();
