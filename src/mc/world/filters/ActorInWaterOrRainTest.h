...
public:
    ...
    ActorInWaterOrRainTest& operator=(ActorInWaterOrRainTest const &) = delete;
    ActorInWaterOrRainTest(ActorInWaterOrRainTest const &) = delete;
...
public:
    ...
    // symbol: ??1ActorInWaterOrRainTest@@UEAA@XZ
    MCVAPI ~ActorInWaterOrRainTest();
