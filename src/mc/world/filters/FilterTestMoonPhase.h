...
public:
    ...
    FilterTestMoonPhase& operator=(FilterTestMoonPhase const &) = delete;
    FilterTestMoonPhase(FilterTestMoonPhase const &) = delete;
...
public:
    ...
    // symbol: ??1FilterTestMoonPhase@@UEAA@XZ
    MCVAPI ~FilterTestMoonPhase();
