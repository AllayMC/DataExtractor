...
public:
    ...
    ActorInContactWithWater& operator=(ActorInContactWithWater const &) = delete;
    ActorInContactWithWater(ActorInContactWithWater const &) = delete;
...
public:
    ...
    // symbol: ??1ActorInContactWithWater@@UEAA@XZ
    MCVAPI ~ActorInContactWithWater();
