...
public:
    ...
    ActorTrustsSubjectTest& operator=(ActorTrustsSubjectTest const &) = delete;
    ActorTrustsSubjectTest(ActorTrustsSubjectTest const &) = delete;
...
public:
    ...
    // symbol: ??1ActorTrustsSubjectTest@@UEAA@XZ
    MCVAPI ~ActorTrustsSubjectTest();
