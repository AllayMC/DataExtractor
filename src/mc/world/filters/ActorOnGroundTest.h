...
public:
    ...
    ActorOnGroundTest& operator=(ActorOnGroundTest const &) = delete;
    ActorOnGroundTest(ActorOnGroundTest const &) = delete;
...
public:
    ...
    // symbol: ??1ActorOnGroundTest@@UEAA@XZ
    MCVAPI ~ActorOnGroundTest();
