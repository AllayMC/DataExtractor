...
public:
    ...
    ActorHasEquipmentTest& operator=(ActorHasEquipmentTest const &) = delete;
    ActorHasEquipmentTest(ActorHasEquipmentTest const &) = delete;
...
public:
    ...
    // symbol: ??1ActorHasEquipmentTest@@UEAA@XZ
    MCVAPI ~ActorHasEquipmentTest();
