...
public:
    ...
    ActorInWaterTest& operator=(ActorInWaterTest const &) = delete;
    ActorInWaterTest(ActorInWaterTest const &) = delete;
...
public:
    ...
    // symbol: ??1ActorInWaterTest@@UEAA@XZ
    MCVAPI ~ActorInWaterTest();
