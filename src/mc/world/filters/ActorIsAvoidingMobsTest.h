...
public:
    ...
    ActorIsAvoidingMobsTest& operator=(ActorIsAvoidingMobsTest const &) = delete;
    ActorIsAvoidingMobsTest(ActorIsAvoidingMobsTest const &) = delete;
...
public:
    ...
    // symbol: ??1ActorIsAvoidingMobsTest@@UEAA@XZ
    MCVAPI ~ActorIsAvoidingMobsTest();
