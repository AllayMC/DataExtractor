...
public:
    ...
    ActorUndergroundTest& operator=(ActorUndergroundTest const &) = delete;
    ActorUndergroundTest(ActorUndergroundTest const &) = delete;
...
public:
    ...
    // symbol: ??1ActorUndergroundTest@@UEAA@XZ
    MCVAPI ~ActorUndergroundTest();
