...
public:
    ...
    FilterTestBrightness& operator=(FilterTestBrightness const &) = delete;
    FilterTestBrightness(FilterTestBrightness const &) = delete;
...
public:
    ...
    // symbol: ??1FilterTestBrightness@@UEAA@XZ
    MCVAPI ~FilterTestBrightness();
