...
public:
    ...
    ActorInLavaTest& operator=(ActorInLavaTest const &) = delete;
    ActorInLavaTest(ActorInLavaTest const &) = delete;
...
public:
    ...
    // symbol: ??1ActorInLavaTest@@UEAA@XZ
    MCVAPI ~ActorInLavaTest();
