...
public:
    ...
    ActorOnLadderTest& operator=(ActorOnLadderTest const &) = delete;
    ActorOnLadderTest(ActorOnLadderTest const &) = delete;
...
public:
    ...
    // symbol: ??1ActorOnLadderTest@@UEAA@XZ
    MCVAPI ~ActorOnLadderTest();
