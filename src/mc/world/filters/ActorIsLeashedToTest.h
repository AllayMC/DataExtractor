...
public:
    ...
    ActorIsLeashedToTest& operator=(ActorIsLeashedToTest const &) = delete;
    ActorIsLeashedToTest(ActorIsLeashedToTest const &) = delete;
...
public:
    ...
    // symbol: ??1ActorIsLeashedToTest@@UEAA@XZ
    MCVAPI ~ActorIsLeashedToTest();
