...
public:
    ...
    ActorIsBabyTest& operator=(ActorIsBabyTest const &) = delete;
    ActorIsBabyTest(ActorIsBabyTest const &) = delete;
...
public:
    ...
    // symbol: ??1ActorIsBabyTest@@UEAA@XZ
    MCVAPI ~ActorIsBabyTest();
