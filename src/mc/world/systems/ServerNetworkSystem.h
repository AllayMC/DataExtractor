...
public:
    ...
    MCVAPI std::shared_ptr<class SignalServiceSigninJob> createSignalServiceSigninJob(std::function<void (bool)> &&, std::function<void (void)> &&, gsl::not_null<class Bedrock::NonOwnerPointer<class DisconnectionRequestHandler>>, gsl::not_null<class Bedrock::NonOwnerPointer<class ServicesManager>>, gsl::not_null<class Bedrock::NonOwnerPointer<class IMinecraftEventing>>, bool);
    ...
    MCAPI ServerNetworkSystem(class Scheduler &, std::vector<std::string> const &, struct NetworkSystemToggles const &, class Bedrock::NonOwnerPointer<class NetworkDebugManager> const &, class ServiceReference<class ServicesManager>, gsl::not_null<class Bedrock::NonOwnerPointer<class NetworkSessionOwner>>);
