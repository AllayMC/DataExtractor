...
public:
    ...
    MCAPI static std::vector<std::string> _unlockRecipes(class UnlockedRecipesServerComponent &, class Recipes const &, bool, std::optional<struct RecipeUnlockingSystem::InventoryChangedData> const &);
    ...
    MCAPI static void _useContext(class UnlockedRecipesServerComponent &, class Recipes const &, ::RecipeUnlockingRequirement::UnlockingContext, std::vector<std::string> &);
