...
public:
    ...
    MCVAPI void onConnectionClosed(class NetworkIdentifier const &, ::Connection::DisconnectFailReason, std::string const &, bool);
    ...
    MCAPI void _createNetworkStatistics(::TrackerType, std::function<bool (struct RakNet::RakNetStatistics &)> &&, gsl::not_null<class Bedrock::NonOwnerPointer<class NetworkDebugManager>> &&);
    ...
    MCAPI void _handlePacketViolation(struct Bedrock::ErrorInfo<std::error_code> const &, ::PacketViolationResponse, ::MinecraftPacketIds, class NetworkIdentifier const &, class NetworkConnection &, ::SubClientId);
