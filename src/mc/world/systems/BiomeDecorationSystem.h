...
namespace BiomeDecorationSystem {
    ...
    MCAPI bool decorateBiome(class LevelChunk &, class BlockSource &, class Random &, gsl::span<struct BiomeDecorationFeature>, std::string const &, class Biome const *, class IPreliminarySurfaceProvider const &);
    ...
    MCAPI bool decorateLargeFeature(::GeneratorType, uint const &, class BlockVolumeTarget &, class Random &, gsl::span<struct BiomeDecorationFeature>, class ChunkPos const &, std::string const &);
    // NOLINTEND
