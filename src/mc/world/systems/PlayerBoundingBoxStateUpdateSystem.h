...
public:
    ...
    PlayerBoundingBoxStateUpdateSystem& operator=(PlayerBoundingBoxStateUpdateSystem const &) = delete;
    PlayerBoundingBoxStateUpdateSystem(PlayerBoundingBoxStateUpdateSystem const &) = delete;
