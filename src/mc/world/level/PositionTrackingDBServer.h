...
public:
    ...
    // symbol: ?findTracker@PositionTrackingDBServer@PositionTrackingDB@@QEAA?AW4ResultCode@2@AEBVPositionTrackingId@@PEAPEAVTrackingRecord@2@@Z
    MCAPI ::PositionTrackingDB::ResultCode findTracker(class PositionTrackingId const &, class PositionTrackingDB::TrackingRecord **);

    // symbol: ?onReceivePacket@PositionTrackingDBServer@PositionTrackingDB@@QEAAXAEBVPositionTrackingDBClientRequestPacket@@@Z
    ...
    // symbol: ?_initializeNewPositionTrackerId@PositionTrackingDBServer@PositionTrackingDB@@AEAAXAEAVPositionTrackingId@@_N@Z
