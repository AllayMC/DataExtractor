...
public:
    ...
    MCAPI ::AddTickingAreaStatus addArea(class AutomaticID<class Dimension, int>, std::string const &, class BlockPos const &, int, ::TickingAreasManager::AreaLimitCheck, bool, ::TickingAreaLoadMode, class LevelStorage &);
    ...
    MCAPI ::AddTickingAreaStatus addArea(class AutomaticID<class Dimension, int>, std::string const &, class BlockPos const &, class BlockPos const &, ::TickingAreasManager::AreaLimitCheck, bool, ::TickingAreaLoadMode, class LevelStorage &);
    ...
    MCAPI void addTickingAreaListForDimension(class AutomaticID<class Dimension, int>, std::shared_ptr<class TickingAreaList> const &);
    ...
    MCAPI std::vector<struct TickingAreaDescription> setPendingAreaLoadModeByName(class AutomaticID<class Dimension, int>, std::string const &, ::TickingAreaLoadMode, class LevelStorage &);
    ...
    MCAPI std::vector<struct TickingAreaDescription> setPendingAreaLoadModeByPosition(class AutomaticID<class Dimension, int>, class BlockPos const &, ::TickingAreaLoadMode, class LevelStorage &);
    ...
    MCAPI ::AddTickingAreaStatus _addArea(class AutomaticID<class Dimension, int>, std::string const &, struct Bounds const &, bool, ::TickingAreasManager::AreaLimitCheck, bool, ::TickingAreaLoadMode, class LevelStorage &);
    ...
    MCAPI std::vector<struct TickingAreaDescription> _getPendingAreaDescriptionsFiltered(class AutomaticID<class Dimension, int>, std::function<bool (struct PendingArea const &)>) const;
