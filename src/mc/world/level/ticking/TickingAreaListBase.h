...
public:
    ...
    // vIndex: 1, symbol: ?removeDistantEntityAreasAndCheckForRemoved@TickingAreaListBase@@UEAA_NAEBV?$vector@VVec3@@V?$allocator@VVec3@@@std@@@std@@V?$function@$$A6AXAEBVITickingArea@@@Z@3@AEAVLevelStorage@@@Z
    virtual bool removeDistantEntityAreasAndCheckForRemoved(std::vector<class Vec3> const &, std::function<void (class ITickingArea const &)>, class LevelStorage &);
    ...
    MCAPI std::vector<struct TickingAreaDescription> removeAreas(std::vector<std::shared_ptr<class ITickingArea>> const &, class LevelStorage &);
