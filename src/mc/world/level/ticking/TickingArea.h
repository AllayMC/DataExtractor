...
public:
    ...
    virtual class Actor * findOwner(uint8_t &);
    ...
    virtual void onComponentChanged(uint32_t, float, bool, class LevelStorage &);
    ...
    MCAPI TickingArea(class Dimension &, class mce::UUID, std::string const &, struct Bounds const &, bool, ::TickingAreaLoadMode);
    ...
    MCAPI TickingArea(class Dimension &, class mce::UUID, std::string const &, struct ActorUniqueID, struct Bounds const &, bool, float, bool, ::TickingAreaLoadMode);
