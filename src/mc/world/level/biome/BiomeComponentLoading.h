...
namespace BiomeComponentLoading {
    ...
    MCAPI void _read(std::string const &, class CompoundTag const &, std::vector<std::pair<class Biome *, uint32_t>> &, class IWorldRegistriesProvider &);
    ...
    MCAPI void _write(std::string const &, class CompoundTag &, std::vector<std::pair<class Biome *, uint32_t>> const &);
    // NOLINTEND
