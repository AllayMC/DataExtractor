...
public:
    ...
    MCAPI void _buildSurface(class BlockPos const &, float, class Random &, class BlockVolume &, int, short, struct MesaSurfaceBlocks const &, struct SurfaceMaterialBlocks const &, float) const;
