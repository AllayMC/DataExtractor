...
namespace BiomeSourceUtil {
    ...
    MCAPI std::optional<class BlockPos> locateBiome(std::function<bool (class Biome const &)> const &, class BiomeSource const &, class BoundingBox const &, uint32_t);
    ...
    MCAPI std::optional<class BlockPos> locateBiome(std::function<bool (class Biome const &)> const &, class BiomeSource const &, class BlockPos const &, class BoundingBox, uint32_t);
    ...
    MCAPI std::optional<class BlockPos> locateBiome(std::function<bool (class Biome const &)> const &, class BiomeSource const &, class BlockPos const &, class BlockPos const &, uint32_t);
    // NOLINTEND
