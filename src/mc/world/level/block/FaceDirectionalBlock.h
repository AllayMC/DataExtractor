...
public:
    ...
    FaceDirectionalBlock& operator=(FaceDirectionalBlock const &) = delete;
    FaceDirectionalBlock(FaceDirectionalBlock const &) = delete;
...
public:
    ...
    // vIndex: 144, symbol: ?getRenderBlock@FaceDirectionalBlock@@UEBAAEBVBlock@@XZ
    ...
    // symbol: ??1FaceDirectionalBlock@@UEAA@XZ
