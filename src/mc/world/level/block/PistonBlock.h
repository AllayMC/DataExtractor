...
public:
    ...
    // vIndex: 65, symbol: ?shouldConnectToRedstone@PistonBlock@@UEBA_NAEAVBlockSource@@AEBVBlockPos@@W4Type@Direction@@@Z
    ...
    MCAPI PistonBlock(std::string const &, int32_t, ::PistonBlock::Type);
