...
public:
    ...
    ShulkerBoxBlock& operator=(ShulkerBoxBlock const &) = delete;
    ShulkerBoxBlock(ShulkerBoxBlock const &) = delete;
...
public:
    ...
    // vIndex: 132, symbol: ?buildDescriptionId@ShulkerBoxBlock@@UEBA?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@AEBVBlock@@@Z
