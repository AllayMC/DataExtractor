...
public:
    ...
    DecoratedPotBlock& operator=(DecoratedPotBlock const &) = delete;
    DecoratedPotBlock(DecoratedPotBlock const &) = delete;
...
public:
    ...
    // vIndex: 63, symbol: ?canContainLiquid@DecoratedPotBlock@@UEBA_NXZ
    virtual bool canContainLiquid() const;

    // vIndex: 70, symbol: ?checkIsPathable@DecoratedPotBlock@@UEBA_NAEAVActor@@AEBVBlockPos@@1@Z
    ...
    // vIndex: 102, symbol: ?playerWillDestroy@DecoratedPotBlock@@UEBA_NAEAVPlayer@@AEBVBlockPos@@AEBVBlock@@@Z
    virtual bool playerWillDestroy(class Player &, class BlockPos const &, class Block const &) const;

    // vIndex: 103, symbol: ?spawnResources@DecoratedPotBlock@@UEBAXAEAVBlockSource@@AEBVBlockPos@@AEBVBlock@@AEAVRandomize@@AEBUResourceDropsContext@@@Z
    ...
    // vIndex: 104, symbol: ?asItemInstance@DecoratedPotBlock@@UEBA?AVItemInstance@@AEBVBlock@@PEBVBlockActor@@@Z
    virtual class ItemInstance asItemInstance(class Block const &, class BlockActor const *) const;

    // vIndex: 105, symbol: ?trySpawnResourcesOnExplosion@DecoratedPotBlock@@UEBAXAEAVBlockSource@@AEBVBlockPos@@AEBVBlock@@AEAVRandomize@@M@Z
