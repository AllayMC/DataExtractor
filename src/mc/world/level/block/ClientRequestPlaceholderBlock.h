...
public:
    ...
    // vIndex: 5, symbol: ?clip@ClientRequestPlaceholderBlock@@UEBA?AVHitResult@@AEBVBlockSource@@AEBVBlockPos@@AEBVVec3@@2W4ShapeType@@V?$optional_ref@$$CBVGetCollisionShapeInterface@@@@@Z
