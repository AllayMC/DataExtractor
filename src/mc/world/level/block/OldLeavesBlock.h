...
public:
    ...
    OldLeavesBlock& operator=(OldLeavesBlock const &) = delete;
    OldLeavesBlock(OldLeavesBlock const &) = delete;
    OldLeavesBlock() = delete;
...
public:
    ...
    // vIndex: 104, symbol: ?asItemInstance@OldLeavesBlock@@UEBA?AVItemInstance@@AEBVBlock@@PEBVBlockActor@@@Z
    ...
    // vIndex: 132, symbol: ?buildDescriptionId@OldLeavesBlock@@UEBA?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@AEBVBlock@@@Z
    virtual std::string buildDescriptionId(class Block const &) const;

    // vIndex: 133, symbol: ?isAuxValueRelevantForPicking@OldLeavesBlock@@UEBA_NXZ
    ...
    // vIndex: 177, symbol: ?getRenderLayer@OldLeavesBlock@@UEBA?AW4BlockRenderLayer@@AEBVBlock@@AEAVBlockSource@@AEBVBlockPos@@@Z
    virtual ::BlockRenderLayer getRenderLayer(class Block const &, class BlockSource &, class BlockPos const &) const;

    // vIndex: 182, symbol: ?getMapColor@OldLeavesBlock@@UEBA?AVColor@mce@@AEAVBlockSource@@AEBVBlockPos@@AEBVBlock@@@Z
    ...
    // vIndex: 192, symbol: ?getExtraResourceItem@OldLeavesBlock@@MEBA?AVItemInstance@@AEBVBlock@@@Z
