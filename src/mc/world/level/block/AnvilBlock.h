...
public:
    ...
    AnvilBlock& operator=(AnvilBlock const &) = delete;
    AnvilBlock(AnvilBlock const &) = delete;
    AnvilBlock() = delete;
...
public:
    ...
    // vIndex: 6, symbol: ?getCollisionShape@AnvilBlock@@UEBA?AVAABB@@AEBVBlock@@AEBVIConstBlockSource@@AEBVBlockPos@@V?$optional_ref@$$CBVGetCollisionShapeInterface@@@@@Z
    ...
    // vIndex: 10, symbol: ?getOutline@AnvilBlock@@UEBAAEBVAABB@@AEBVBlock@@AEBVIConstBlockSource@@AEBVBlockPos@@AEAV2@@Z
    ...
    // vIndex: 14, symbol: ?getLiquidClipVolume@AnvilBlock@@UEBA_NAEAVBlockSource@@AEBVBlockPos@@AEAVAABB@@@Z
    ...
    // vIndex: 132, symbol: ?buildDescriptionId@AnvilBlock@@UEBA?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@AEBVBlock@@@Z
    ...
    // vIndex: 193, symbol: ?getDustParticleName@AnvilBlock@@UEBA?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@AEBVBlock@@@Z
