...
public:
    ...
    // vIndex: 6, symbol: ?getCollisionShape@PotatoBlock@@UEBA?AVAABB@@AEBVBlock@@AEBVIConstBlockSource@@AEBVBlockPos@@V?$optional_ref@$$CBVGetCollisionShapeInterface@@@@@Z
    ...
    // vIndex: 10, symbol: ?getOutline@PotatoBlock@@UEBAAEBVAABB@@AEBVBlock@@AEBVIConstBlockSource@@AEBVBlockPos@@AEAV2@@Z
    ...
    // vIndex: 103, symbol: ?spawnResources@PotatoBlock@@UEBAXAEAVBlockSource@@AEBVBlockPos@@AEBVBlock@@AEAVRandomize@@AEBUResourceDropsContext@@@Z
    ...
    // vIndex: 142, symbol: ?getVariant@PotatoBlock@@UEBAHAEBVBlock@@@Z
    ...
    // vIndex: 194, symbol: ?getBaseSeed@PotatoBlock@@UEBA?BVItemInstance@@XZ
    virtual class ItemInstance const getBaseSeed() const;

    // vIndex: 195, symbol: ?getBaseCrop@PotatoBlock@@UEBA?BVItemInstance@@XZ
    virtual class ItemInstance const getBaseCrop() const;

    // vIndex: 197, symbol: ?getCropNum@PotatoBlock@@UEBAHAEAVRandomize@@HH@Z
