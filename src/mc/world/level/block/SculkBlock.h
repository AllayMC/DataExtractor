...
public:
    ...
    // vIndex: 185, symbol: ?getResourceItem@SculkBlock@@UEBA?AVItemInstance@@AEAVRandomize@@AEBVBlock@@H@Z
    virtual class ItemInstance getResourceItem(class Randomize &, class Block const &, int32_t) const;

    // vIndex: 186, symbol: ?getResourceCount@SculkBlock@@UEBAHAEAVRandomize@@AEBVBlock@@H@Z
    ...
    MCAPI SculkBlock(std::string const &, int32_t, class Material const &);
