...
public:
    ...
    GrindstoneBlock& operator=(GrindstoneBlock const &) = delete;
    GrindstoneBlock(GrindstoneBlock const &) = delete;
...
public:
    ...
    // vIndex: 63, symbol: ?canContainLiquid@GrindstoneBlock@@UEBA_NXZ
    ...
    // vIndex: 100, symbol: ?neighborChanged@GrindstoneBlock@@UEBAXAEAVBlockSource@@AEBVBlockPos@@1@Z
    ...
    // vIndex: 168, symbol: ?tick@GrindstoneBlock@@UEBAXAEAVBlockSource@@AEBVBlockPos@@AEAVRandom@@@Z
    ...
    // vIndex: 175, symbol: ?canSurvive@GrindstoneBlock@@UEBA_NAEAVBlockSource@@AEBVBlockPos@@@Z
    virtual bool canSurvive(class BlockSource &, class BlockPos const &) const;

    // vIndex: 183, symbol: __unk_vfn_183
    virtual void __unk_vfn_183();

    // vIndex: 187, symbol: ?getSilkTouchItemInstance@GrindstoneBlock@@UEBA?AVItemInstance@@AEBVBlock@@@Z
