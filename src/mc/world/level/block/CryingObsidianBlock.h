...
public:
    ...
    // vIndex: 147, symbol: ?animateTickBedrockLegacy@CryingObsidianBlock@@UEBAXAEAVBlockSource@@AEBVBlockPos@@AEAVRandom@@@Z
    ...
    MCAPI CryingObsidianBlock(std::string const &, int32_t);
