...
public:
    ...
    // vIndex: 4, symbol: ?hasTag@CaveVinesBlock@@UEBA_NAEAVBlockSource@@AEBVBlockPos@@AEBVBlock@@AEBV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@Z
    virtual bool hasTag(class BlockSource &, class BlockPos const &, class Block const &, std::string const &) const;

    // vIndex: 6, symbol: ?getCollisionShape@CaveVinesBlock@@UEBA?AVAABB@@AEBVBlock@@AEBVIConstBlockSource@@AEBVBlockPos@@V?$optional_ref@$$CBVGetCollisionShapeInterface@@@@@Z
    ...
    // vIndex: 10, symbol: ?getOutline@CaveVinesBlock@@UEBAAEBVAABB@@AEBVBlock@@AEBVIConstBlockSource@@AEBVBlockPos@@AEAV2@@Z
    ...
    // vIndex: 87, symbol: ?onFertilized@CaveVinesBlock@@UEBA_NAEAVBlockSource@@AEBVBlockPos@@PEAVActor@@W4FertilizerType@@@Z
    ...
    // vIndex: 117, symbol: ?executeEvent@CaveVinesBlock@@UEBAXAEAVBlockSource@@AEBVBlockPos@@AEBVBlock@@AEBV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@AEAVActor@@@Z
    ...
    MCAPI CaveVinesBlock(std::string const &, int32_t, ::CaveVinesVariant);
