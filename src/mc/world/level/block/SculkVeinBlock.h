...
public:
    ...
    // vIndex: 70, symbol: ?checkIsPathable@SculkVeinBlock@@UEBA_NAEAVActor@@AEBVBlockPos@@1@Z
    ...
    // vIndex: 104, symbol: ?asItemInstance@SculkVeinBlock@@UEBA?AVItemInstance@@AEBVBlock@@PEBVBlockActor@@@Z
    ...
    // vIndex: 185, symbol: ?getResourceItem@SculkVeinBlock@@UEBA?AVItemInstance@@AEAVRandomize@@AEBVBlock@@H@Z
    virtual class ItemInstance getResourceItem(class Randomize &, class Block const &, int32_t) const;

    // vIndex: 186, symbol: ?getResourceCount@SculkVeinBlock@@UEBAHAEAVRandomize@@AEBVBlock@@H@Z
    virtual int32_t getResourceCount(class Randomize &, class Block const &, int32_t) const;

    // vIndex: 187, symbol: ?getSilkTouchItemInstance@SculkVeinBlock@@UEBA?AVItemInstance@@AEBVBlock@@@Z
