...
public:
    ...
    // vIndex: 12, symbol: ?getVisualShape@LadderBlock@@UEBAAEBVAABB@@AEBVBlock@@AEAV2@@Z
    virtual class AABB const & getVisualShape(class Block const &, class AABB &) const;

    // vIndex: 14, symbol: ?getLiquidClipVolume@LadderBlock@@UEBA_NAEBVBlock@@AEAVBlockSource@@AEBVBlockPos@@AEAVAABB@@@Z
    ...
    // vIndex: 37, symbol: ?isWaterBlocking@LadderBlock@@UEBA_NXZ
    ...
    // vIndex: 58, symbol: ?sanitizeFillBlock@LadderBlock@@UEBAAEBVBlock@@AEAVBlockSource@@AEBVBlockPos@@AEBV2@@Z
    ...
    // vIndex: 63, symbol: ?canContainLiquid@LadderBlock@@UEBA_NXZ
    ...
    // vIndex: 92, symbol: ?mayPlace@LadderBlock@@UEBA_NAEAVBlockSource@@AEBVBlockPos@@E@Z
    virtual bool mayPlace(class BlockSource &, class BlockPos const &, uchar) const;

    // vIndex: 100, symbol: ?neighborChanged@LadderBlock@@UEBAXAEAVBlockSource@@AEBVBlockPos@@1@Z
    virtual void neighborChanged(class BlockSource &, class BlockPos const &, class BlockPos const &) const;

    // vIndex: 106, symbol: __unk_vfn_106
    virtual void __unk_vfn_106();

    // vIndex: 107, symbol: ?getPlacementBlock@LadderBlock@@UEBAAEBVBlock@@AEBVActor@@AEBVBlockPos@@EAEBVVec3@@H@Z
    ...
    // vIndex: 168, symbol: ?tick@LadderBlock@@UEBAXAEAVBlockSource@@AEBVBlockPos@@AEAVRandom@@@Z
    ...
    // vIndex: 175, symbol: ?canSurvive@LadderBlock@@UEBA_NAEAVBlockSource@@AEBVBlockPos@@@Z
