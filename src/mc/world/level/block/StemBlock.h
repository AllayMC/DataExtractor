...
public:
    ...
    // vIndex: 63, symbol: ?canContainLiquid@StemBlock@@UEBA_NXZ
    ...
    // vIndex: 87, symbol: ?onFertilized@StemBlock@@UEBA_NAEAVBlockSource@@AEBVBlockPos@@PEAVActor@@W4FertilizerType@@@Z
    virtual bool onFertilized(class BlockSource &, class BlockPos const &, class Actor *, ::FertilizerType) const;

    // vIndex: 89, symbol: ?canBeFertilized@StemBlock@@UEBA_NAEAVBlockSource@@AEBVBlockPos@@AEBVBlock@@@Z
    virtual bool canBeFertilized(class BlockSource &, class BlockPos const &, class Block const &) const;

    // vIndex: 94, symbol: ?mayPlaceOn@StemBlock@@UEBA_NAEAVBlockSource@@AEBVBlockPos@@@Z
    virtual bool mayPlaceOn(class BlockSource &, class BlockPos const &) const;

    // vIndex: 100, symbol: ?neighborChanged@StemBlock@@UEBAXAEAVBlockSource@@AEBVBlockPos@@1@Z
    virtual void neighborChanged(class BlockSource &, class BlockPos const &, class BlockPos const &) const;

    // vIndex: 104, symbol: ?asItemInstance@StemBlock@@UEBA?AVItemInstance@@AEBVBlock@@PEBVBlockActor@@@Z
    ...
    // vIndex: 134, symbol: ?getColor@StemBlock@@UEBAHAEBVBlock@@@Z
    virtual int32_t getColor(class Block const &) const;

    // vIndex: 135, symbol: ?getColor@StemBlock@@UEBAHAEAVBlockSource@@AEBVBlockPos@@AEBVBlock@@@Z
    virtual int32_t getColor(class BlockSource &, class BlockPos const &, class Block const &) const;

    // vIndex: 136, symbol: ?getColorAtPos@StemBlock@@UEBAHAEAVBlockSource@@AEBVBlockPos@@@Z
    ...
    // vIndex: 169, symbol: ?randomTick@StemBlock@@UEBAXAEAVBlockSource@@AEBVBlockPos@@AEAVRandom@@@Z
    ...
    // vIndex: 185, symbol: ?getResourceItem@StemBlock@@UEBA?AVItemInstance@@AEAVRandomize@@AEBVBlock@@H@Z
    virtual class ItemInstance getResourceItem(class Randomize &, class Block const &, int32_t) const;

    // vIndex: 186, symbol: ?getResourceCount@StemBlock@@UEBAHAEAVRandomize@@AEBVBlock@@H@Z
