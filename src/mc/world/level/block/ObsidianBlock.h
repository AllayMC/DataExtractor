...
public:
    ...
    ObsidianBlock& operator=(ObsidianBlock const &) = delete;
    ObsidianBlock(ObsidianBlock const &) = delete;
...
public:
    ...
    // vIndex: 147, symbol: ?animateTickBedrockLegacy@ObsidianBlock@@UEBAXAEAVBlockSource@@AEBVBlockPos@@AEAVRandom@@@Z
    virtual void animateTickBedrockLegacy(class BlockSource &, class BlockPos const &, class Random &) const;

    // vIndex: 153, symbol: __unk_vfn_153
    virtual void __unk_vfn_153();

    // vIndex: 158, symbol: ?_addHardCodedBlockComponents@ObsidianBlock@@UEAAXXZ
    ...
    MCAPI ObsidianBlock(std::string const &, int32_t, bool);
