...
public:
    ...
    StoneSlabBlock4& operator=(StoneSlabBlock4 const &) = delete;
    StoneSlabBlock4(StoneSlabBlock4 const &) = delete;
...
public:
    ...
    // vIndex: 104, symbol: ?asItemInstance@StoneSlabBlock4@@UEBA?AVItemInstance@@AEBVBlock@@PEBVBlockActor@@@Z
    ...
    // vIndex: 132, symbol: ?buildDescriptionId@StoneSlabBlock4@@UEBA?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@AEBVBlock@@@Z
    virtual std::string buildDescriptionId(class Block const &) const;

    // vIndex: 133, symbol: ?isAuxValueRelevantForPicking@StoneSlabBlock4@@UEBA_NXZ
    ...
    // vIndex: 182, symbol: ?getMapColor@StoneSlabBlock4@@UEBA?AVColor@mce@@AEAVBlockSource@@AEBVBlockPos@@AEBVBlock@@@Z
