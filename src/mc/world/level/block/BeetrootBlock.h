...
public:
    ...
    // vIndex: 6, symbol: ?getCollisionShape@BeetrootBlock@@UEBA?AVAABB@@AEBVBlock@@AEBVIConstBlockSource@@AEBVBlockPos@@V?$optional_ref@$$CBVGetCollisionShapeInterface@@@@@Z
    ...
    // vIndex: 10, symbol: ?getOutline@BeetrootBlock@@UEBAAEBVAABB@@AEBVBlock@@AEBVIConstBlockSource@@AEBVBlockPos@@AEAV2@@Z
    ...
    // vIndex: 142, symbol: ?getVariant@BeetrootBlock@@UEBAHAEBVBlock@@@Z
    ...
    // vIndex: 194, symbol: ?getBaseSeed@BeetrootBlock@@UEBA?BVItemInstance@@XZ
    virtual class ItemInstance const getBaseSeed() const;

    // vIndex: 195, symbol: ?getBaseCrop@BeetrootBlock@@UEBA?BVItemInstance@@XZ
    virtual class ItemInstance const getBaseCrop() const;

    // vIndex: 197, symbol: ?getCropNum@BeetrootBlock@@UEBAHAEAVRandomize@@HH@Z
