...
public:
    ...
    SoulFireBlock& operator=(SoulFireBlock const &) = delete;
    SoulFireBlock(SoulFireBlock const &) = delete;
    SoulFireBlock() = delete;
...
public:
    ...
    // vIndex: 6, symbol: ?getCollisionShape@SoulFireBlock@@UEBA?AVAABB@@AEBVBlock@@AEBVIConstBlockSource@@AEBVBlockPos@@V?$optional_ref@$$CBVGetCollisionShapeInterface@@@@@Z
    ...
    // vIndex: 10, symbol: ?getOutline@SoulFireBlock@@UEBAAEBVAABB@@AEBVBlock@@AEBVIConstBlockSource@@AEBVBlockPos@@AEAV2@@Z
