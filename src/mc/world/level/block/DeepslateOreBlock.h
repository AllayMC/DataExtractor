...
public:
    ...
    // vIndex: 54, symbol: ?canBeOriginalSurface@DeepslateOreBlock@@UEBA_NXZ
    ...
    // vIndex: 103, symbol: ?spawnResources@DeepslateOreBlock@@UEBAXAEAVBlockSource@@AEBVBlockPos@@AEBVBlock@@AEAVRandomize@@AEBUResourceDropsContext@@@Z
    ...
    // vIndex: 185, symbol: ?getResourceItem@DeepslateOreBlock@@UEBA?AVItemInstance@@AEAVRandomize@@AEBVBlock@@H@Z
    virtual class ItemInstance getResourceItem(class Randomize &, class Block const &, int32_t) const;

    // vIndex: 186, symbol: ?getResourceCount@DeepslateOreBlock@@UEBAHAEAVRandomize@@AEBVBlock@@H@Z
    ...
    MCAPI DeepslateOreBlock(std::string const &, int32_t);
