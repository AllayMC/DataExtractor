...
public:
    ...
    // vIndex: 147, symbol: ?animateTickBedrockLegacy@BookshelfBlock@@UEBAXAEAVBlockSource@@AEBVBlockPos@@AEAVRandom@@@Z
    ...
    // vIndex: 185, symbol: ?getResourceItem@BookshelfBlock@@UEBA?AVItemInstance@@AEAVRandomize@@AEBVBlock@@H@Z
    virtual class ItemInstance getResourceItem(class Randomize &, class Block const &, int32_t) const;

    // vIndex: 186, symbol: ?getResourceCount@BookshelfBlock@@UEBAHAEAVRandomize@@AEBVBlock@@H@Z
    ...
    MCAPI BookshelfBlock(std::string const &, int32_t);
