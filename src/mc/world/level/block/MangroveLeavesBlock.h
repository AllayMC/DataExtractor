...
public:
    ...
    MangroveLeavesBlock& operator=(MangroveLeavesBlock const &) = delete;
    MangroveLeavesBlock(MangroveLeavesBlock const &) = delete;
    MangroveLeavesBlock() = delete;
...
public:
    ...
    // vIndex: 87, symbol: ?onFertilized@MangroveLeavesBlock@@UEBA_NAEAVBlockSource@@AEBVBlockPos@@PEAVActor@@W4FertilizerType@@@Z
    virtual bool onFertilized(class BlockSource &, class BlockPos const &, class Actor *, ::FertilizerType) const;

    // vIndex: 89, symbol: ?canBeFertilized@MangroveLeavesBlock@@UEBA_NAEAVBlockSource@@AEBVBlockPos@@AEBVBlock@@@Z
