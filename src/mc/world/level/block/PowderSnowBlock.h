...
public:
    ...
    // vIndex: 6, symbol: ?getCollisionShape@PowderSnowBlock@@UEBA?AVAABB@@AEBVBlock@@AEBVIConstBlockSource@@AEBVBlockPos@@V?$optional_ref@$$CBVGetCollisionShapeInterface@@@@@Z
    ...
    // vIndex: 63, symbol: ?canContainLiquid@PowderSnowBlock@@UEBA_NXZ
    ...
    // vIndex: 97, symbol: ?breaksFallingBlocks@PowderSnowBlock@@UEBA_NAEBVBlock@@VBaseGameVersion@@@Z
    virtual bool breaksFallingBlocks(class Block const &, class BaseGameVersion) const;

    // vIndex: 104, symbol: ?asItemInstance@PowderSnowBlock@@UEBA?AVItemInstance@@AEBVBlock@@PEBVBlockActor@@@Z
