...
public:
    ...
    MCAPI static std::unordered_map<std::string,struct BlockComponentFactory::Constructor> & getPropRegisteredCerealComponents(struct cereal::ReflectionCtx &);
    ...
    MCAPI static std::unordered_map<std::string,std::string> & getPropRegisteredDeprecatedCerealComponents(struct cereal::ReflectionCtx &);
