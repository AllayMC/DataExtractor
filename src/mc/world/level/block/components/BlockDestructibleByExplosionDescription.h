...
public:
    ...
    // vIndex: 1, symbol: ?getName@BlockDestructibleByExplosionDescription@@UEBAAEBV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@XZ
    virtual std::string const & getName() const;

    // vIndex: 3, symbol: ?initializeComponent@BlockDestructibleByExplosionDescription@@UEBAXAEAVBlockComponentStorage@@@Z
