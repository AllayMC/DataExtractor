...
public:
    ...
    // vIndex: 4, symbol: ?initializeComponentFromCode@BlockMaterialInstancesDescription@@UEBAXAEAVBlockComponentStorage@@@Z
    ...
    // vIndex: 8, symbol: ?buildNetworkTag@BlockMaterialInstancesDescription@@UEBA?AV?$unique_ptr@VCompoundTag@@U?$default_delete@VCompoundTag@@@std@@@std@@AEBUReflectionCtx@cereal@@@Z
    virtual std::unique_ptr<class CompoundTag> buildNetworkTag(struct cereal::ReflectionCtx const &) const;

    // vIndex: 9, symbol: ?initializeFromNetwork@BlockMaterialInstancesDescription@@UEAAXAEBVCompoundTag@@AEBUReflectionCtx@cereal@@@Z
