...
public:
    ...
    // vIndex: 1, symbol: ?getName@BlockPlacementFilterDescription@@UEBAAEBV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@XZ
    ...
    // vIndex: 8, symbol: ?buildNetworkTag@BlockPlacementFilterDescription@@UEBA?AV?$unique_ptr@VCompoundTag@@U?$default_delete@VCompoundTag@@@std@@@std@@AEBUReflectionCtx@cereal@@@Z
    virtual std::unique_ptr<class CompoundTag> buildNetworkTag(struct cereal::ReflectionCtx const &) const;

    // vIndex: 9, symbol: ?initializeFromNetwork@BlockPlacementFilterDescription@@UEAAXAEBVCompoundTag@@AEBUReflectionCtx@cereal@@@Z
