...
public:
    ...
    // vIndex: 74, symbol: ?onRedstoneUpdate@PoweredRailBlock@@UEBAXAEAVBlockSource@@AEBVBlockPos@@H_N@Z
    ...
    // vIndex: 142, symbol: ?getVariant@PoweredRailBlock@@UEBAHAEBVBlock@@@Z
    ...
    MCAPI PoweredRailBlock(std::string const &, int32_t);
