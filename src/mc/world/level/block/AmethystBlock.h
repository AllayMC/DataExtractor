...
public:
    ...
    AmethystBlock& operator=(AmethystBlock const &) = delete;
    AmethystBlock(AmethystBlock const &) = delete;
...
public:
    ...
    MCAPI AmethystBlock(std::string const &, int32_t, class Material const &);
