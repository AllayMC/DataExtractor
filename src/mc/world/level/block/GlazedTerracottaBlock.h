...
public:
    ...
    // vIndex: 56, symbol: ?isValidAuxValue@GlazedTerracottaBlock@@UEBA_NH@Z
    ...
    // vIndex: 107, symbol: ?getPlacementBlock@GlazedTerracottaBlock@@UEBAAEBVBlock@@AEBVActor@@AEBVBlockPos@@EAEBVVec3@@H@Z
