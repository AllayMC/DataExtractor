...
public:
    ...
    // vIndex: 54, symbol: ?canBeOriginalSurface@OreBlock@@UEBA_NXZ
    ...
    // vIndex: 103, symbol: ?spawnResources@OreBlock@@UEBAXAEAVBlockSource@@AEBVBlockPos@@AEBVBlock@@AEAVRandomize@@AEBUResourceDropsContext@@@Z
    ...
    // vIndex: 185, symbol: ?getResourceItem@OreBlock@@UEBA?AVItemInstance@@AEAVRandomize@@AEBVBlock@@H@Z
    virtual class ItemInstance getResourceItem(class Randomize &, class Block const &, int32_t) const;

    // vIndex: 186, symbol: ?getResourceCount@OreBlock@@UEBAHAEAVRandomize@@AEBVBlock@@H@Z
    ...
    MCAPI OreBlock(std::string const &, int32_t);
