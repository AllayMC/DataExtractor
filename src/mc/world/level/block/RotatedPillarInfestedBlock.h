...
public:
    ...
    // vIndex: 103, symbol: ?spawnResources@RotatedPillarInfestedBlock@@UEBAXAEAVBlockSource@@AEBVBlockPos@@AEBVBlock@@AEAVRandomize@@AEBUResourceDropsContext@@@Z
    ...
    // vIndex: 186, symbol: ?getResourceCount@RotatedPillarInfestedBlock@@UEBAHAEAVRandomize@@AEBVBlock@@H@Z
    virtual int getResourceCount(class Randomize &, class Block const &, int) const;

    // vIndex: 187, symbol: ?getSilkTouchItemInstance@RotatedPillarInfestedBlock@@MEBA?AVItemInstance@@AEBVBlock@@@Z
