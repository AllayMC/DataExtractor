...
public:
    ...
    SetBlockAtPos& operator=(SetBlockAtPos const &) = delete;
    SetBlockAtPos(SetBlockAtPos const &) = delete;
...
public:
    ...
    // vIndex: 1, symbol: ?getName@SetBlockAtPos@@UEBAAEBV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@XZ
    virtual std::string const & getName() const;

    // vIndex: 2, symbol: ?executeAction@SetBlockAtPos@@UEBAXAEAVRenderParams@@@Z
    virtual void executeAction(class RenderParams &) const;

    // vIndex: 3, symbol: ?buildSchema@SetBlockAtPos@@UEBAXAEAV?$shared_ptr@V?$JsonSchemaObjectNode@VEmptyClass@JsonUtil@@UEventResponseCollection@@@JsonUtil@@@std@@AEBV?$Factory@VEventResponse@@$$V@@@Z
