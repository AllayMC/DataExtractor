...
public:
    ...
    CoralPlantBlock& operator=(CoralPlantBlock const &) = delete;
    CoralPlantBlock(CoralPlantBlock const &) = delete;
    CoralPlantBlock() = delete;
...
public:
    ...
    // vIndex: 6, symbol: ?getCollisionShape@CoralPlantBlock@@UEBA?AVAABB@@AEBVBlock@@AEBVIConstBlockSource@@AEBVBlockPos@@V?$optional_ref@$$CBVGetCollisionShapeInterface@@@@@Z
    ...
    // vIndex: 10, symbol: ?getOutline@CoralPlantBlock@@UEBAAEBVAABB@@AEBVBlock@@AEBVIConstBlockSource@@AEBVBlockPos@@AEAV2@@Z
    ...
    // vIndex: 70, symbol: ?checkIsPathable@CoralPlantBlock@@UEBA_NAEAVActor@@AEBVBlockPos@@1@Z
    ...
    // vIndex: 88, symbol: ?mayConsumeFertilizer@CoralPlantBlock@@UEBA_NAEAVBlockSource@@@Z
    virtual bool mayConsumeFertilizer(class BlockSource &) const;

    // vIndex: 94, symbol: ?mayPlaceOn@CoralPlantBlock@@MEBA_NAEAVBlockSource@@AEBVBlockPos@@@Z
    virtual bool mayPlaceOn(class BlockSource &, class BlockPos const &) const;

    // vIndex: 100, symbol: ?neighborChanged@CoralPlantBlock@@UEBAXAEAVBlockSource@@AEBVBlockPos@@1@Z
    virtual void neighborChanged(class BlockSource &, class BlockPos const &, class BlockPos const &) const;

    // vIndex: 103, symbol: ?spawnResources@CoralPlantBlock@@UEBAXAEAVBlockSource@@AEBVBlockPos@@AEBVBlock@@AEAVRandomize@@AEBUResourceDropsContext@@@Z
