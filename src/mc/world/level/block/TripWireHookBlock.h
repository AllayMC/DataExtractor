...
public:
    ...
    TripWireHookBlock& operator=(TripWireHookBlock const &) = delete;
    TripWireHookBlock(TripWireHookBlock const &) = delete;
...
public:
    ...
    // vIndex: 6, symbol: ?getCollisionShape@TripWireHookBlock@@UEBA?AVAABB@@AEBVBlock@@AEBVIConstBlockSource@@AEBVBlockPos@@V?$optional_ref@$$CBVGetCollisionShapeInterface@@@@@Z
    ...
    // vIndex: 65, symbol: ?shouldConnectToRedstone@TripWireHookBlock@@UEBA_NAEAVBlockSource@@AEBVBlockPos@@W4Type@Direction@@@Z
    ...
    // vIndex: 159, symbol: ?onRemove@TripWireHookBlock@@UEBAXAEAVBlockSource@@AEBVBlockPos@@@Z
    ...
    // vIndex: 165, symbol: ?onPlace@TripWireHookBlock@@UEBAXAEAVBlockSource@@AEBVBlockPos@@@Z
    virtual void onPlace(class BlockSource &, class BlockPos const &) const;

    // vIndex: 167, symbol: __unk_vfn_167
    virtual void __unk_vfn_167();

    // vIndex: 168, symbol: ?tick@TripWireHookBlock@@UEBAXAEAVBlockSource@@AEBVBlockPos@@AEAVRandom@@@Z
    ...
    // vIndex: 175, symbol: ?canSurvive@TripWireHookBlock@@UEBA_NAEAVBlockSource@@AEBVBlockPos@@@Z
