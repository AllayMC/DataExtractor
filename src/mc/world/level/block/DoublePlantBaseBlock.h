...
public:
    ...
    DoublePlantBaseBlock& operator=(DoublePlantBaseBlock const &) = delete;
    DoublePlantBaseBlock(DoublePlantBaseBlock const &) = delete;
...
public:
    ...
    // vIndex: 6, symbol: ?getCollisionShape@DoublePlantBaseBlock@@UEBA?AVAABB@@AEBVBlock@@AEBVIConstBlockSource@@AEBVBlockPos@@V?$optional_ref@$$CBVGetCollisionShapeInterface@@@@@Z
    ...
    // vIndex: 10, symbol: ?getOutline@DoublePlantBaseBlock@@UEBAAEBVAABB@@AEBVBlock@@AEBVIConstBlockSource@@AEBVBlockPos@@AEAV2@@Z
    ...
    // vIndex: 12, symbol: ?getVisualShape@DoublePlantBaseBlock@@UEBAAEBVAABB@@AEBVBlock@@AEAV2@@Z
    ...
    // vIndex: 63, symbol: ?canContainLiquid@DoublePlantBaseBlock@@UEBA_NXZ
    ...
    // vIndex: 87, symbol: ?onFertilized@DoublePlantBaseBlock@@UEBA_NAEAVBlockSource@@AEBVBlockPos@@PEAVActor@@W4FertilizerType@@@Z
    virtual bool onFertilized(class BlockSource &, class BlockPos const &, class Actor *, ::FertilizerType) const;

    // vIndex: 89, symbol: ?canBeFertilized@DoublePlantBaseBlock@@UEBA_NAEAVBlockSource@@AEBVBlockPos@@AEBVBlock@@@Z
    ...
    // vIndex: 101, symbol: ?getSecondPart@DoublePlantBaseBlock@@UEBA_NAEBVBlockSource@@AEBVBlockPos@@AEAV3@@Z
    virtual bool getSecondPart(class BlockSource const &, class BlockPos const &, class BlockPos &) const;

    // vIndex: 102, symbol: ?playerWillDestroy@DoublePlantBaseBlock@@UEBA_NAEAVPlayer@@AEBVBlockPos@@AEBVBlock@@@Z
    virtual bool playerWillDestroy(class Player &, class BlockPos const &, class Block const &) const;

    // vIndex: 103, symbol: ?spawnResources@DoublePlantBaseBlock@@UEBAXAEAVBlockSource@@AEBVBlockPos@@AEBVBlock@@AEAVRandomize@@AEBUResourceDropsContext@@@Z
    ...
    // vIndex: 165, symbol: ?onPlace@DoublePlantBaseBlock@@UEBAXAEAVBlockSource@@AEBVBlockPos@@@Z
    virtual void onPlace(class BlockSource &, class BlockPos const &) const;

    // vIndex: 167, symbol: __unk_vfn_167
    virtual void __unk_vfn_167();

    // vIndex: 168, symbol: ?tick@DoublePlantBaseBlock@@UEBAXAEAVBlockSource@@AEBVBlockPos@@AEAVRandom@@@Z
    ...
    // vIndex: 175, symbol: ?canSurvive@DoublePlantBaseBlock@@UEBA_NAEAVBlockSource@@AEBVBlockPos@@@Z
    ...
    // vIndex: 194, symbol: ?_keepRelevantStateForDropping@DoublePlantBaseBlock@@MEBAAEBVBlock@@AEBV2@@Z
