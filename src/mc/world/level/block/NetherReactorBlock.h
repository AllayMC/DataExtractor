...
public:
    ...
    // vIndex: 103, symbol: ?spawnResources@NetherReactorBlock@@UEBAXAEAVBlockSource@@AEBVBlockPos@@AEBVBlock@@AEAVRandomize@@AEBUResourceDropsContext@@@Z
    ...
    // vIndex: 186, symbol: ?getResourceCount@NetherReactorBlock@@UEBAHAEAVRandomize@@AEBVBlock@@H@Z
    ...
    MCAPI NetherReactorBlock(std::string const &, int32_t, class Material const &);
