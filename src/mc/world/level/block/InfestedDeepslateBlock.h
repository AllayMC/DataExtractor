...
public:
    ...
    InfestedDeepslateBlock& operator=(InfestedDeepslateBlock const &) = delete;
    InfestedDeepslateBlock(InfestedDeepslateBlock const &) = delete;
...
public:
    ...
    // vIndex: 157, symbol: ?tryGetUninfested@InfestedDeepslateBlock@@UEBAPEBVBlock@@AEBV2@@Z
    ...
    MCAPI InfestedDeepslateBlock(std::string const &, int32_t, class Material const &);
