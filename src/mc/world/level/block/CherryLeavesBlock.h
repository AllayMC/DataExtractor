...
public:
    ...
    // vIndex: 139, symbol: ?onGraphicsModeChanged@CherryLeavesBlock@@UEAAXAEBUBlockGraphicsModeChangeContext@@@Z
    ...
    // vIndex: 177, symbol: ?getRenderLayer@CherryLeavesBlock@@UEBA?AW4BlockRenderLayer@@AEBVBlock@@AEAVBlockSource@@AEBVBlockPos@@@Z
    virtual ::BlockRenderLayer getRenderLayer(class Block const &, class BlockSource &, class BlockPos const &) const;

    // vIndex: 182, symbol: ?getMapColor@CherryLeavesBlock@@UEBA?AVColor@mce@@AEAVBlockSource@@AEBVBlockPos@@AEBVBlock@@@Z
