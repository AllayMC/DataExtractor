...
public:
    ...
    public:
        ...
        virtual std::optional<int32_t> getState(class BlockLegacy const &, int32_t) const;
    
        // vIndex: 1, symbol: ?setState@RearrangedStateCollection@BlockLegacy@@UEBAPEBVBlock@@AEBV2@HH@Z
        virtual class Block const * setState(class BlockLegacy const &, int32_t, int32_t) const;
    
        // symbol: ?add@RearrangedStateCollection@BlockLegacy@@SAXAEAV2@AEBVBlockState@@V?$function@$$A6A?AV?$optional@H@std@@AEBVBlockLegacy@@H@Z@std@@V?$function@$$A6APEBVBlock@@AEBVBlockLegacy@@HH@Z@5@AEBVSemVersion@@@Z
        MCAPI static void add(class BlockLegacy &, class BlockState const &, std::function<std::optional<int32_t> (class BlockLegacy const &, int32_t)>, std::function<class Block const * (class BlockLegacy const &, int32_t, int32_t)>, class SemVersion const &);
    ...
    public:
        ...
        public:
            ...
            MCAPI SplitBlock(int32_t, class BlockLegacy &);
    ...
    public:
        ...
        // symbol: ?add@RemovedStateCollection@BlockLegacy@@SAXAEBVBlockState@@$$QEAV?$vector@USplitBlock@RemovedStateCollection@BlockLegacy@@V?$allocator@USplitBlock@RemovedStateCollection@BlockLegacy@@@std@@@std@@AEBVSemVersion@@@Z
        MCAPI static void add(class BlockState const &, std::vector<struct BlockLegacy::RemovedStateCollection::SplitBlock> &&, class SemVersion const &);
...
public:
    ...
    virtual class Block const & getStateFromLegacyData(uint16_t) const;

    // vIndex: 2, symbol: ?newBlockEntity@BlockLegacy@@UEBA?AV?$shared_ptr@VBlockActor@@@std@@AEBVBlockPos@@AEBVBlock@@@Z
    ...
    // vIndex: 7, symbol: ?getCollisionShapeForCamera@BlockLegacy@@UEBA_NAEAVAABB@@AEBVBlock@@AEBVIConstBlockSource@@AEBVBlockPos@@@Z
    ...
    // vIndex: 8, symbol: ?addCollisionShapes@BlockLegacy@@UEBA_NAEBVBlock@@AEBVBlockSource@@AEBVBlockPos@@PEBVAABB@@AEAV?$vector@VAABB@@V?$allocator@VAABB@@@std@@@std@@V?$optional_ref@$$CBVGetCollisionShapeInterface@@@@@Z
    virtual bool addCollisionShapes(class Block const &, class BlockSource const &, class BlockPos const &, class AABB const *, std::vector<class AABB> &, class optional_ref<class GetCollisionShapeInterface const>) const;

    // vIndex: 9, symbol: ?addAABBs@BlockLegacy@@UEBAXAEBVBlock@@AEBVBlockSource@@AEBVBlockPos@@PEBVAABB@@AEAV?$vector@VAABB@@V?$allocator@VAABB@@@std@@@std@@@Z
    ...
    // vIndex: 10, symbol: ?getOutline@BlockLegacy@@UEBAAEBVAABB@@AEBVBlock@@AEBVIConstBlockSource@@AEBVBlockPos@@AEAV2@@Z
    ...
    // vIndex: 11, symbol: ?getVisualShapeInWorld@BlockLegacy@@UEBAAEBVAABB@@AEBVBlock@@AEBVIConstBlockSource@@AEBVBlockPos@@AEAV2@@Z
    ...
    // vIndex: 20, symbol: ?liquidCanFlowIntoFromDirection@BlockLegacy@@UEBA_NEAEBV?$function@$$A6AAEBVBlock@@AEBVBlockPos@@@Z@std@@AEBVBlockPos@@@Z
    ...
    virtual bool canProvideFullSupport(class Block const &, uint8_t) const;
    ...
    // vIndex: 82, symbol: ?updateEntityAfterFallOn@BlockLegacy@@UEBAXAEBVBlockPos@@AEAUUpdateEntityAfterFallOnInterface@@@Z
    ...
    // vIndex: 87, symbol: ?onFertilized@BlockLegacy@@UEBA_NAEAVBlockSource@@AEBVBlockPos@@PEAVActor@@W4FertilizerType@@@Z
    ...
    // vIndex: 95, symbol: ?tryToPlace@BlockLegacy@@UEBA_NAEAVBlockSource@@AEBVBlockPos@@AEBVBlock@@PEBUActorBlockSyncMessage@@@Z
    ...
    // vIndex: 103, symbol: ?spawnResources@BlockLegacy@@UEBAXAEAVBlockSource@@AEBVBlockPos@@AEBVBlock@@AEAVRandomize@@AEBUResourceDropsContext@@@Z
    ...
    // vIndex: 105, symbol: ?trySpawnResourcesOnExplosion@BlockLegacy@@UEBAXAEAVBlockSource@@AEBVBlockPos@@AEBVBlock@@AEAVRandomize@@M@Z
    ...
    // vIndex: 116, symbol: ?executeEvent@BlockLegacy@@UEBAXAEBV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@AEAVRenderParams@@@Z
    virtual void executeEvent(std::string const &, class RenderParams &) const;

    // vIndex: 117, symbol: ?executeEvent@BlockLegacy@@UEBAXAEAVBlockSource@@AEBVBlockPos@@AEBVBlock@@AEBV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@AEAVActor@@@Z
    ...
    // vIndex: 132, symbol: ?buildDescriptionId@BlockLegacy@@UEBA?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@AEBVBlock@@@Z
    ...
    virtual class BlockLegacy & addState(class BlockState const &, uint64_t);
    ...
    // vIndex: 177, symbol: ?getRenderLayer@BlockLegacy@@MEBA?AW4BlockRenderLayer@@AEBVBlock@@AEAVBlockSource@@AEBVBlockPos@@@Z
    ...
    // vIndex: 189, symbol: ?_executeEvent@BlockLegacy@@EEBAXAEBV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@AEAV?$vector@U?$pair@$$CBV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@$$CBV12@@std@@V?$allocator@U?$pair@$$CBV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@$$CBV12@@std@@@2@@3@AEAVRenderParams@@@Z
    virtual void _executeEvent(std::string const &, std::vector<std::pair<std::string const, std::string const>> &, class RenderParams &) const;

    // vIndex: 190, symbol: ?_executeTrigger@BlockLegacy@@EEBA_NAEBVDefinitionTrigger@@AEAV?$vector@U?$pair@$$CBV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@$$CBV12@@std@@V?$allocator@U?$pair@$$CBV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@$$CBV12@@std@@@2@@std@@AEAVRenderParams@@@Z
    virtual bool _executeTrigger(class DefinitionTrigger const &, std::vector<std::pair<std::string const, std::string const>> &, class RenderParams &) const;

    // vIndex: 191, symbol: ?_forceExecuteTrigger@BlockLegacy@@EEBAXAEBVDefinitionTrigger@@AEAV?$vector@U?$pair@$$CBV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@$$CBV12@@std@@V?$allocator@U?$pair@$$CBV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@$$CBV12@@std@@@2@@std@@AEAVRenderParams@@@Z
    virtual void _forceExecuteTrigger(class DefinitionTrigger const &, std::vector<std::pair<std::string const, std::string const>> &, class RenderParams &) const;
    ...
    MCVAPI void onPlayerPlacing(class BlockSource &, class BlockPos const &, class Actor &, uint8_t) const;
    ...
    MCAPI BlockLegacy(std::string const &, int32_t, class Material const &);
    ...
    // symbol: ?addGetPlacementBlockCallback@BlockLegacy@@QEAAXV?$unique_ptr@VIGetPlacementBlockCallback@BlockTrait@@U?$default_delete@VIGetPlacementBlockCallback@BlockTrait@@@std@@@std@@@Z
    ...
    MCAPI void createBlockPermutations(uint32_t);
    ...
    MCAPI int16_t getBlockItemId() const;
    ...
    MCAPI int32_t getExperienceDrop(class Random &) const;
    ...
    MCAPI uint64_t getUniquePermutations() const;
    ...
    MCAPI class Block const * tryGetStateFromLegacyData(uint16_t) const;
    ...
    // symbol: ?getConnectedDirections@BlockLegacy@@SA?AUHorizontalDirectionBits@1@AEBVBlock@@AEBVBlockPos@@AEBVIConstBlockSource@@@Z
    MCAPI static struct BlockLegacy::HorizontalDirectionBits getConnectedDirections(class Block const &, class BlockPos const &, class IConstBlockSource const &);

    // symbol: ?getPlacementFacingAll@BlockLegacy@@SAEAEBVActor@@AEBVBlockPos@@M@Z
    MCAPI static uint8_t getPlacementFacingAll(class Actor const &, class BlockPos const &, float);

    // symbol: ?getPlacementFacingAllExceptAxisY@BlockLegacy@@SAEAEBVActor@@AEBVBlockPos@@M@Z
    MCAPI static uint8_t getPlacementFacingAllExceptAxisY(class Actor const &, class BlockPos const &, float);
    ...
    MCAPI std::optional<int32_t> _tryLookupAlteredStateCollection(uint64_t, uint16_t) const;

    // symbol: ?_trySetStateFromAlteredStateCollection@BlockLegacy@@AEBAPEBVBlock@@_KHG@Z
    MCAPI class Block const * _trySetStateFromAlteredStateCollection(uint64_t, int32_t, uint16_t) const;
