...
public:
    ...
    // vIndex: 6, symbol: ?getCollisionShape@MobSpawnerBlock@@UEBA?AVAABB@@AEBVBlock@@AEBVIConstBlockSource@@AEBVBlockPos@@V?$optional_ref@$$CBVGetCollisionShapeInterface@@@@@Z
    ...
    // vIndex: 10, symbol: ?getOutline@MobSpawnerBlock@@UEBAAEBVAABB@@AEBVBlock@@AEBVIConstBlockSource@@AEBVBlockPos@@AEAV2@@Z
    ...
    // vIndex: 63, symbol: ?canContainLiquid@MobSpawnerBlock@@UEBA_NXZ
    ...
    // vIndex: 185, symbol: ?getResourceItem@MobSpawnerBlock@@UEBA?AVItemInstance@@AEAVRandomize@@AEBVBlock@@H@Z
    virtual class ItemInstance getResourceItem(class Randomize &, class Block const &, int32_t) const;

    // vIndex: 186, symbol: ?getResourceCount@MobSpawnerBlock@@UEBAHAEAVRandomize@@AEBVBlock@@H@Z
    ...
    MCAPI MobSpawnerBlock(std::string const &, int32_t);
