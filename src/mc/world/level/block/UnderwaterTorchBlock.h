...
public:
    ...
    // vIndex: 37, symbol: ?isWaterBlocking@UnderwaterTorchBlock@@UEBA_NXZ
    ...
    // vIndex: 63, symbol: ?canContainLiquid@UnderwaterTorchBlock@@UEBA_NXZ
    virtual bool canContainLiquid() const;

    // vIndex: 67, symbol: ?canBeUsedInCommands@UnderwaterTorchBlock@@UEBA_NAEBVBaseGameVersion@@@Z
    ...
    // vIndex: 93, symbol: ?mayPlace@UnderwaterTorchBlock@@UEBA_NAEAVBlockSource@@AEBVBlockPos@@@Z
    ...
    // vIndex: 147, symbol: ?animateTickBedrockLegacy@UnderwaterTorchBlock@@UEBAXAEAVBlockSource@@AEBVBlockPos@@AEAVRandom@@@Z
