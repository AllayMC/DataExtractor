...
public:
    ...
    CobblestoneBlock& operator=(CobblestoneBlock const &) = delete;
    CobblestoneBlock(CobblestoneBlock const &) = delete;
...
public:
    ...
    // vIndex: 156, symbol: ?tryGetInfested@CobblestoneBlock@@UEBAPEBVBlock@@AEBV2@@Z
    ...
    MCAPI CobblestoneBlock(std::string const &, int32_t, class Material const &);
