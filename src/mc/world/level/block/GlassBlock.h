...
public:
    ...
    // vIndex: 7, symbol: ?getCollisionShapeForCamera@GlassBlock@@UEBA_NAEAVAABB@@AEBVBlock@@AEBVIConstBlockSource@@AEBVBlockPos@@@Z
    ...
    // vIndex: 67, symbol: ?canBeUsedInCommands@GlassBlock@@UEBA_NAEBVBaseGameVersion@@@Z
    ...
    // vIndex: 97, symbol: ?breaksFallingBlocks@GlassBlock@@UEBA_NAEBVBlock@@VBaseGameVersion@@@Z
