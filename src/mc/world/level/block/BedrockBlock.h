...
public:
    ...
    // vIndex: 54, symbol: ?canBeOriginalSurface@BedrockBlock@@UEBA_NXZ
    ...
    // vIndex: 158, symbol: ?_addHardCodedBlockComponents@BedrockBlock@@UEAAXXZ
    ...
    // vIndex: 187, symbol: ?getSilkTouchItemInstance@BedrockBlock@@UEBA?AVItemInstance@@AEBVBlock@@@Z
    virtual class ItemInstance getSilkTouchItemInstance(class Block const &) const;

    // symbol: ??0BedrockBlock@@QEAA@AEBV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@H@Z
    MCAPI BedrockBlock(std::string const &, int32_t);
