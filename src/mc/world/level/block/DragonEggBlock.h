...
public:
    ...
    DragonEggBlock& operator=(DragonEggBlock const &) = delete;
    DragonEggBlock(DragonEggBlock const &) = delete;
...
public:
    ...
    // vIndex: 103, symbol: ?spawnResources@DragonEggBlock@@UEBAXAEAVBlockSource@@AEBVBlockPos@@AEBVBlock@@AEAVRandomize@@AEBUResourceDropsContext@@@Z
    ...
    MCAPI DragonEggBlock(std::string const &, int32_t);
