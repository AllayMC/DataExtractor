...
public:
    ...
    AzaleaBlock& operator=(AzaleaBlock const &) = delete;
    AzaleaBlock(AzaleaBlock const &) = delete;
    AzaleaBlock() = delete;
...
public:
    ...
    // vIndex: 6, symbol: ?getCollisionShape@AzaleaBlock@@UEBA?AVAABB@@AEBVBlock@@AEBVIConstBlockSource@@AEBVBlockPos@@V?$optional_ref@$$CBVGetCollisionShapeInterface@@@@@Z
    ...
    // vIndex: 37, symbol: ?isWaterBlocking@AzaleaBlock@@UEBA_NXZ
    ...
    // vIndex: 87, symbol: ?onFertilized@AzaleaBlock@@UEBA_NAEAVBlockSource@@AEBVBlockPos@@PEAVActor@@W4FertilizerType@@@Z
    virtual bool onFertilized(class BlockSource &, class BlockPos const &, class Actor *, ::FertilizerType) const;

    // vIndex: 89, symbol: ?canBeFertilized@AzaleaBlock@@UEBA_NAEAVBlockSource@@AEBVBlockPos@@AEBVBlock@@@Z
    virtual bool canBeFertilized(class BlockSource &, class BlockPos const &, class Block const &) const;

    // vIndex: 94, symbol: ?mayPlaceOn@AzaleaBlock@@MEBA_NAEAVBlockSource@@AEBVBlockPos@@@Z
