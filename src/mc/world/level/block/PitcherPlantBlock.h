...
public:
    ...
    // vIndex: 87, symbol: ?onFertilized@PitcherPlantBlock@@UEBA_NAEAVBlockSource@@AEBVBlockPos@@PEAVActor@@W4FertilizerType@@@Z
    virtual bool onFertilized(class BlockSource &, class BlockPos const &, class Actor *, ::FertilizerType) const;

    // vIndex: 89, symbol: ?canBeFertilized@PitcherPlantBlock@@UEBA_NAEAVBlockSource@@AEBVBlockPos@@AEBVBlock@@@Z
    ...
    // vIndex: 185, symbol: ?getResourceItem@PitcherPlantBlock@@MEBA?AVItemInstance@@AEAVRandomize@@AEBVBlock@@H@Z
    virtual class ItemInstance getResourceItem(class Randomize &, class Block const &, int32_t) const;

    // vIndex: 186, symbol: ?getResourceCount@PitcherPlantBlock@@UEBAHAEAVRandomize@@AEBVBlock@@H@Z
    ...
    MCAPI PitcherPlantBlock(std::string const &, int32_t);
