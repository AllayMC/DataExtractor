...
public:
    ...
    // vIndex: 6, symbol: ?getCollisionShape@HoneyBlock@@UEBA?AVAABB@@AEBVBlock@@AEBVIConstBlockSource@@AEBVBlockPos@@V?$optional_ref@$$CBVGetCollisionShapeInterface@@@@@Z
    ...
    // vIndex: 12, symbol: ?getVisualShape@HoneyBlock@@UEBAAEBVAABB@@AEBVBlock@@AEAV2@@Z
    ...
    // vIndex: 161, symbol: ?onStandOn@HoneyBlock@@UEBAXAEAVEntityContext@@AEBVBlockPos@@@Z
    ...
    // vIndex: 166, symbol: ?onFallOn@HoneyBlock@@UEBAXAEAVBlockSource@@AEBVBlockPos@@AEAVActor@@M@Z
    ...
    // vIndex: 178, symbol: ?getExtraRenderLayers@HoneyBlock@@UEBAHXZ
