...
public:
    ...
    // vIndex: 10, symbol: ?getOutline@TorchflowerCropBlock@@UEBAAEBVAABB@@AEBVBlock@@AEBVIConstBlockSource@@AEBVBlockPos@@AEAV2@@Z
    ...
    // vIndex: 87, symbol: ?onFertilized@TorchflowerCropBlock@@MEBA_NAEAVBlockSource@@AEBVBlockPos@@PEAVActor@@W4FertilizerType@@@Z
    ...
    // vIndex: 195, symbol: ?getBaseCrop@TorchflowerCropBlock@@UEBA?BVItemInstance@@XZ
