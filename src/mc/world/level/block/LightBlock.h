...
public:
    ...
    LightBlock& operator=(LightBlock const &) = delete;
    LightBlock(LightBlock const &) = delete;
    LightBlock() = delete;
...
public:
    ...
    // vIndex: 6, symbol: ?getCollisionShape@LightBlock@@UEBA?AVAABB@@AEBVBlock@@AEBVIConstBlockSource@@AEBVBlockPos@@V?$optional_ref@$$CBVGetCollisionShapeInterface@@@@@Z
    ...
    // vIndex: 8, symbol: ?addCollisionShapes@LightBlock@@UEBA_NAEBVBlock@@AEBVBlockSource@@AEBVBlockPos@@PEBVAABB@@AEAV?$vector@VAABB@@V?$allocator@VAABB@@@std@@@std@@V?$optional_ref@$$CBVGetCollisionShapeInterface@@@@@Z
    ...
    // vIndex: 84, symbol: ?isFilteredOut@LightBlock@@UEBA_NW4BlockRenderLayer@@@Z
    ...
    // vIndex: 95, symbol: ?tryToPlace@LightBlock@@UEBA_NAEAVBlockSource@@AEBVBlockPos@@AEBVBlock@@PEBUActorBlockSyncMessage@@@Z
    ...
    // vIndex: 104, symbol: ?asItemInstance@LightBlock@@UEBA?AVItemInstance@@AEBVBlock@@PEBVBlockActor@@@Z
    ...
    // vIndex: 133, symbol: ?isAuxValueRelevantForPicking@LightBlock@@UEBA_NXZ
    virtual bool isAuxValueRelevantForPicking() const;

    // vIndex: 149, symbol: ?init@LightBlock@@UEAAAEAVBlockLegacy@@XZ
    virtual class BlockLegacy & init();

    // vIndex: 150, symbol: ?getLightEmission@LightBlock@@UEBA?AUBrightness@@AEBVBlock@@@Z
