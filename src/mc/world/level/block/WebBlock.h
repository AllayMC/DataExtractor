...
public:
    ...
    // vIndex: 6, symbol: ?getCollisionShape@WebBlock@@UEBA?AVAABB@@AEBVBlock@@AEBVIConstBlockSource@@AEBVBlockPos@@V?$optional_ref@$$CBVGetCollisionShapeInterface@@@@@Z
    ...
    // vIndex: 103, symbol: ?spawnResources@WebBlock@@UEBAXAEAVBlockSource@@AEBVBlockPos@@AEBVBlock@@AEAVRandomize@@AEBUResourceDropsContext@@@Z
    ...
    // vIndex: 158, symbol: ?_addHardCodedBlockComponents@WebBlock@@UEAAXXZ
    ...
    // vIndex: 185, symbol: ?getResourceItem@WebBlock@@UEBA?AVItemInstance@@AEAVRandomize@@AEBVBlock@@H@Z
