...
public:
    ...
    // vIndex: 28, symbol: ?canConnect@MelonBlock@@UEBA_NAEBVBlock@@E0@Z
    ...
    // vIndex: 185, symbol: ?getResourceItem@MelonBlock@@UEBA?AVItemInstance@@AEAVRandomize@@AEBVBlock@@H@Z
    virtual class ItemInstance getResourceItem(class Randomize &, class Block const &, int32_t) const;

    // vIndex: 186, symbol: ?getResourceCount@MelonBlock@@UEBAHAEAVRandomize@@AEBVBlock@@H@Z
    ...
    MCAPI MelonBlock(std::string const &, int32_t);
