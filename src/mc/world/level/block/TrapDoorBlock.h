...
public:
    ...
    // vIndex: 10, symbol: ?getOutline@TrapDoorBlock@@UEBAAEBVAABB@@AEBVBlock@@AEBVIConstBlockSource@@AEBVBlockPos@@AEAV2@@Z
    ...
    // vIndex: 70, symbol: ?checkIsPathable@TrapDoorBlock@@UEBA_NAEAVActor@@AEBVBlockPos@@1@Z
    ...
    // vIndex: 80, symbol: ?setupRedstoneComponent@TrapDoorBlock@@UEBAXAEAVBlockSource@@AEBVBlockPos@@@Z
    virtual void setupRedstoneComponent(class BlockSource &, class BlockPos const &) const;

    // vIndex: 83, symbol: __unk_vfn_83
    virtual void __unk_vfn_83();

    // vIndex: 97, symbol: ?breaksFallingBlocks@TrapDoorBlock@@UEBA_NAEBVBlock@@VBaseGameVersion@@@Z
    virtual bool breaksFallingBlocks(class Block const &, class BaseGameVersion) const;

    // vIndex: 104, symbol: ?asItemInstance@TrapDoorBlock@@UEBA?AVItemInstance@@AEBVBlock@@PEBVBlockActor@@@Z
...
public:
    // NOLINTBEGIN
    inline auto& $TRAP_DOOR_DOESNT_BREAK_FALLING_BLOCK_VERSION() { return TRAP_DOOR_DOESNT_BREAK_FALLING_BLOCK_VERSION; }
