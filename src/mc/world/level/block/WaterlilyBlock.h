...
public:
    ...
    WaterlilyBlock& operator=(WaterlilyBlock const &) = delete;
    WaterlilyBlock(WaterlilyBlock const &) = delete;
...
public:
    ...
    // vIndex: 6, symbol: ?getCollisionShape@WaterlilyBlock@@UEBA?AVAABB@@AEBVBlock@@AEBVIConstBlockSource@@AEBVBlockPos@@V?$optional_ref@$$CBVGetCollisionShapeInterface@@@@@Z
    ...
    // vIndex: 10, symbol: ?getOutline@WaterlilyBlock@@UEBAAEBVAABB@@AEBVBlock@@AEBVIConstBlockSource@@AEBVBlockPos@@AEAV2@@Z
    ...
    // vIndex: 37, symbol: ?isWaterBlocking@WaterlilyBlock@@UEBA_NXZ
    ...
    // vIndex: 63, symbol: ?canContainLiquid@WaterlilyBlock@@UEBA_NXZ
    ...
    // vIndex: 94, symbol: ?mayPlaceOn@WaterlilyBlock@@UEBA_NAEAVBlockSource@@AEBVBlockPos@@@Z
    ...
    // vIndex: 175, symbol: ?canSurvive@WaterlilyBlock@@UEBA_NAEAVBlockSource@@AEBVBlockPos@@@Z
