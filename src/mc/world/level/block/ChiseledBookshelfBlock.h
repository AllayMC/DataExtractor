...
public:
    ...
    // vIndex: 104, symbol: ?asItemInstance@ChiseledBookshelfBlock@@UEBA?AVItemInstance@@AEBVBlock@@PEBVBlockActor@@@Z
    ...
    // vIndex: 125, symbol: ?getComparatorSignal@ChiseledBookshelfBlock@@UEBAHAEAVBlockSource@@AEBVBlockPos@@AEBVBlock@@E@Z
    ...
    // vIndex: 159, symbol: ?onRemove@ChiseledBookshelfBlock@@UEBAXAEAVBlockSource@@AEBVBlockPos@@@Z
    ...
    // vIndex: 172, symbol: ?use@ChiseledBookshelfBlock@@UEBA_NAEAVPlayer@@AEBVBlockPos@@EV?$optional@VVec3@@@std@@@Z
    ...
    // vIndex: 185, symbol: ?getResourceItem@ChiseledBookshelfBlock@@UEBA?AVItemInstance@@AEAVRandomize@@AEBVBlock@@H@Z
    virtual class ItemInstance getResourceItem(class Randomize &, class Block const &, int) const;

    // vIndex: 186, symbol: ?getResourceCount@ChiseledBookshelfBlock@@UEBAHAEAVRandomize@@AEBVBlock@@H@Z
    virtual int getResourceCount(class Randomize &, class Block const &, int) const;

    // vIndex: 187, symbol: ?getSilkTouchItemInstance@ChiseledBookshelfBlock@@UEBA?AVItemInstance@@AEBVBlock@@@Z
