...
public:
    ...
    // vIndex: 147, symbol: ?animateTickBedrockLegacy@SoulTorchBlock@@UEBAXAEAVBlockSource@@AEBVBlockPos@@AEAVRandom@@@Z
    virtual void animateTickBedrockLegacy(class BlockSource &, class BlockPos const &, class Random &) const;

    // vIndex: 153, symbol: __unk_vfn_153
    virtual void __unk_vfn_153();

    // vIndex: 158, symbol: ?_addHardCodedBlockComponents@SoulTorchBlock@@UEAAXXZ
