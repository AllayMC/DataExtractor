...
public:
    ...
    DriedKelpBlock& operator=(DriedKelpBlock const &) = delete;
    DriedKelpBlock(DriedKelpBlock const &) = delete;
...
public:
    ...
    MCAPI DriedKelpBlock(std::string const &, int32_t, class Material const &);
