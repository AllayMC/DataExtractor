...
public:
    ...
    BlockLegacyComponentStorageFinaliser& operator=(BlockLegacyComponentStorageFinaliser const &) = delete;
    BlockLegacyComponentStorageFinaliser(BlockLegacyComponentStorageFinaliser const &) = delete;
