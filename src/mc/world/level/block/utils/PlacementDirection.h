...
public:
    ...
    public:
        // NOLINTBEGIN
        // symbol: ?fromStringVector@EnabledStates@PlacementDirection@BlockTrait@@SAXAEAU123@AEBV?$vector@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@V?$allocator@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@2@@std@@@Z
        MCAPI static void fromStringVector(struct BlockTrait::PlacementDirection::EnabledStates &, std::vector<std::string> const &);
    ...
    public:
        ...
        // vIndex: 1, symbol: ?getPlacementBlock@UpdateFacingGetPlacementBlockCallback@PlacementDirection@BlockTrait@@UEBA?AV?$not_null@PEBVBlock@@@gsl@@V45@AEBVActor@@AEBVBlockPos@@EAEBVVec3@@H@Z
        virtual class gsl::not_null<class Block const *> getPlacementBlock(class gsl::not_null<class Block const *>, class Actor const &, class BlockPos const &, uint8_t, class Vec3 const &, int32_t) const;
...
public:
    ...
    // vIndex: 2, symbol: ?buildNetworkTag@PlacementDirection@BlockTrait@@UEBA?AV?$unique_ptr@VCompoundTag@@U?$default_delete@VCompoundTag@@@std@@@std@@XZ
    ...
    // symbol: ?getName@PlacementDirection@BlockTrait@@SAAEBV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@XZ
