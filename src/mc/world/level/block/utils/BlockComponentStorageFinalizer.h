...
public:
    ...
    BlockComponentStorageFinalizer& operator=(BlockComponentStorageFinalizer const &) = delete;
    BlockComponentStorageFinalizer(BlockComponentStorageFinalizer const &) = delete;
    BlockComponentStorageFinalizer() = delete;
