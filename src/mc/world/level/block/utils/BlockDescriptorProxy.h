...
public:
    // NOLINTBEGIN
    // symbol: ??0BlockDescriptorProxy@BlockDescriptorSerializer@@QEAA@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@V?$vector@UState@BlockDescriptor@@V?$allocator@UState@BlockDescriptor@@@std@@@3@0@Z
