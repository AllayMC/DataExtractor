...
namespace SplitBlockUtils {
    // NOLINTBEGIN
    // symbol: ?LegacyBlockInfos@SplitBlockUtils@@3V?$vector@V?$reference_wrapper@$$CBULegacyBlockInfo@SplitBlockUtils@@@std@@V?$allocator@V?$reference_wrapper@$$CBULegacyBlockInfo@SplitBlockUtils@@@std@@@2@@std@@B
    MCAPI extern std::vector<std::reference_wrapper<struct SplitBlockUtils::LegacyBlockInfo const>> const LegacyBlockInfos;
    ...
    // symbol: ?LegacyConcreteInfo@SplitBlockUtils@@3ULegacyBlockInfo@1@B
    ...
    MCAPI extern struct SplitBlockUtils::LegacyBlockInfo const LegacyLog2Info;
    ...
    MCAPI extern struct SplitBlockUtils::LegacyBlockInfo const LegacyWoolInfo;
    // NOLINTEND
