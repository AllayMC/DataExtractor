...
namespace BlockSerializationUtils {
    ...
    MCAPI extern std::unordered_map<class HashedString,std::function<void (int32_t, class CompoundTag &)>> BLOCK_REPLACE_DATA_MAP;
    ...
    // symbol: ?getBlockFromNBT@BlockSerializationUtils@@YAAEBVBlock@@AEBVCompoundTag@@V?$NonOwnerPointer@VIUnknownBlockTypeRegistry@@@Bedrock@@@Z
    MCAPI class Block const & getBlockFromNBT(class CompoundTag const &, class Bedrock::NonOwnerPointer<class IUnknownBlockTypeRegistry>);
    ...
    MCAPI std::pair<::BlockSerializationUtils::NBTState, class Block const *> tryGetBlockFromNBT(class CompoundTag const &, struct BlockSerializationUtils::NbtToBlockCache *);
    // NOLINTEND
