...
public:
    ...
    BlockLegacyComponentStorageFinalizer& operator=(BlockLegacyComponentStorageFinalizer const &) = delete;
    BlockLegacyComponentStorageFinalizer(BlockLegacyComponentStorageFinalizer const &) = delete;
    BlockLegacyComponentStorageFinalizer() = delete;
