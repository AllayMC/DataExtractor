...
public:
    ...
    // vIndex: 158, symbol: ?_addHardCodedBlockComponents@CraftingTableBlock@@UEAAXXZ
    ...
    // vIndex: 173, symbol: ?use@CraftingTableBlock@@UEBA_NAEAVPlayer@@AEBVBlockPos@@E@Z
    ...
    // symbol: ?isCraftingBlock@CraftingTableBlock@@UEBA_NXZ
