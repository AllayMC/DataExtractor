...
public:
    ...
    // vIndex: 103, symbol: ?spawnResources@InfestedBlock@@UEBAXAEAVBlockSource@@AEBVBlockPos@@AEBVBlock@@AEAVRandomize@@AEBUResourceDropsContext@@@Z
    ...
    // vIndex: 104, symbol: ?asItemInstance@InfestedBlock@@UEBA?AVItemInstance@@AEBVBlock@@PEBVBlockActor@@@Z
    ...
    // vIndex: 132, symbol: ?buildDescriptionId@InfestedBlock@@UEBA?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@AEBVBlock@@@Z
    virtual std::string buildDescriptionId(class Block const &) const;

    // vIndex: 133, symbol: ?isAuxValueRelevantForPicking@InfestedBlock@@UEBA_NXZ
    ...
    // vIndex: 157, symbol: ?tryGetUninfested@InfestedBlock@@UEBAPEBVBlock@@AEBV2@@Z
