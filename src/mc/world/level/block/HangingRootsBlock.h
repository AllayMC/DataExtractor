...
public:
    ...
    // vIndex: 6, symbol: ?getCollisionShape@HangingRootsBlock@@UEBA?AVAABB@@AEBVBlock@@AEBVIConstBlockSource@@AEBVBlockPos@@V?$optional_ref@$$CBVGetCollisionShapeInterface@@@@@Z
    ...
    // vIndex: 10, symbol: ?getOutline@HangingRootsBlock@@UEBAAEBVAABB@@AEBVBlock@@AEBVIConstBlockSource@@AEBVBlockPos@@AEAV2@@Z
    ...
    // vIndex: 17, symbol: ?randomlyModifyPosition@HangingRootsBlock@@UEBA?AVVec3@@AEBVBlockPos@@@Z
    ...
    // vIndex: 63, symbol: ?canContainLiquid@HangingRootsBlock@@UEBA_NXZ
    ...
    // vIndex: 93, symbol: ?mayPlace@HangingRootsBlock@@UEBA_NAEAVBlockSource@@AEBVBlockPos@@@Z
    virtual bool mayPlace(class BlockSource &, class BlockPos const &) const;

    // vIndex: 100, symbol: ?neighborChanged@HangingRootsBlock@@UEBAXAEAVBlockSource@@AEBVBlockPos@@1@Z
    virtual void neighborChanged(class BlockSource &, class BlockPos const &, class BlockPos const &) const;

    // vIndex: 103, symbol: ?spawnResources@HangingRootsBlock@@UEBAXAEAVBlockSource@@AEBVBlockPos@@AEBVBlock@@AEAVRandomize@@AEBUResourceDropsContext@@@Z
    ...
    // vIndex: 168, symbol: ?tick@HangingRootsBlock@@UEBAXAEAVBlockSource@@AEBVBlockPos@@AEAVRandom@@@Z
    ...
    // vIndex: 175, symbol: ?canSurvive@HangingRootsBlock@@UEBA_NAEAVBlockSource@@AEBVBlockPos@@@Z
