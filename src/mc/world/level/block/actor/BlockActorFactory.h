...
public:
    ...
    MCAPI static std::shared_ptr<class BlockActor> createBlockEntity(::BlockActorType, class BlockPos const &, class BlockLegacy const &);
...
private:
    ...
    MCAPI static std::vector<std::pair<::BlockActorType, std::function<std::shared_ptr<class BlockActor> (class BlockPos const &)>>> mCustomBlockEntityCreation;
...
public:
    // NOLINTBEGIN
    inline auto& $mCustomBlockEntityCreation() { return mCustomBlockEntityCreation; }
