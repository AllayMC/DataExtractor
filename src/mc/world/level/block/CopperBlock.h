...
public:
    ...
    // vIndex: 30, symbol: ?tryGetCopperBehavior@CopperBlock@@UEBAPEBVCopperBehavior@@XZ
    ...
    // vIndex: 169, symbol: ?randomTick@CopperBlock@@UEBAXAEAVBlockSource@@AEBVBlockPos@@AEAVRandom@@@Z
