...
public:
    ...
    // vIndex: 104, symbol: ?asItemInstance@BlastFurnaceBlock@@UEBA?AVItemInstance@@AEBVBlock@@PEBVBlockActor@@@Z
    ...
    // vIndex: 173, symbol: ?use@BlastFurnaceBlock@@UEBA_NAEAVPlayer@@AEBVBlockPos@@E@Z
    ...
    // vIndex: 185, symbol: ?getResourceItem@BlastFurnaceBlock@@UEBA?AVItemInstance@@AEAVRandomize@@AEBVBlock@@H@Z
    virtual class ItemInstance getResourceItem(class Randomize &, class Block const &, int) const;

    // vIndex: 187, symbol: ?getSilkTouchItemInstance@BlastFurnaceBlock@@UEBA?AVItemInstance@@AEBVBlock@@@Z
