...
public:
    ...
    virtual class OperationNodeDetails::TransferData<class Biome *> _allocateAndFill(uint64, class Pos2d const &, class Pos2d const &) const;
    ...
    MCAPI RegionHillsOperationNode(uint, std::shared_ptr<class OperationNode<class Biome *, class Pos2d>> &, std::shared_ptr<class OperationNode<int, class Pos2d>> &, class BiomeRegistry const &);
