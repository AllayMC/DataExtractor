...
public:
    ...
    // vIndex: 2, symbol: ?_allocateAndFill@?$MixerOperationNode@PEAVBiome@@VPos2d@@PEAV1@$$V@@MEBA?AV?$TransferData@PEAVBiome@@@OperationNodeDetails@@_KAEBVPos2d@@1@Z
    virtual class OperationNodeDetails::TransferData<class Biome *> _allocateAndFill(uint64_t, class Pos2d const &, class Pos2d const &) const;

    // vIndex: 3, symbol: ?_fillArea@RegionHillsOperationNode@@MEBAXAEAV?$WorkingData@PEAVBiome@@PEAV1@@OperationNodeDetails@@AEBVPos2d@@1H@Z
    virtual void _fillArea(class OperationNodeDetails::WorkingData<class Biome *, class Biome *> &, class Pos2d const &, class Pos2d const &, int32_t) const;
    ...
    MCAPI RegionHillsOperationNode(uint32_t, std::shared_ptr<class OperationNode<class Biome *, class Pos2d>> &, std::shared_ptr<class OperationNode<int32_t, class Pos2d>> &, class BiomeRegistry const &);
