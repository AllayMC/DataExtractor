...
public:
    ...
    MCAPI void dispatchEvent(class BlockPos const &, uint, class Block const &, class Block const &, class Actor *);
    ...
    MCAPI class BlockEventDispatcherToken registerListener(class Vec3 const &, float, std::function<void (class BlockPos const &, uint, class Block const &, class Actor *)>);
