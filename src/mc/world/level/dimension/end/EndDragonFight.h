...
public:
    ...
    MCAPI void _spawnNewGatewayChunksTask(std::tuple<::EndDragonFight::GatewayTask, struct EndDragonFight::GateWayGenerator, struct EndDragonFight::GateWayGenerator> &);
    ...
    MCAPI void _verifyExitPositionsTask(std::tuple<::EndDragonFight::GatewayTask, struct EndDragonFight::GateWayGenerator, struct EndDragonFight::GateWayGenerator> &);
