...
public:
    ...
    MCAPI void addChunkLoadedRequest(class ChunkLoadedRequest, std::string const &, ::ChunksLoadedStatus, class LevelStorage &);
    ...
    MCAPI ::QueueRequestResult queueRequestOrExecuteAction(class ChunkLoadedRequest, class ServerLevel &, class LevelStorage &, class Dimension &);
    ...
    MCAPI void _addChunkLoadedRequest(class ChunkLoadedRequest, std::string const &, ::ChunksLoadedStatus, class LevelStorage &);
    ...
    MCAPI void _saveRequest(class ChunkLoadedRequest &, std::string const &, ::ChunkRequestListType, class LevelStorage &);
    ...
    MCAPI void _updateAsyncList(class LevelStorage &, class Dimension &, std::function<::ChunksLoadedStatus (class ChunkLoadedRequest &)>);
    ...
    MCAPI void _updateTickingList(class ServerLevel &, class Dimension &, std::function<::ChunksLoadedStatus (class ChunkLoadedRequest &)>);
