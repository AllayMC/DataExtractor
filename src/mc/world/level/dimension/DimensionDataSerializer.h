...
public:
    ...
    MCAPI void forEachKeyWithDimensionPrefix(std::string const &, std::string const &, class LevelStorage &, std::function<void (std::string const &, class CompoundTag const &)> const &);
