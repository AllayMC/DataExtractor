...
public:
    ...
    // vIndex: 7, symbol: ?createNewChunk@ChunkSource@@UEAA?AV?$shared_ptr@VLevelChunk@@@std@@AEBVChunkPos@@W4LoadMode@1@_N@Z
    virtual std::shared_ptr<class LevelChunk> createNewChunk(class ChunkPos const &, ::ChunkSource::LoadMode, bool);

    // vIndex: 8, symbol: ?getOrLoadChunk@ChunkSource@@UEAA?AV?$shared_ptr@VLevelChunk@@@std@@AEBVChunkPos@@W4LoadMode@1@_N@Z
    ...
    // vIndex: 15, symbol: ?writeEntityChunkTransfersToUnloadedChunk@ChunkSource@@UEAAXAEBVChunkKey@@AEBV?$vector@UActorUnloadedChunkTransferEntry@@V?$allocator@UActorUnloadedChunkTransferEntry@@@std@@@std@@@Z
    ...
    // vIndex: 19, symbol: ?acquireDiscarded@ChunkSource@@UEAAXV?$unique_ptr@VLevelChunk@@ULevelChunkFinalDeleter@@@std@@@Z
    ...
    // vIndex: 24, symbol: ?getChunkMap@ChunkSource@@UEAAPEBV?$unordered_map@VChunkPos@@V?$weak_ptr@VLevelChunk@@@std@@U?$hash@VChunkPos@@@3@U?$equal_to@VChunkPos@@@3@V?$allocator@U?$pair@$$CBVChunkPos@@V?$weak_ptr@VLevelChunk@@@std@@@std@@@3@@std@@XZ
    virtual std::unordered_map<class ChunkPos,std::weak_ptr<class LevelChunk>> const * getChunkMap();

    // vIndex: 25, symbol: ?getStorage@ChunkSource@@UEBAAEBV?$unordered_map@VChunkPos@@V?$weak_ptr@VLevelChunk@@@std@@U?$hash@VChunkPos@@@3@U?$equal_to@VChunkPos@@@3@V?$allocator@U?$pair@$$CBVChunkPos@@V?$weak_ptr@VLevelChunk@@@std@@@std@@@3@@std@@XZ
    ...
    // vIndex: 28, symbol: ?tryGetBlendingDataProvider@ChunkSource@@UEAA?AV?$unique_ptr@VBlendingDataProvider@@U?$default_delete@VBlendingDataProvider@@@std@@@std@@XZ
    virtual std::unique_ptr<class BlendingDataProvider> tryGetBlendingDataProvider();

    // vIndex: 29, symbol: ?loadLevelChunkMetaDataDictionary@ChunkSource@@UEAA?AV?$shared_ptr@VLevelChunkMetaDataDictionary@@@std@@XZ
    ...
    MCAPI class GridArea<std::shared_ptr<class LevelChunk>> createEmptyView(::ChunkSource::LoadMode, bool, std::function<void (class buffer_span_mut<std::shared_ptr<class LevelChunk>>, class buffer_span<uint32_t>)>, ::ChunkSourceViewGenerateMode, float const *);
    ...
    MCAPI void _checkLevelChunkForNextStage(class LevelChunk const &, class LevelChunkGridAreaElement<std::weak_ptr<class LevelChunk>> &, ::ChunkState);
    ...
    MCAPI void _checkLevelChunkForPostProcessing(class LevelChunk const &, class LevelChunkGridAreaElement<std::weak_ptr<class LevelChunk>> &);
    ...
    MCAPI void _launchLightingTask(std::shared_ptr<class LevelChunk> const &, std::shared_ptr<class ChunkViewSource> const &, bool);
    ...
    MCAPI void _launchPostProcessingTask(std::shared_ptr<class LevelChunk> const &, std::shared_ptr<class ChunkViewSource> const &, bool);
    ...
    MCAPI void _launchReplacementDataTask(std::shared_ptr<class LevelChunk> const &, std::shared_ptr<class ChunkViewSource> const &, bool);
