...
public:
    ...
    MCAPI static bool isValidTag(::IRequestAction::RequestActionType, class CompoundTag const &);
    ...
    MCAPI static std::unique_ptr<class IRequestAction> load(::IRequestAction::RequestActionType, class CompoundTag const &, class ICommandOriginLoader &, std::string const &);
