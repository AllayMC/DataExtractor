...
public:
    ...
    public:
        ...
        MCAPI struct FeatureTerrainAdjustments::Descriptions & operator=(struct FeatureTerrainAdjustments::Descriptions &&);
...
public:
    ...
    MCAPI std::shared_ptr<bool> _insertDescriptions(std::vector<class ChunkPos> const &, std::function<void (struct FeatureTerrainAdjustments::Descriptions &, std::weak_ptr<bool>)> &&);
