...
public:
    ...
    MCAPI void forEachFeature(std::function<void (class HashedString const &, class WeakRefT<struct FeatureRefTraits>)>) const;
    ...
    // symbol: ?_setupFeature@FeatureRegistry@@AEAA_NAEAVIWorldRegistriesProvider@@_NAEBVResourcePackManager@@AEBV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@3AEBVSemVersion@@1@Z
    MCAPI bool _setupFeature(class IWorldRegistriesProvider &, bool, class ResourcePackManager const &, std::string const &, std::string const &, class SemVersion const &, bool);
