...
public:
    // NOLINTBEGIN
    // symbol: ?attachAutomaticFeatures@AutomaticFeatureRules@@QEBAXAEAVResourcePackManager@@AEAVIWorldRegistriesProvider@@@Z
    ...
    MCAPI std::unordered_map<std::string,std::unordered_map<class HashedString,struct AutomaticFeatureRules::AutomaticFeatureRule>> parseAutomaticFeatures(class ResourcePackManager &, class IWorldRegistriesProvider &) const;
    ...
    MCAPI void _parseAndInsertUnsorted(class JsonUtil::JsonSchemaObjectNode<class JsonUtil::EmptyClass, std::tuple<std::reference_wrapper<std::string>, std::reference_wrapper<struct AutomaticFeatureRules::AutomaticFeatureRule>, std::reference_wrapper<class IWorldRegistriesProvider>>> const &, std::string const &, std::string const &, class SemVersion const &, class IWorldRegistriesProvider &, std::unordered_map<std::string,std::unordered_map<class HashedString,struct AutomaticFeatureRules::AutomaticFeatureRule>> &, bool) const;
