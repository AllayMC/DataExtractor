...
public:
    ...
    MCAPI void _buildHand(class BlockSource &, class BlockPos const &, class Random &, std::vector<class BlockPos> &, std::vector<std::pair<class BlockPos, uint8_t>> &, class gsl::not_null<class Block const *>) const;
    ...
    MCAPI void _buildPlantArm(class BlockSource &, class Random &, class BlockPos const &, class gsl::not_null<class Block const *>, std::vector<class BlockPos> &, std::vector<std::pair<class BlockPos, uint8_t>> &, uint8_t, bool) const;
    ...
    MCAPI void _buildPlantLike(class BlockSource &, class BlockPos const &, class Random &, std::vector<class BlockPos> &, std::vector<std::pair<class BlockPos, uint8_t>> &, class gsl::not_null<class Block const *>) const;
    ...
    MCAPI void _buildSmallClump(class BlockSource &, class BlockPos const &, class Random &, std::vector<class BlockPos> &, std::vector<std::pair<class BlockPos, uint8_t>> &, class gsl::not_null<class Block const *>) const;
    ...
    MCAPI void _buildSpire(class BlockSource &, class BlockPos const &, class Random &, std::vector<class BlockPos> &, std::vector<std::pair<class BlockPos, uint8_t>> &, class gsl::not_null<class Block const *>) const;
    ...
    MCAPI bool _setBlock(class BlockSource &, class BlockPos const &, class gsl::not_null<class Block const *>, int32_t) const;

    // symbol: ?_setBlockOnSolid@CoralFeature@@AEBA_NAEAVBlockSource@@AEBVBlockPos@@V?$not_null@PEBVBlock@@@gsl@@H@Z
    MCAPI bool _setBlockOnSolid(class BlockSource &, class BlockPos const &, class gsl::not_null<class Block const *>, int32_t) const;

    // symbol: ?_starCorners@CoralFeature@@AEBAXAEAVBlockSource@@AEAVRandom@@AEBVBlockPos@@V?$not_null@PEBVBlock@@@gsl@@MH_N@Z
    MCAPI void _starCorners(class BlockSource &, class Random &, class BlockPos const &, class gsl::not_null<class Block const *>, float, int32_t, bool) const;

    // symbol: ?_starFormation@CoralFeature@@AEBAXAEAVBlockSource@@AEAVRandom@@AEBVBlockPos@@V?$not_null@PEBVBlock@@@gsl@@MH_N@Z
    MCAPI void _starFormation(class BlockSource &, class Random &, class BlockPos const &, class gsl::not_null<class Block const *>, float, int32_t, bool) const;
