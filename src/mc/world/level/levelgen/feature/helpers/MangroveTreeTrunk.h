...
public:
    ...
    // vIndex: 1, symbol: ?placeTrunk@MangroveTreeTrunk@@UEBA?AV?$optional@VBlockPos@@@std@@AEAVIBlockWorldGenAPI@@AEBVBlockPos@@AEAVRandom@@HAEAVRenderParams@@AEBUTreeParams@TreeHelper@@PEBVITreeCanopy@@@Z
    ...
    MCAPI void _placeBranch(class IBlockWorldGenAPI &, std::vector<class BlockPos> *, class Random &, int32_t, class RenderParams &, struct TreeHelper::TreeParams const &, class BlockPos &, int32_t, uint8_t, int32_t, int32_t, class Block const *) const;
