...
public:
    ...
    // vIndex: 1, symbol: ?placeTrunk@MegaTreeTrunk@@UEBA?AV?$optional@VBlockPos@@@std@@AEAVIBlockWorldGenAPI@@AEBVBlockPos@@AEAVRandom@@HAEAVRenderParams@@AEBUTreeParams@TreeHelper@@PEBVITreeCanopy@@@Z
    ...
    MCAPI bool _prepareSpawn(class IBlockWorldGenAPI &, class BlockPos const &, int32_t, struct TreeHelper::TreeParams const &) const;
