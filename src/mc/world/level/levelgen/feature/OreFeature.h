...
public:
    ...
    public:
        // NOLINTBEGIN
        // symbol: ?setRules@ReplaceRulesAccelerator@OreFeature@@QEAAXAEBV?$vector@UReplaceRule@@V?$allocator@UReplaceRule@@@std@@@std@@@Z
...
public:
    ...
    // vIndex: 1, symbol: ?place@OreFeature@@UEBA?AV?$optional@VBlockPos@@@std@@AEAVIBlockWorldGenAPI@@AEBVBlockPos@@AEAVRandom@@AEAVRenderParams@@@Z
