...
public:
    ...
    MCAPI JigsawEditorData(std::string const &, std::string const &, std::string const &, std::string const &, ::JigsawJointType);
...
private:
    ...
    MCAPI static std::unordered_map<int32_t,std::string> const JOINT_TYPE_TO_NAME;
