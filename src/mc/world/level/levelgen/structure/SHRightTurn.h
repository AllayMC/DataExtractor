...
public:
    ...
    SHRightTurn& operator=(SHRightTurn const &) = delete;
    SHRightTurn(SHRightTurn const &) = delete;
    SHRightTurn() = delete;
...
public:
    ...
    // vIndex: 3, symbol: ?addChildren@SHRightTurn@@UEAAXAEAVStructurePiece@@AEAV?$vector@V?$unique_ptr@VStructurePiece@@U?$default_delete@VStructurePiece@@@std@@@std@@V?$allocator@V?$unique_ptr@VStructurePiece@@U?$default_delete@VStructurePiece@@@std@@@std@@@2@@std@@AEAVRandom@@@Z
    virtual void addChildren(class StructurePiece &, std::vector<std::unique_ptr<class StructurePiece>> &, class Random &);

    // vIndex: 4, symbol: ?postProcess@SHRightTurn@@UEAA_NAEAVBlockSource@@AEAVRandom@@AEBVBoundingBox@@@Z
