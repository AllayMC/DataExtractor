...
public:
    ...
    MCAPI void registerActorRules(std::string, std::unique_ptr<std::vector<std::unique_ptr<class StructurePoolActorRule, std::default_delete<class StructurePoolActorRule>>>> &&);
