...
public:
    ...
    MCAPI void registerBlockRules(std::string, std::unique_ptr<std::vector<std::unique_ptr<class StructurePoolBlockRule, std::default_delete<class StructurePoolBlockRule>>>> &&);
