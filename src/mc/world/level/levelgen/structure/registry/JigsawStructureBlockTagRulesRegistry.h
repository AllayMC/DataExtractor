...
public:
    ...
    MCAPI void registerBlockTagRules(std::string, std::unique_ptr<std::vector<std::unique_ptr<class StructurePoolBlockTagRule, std::default_delete<class StructurePoolBlockTagRule>>>> &&);
