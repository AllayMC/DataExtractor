...
public:
    ...
    MCAPI JigsawPlacement(uint64, uint64, std::vector<std::unique_ptr<class StructurePiece>> &, std::function<std::unique_ptr<class PoolElementStructurePiece> (class StructurePoolElement const &, class BlockPos const &, ::Rotation const &, int, struct JigsawJunction &, class BoundingBox const &, class BlockPos const &)>, class Random &, class JigsawStructureRegistry const &, class Dimension &);
    ...
    MCAPI void _addPiece(class PoolElementStructurePiece const &, class BlockPos const &, ::Rotation const &, class BlockPos const &, uint64);
    ...
    MCAPI bool _tryPlacingPiece(class PoolElementStructurePiece const &, class BoundingBox const &, class JigsawBlockInfo const &, class BlockPos const &, class StructureTemplatePool const *, class BlockPos const &, uint64);
