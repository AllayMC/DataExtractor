...
public:
    ...
    MCAPI JigsawPlacement(uint64_t, uint64_t, std::vector<std::unique_ptr<class StructurePiece>> &, std::function<std::unique_ptr<class PoolElementStructurePiece> (class StructurePoolElement const &, class BlockPos const &, ::Rotation const &, int32_t, struct JigsawJunction &, class BoundingBox const &, class BlockPos const &)>, class Random &, class JigsawStructureRegistry const &, class Dimension &);
    ...
    MCAPI void _addPiece(class PoolElementStructurePiece const &, class BlockPos const &, ::Rotation const &, class BlockPos const &, uint64_t);
    ...
    MCAPI class BlockPos _findLocalAnchorOffset(class StructurePoolElement const &, class BlockPos const &, ::Rotation const &, std::string_view) const;
    ...
    MCAPI std::shared_ptr<bool> _setTerrainAdjustment(::AdjustmentEffect, class BoundingBox const &, struct JigsawJunction const &) const;
    ...
    MCAPI bool _tryPlacingPiece(class PoolElementStructurePiece const &, class BoundingBox const &, class JigsawBlockInfo const &, class BlockPos const &, class StructureTemplatePool const *, class BlockPos const &, uint64_t);
