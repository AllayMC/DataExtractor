...
namespace StructureFeatureTypeNames {
    // NOLINTBEGIN
    // symbol: ?dealiasFeatureName@StructureFeatureTypeNames@@YAAEBV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@AEBV23@@Z
    ...
    // symbol: ?getFeatureNameAliasesMap@StructureFeatureTypeNames@@YAAEBV?$map@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@V12@U?$less@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@2@V?$allocator@U?$pair@$$CBV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@V12@@std@@@2@@std@@XZ
