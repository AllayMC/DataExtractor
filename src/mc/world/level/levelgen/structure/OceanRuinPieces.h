...
public:
    ...
    public:
        ...
        MCAPI OceanRuinPiece(Bedrock::NotNullNonOwnerPtr<class StructureManager>, std::string, class BlockPos const &, ::Rotation, float, bool, ::OceanTempCategory);
...
public:
    ...
    MCAPI static void addPieces(Bedrock::NotNullNonOwnerPtr<class StructureManager>, class BlockPos const &, ::Rotation const &, std::vector<std::unique_ptr<class StructurePiece>> &, class Random &, struct OceanRuinConfiguration const &);
    ...
    MCAPI static void _addClusterRuins(Bedrock::NotNullNonOwnerPtr<class StructureManager>, class Random &, ::Rotation const &, class BlockPos const &, struct OceanRuinConfiguration const &, std::vector<std::unique_ptr<class StructurePiece>> &);
    ...
    MCAPI static void _addPiece(Bedrock::NotNullNonOwnerPtr<class StructureManager>, class BlockPos const &, ::Rotation const &, std::vector<std::unique_ptr<class StructurePiece>> &, class Random &, struct OceanRuinConfiguration const &, bool, float);
