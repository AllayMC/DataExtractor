...
public:
    ...
    // vIndex: 3, symbol: ?getNearestGeneratedFeature@WoodlandMansionFeature@@UEAA_NAEAVDimension@@AEBVBiomeSource@@AEBVBlockPos@@AEAV4@AEBVIPreliminarySurfaceProvider@@_N@Z
