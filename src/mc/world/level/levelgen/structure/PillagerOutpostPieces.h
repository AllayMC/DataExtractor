...
public:
    ...
    public:
        ...
        // vIndex: 4, symbol: ?postProcess@PillagerOutpostPiece@PillagerOutpostPieces@@UEAA_NAEAVBlockSource@@AEAVRandom@@AEBVBoundingBox@@@Z
        virtual bool postProcess(class BlockSource &, class Random &, class BoundingBox const &);
    
        // vIndex: 5, symbol: ?postProcessMobsAt@PillagerOutpostPiece@PillagerOutpostPieces@@UEAAXAEAVBlockSource@@AEAVRandom@@AEBVBoundingBox@@@Z
        virtual void postProcessMobsAt(class BlockSource &, class Random &, class BoundingBox const &);
    
        // vIndex: 12, symbol: ?addHardcodedSpawnAreas@PillagerOutpostPiece@PillagerOutpostPieces@@UEBAXAEAVLevelChunk@@@Z
        virtual void addHardcodedSpawnAreas(class LevelChunk &) const;
    
        // vIndex: 13, symbol: ?_handleDataMarker@PillagerOutpostPiece@PillagerOutpostPieces@@MEAAXAEBV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@AEBVBlockPos@@AEAVBlockSource@@AEAVRandom@@AEBVBoundingBox@@@Z
        ...
        // symbol: ??0PillagerOutpostPiece@PillagerOutpostPieces@@QEAA@V?$not_null@V?$NonOwnerPointer@VStructureManager@@@Bedrock@@@gsl@@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@AEBVBlockPos@@W4Rotation@@M_NAEAVDimension@@@Z
        MCAPI PillagerOutpostPiece(class gsl::not_null<class Bedrock::NonOwnerPointer<class StructureManager>>, std::string, class BlockPos const &, ::Rotation, float, bool, class Dimension &);
    
        // NOLINTEND
    
        // private:
        // NOLINTBEGIN
        // symbol: ?_addMobsFromPositions@PillagerOutpostPiece@PillagerOutpostPieces@@AEAAXAEBVBoundingBox@@AEBUActorDefinitionIdentifier@@AEAVBlockSource@@AEBV?$vector@VBlockPos@@V?$allocator@VBlockPos@@@std@@@std@@@Z
        MCAPI void _addMobsFromPositions(class BoundingBox const &, struct ActorDefinitionIdentifier const &, class BlockSource &, std::vector<class BlockPos> const &);
...
public:
    ...
    MCAPI static void _addPiece(class gsl::not_null<class Bedrock::NonOwnerPointer<class StructureManager>>, class BlockPos const &, ::Rotation const &, std::vector<std::unique_ptr<class StructurePiece>> &, class Random &, class Dimension &);
    ...
    MCAPI static void _addScatteredPieces(class gsl::not_null<class Bedrock::NonOwnerPointer<class StructureManager>>, class Random &, ::Rotation const &, class BlockPos const &, std::vector<std::unique_ptr<class StructurePiece>> &, class Dimension &);
