...
public:
    ...
    // vIndex: 3, symbol: ?getNearestGeneratedFeature@StructureFeature@@UEAA_NAEAVDimension@@AEBVBiomeSource@@AEBVBlockPos@@AEAV4@AEBVIPreliminarySurfaceProvider@@_NAEBV?$optional@VHashedString@@@std@@@Z
    ...
    // vIndex: 5, symbol: ?isFeatureChunk@AncientCityFeature@@UEAA_NAEBVBiomeSource@@AEAVRandom@@AEBVChunkPos@@IAEBVIPreliminarySurfaceProvider@@AEBVDimension@@@Z
    virtual bool isFeatureChunk(class BiomeSource const &, class Random &, class ChunkPos const &, uint32_t, class IPreliminarySurfaceProvider const &, class Dimension const &) = 0;

    // vIndex: 6, symbol: ?createStructureStart@AncientCityFeature@@MEAA?AV?$unique_ptr@VStructureStart@@U?$default_delete@VStructureStart@@@std@@@std@@AEAVDimension@@AEBVBiomeSource@@AEAVRandom@@AEBVChunkPos@@AEBVIPreliminarySurfaceProvider@@@Z
    ...
    MCAPI StructureFeature(uint32_t, ::StructureFeatureType);
    ...
    // symbol: ?findNearestFeaturePositionBySpacing@StructureFeature@@SA_NAEAVDimension@@AEBVIPreliminarySurfaceProvider@@AEAV1@AEBV?$optional@VHashedString@@@std@@AEBVBiomeSource@@AEBVBlockPos@@AEAV7@HHH_NH7@Z
    MCAPI static bool findNearestFeaturePositionBySpacing(class Dimension &, class IPreliminarySurfaceProvider const &, class StructureFeature &, std::optional<class HashedString> const &, class BiomeSource const &, class BlockPos const &, class BlockPos &, int32_t, int32_t, int32_t, bool, int32_t, bool);

    // symbol: ?getBiomeForFeatureGeneration@StructureFeature@@SA?AU?$pair@$$CBVBlockPos@@PEBVBiome@@@std@@AEBVBiomeSource@@AEBVChunkPos@@AEBVIPreliminarySurfaceProvider@@@Z
    MCAPI static std::pair<class BlockPos const, class Biome const *> getBiomeForFeatureGeneration(class BiomeSource const &, class ChunkPos const &, class IPreliminarySurfaceProvider const &);

    // symbol: ?getChunkPosInSpace@StructureFeature@@SA?AVChunkPos@@AEBV2@AEAVRandom@@IHHH_N@Z
    MCAPI static class ChunkPos getChunkPosInSpace(class ChunkPos const &, class Random &, uint32_t, int32_t, int32_t, int32_t, bool);
    ...
    // private:
    // NOLINTBEGIN
    // symbol: ?_doesBiomeHaveTag@StructureFeature@@CA_NAEBV?$TagRegistry@U?$IDType@UBiomeTagIDType@@@@U?$IDType@UBiomeTagSetIDType@@@@@@AEBVBiomeSource@@AEBVChunkPos@@AEBVIPreliminarySurfaceProvider@@AEBVHashedString@@@Z
    MCAPI static bool _doesBiomeHaveTag(class TagRegistry<struct IDType<struct BiomeTagIDType>, struct IDType<struct BiomeTagSetIDType>> const &, class BiomeSource const &, class ChunkPos const &, class IPreliminarySurfaceProvider const &, class HashedString const &);
