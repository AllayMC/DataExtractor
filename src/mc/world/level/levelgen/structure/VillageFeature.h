...
public:
    ...
    // vIndex: 3, symbol: ?getNearestGeneratedFeature@VillageFeature@@UEAA_NAEAVDimension@@AEBVBiomeSource@@AEBVBlockPos@@AEAV4@AEBVIPreliminarySurfaceProvider@@_N@Z
    ...
    MCAPI VillageFeature(uint, int, int);
