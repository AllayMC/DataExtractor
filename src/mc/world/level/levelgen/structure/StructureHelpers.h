...
public:
    ...
    MCAPI static bool createChest(class StructurePiece &, class BlockSource &, class BoundingBox const &, class Random &, int, int, int, uchar, std::string const &);
    ...
    MCAPI static int getTorchRotation(int, ushort);
