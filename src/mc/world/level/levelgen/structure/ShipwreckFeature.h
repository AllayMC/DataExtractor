...
public:
    ...
    // vIndex: 3, symbol: ?getNearestGeneratedFeature@ShipwreckFeature@@UEAA_NAEAVDimension@@AEBVBiomeSource@@AEBVBlockPos@@AEAV4@AEBVIPreliminarySurfaceProvider@@_N@Z
