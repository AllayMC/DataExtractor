...
public:
    ...
    MCAPI class StructureTemplateDataResponsePacket createStructureDataExportPacket(std::string const &, class ResourcePackManager const *, class LevelStorage *, ::StructureTemplateResponseType);
    ...
    MCAPI class StructureTemplateDataResponsePacket createStructureDataImportPacket(std::string const &, ::StructureTemplateResponseType);
    ...
    // symbol: ?setUnknownBlockRegistry@StructureManager@@QEAAXV?$NonOwnerPointer@VIUnknownBlockTypeRegistry@@@Bedrock@@@Z
    ...
    MCAPI ::QueueRequestResult tryPlaceStructureInWorld(std::unique_ptr<class CommandArea>, class ServerLevel &, class Dimension &, class BoundingBox const &, class BlockPos const &, class StructureSettings const &, class StructureTemplate const &, std::unique_ptr<class StructureAnimationData>);
