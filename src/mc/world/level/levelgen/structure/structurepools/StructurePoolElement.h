...
public:
    ...
    public:
        ...
        MCAPI LazyTemplate(gsl::not_null<class Bedrock::NonOwnerPointer<class StructureManager>>, std::string const &, std::vector<std::unique_ptr<class StructurePoolBlockTagRule>> const *);
        ...
        MCAPI static std::vector<class JigsawBlockInfo> _findJigsawBlocks(std::vector<class JigsawStructureBlockInfo> &, std::vector<std::unique_ptr<class StructurePoolBlockTagRule>> const *);
...
public:
    ...
    // vIndex: 1, symbol: ?getJigsawMarkers@StructurePoolElement@@UEBA?AV?$vector@VJigsawBlockInfo@@V?$allocator@VJigsawBlockInfo@@@std@@@std@@VBlockPos@@W4Rotation@@@Z
    virtual std::vector<class JigsawBlockInfo> getJigsawMarkers(class BlockPos, ::Rotation) const;

    // vIndex: 2, symbol: ?getJigsawMarkers@StructurePoolElement@@UEBA?AV?$vector@VJigsawBlockInfo@@V?$allocator@VJigsawBlockInfo@@@std@@@std@@VBlockPos@@AEAVLegacyStructureSettings@@PEAVBlockSource@@@Z
    ...
    // vIndex: 9, symbol: ?handleJigsawBlock@StructurePoolElement@@UEBAXAEAVBlockSource@@AEAVJigsawBlockInfo@@AEAVLegacyStructureSettings@@@Z
    virtual void handleJigsawBlock(class BlockSource &, class JigsawBlockInfo &, class LegacyStructureSettings &) const;

    // vIndex: 10, symbol: ?handleDataMarker@StructurePoolElement@@UEBAXAEAVBlockSource@@VBlockPos@@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@AEAV?$unordered_map@VBlockPos@@V?$optional@UActorDefinitionIdentifier@@@std@@U?$hash@VBlockPos@@@3@U?$equal_to@VBlockPos@@@3@V?$allocator@U?$pair@$$CBVBlockPos@@V?$optional@UActorDefinitionIdentifier@@@std@@@std@@@3@@5@@Z
    virtual void handleDataMarker(class BlockSource &, class BlockPos, std::string, std::unordered_map<class BlockPos,std::optional<struct ActorDefinitionIdentifier>> &) const;
    ...
    MCAPI StructurePoolElement(gsl::not_null<class Bedrock::NonOwnerPointer<class StructureManager>>, std::string const &, ::Projection, ::PostProcessSettings);
    ...
    MCAPI StructurePoolElement(gsl::not_null<class Bedrock::NonOwnerPointer<class StructureManager>>, std::string const &, struct StructurePoolElementSettings);
    ...
    MCAPI StructurePoolElement(gsl::not_null<class Bedrock::NonOwnerPointer<class StructureManager>>, std::string const &, std::vector<std::unique_ptr<class StructurePoolBlockRule>> const *, std::vector<std::unique_ptr<class StructurePoolBlockTagRule>> const *, std::vector<std::unique_ptr<class StructurePoolActorRule>> const *, ::Projection, ::PostProcessSettings);
