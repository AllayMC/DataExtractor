...
public:
    ...
    StructurePoolBlockPredicateCappedRandomBlockReplacement& operator=(StructurePoolBlockPredicateCappedRandomBlockReplacement const &) = delete;
    StructurePoolBlockPredicateCappedRandomBlockReplacement(StructurePoolBlockPredicateCappedRandomBlockReplacement const &) = delete;
...
public:
    ...
    // vIndex: 1, symbol: ?test@StructurePoolBlockPredicateCappedRandomBlockReplacement@@UEBA_NAEBVBlock@@AEAVRandomize@@@Z
    virtual bool test(class Block const &, class Randomize &) const;

    // vIndex: 2, symbol: ?test@StructurePoolBlockPredicateCappedRandomBlockReplacement@@UEBA_NAEBVBlockPos@@0AEAVRandomize@@@Z
    virtual bool test(class BlockPos const &, class BlockPos const &, class Randomize &) const;

    // vIndex: 3, symbol: ?finalize@StructurePoolBlockPredicateCappedRandomBlockReplacement@@UEAA_NAEAVBlockSource@@AEAVIRandom@@@Z
