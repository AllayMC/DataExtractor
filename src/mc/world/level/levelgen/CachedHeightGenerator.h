...
namespace CachedHeightGenerator {
    ...
    MCAPI int16_t cachedGenerationOfTerrainHeight(class BlockPos const &, class Dimension &, class BlockVolume &, std::unordered_map<class ChunkPos,std::unique_ptr<std::vector<int16_t>>> &);
    // NOLINTEND
