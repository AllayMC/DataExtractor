...
public:
    ...
    MCAPI FileArchiver(class Scheduler &, class ILevelListCache &, class gsl::not_null<class Bedrock::NonOwnerPointer<class Core::FilePathManager>> const &, class gsl::not_null<class Bedrock::NonOwnerPointer<class IResourcePackRepository>> const &, bool, std::unique_ptr<class FileArchiver::IWorldConverter>, class gsl::not_null<class Bedrock::NonOwnerPointer<class IContentKeyProvider const>>, class gsl::not_null<class Bedrock::NonOwnerPointer<class LevelDbEnv>>, std::function<void (std::string const &)>);
    ...
    MCAPI std::shared_ptr<class Bedrock::Threading::IAsyncResult<struct FileArchiver::Result>> exportPack(class Core::Path const &, class Core::Path const &);

    // symbol: ?exportPack@FileArchiver@@QEAAXAEBVPath@Core@@0V?$function@$$A6AXAEAUResult@FileArchiver@@@Z@std@@@Z
    MCAPI void exportPack(class Core::Path const &, class Core::Path const &, std::function<void (struct FileArchiver::Result &)>);
