...
public:
    ...
    MCAPI std::shared_ptr<class MapItemTrackedActor> addTrackedMapEntity(class Actor &, ::MapDecoration::Type);
    ...
    MCAPI std::shared_ptr<class MapItemTrackedActor> addTrackedMapEntity(class BlockPos const &, class BlockSource &, ::MapDecoration::Type);
    ...
    MCAPI void _addDecoration(::MapDecoration::Type, class Level &, struct MapItemTrackedActor::UniqueId const &, class Vec3 const &, std::string const &, class mce::Color const &);
    ...
    MCAPI std::shared_ptr<class MapItemTrackedActor> _addTrackedMapEntity(struct MapItemTrackedActor::UniqueId const &, class BlockSource &, ::MapDecoration::Type);
    ...
    MCAPI bool _updateTrackedEntityDecoration(class BlockSource &, std::shared_ptr<class MapItemTrackedActor>);
