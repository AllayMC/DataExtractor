...
public:
    ...
    MCAPI std::unordered_set<struct ActorUniqueID> spawnMobGroup(class BlockSource &, std::string const &, class Vec3 const &, bool, bool, std::function<void (class Mob &)> &&);
    ...
    MCAPI static bool findNextSpawnBlockUnder(class BlockSource const &, class BlockPos &, ::MaterialType, ::SpawnBlockRequirements);
