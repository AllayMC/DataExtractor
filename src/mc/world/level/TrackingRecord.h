...
public:
    ...
    // protected:
    // NOLINTBEGIN
    // symbol: ?_addTransaction@TrackingRecord@PositionTrackingDB@@IEAA_NV?$weak_ptr@VPositionTrackingDBServer@PositionTrackingDB@@@std@@V?$unique_ptr@VOperationBase@PositionTrackingDB@@U?$default_delete@VOperationBase@PositionTrackingDB@@@std@@@4@@Z
    MCAPI bool _addTransaction(std::weak_ptr<class PositionTrackingDB::PositionTrackingDBServer>, std::unique_ptr<class PositionTrackingDB::OperationBase>);
    ...
    // symbol: ?loadRecordFromStorage@TrackingRecord@PositionTrackingDB@@IEAA_NV?$weak_ptr@VPositionTrackingDBServer@PositionTrackingDB@@@std@@@Z
