...
public:
    ...
    MCAPI static void inferInitialMetaDataAfterDeserialization(class LevelChunk &, class LevelSeed64, ::GeneratorType, std::string const &, DimensionType, class DimensionHeightRange const &, class BaseGameVersion const &, class LevelChunkMetaData &);
    ...
    MCAPI static std::shared_ptr<class LevelChunkMetaData> initializeLevelChunkMetaData(DimensionType, std::string const &, class DimensionHeightRange const &, bool, class LevelSeed64, ::GeneratorType, class BaseGameVersion const &);
