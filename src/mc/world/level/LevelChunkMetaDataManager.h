...
public:
    ...
    MCAPI static void inferInitialMetaDataAfterDeserialization(class LevelChunk &, class LevelSeed64, ::GeneratorType, std::string const &, class AutomaticID<class Dimension, int>, class DimensionHeightRange const &, class BaseGameVersion const &, class LevelChunkMetaData &);
    ...
    MCAPI static std::shared_ptr<class LevelChunkMetaData> initializeLevelChunkMetaData(class AutomaticID<class Dimension, int>, std::string const &, class DimensionHeightRange const &, bool, class LevelSeed64, ::GeneratorType, class BaseGameVersion const &);
