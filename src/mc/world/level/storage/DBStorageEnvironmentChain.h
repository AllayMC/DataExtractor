...
public:
    ...
    MCAPI static bool isContentKeyValid(class leveldb::Env *, class Core::Path const &, class ContentIdentity const &, std::string const &, std::shared_ptr<class Core::FileStorageArea>);
    ...
    MCAPI static std::unique_ptr<class FlushableEnv> createFlushableEnv(class leveldb::Env *, std::shared_ptr<class Core::FileStorageArea>, class Core::Path const &);
