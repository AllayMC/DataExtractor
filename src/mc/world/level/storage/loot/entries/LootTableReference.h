...
public:
    // NOLINTBEGIN
    // vIndex: 0, symbol: ?_createItem@LootTableReference@@MEAA_NAEAV?$vector@VItemStack@@V?$allocator@VItemStack@@@std@@@std@@AEAVRandom@@AEAVLootTableContext@@@Z
    ...
    MCAPI static std::unique_ptr<class LootPoolEntry> deserialize(class Json::Value, int32_t, int32_t, std::vector<std::unique_ptr<class LootItemCondition>> &);
