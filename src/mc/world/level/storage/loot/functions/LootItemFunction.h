...
private:
    ...
    MCAPI static std::unordered_map<class HashedString,std::function<std::unique_ptr<class LootItemFunction> (class Json::Value &, std::vector<std::unique_ptr<class LootItemCondition>> &)>> const mLootingFunctions;
