...
public:
    ...
    MCAPI ::RandomBlockStateFunction::RemapComplexAliasBlockResult _remapComplexAliasBlock(int32_t, class Block const *&, std::string const &);
    ...
    MCAPI ::RandomBlockStateFunction::RemapComplexAliasBlockResult _tryRemapComplexAliasBlock(class ItemStack &, int32_t, class Block const *&, std::string const &);
    ...
    MCAPI ::RandomBlockStateFunction::RemapComplexAliasBlockResult _tryRemapComplexAliasBlock(class ItemInstance &, int32_t, class Block const *&, std::string const &);
