...
public:
    ...
    public:
        // NOLINTBEGIN
        // symbol: ??0PendingWriteResult@DBStorage@@QEAA@V?$shared_ptr@$$CBV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@std@@_N@Z
...
public:
    ...
    // vIndex: 1, symbol: ?addStorageObserver@DBStorage@@UEAAXV?$unique_ptr@VLevelStorageObserver@@U?$default_delete@VLevelStorageObserver@@@std@@@std@@@Z
    virtual void addStorageObserver(std::unique_ptr<class LevelStorageObserver>);

    // vIndex: 2, symbol: ?getCompoundTag@DBStorage@@UEAA?AV?$unique_ptr@VCompoundTag@@U?$default_delete@VCompoundTag@@@std@@@std@@AEBV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@3@W4Category@DBHelpers@@@Z
    virtual std::unique_ptr<class CompoundTag> getCompoundTag(std::string const &, ::DBHelpers::Category);

    // vIndex: 3, symbol: ?hasKey@DBStorage@@UEBA_NV?$basic_string_view@DU?$char_traits@D@std@@@std@@W4Category@DBHelpers@@@Z
    virtual bool hasKey(std::string_view, ::DBHelpers::Category) const;

    // vIndex: 4, symbol: ?forEachKeyWithPrefix@DBStorage@@UEBAXV?$basic_string_view@DU?$char_traits@D@std@@@std@@W4Category@DBHelpers@@AEBV?$function@$$A6AXV?$basic_string_view@DU?$char_traits@D@std@@@std@@0@Z@3@@Z
    ...
    // vIndex: 6, symbol: ?createChunkStorage@DBStorage@@UEAA?AV?$unique_ptr@VChunkSource@@U?$default_delete@VChunkSource@@@std@@@std@@V23@W4StorageVersion@@@Z
    ...
    // vIndex: 8, symbol: ?getFullPath@DBStorage@@UEBAAEBV?$PathBuffer@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@Core@@XZ
    virtual class Core::PathBuffer<std::string> const & getFullPath() const;

    // vIndex: 9, symbol: ?saveData@DBStorage@@UEAA?AV?$shared_ptr@V?$IAsyncResult@X@Threading@Bedrock@@@std@@AEBV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@3@$$QEAV43@W4Category@DBHelpers@@@Z
    virtual std::shared_ptr<class Bedrock::Threading::IAsyncResult<void>> saveData(std::string const &, std::string &&, ::DBHelpers::Category);

    // vIndex: 10, symbol: ?saveData@DBStorage@@UEAA?AV?$shared_ptr@V?$IAsyncResult@X@Threading@Bedrock@@@std@@AEBVLevelStorageWriteBatch@@@Z
    virtual std::shared_ptr<class Bedrock::Threading::IAsyncResult<void>> saveData(class LevelStorageWriteBatch const &);

    // vIndex: 11, symbol: ?deleteData@DBStorage@@UEAA?AV?$shared_ptr@V?$IAsyncResult@X@Threading@Bedrock@@@std@@AEBV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@3@W4Category@DBHelpers@@@Z
    virtual std::shared_ptr<class Bedrock::Threading::IAsyncResult<void>> deleteData(std::string const &, ::DBHelpers::Category);

    // vIndex: 12, symbol: ?getStatistics@DBStorage@@UEBAXAEAV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@Z
    ...
    // vIndex: 18, symbol: ?loadData@DBStorage@@UEBA_NV?$basic_string_view@DU?$char_traits@D@std@@@std@@AEAV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@3@W4Category@DBHelpers@@@Z
    virtual bool loadData(std::string_view, std::string &, ::DBHelpers::Category) const;

    // vIndex: 19, symbol: __unk_vfn_19
    virtual void __unk_vfn_19();

    // vIndex: 20, symbol: ?createSnapshot@DBStorage@@UEAA?AV?$vector@USnapshotFilenameAndLength@@V?$allocator@USnapshotFilenameAndLength@@@std@@@std@@AEBV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@3@_N@Z
    ...
    MCAPI std::pair<class LevelStorageWriteBatch *, std::_Tree_iterator<std::_Tree_val<std::_Tree_simple_types<std::pair<std::string const, struct LevelStorageWriteBatch::BatchEntry>>>>> _findCacheEntry(std::string const &);
    ...
    // symbol: ?_read@DBStorage@@IEBAXV?$basic_string_view@DU?$char_traits@D@std@@@std@@W4Category@DBHelpers@@AEBV?$function@$$A6AXV?$basic_string_view@DU?$char_traits@D@std@@@std@@0@Z@3@@Z
    MCAPI void _read(std::string_view, ::DBHelpers::Category, std::function<void (std::string_view, std::string_view)> const &) const;
    ...
    MCAPI struct DBStorage::PendingWriteResult _readPendingWrite(std::string const &, ::DBHelpers::Category) const;
