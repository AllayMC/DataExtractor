...
public:
    ...
    MCAPI std::unique_ptr<class GameRulesChangedPacket> _setGameRule(class GameRule *, union GameRule::Value, ::GameRule::Type, bool, bool *, bool *, class GameRule::ValidationError *);
    ...
    MCAPI std::unique_ptr<class GameRulesChangedPacket> _setRule(struct GameRuleId, union GameRule::Value, ::GameRule::Type, bool, bool *, bool *, class GameRule::ValidationError *);
