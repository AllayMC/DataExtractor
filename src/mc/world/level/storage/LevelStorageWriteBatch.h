...
public:
    ...
    // vIndex: 1, symbol: ?putKey@LevelStorageWriteBatch@@UEAAXAEBV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@V?$basic_string_view@DU?$char_traits@D@std@@@3@W4Category@DBHelpers@@@Z
    virtual void putKey(std::string const &, std::string_view, ::DBHelpers::Category);

    // vIndex: 2, symbol: ?putKey@LevelStorageWriteBatch@@UEAAXAEBV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@0W4Category@DBHelpers@@@Z
    virtual void putKey(std::string const &, std::string const &, ::DBHelpers::Category);

    // vIndex: 3, symbol: ?putKey@LevelStorageWriteBatch@@UEAAXAEBV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@$$QEAV23@W4Category@DBHelpers@@@Z
    virtual void putKey(std::string const &, std::string &&, ::DBHelpers::Category);

    // vIndex: 4, symbol: ?putKey@LevelStorageWriteBatch@@UEAAXAEBV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@V?$shared_ptr@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@3@W4Category@DBHelpers@@@Z
    virtual void putKey(std::string const &, std::shared_ptr<std::string>, ::DBHelpers::Category);

    // vIndex: 5, symbol: ?deleteKey@LevelStorageWriteBatch@@UEAAXAEBV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@W4Category@DBHelpers@@@Z
    ...
    MCAPI void erase(std::_Tree_const_iterator<std::_Tree_val<std::_Tree_simple_types<std::pair<std::string const, struct LevelStorageWriteBatch::BatchEntry>>>> const &);
    ...
    MCAPI std::_Tree_const_iterator<std::_Tree_val<std::_Tree_simple_types<std::pair<std::string const, struct LevelStorageWriteBatch::BatchEntry>>>> find(std::string const &) const;
    ...
    MCAPI std::_Tree_iterator<std::_Tree_val<std::_Tree_simple_types<std::pair<std::string const, struct LevelStorageWriteBatch::BatchEntry>>>> find(std::string const &);
