...
public:
    ...
    virtual std::unique_ptr<class LevelLooseFileStorage> createLevelLooseStorage(std::string const &, class ContentIdentity const &, Bedrock::NotNullNonOwnerPtr<class IContentKeyProvider const> const &);
    ...
    MCAPI ExternalFileLevelStorageSource(Bedrock::NotNullNonOwnerPtr<class Core::FilePathManager> const &, Bedrock::NotNullNonOwnerPtr<class SaveTransactionManager> const &);
