...
public:
    ...
    MCAPI class Bedrock::PubSub::Subscription registerOnPollSaveGameStatisticsCallback(std::function<void (class LevelStorage &)>);
    ...
    MCAPI class Bedrock::PubSub::Subscription registerOnStartLeaveGameCallback(std::function<void (class LevelStorage &)>);
