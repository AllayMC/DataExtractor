...
public:
    ...
    MCAPI static ::Direction::Type convertFacingDirectionToDirection(uint8_t);

    // symbol: ?getDirection@Direction@@SA?AW4Type@1@MM@Z
    MCAPI static ::Direction::Type getDirection(float, float);
    ...
    MCAPI static std::array<uint8_t, 4> const DIRECTION_FACING;
    ...
    MCAPI static std::unordered_map<uint32_t,std::string> const TO_STRING_MAP;
