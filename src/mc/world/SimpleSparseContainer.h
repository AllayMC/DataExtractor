...
public:
    ...
    MCAPI SimpleSparseContainer(class Container &, ::SparseContainerBackingSetType, std::unique_ptr<class ISparseContainerSetListener>, std::unique_ptr<class IPlayerContainerSetter>);
