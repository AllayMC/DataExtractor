...
public:
    ...
    SetBlockState& operator=(SetBlockState const &) = delete;
    SetBlockState(SetBlockState const &) = delete;
    SetBlockState() = delete;
...
public:
    ...
    // vIndex: 1, symbol: ?getName@SetBlockState@@UEBAAEBV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@XZ
    virtual std::string const & getName() const;

    // vIndex: 2, symbol: ?executeAction@SetBlockState@@UEBAXAEAVRenderParams@@@Z
    virtual void executeAction(class RenderParams &) const;

    // vIndex: 3, symbol: ?buildSchema@SetBlockState@@UEBAXAEAV?$shared_ptr@V?$JsonSchemaObjectNode@VEmptyClass@JsonUtil@@UEventResponseCollection@@@JsonUtil@@@std@@AEBV?$Factory@VEventResponse@@$$V@@@Z
