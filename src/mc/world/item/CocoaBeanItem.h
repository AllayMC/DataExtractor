...
public:
    ...
    // vIndex: 95, symbol: ?buildDescriptionId@CocoaBeanItem@@UEBA?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@AEBVItemDescriptor@@PEBVCompoundTag@@@Z
    ...
    // vIndex: 119, symbol: ?setIconInfo@CocoaBeanItem@@UEAAAEAVItem@@AEBV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@H@Z
    virtual class Item & setIconInfo(std::string const &, int32_t);

    // vIndex: 135, symbol: ?_useOn@CocoaBeanItem@@EEBA?AVInteractionResult@@AEAVItemStack@@AEAVActor@@VBlockPos@@EAEBVVec3@@@Z
    ...
    MCAPI CocoaBeanItem(std::string const &, int32_t, bool);
