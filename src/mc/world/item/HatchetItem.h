...
public:
    ...
    // vIndex: 10, symbol: ?executeEvent@HatchetItem@@UEBAXAEAVItemStackBase@@AEBV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@AEAVRenderParams@@@Z
    ...
    // vIndex: 62, symbol: ?getEnchantSlot@HatchetItem@@UEBAHXZ
    ...
    // vIndex: 88, symbol: ?getDestroySpeed@HatchetItem@@UEBAMAEBVItemStackBase@@AEBVBlock@@@Z
