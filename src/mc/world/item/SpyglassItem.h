...
public:
    ...
    // vIndex: 69, symbol: ?getViewDamping@SpyglassItem@@UEBAMXZ
    ...
    // vIndex: 84, symbol: ?use@SpyglassItem@@UEBAAEAVItemStack@@AEAV2@AEAVPlayer@@@Z
    virtual class ItemStack & use(class ItemStack &, class Player &) const;

    // vIndex: 86, symbol: ?useTimeDepleted@SpyglassItem@@UEBA?AW4ItemUseMethod@@AEAVItemStack@@PEAVLevel@@PEAVPlayer@@@Z
    virtual ::ItemUseMethod useTimeDepleted(class ItemStack &, class Level *, class Player *) const;

    // vIndex: 87, symbol: ?releaseUsing@SpyglassItem@@UEBAXAEAVItemStack@@PEAVPlayer@@H@Z
    ...
    MCAPI SpyglassItem(std::string const &, int16_t);
