...
public:
    ...
    ChemistryItem& operator=(ChemistryItem const &) = delete;
    ChemistryItem(ChemistryItem const &) = delete;
...
public:
    ...
    // vIndex: 105, symbol: ?fixupCommon@ChemistryItem@@UEBAXAEAVItemStackBase@@@Z
    ...
    // symbol: ??1ChemistryItem@@UEAA@XZ
    MCVAPI ~ChemistryItem();
