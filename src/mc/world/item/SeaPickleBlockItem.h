...
public:
    ...
    SeaPickleBlockItem& operator=(SeaPickleBlockItem const &) = delete;
    SeaPickleBlockItem(SeaPickleBlockItem const &) = delete;
...
public:
    ...
    // vIndex: 45, symbol: ?getLevelDataForAuxValue@SeaPickleBlockItem@@UEBAHH@Z
    ...
    // vIndex: 135, symbol: ?_useOn@SeaPickleBlockItem@@UEBA?AVInteractionResult@@AEAVItemStack@@AEAVActor@@VBlockPos@@EAEBVVec3@@@Z
    ...
    MCAPI SeaPickleBlockItem(std::string const &, int32_t);
