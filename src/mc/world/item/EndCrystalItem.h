...
public:
    ...
    // vIndex: 50, symbol: ?isGlint@EndCrystalItem@@UEBA_NAEBVItemStackBase@@@Z
    ...
    // vIndex: 56, symbol: ?isDestructive@EndCrystalItem@@UEBA_NH@Z
    ...
    // vIndex: 135, symbol: ?_useOn@EndCrystalItem@@EEBA?AVInteractionResult@@AEAVItemStack@@AEAVActor@@VBlockPos@@EAEBVVec3@@@Z
    ...
    MCAPI EndCrystalItem(std::string const &, int32_t);
