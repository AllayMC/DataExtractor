...
public:
    ...
    // symbol: ??0FuelItemComponent@@QEAA@XZ
    MCAPI FuelItemComponent();

    // symbol: ?setFuelDuration@FuelItemComponent@@QEAAXM@Z
    MCAPI void setFuelDuration(float);

    // symbol: ?bindType@FuelItemComponent@@SAXAEAUReflectionCtx@cereal@@AEBV?$vector@W4AllExperiments@@V?$allocator@W4AllExperiments@@@std@@@std@@V?$optional@VSemVersion@@@5@@Z
