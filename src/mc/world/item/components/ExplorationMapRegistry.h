...
public:
    ...
    ExplorationMapRegistry& operator=(ExplorationMapRegistry const &) = delete;
    ExplorationMapRegistry(ExplorationMapRegistry const &) = delete;
    ExplorationMapRegistry() = delete;
...
public:
    // NOLINTBEGIN
    inline auto& $mRegistry() { return mRegistry; }
