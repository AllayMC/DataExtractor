...
public:
    ...
    InteractButtonItemComponent(InteractButtonItemComponent const &) = delete;
    InteractButtonItemComponent() = delete;
...
public:
    ...
    // vIndex: 4, symbol: ?buildNetworkTag@InteractButtonItemComponent@@UEBA?AV?$unique_ptr@VCompoundTag@@U?$default_delete@VCompoundTag@@@std@@@std@@AEBUReflectionCtx@cereal@@@Z
    virtual std::unique_ptr<class CompoundTag> buildNetworkTag(struct cereal::ReflectionCtx const &) const;

    // vIndex: 5, symbol: ?initializeFromNetwork@InteractButtonItemComponent@@UEAA_NAEBVCompoundTag@@AEBUReflectionCtx@cereal@@@Z
