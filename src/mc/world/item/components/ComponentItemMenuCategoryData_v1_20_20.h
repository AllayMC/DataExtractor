...
public:
    ...
    // symbol: ?upgrade@ComponentItemMenuCategoryData_v1_20_20@@SA?AV?$optional@UComponentItemMenuCategoryData_v1_20_20@@@std@@$$QEAV?$optional@W4CreativeItemCategory@@@3@@Z
    MCAPI static std::optional<struct ComponentItemMenuCategoryData_v1_20_20> upgrade(std::optional<::CreativeItemCategory> &&);
