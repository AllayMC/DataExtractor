...
public:
    ...
    public:
        ...
        MCAPI struct CerealItemComponentFactory::Constructor & operator=(struct CerealItemComponentFactory::Constructor &&);
    
        // symbol: ??4Constructor@CerealItemComponentFactory@@QEAAAEAU01@AEBU01@@Z
        MCAPI struct CerealItemComponentFactory::Constructor & operator=(struct CerealItemComponentFactory::Constructor const &);
...
public:
    ...
    MCAPI static std::shared_ptr<class ItemComponent> constructItemComponent(std::string const &, struct cereal::ReflectionCtx &);
    ...
    MCAPI static std::optional<class SemVersion> getReleasedMinFormatVersionForAnyComponent(struct cereal::ReflectionCtx &);
    ...
    MCAPI static std::unordered_map<std::string,struct CerealItemComponentFactory::Constructor> & getPropRegisteredComponents(struct cereal::ReflectionCtx &);
    ...
    MCAPI static std::optional<class SemVersion> & getPropReleasedMinFormatVersionForAnyComponent(struct cereal::ReflectionCtx &);
