...
public:
    ...
    ComplexItem& operator=(ComplexItem const &) = delete;
    ComplexItem(ComplexItem const &) = delete;
    ComplexItem() = delete;
...
public:
    ...
    // vIndex: 136, symbol: ?getUpdatePacket@ComplexItem@@UEBA?AV?$unique_ptr@VPacket@@U?$default_delete@VPacket@@@std@@@std@@AEBVItemStack@@AEAVLevel@@AEAVActor@@@Z
    ...
    MCAPI ComplexItem(std::string const &, int32_t);
