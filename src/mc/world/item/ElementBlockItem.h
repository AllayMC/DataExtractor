...
public:
    ...
    ElementBlockItem& operator=(ElementBlockItem const &) = delete;
    ElementBlockItem(ElementBlockItem const &) = delete;
...
public:
    ...
    // vIndex: 105, symbol: ?fixupCommon@ElementBlockItem@@EEBAXAEAVItemStackBase@@@Z
