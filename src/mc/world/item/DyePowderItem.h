...
public:
    ...
    // vIndex: 95, symbol: ?buildDescriptionId@DyePowderItem@@UEBA?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@AEBVItemDescriptor@@PEBVCompoundTag@@@Z
    ...
    // vIndex: 119, symbol: ?setIconInfo@DyePowderItem@@UEAAAEAVItem@@AEBV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@H@Z
    ...
    MCAPI DyePowderItem(std::string const &, int32_t, ::ItemColor);
