...
public:
    ...
    // vIndex: 60, symbol: ?appendFormattedHovertext@SmithingTemplateItem@@UEBAXAEBVItemStackBase@@AEAVLevel@@AEAV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@_N@Z
    ...
    // vIndex: 95, symbol: ?buildDescriptionId@SmithingTemplateItem@@UEBA?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@AEBVItemDescriptor@@PEBVCompoundTag@@@Z
