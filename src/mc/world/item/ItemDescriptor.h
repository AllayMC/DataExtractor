...
public:
    ...
    public:
        // NOLINTBEGIN
        // vIndex: 0, symbol: ?clone@ComplexAliasDescriptor@@UEBA?AV?$unique_ptr@UBaseDescriptor@ItemDescriptor@@U?$default_delete@UBaseDescriptor@ItemDescriptor@@@std@@@std@@XZ
        ...
        // vIndex: 3, symbol: ?getFullName@BaseDescriptor@ItemDescriptor@@UEBAAEBV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@XZ
        ...
        // vIndex: 14, symbol: ?resolve@BaseDescriptor@ItemDescriptor@@UEBA?AV?$unique_ptr@UBaseDescriptor@ItemDescriptor@@U?$default_delete@UBaseDescriptor@ItemDescriptor@@@std@@@std@@XZ
        virtual std::unique_ptr<struct ItemDescriptor::BaseDescriptor> resolve() const;
    
        // symbol: ??1BaseDescriptor@ItemDescriptor@@UEAA@XZ
...
public:
    ...
    // symbol: ??1ItemDescriptor@@UEAA@XZ
    ...
    MCAPI static void fromMap(class ItemDescriptor &, std::map<std::string,std::string> const &, class BedrockLoadContext const &);
