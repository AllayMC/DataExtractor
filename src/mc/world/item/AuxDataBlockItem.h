...
public:
    ...
    AuxDataBlockItem& operator=(AuxDataBlockItem const &) = delete;
    AuxDataBlockItem(AuxDataBlockItem const &) = delete;
...
public:
    ...
    // vIndex: 95, symbol: ?buildDescriptionId@AuxDataBlockItem@@UEBA?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@AEBVItemDescriptor@@PEBVCompoundTag@@@Z
