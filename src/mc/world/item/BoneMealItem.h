...
public:
    ...
    // vIndex: 19, symbol: ?isDye@BoneMealItem@@UEBA_NXZ
    virtual bool isDye() const;

    // vIndex: 20, symbol: ?getItemColor@BoneMealItem@@UEBA?AW4ItemColor@@XZ
    ...
    // vIndex: 95, symbol: ?buildDescriptionId@BoneMealItem@@UEBA?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@AEBVItemDescriptor@@PEBVCompoundTag@@@Z
