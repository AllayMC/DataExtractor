...
public:
    ...
    WoodSlabBlockItem& operator=(WoodSlabBlockItem const &) = delete;
    WoodSlabBlockItem(WoodSlabBlockItem const &) = delete;
...
public:
    ...
    // vIndex: 45, symbol: ?getLevelDataForAuxValue@WoodSlabBlockItem@@UEBAHH@Z
