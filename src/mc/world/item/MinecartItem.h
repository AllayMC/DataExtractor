...
public:
    ...
    // vIndex: 135, symbol: ?_useOn@MinecartItem@@EEBA?AVInteractionResult@@AEAVItemStack@@AEAVActor@@VBlockPos@@EAEBVVec3@@@Z
    ...
    MCAPI MinecartItem(std::string const &, int32_t, ::MinecartType);
