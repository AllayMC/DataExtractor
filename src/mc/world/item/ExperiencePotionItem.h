...
public:
    ...
    // vIndex: 23, symbol: ?isThrowable@ExperiencePotionItem@@UEBA_NXZ
    virtual bool isThrowable() const;

    // vIndex: 50, symbol: ?isGlint@ExperiencePotionItem@@UEBA_NAEBVItemStackBase@@@Z
    ...
    // vIndex: 84, symbol: ?use@ExperiencePotionItem@@UEBAAEAVItemStack@@AEAV2@AEAVPlayer@@@Z
    virtual class ItemStack & use(class ItemStack &, class Player &) const;

    // vIndex: 85, symbol: ?dispense@ExperiencePotionItem@@UEBA_NAEAVBlockSource@@AEAVContainer@@HAEBVVec3@@E@Z
