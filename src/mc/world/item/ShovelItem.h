...
public:
    ...
    // vIndex: 10, symbol: ?executeEvent@ShovelItem@@UEBAXAEAVItemStackBase@@AEBV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@AEAVRenderParams@@@Z
    ...
    // vIndex: 44, symbol: ?canDestroySpecial@ShovelItem@@UEBA_NAEBVBlock@@@Z
    ...
    // vIndex: 62, symbol: ?getEnchantSlot@ShovelItem@@UEBAHXZ
    ...
    // vIndex: 135, symbol: ?_useOn@ShovelItem@@MEBA?AVInteractionResult@@AEAVItemStack@@AEAVActor@@VBlockPos@@EAEBVVec3@@@Z
