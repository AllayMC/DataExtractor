...
public:
    ...
    BlockPlanterItem& operator=(BlockPlanterItem const &) = delete;
    BlockPlanterItem(BlockPlanterItem const &) = delete;
...
public:
    ...
    // vIndex: 3, symbol: ?setDescriptionId@BlockPlanterItem@@UEAAAEAV1@AEBV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@Z
    ...
    // vIndex: 95, symbol: ?buildDescriptionId@BlockPlanterItem@@UEBA?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@AEBVItemDescriptor@@PEBVCompoundTag@@@Z
    ...
    // vIndex: 119, symbol: ?setIconInfo@BlockPlanterItem@@UEAAAEAVItem@@AEBV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@H@Z
    ...
    MCAPI BlockPlanterItem(std::string const &, int32_t, class Block const &, bool);
