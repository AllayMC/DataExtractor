...
public:
    ...
    MCAPI ItemInstance(std::string_view, int32_t, int32_t, class CompoundTag const *);

    // symbol: ??0ItemInstance@@QEAA@AEBVBlock@@HPEBVCompoundTag@@@Z
    MCAPI ItemInstance(class Block const &, int32_t, class CompoundTag const *);

    // symbol: ??0ItemInstance@@QEAA@AEBVItem@@HHPEBVCompoundTag@@@Z
    MCAPI ItemInstance(class Item const &, int32_t, int32_t, class CompoundTag const *);

    // symbol: ??0ItemInstance@@QEAA@AEBVBlockLegacy@@H@Z
    MCAPI ItemInstance(class BlockLegacy const &, int32_t);
