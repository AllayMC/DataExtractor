...
public:
    ...
    // vIndex: 23, symbol: ?isThrowable@EnderpearlItem@@UEBA_NXZ
    ...
    // vIndex: 84, symbol: ?use@EnderpearlItem@@UEBAAEAVItemStack@@AEAV2@AEAVPlayer@@@Z
    virtual class ItemStack & use(class ItemStack &, class Player &) const;

    // vIndex: 103, symbol: ?getCooldownType@EnderpearlItem@@UEBAAEBVHashedString@@XZ
