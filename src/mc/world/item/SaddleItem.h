...
public:
    ...
    SaddleItem& operator=(SaddleItem const &) = delete;
    SaddleItem(SaddleItem const &) = delete;
    SaddleItem() = delete;
...
public:
    ...
    // vIndex: 85, symbol: ?dispense@SaddleItem@@UEBA_NAEAVBlockSource@@AEAVContainer@@HAEBVVec3@@E@Z
