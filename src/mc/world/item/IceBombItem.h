...
public:
    ...
    IceBombItem& operator=(IceBombItem const &) = delete;
    IceBombItem(IceBombItem const &) = delete;
    IceBombItem() = delete;
...
public:
    ...
    // vIndex: 23, symbol: ?isThrowable@IceBombItem@@UEBA_NXZ
    ...
    // vIndex: 84, symbol: ?use@IceBombItem@@UEBAAEAVItemStack@@AEAV2@AEAVPlayer@@@Z
