...
public:
    ...
    // vIndex: 45, symbol: ?getLevelDataForAuxValue@BambooItem@@UEBAHH@Z
    ...
    // vIndex: 135, symbol: ?_useOn@BambooItem@@UEBA?AVInteractionResult@@AEAVItemStack@@AEAVActor@@VBlockPos@@EAEBVVec3@@@Z
