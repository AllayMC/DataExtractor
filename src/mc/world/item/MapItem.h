...
public:
    ...
    // vIndex: 60, symbol: ?appendFormattedHovertext@MapItem@@UEBAXAEBVItemStackBase@@AEAVLevel@@AEAV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@_N@Z
    ...
    // vIndex: 95, symbol: ?buildDescriptionId@MapItem@@UEBA?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@AEBVItemDescriptor@@PEBVCompoundTag@@@Z
    ...
    // vIndex: 119, symbol: ?setIconInfo@MapItem@@UEAAAEAVItem@@AEBV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@H@Z
    ...
    // vIndex: 136, symbol: ?getUpdatePacket@MapItem@@UEBA?AV?$unique_ptr@VPacket@@U?$default_delete@VPacket@@@std@@@std@@AEBVItemStack@@AEAVLevel@@AEAVActor@@@Z
    ...
    MCAPI static bool sampleMapData(class BlockSource &, int32_t, class BlockPos const &, class BlockPos const &, int32_t, int32_t, std::vector<struct MapSample> *, class MapItemSavedData *, std::vector<struct ClientTerrainPixel> *);
    ...
    MCAPI static void _scheduleMapChunkRendering(class Dimension &, class MapItemSavedData const &, struct MapItemSavedData::ChunkBounds, std::shared_ptr<bool>);
