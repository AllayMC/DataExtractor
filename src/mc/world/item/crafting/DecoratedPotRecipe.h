...
public:
    ...
    // vIndex: 1, symbol: ?assemble@DecoratedPotRecipe@@UEBAAEBV?$vector@VItemInstance@@V?$allocator@VItemInstance@@@std@@@std@@AEAVCraftingContainer@@AEAVCraftingContext@@@Z
