...
public:
    ...
    MCAPI void addShapedRecipe(std::string, class ItemInstance const &, std::vector<std::string> const &, std::vector<class Recipes::Type> const &, std::vector<class HashedString> const &, int32_t, std::function<std::unique_ptr<class ShapedRecipe> (std::string, int32_t, int32_t, std::vector<class RecipeIngredient> const &, std::vector<class ItemInstance> const &, class HashedString, int32_t, class mce::UUID const *, std::optional<class RecipeUnlockingRequirement>, class SemVersion const &)>, std::optional<class RecipeUnlockingRequirement>, class SemVersion const &);

    // symbol: ?addShapedRecipe@Recipes@@QEAAXV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@AEBVItemInstance@@AEBV23@22AEBV?$vector@VType@Recipes@@V?$allocator@VType@Recipes@@@std@@@3@AEBV?$vector@VHashedString@@V?$allocator@VHashedString@@@std@@@3@HV?$function@$$A6A?AV?$unique_ptr@VShapedRecipe@@U?$default_delete@VShapedRecipe@@@std@@@std@@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@2@HHAEBV?$vector@VRecipeIngredient@@V?$allocator@VRecipeIngredient@@@std@@@2@AEBV?$vector@VItemInstance@@V?$allocator@VItemInstance@@@std@@@2@VHashedString@@HPEBVUUID@mce@@V?$optional@VRecipeUnlockingRequirement@@@2@AEBVSemVersion@@@Z@3@V?$optional@VRecipeUnlockingRequirement@@@3@AEBVSemVersion@@@Z
    MCAPI void addShapedRecipe(std::string, class ItemInstance const &, std::string const &, std::string const &, std::string const &, std::vector<class Recipes::Type> const &, std::vector<class HashedString> const &, int32_t, std::function<std::unique_ptr<class ShapedRecipe> (std::string, int32_t, int32_t, std::vector<class RecipeIngredient> const &, std::vector<class ItemInstance> const &, class HashedString, int32_t, class mce::UUID const *, std::optional<class RecipeUnlockingRequirement>, class SemVersion const &)>, std::optional<class RecipeUnlockingRequirement>, class SemVersion const &);

    // symbol: ?addShapedRecipe@Recipes@@QEAAXV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@AEBVItemInstance@@AEBV23@AEBV?$vector@VType@Recipes@@V?$allocator@VType@Recipes@@@std@@@3@AEBV?$vector@VHashedString@@V?$allocator@VHashedString@@@std@@@3@HV?$function@$$A6A?AV?$unique_ptr@VShapedRecipe@@U?$default_delete@VShapedRecipe@@@std@@@std@@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@2@HHAEBV?$vector@VRecipeIngredient@@V?$allocator@VRecipeIngredient@@@std@@@2@AEBV?$vector@VItemInstance@@V?$allocator@VItemInstance@@@std@@@2@VHashedString@@HPEBVUUID@mce@@V?$optional@VRecipeUnlockingRequirement@@@2@AEBVSemVersion@@@Z@3@V?$optional@VRecipeUnlockingRequirement@@@3@AEBVSemVersion@@@Z
    MCAPI void addShapedRecipe(std::string, class ItemInstance const &, std::string const &, std::vector<class Recipes::Type> const &, std::vector<class HashedString> const &, int32_t, std::function<std::unique_ptr<class ShapedRecipe> (std::string, int32_t, int32_t, std::vector<class RecipeIngredient> const &, std::vector<class ItemInstance> const &, class HashedString, int32_t, class mce::UUID const *, std::optional<class RecipeUnlockingRequirement>, class SemVersion const &)>, std::optional<class RecipeUnlockingRequirement>, class SemVersion const &);

    // symbol: ?addShapedRecipe@Recipes@@QEAAXV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@AEBVItemInstance@@AEBV23@2AEBV?$vector@VType@Recipes@@V?$allocator@VType@Recipes@@@std@@@3@AEBV?$vector@VHashedString@@V?$allocator@VHashedString@@@std@@@3@HV?$function@$$A6A?AV?$unique_ptr@VShapedRecipe@@U?$default_delete@VShapedRecipe@@@std@@@std@@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@2@HHAEBV?$vector@VRecipeIngredient@@V?$allocator@VRecipeIngredient@@@std@@@2@AEBV?$vector@VItemInstance@@V?$allocator@VItemInstance@@@std@@@2@VHashedString@@HPEBVUUID@mce@@V?$optional@VRecipeUnlockingRequirement@@@2@AEBVSemVersion@@@Z@3@V?$optional@VRecipeUnlockingRequirement@@@3@AEBVSemVersion@@@Z
    MCAPI void addShapedRecipe(std::string, class ItemInstance const &, std::string const &, std::string const &, std::vector<class Recipes::Type> const &, std::vector<class HashedString> const &, int32_t, std::function<std::unique_ptr<class ShapedRecipe> (std::string, int32_t, int32_t, std::vector<class RecipeIngredient> const &, std::vector<class ItemInstance> const &, class HashedString, int32_t, class mce::UUID const *, std::optional<class RecipeUnlockingRequirement>, class SemVersion const &)>, std::optional<class RecipeUnlockingRequirement>, class SemVersion const &);
    ...
    MCAPI void addShapelessRecipe(std::string, class ItemInstance const &, std::vector<class Recipes::Type> const &, std::vector<class HashedString> const &, int32_t, std::function<std::unique_ptr<class ShapelessRecipe> (std::string, std::vector<class RecipeIngredient> const &, std::vector<class ItemInstance> const &, class HashedString, int32_t, class mce::UUID const *, std::optional<class RecipeUnlockingRequirement>, class SemVersion const &)>, std::optional<class RecipeUnlockingRequirement>, class SemVersion const &);

    // symbol: ?addShulkerBoxRecipe@Recipes@@QEAAXAEAV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@AEBVItemInstance@@AEBV?$vector@VType@Recipes@@V?$allocator@VType@Recipes@@@std@@@3@AEBV?$vector@VHashedString@@V?$allocator@VHashedString@@@std@@@3@V?$optional@VRecipeUnlockingRequirement@@@3@AEBVSemVersion@@@Z
    MCAPI void addShulkerBoxRecipe(std::string &, class ItemInstance const &, std::vector<class Recipes::Type> const &, std::vector<class HashedString> const &, std::optional<class RecipeUnlockingRequirement>, class SemVersion const &);
    ...
    MCAPI uint32_t getNumberOfUnlockableRecipes() const;

    // symbol: ?getRecipeByNetId@Recipes@@QEBAPEBVRecipe@@AEBV?$TypedServerNetId@URecipeNetIdTag@@I$0A@@@@Z
    MCAPI class Recipe const * getRecipeByNetId(class TypedServerNetId<struct RecipeNetIdTag, uint32_t, 0> const &) const;
    ...
    MCAPI std::map<class HashedString,std::map<std::string,std::shared_ptr<class Recipe>>> const & getRecipesAllTags() const;

    // symbol: ?init@Recipes@@QEAAXAEAVResourcePackManager@@AEAVExternalRecipeStore@@AEBVBaseGameVersion@@AEBVExperiments@@@Z
    MCAPI void init(class ResourcePackManager &, class ExternalRecipeStore &, class BaseGameVersion const &, class Experiments const &);

    // symbol: ?loadRecipe@Recipes@@QEAA_NAEBU?$pair@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@VValue@Json@@@std@@AEBVSemVersion@@1_N@Z
    MCAPI bool loadRecipe(std::pair<std::string, class Json::Value> const &, class SemVersion const &, class SemVersion const &, bool);
    ...
    // protected:
    // NOLINTBEGIN
    // symbol: ?_createUnlockingRequirementFromContext@Recipes@@IEBA?AV?$optional@VRecipeUnlockingRequirement@@@std@@W4UnlockingContext@RecipeUnlockingRequirement@@@Z
    MCAPI std::optional<class RecipeUnlockingRequirement> _createUnlockingRequirementFromContext(::RecipeUnlockingRequirement::UnlockingContext) const;
    ...
    // symbol: ?_loadUnlockingRequirementFromJson@Recipes@@IEBA?AV?$optional@VRecipeUnlockingRequirement@@@std@@AEBVValue@Json@@AEBVSemVersion@@AEBV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@3@@Z
    MCAPI std::optional<class RecipeUnlockingRequirement> _loadUnlockingRequirementFromJson(class Json::Value const &, class SemVersion const &, std::string const &) const;
    ...
    // symbol: ?_loadSmithingTrim@Recipes@@AEAA_NAEBVValue@Json@@AEBVSemVersion@@AEBV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@AEBV?$vector@VHashedString@@V?$allocator@VHashedString@@@std@@@6@@Z
    MCAPI bool _loadSmithingTrim(class Json::Value const &, class SemVersion const &, std::string const &, std::vector<class HashedString> const &);
