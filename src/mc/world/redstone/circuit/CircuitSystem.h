...
public:
    ...
    MCAPI class BaseCircuitComponent * createComponent(class BlockPos const &, uchar, std::unique_ptr<class BaseCircuitComponent>);
    ...
    MCAPI void updateIndividualBlock(gsl::not_null<class BaseCircuitComponent *>, class BlockPos const &, class BlockPos const &, class BlockSource &);
