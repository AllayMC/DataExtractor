...
public:
    ...
    // vIndex: 12, symbol: ?allowConnection@SidePoweredComponent@@UEAA_NAEAVCircuitSceneGraph@@AEBVCircuitTrackingInfo@@AEA_N@Z
    ...
    MCAPI void addToSideComponents(std::_Vector_iterator<std::_Vector_val<std::_Simple_types<class CircuitComponentList::Item>>> &, class BaseCircuitComponent *);
