...
public:
    ...
    DamageItemComponent& operator=(DamageItemComponent const &) = delete;
    DamageItemComponent(DamageItemComponent const &) = delete;
...
public:
    ...
    // symbol: ??0DamageItemComponent@@QEAA@XZ
    MCAPI DamageItemComponent();

    // symbol: ?bindType@DamageItemComponent@@SAXAEAUReflectionCtx@cereal@@AEBV?$vector@W4AllExperiments@@V?$allocator@W4AllExperiments@@@std@@@std@@V?$optional@VSemVersion@@@5@@Z
