...
public:
    ...
    GlintItemComponent& operator=(GlintItemComponent const &) = delete;
    GlintItemComponent(GlintItemComponent const &) = delete;
    GlintItemComponent() = delete;
...
public:
    ...
    // vIndex: 9, symbol: ?_initializeComponent@GlintItemComponent@@UEBAXXZ
    virtual void _initializeComponent() const;

    // symbol: ?bindType@GlintItemComponent@@SAXAEAUReflectionCtx@cereal@@AEBV?$vector@W4AllExperiments@@V?$allocator@W4AllExperiments@@@std@@@std@@V?$optional@VSemVersion@@@5@@Z
