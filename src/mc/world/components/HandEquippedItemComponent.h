...
public:
    ...
    HandEquippedItemComponent& operator=(HandEquippedItemComponent const &) = delete;
    HandEquippedItemComponent(HandEquippedItemComponent const &) = delete;
    HandEquippedItemComponent() = delete;
...
public:
    ...
    // symbol: ?bindType@HandEquippedItemComponent@@SAXAEAUReflectionCtx@cereal@@AEBV?$vector@W4AllExperiments@@V?$allocator@W4AllExperiments@@@std@@@std@@V?$optional@VSemVersion@@@5@@Z
