...
public:
    ...
    // symbol: ??1HoverTextColorItemComponent@@UEAA@XZ
    MCVAPI ~HoverTextColorItemComponent();

    // symbol: ?bindType@HoverTextColorItemComponent@@SAXAEAUReflectionCtx@cereal@@AEBV?$vector@W4AllExperiments@@V?$allocator@W4AllExperiments@@@std@@@std@@V?$optional@VSemVersion@@@5@@Z
