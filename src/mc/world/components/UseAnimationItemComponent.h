...
public:
    ...
    UseAnimationItemComponent& operator=(UseAnimationItemComponent const &) = delete;
    UseAnimationItemComponent(UseAnimationItemComponent const &) = delete;
...
public:
    ...
    // symbol: ??0UseAnimationItemComponent@@QEAA@XZ
    MCAPI UseAnimationItemComponent();

    // symbol: ?bindType@UseAnimationItemComponent@@SAXAEAUReflectionCtx@cereal@@AEBV?$vector@W4AllExperiments@@V?$allocator@W4AllExperiments@@@std@@@std@@V?$optional@VSemVersion@@@5@@Z
