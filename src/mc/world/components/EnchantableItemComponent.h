...
public:
    ...
    EnchantableItemComponent(EnchantableItemComponent const &) = delete;
    EnchantableItemComponent() = delete;
...
public:
    ...
    // symbol: ?bindType@EnchantableItemComponent@@SAXAEAUReflectionCtx@cereal@@AEBV?$vector@W4AllExperiments@@V?$allocator@W4AllExperiments@@@std@@@std@@V?$optional@VSemVersion@@@5@@Z
