...
public:
    ...
    AllowOffHandItemComponent& operator=(AllowOffHandItemComponent const &) = delete;
    AllowOffHandItemComponent(AllowOffHandItemComponent const &) = delete;
    AllowOffHandItemComponent() = delete;
