...
public:
    ...
    ShouldDespawnItemComponent& operator=(ShouldDespawnItemComponent const &) = delete;
    ShouldDespawnItemComponent(ShouldDespawnItemComponent const &) = delete;
...
public:
    ...
    // symbol: ??0ShouldDespawnItemComponent@@QEAA@XZ
    MCAPI ShouldDespawnItemComponent();

    // symbol: ?bindType@ShouldDespawnItemComponent@@SAXAEAUReflectionCtx@cereal@@AEBV?$vector@W4AllExperiments@@V?$allocator@W4AllExperiments@@@std@@@std@@V?$optional@VSemVersion@@@5@@Z
