...
public:
    ...
    StackedByDataItemComponent& operator=(StackedByDataItemComponent const &) = delete;
    StackedByDataItemComponent(StackedByDataItemComponent const &) = delete;
    StackedByDataItemComponent() = delete;
...
public:
    ...
    // symbol: ?bindType@StackedByDataItemComponent@@SAXAEAUReflectionCtx@cereal@@AEBV?$vector@W4AllExperiments@@V?$allocator@W4AllExperiments@@@std@@@std@@V?$optional@VSemVersion@@@5@@Z
