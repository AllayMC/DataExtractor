...
public:
    ...
    UseDurationItemComponent& operator=(UseDurationItemComponent const &) = delete;
    UseDurationItemComponent(UseDurationItemComponent const &) = delete;
    UseDurationItemComponent() = delete;
...
public:
    ...
    // symbol: ?bindType@UseDurationItemComponent@@SAXAEAUReflectionCtx@cereal@@AEBV?$vector@W4AllExperiments@@V?$allocator@W4AllExperiments@@@std@@@std@@V?$optional@VSemVersion@@@5@@Z
