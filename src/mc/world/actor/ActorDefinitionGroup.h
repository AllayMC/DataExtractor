...
public:
    ...
    MCAPI static void forEachComponentOf(class Json::Value &, std::string const &, std::function<void (class Json::Value &, class Json::Value &)> const &);
    ...
    MCAPI struct ActorDefinitionGroup::LoadActorResult _loadActorDefinition(class Level &, class SemVersion const &, std::string const &, ::CurrentCmdVersion const &, class Json::Value &, std::unordered_set<std::string> &, bool, ::LogArea);
    ...
    MCAPI bool _loadDefinitionFromJSON(class SemVersion const &, class SemVersion const &, ::CurrentCmdVersion const &, std::string const &, class Json::Value &, std::string const &, class Level &, bool, ::LogArea);
