...
public:
    ...
    OwningGetCollisionShapeEntityProxy& operator=(OwningGetCollisionShapeEntityProxy const &) = delete;
    OwningGetCollisionShapeEntityProxy(OwningGetCollisionShapeEntityProxy const &) = delete;
    OwningGetCollisionShapeEntityProxy() = delete;
...
public:
    ...
    // vIndex: 7, symbol: ?getAABB@?$GetCollisionShapeEntityProxy@V?$StrictExecutionContext@U?$Filter@V?$FlagComponent@UCanStandOnSnowFlag@@@@V?$FlagComponent@UHasLightweightFamilyFlag@@@@@@U?$Read@UAABBShapeComponent@@UAbilitiesComponent@@UActorTypeComponent@@UFallDistanceComponent@@UPassengerComponent@@UActorGameTypeComponent@@USynchedActorDataComponent@@UVehicleComponent@@@@U?$Write@$$V@@U?$AddRemove@$$V@@U?$GlobalRead@UExternalDataComponent@@@@U?$GlobalWrite@$$V@@U?$EntityFactoryT@$$V@@@@@@UEBAAEBVAABB@@XZ
    virtual class AABB const & getAABB() const;

    // vIndex: 8, symbol: ?isWorldBuilder@?$GetCollisionShapeEntityProxy@V?$StrictExecutionContext@U?$Filter@V?$FlagComponent@UCanStandOnSnowFlag@@@@V?$FlagComponent@UHasLightweightFamilyFlag@@@@@@U?$Read@UAABBShapeComponent@@UAbilitiesComponent@@UActorTypeComponent@@UFallDistanceComponent@@UPassengerComponent@@UActorGameTypeComponent@@USynchedActorDataComponent@@UVehicleComponent@@@@U?$Write@$$V@@U?$AddRemove@$$V@@U?$GlobalRead@UExternalDataComponent@@@@U?$GlobalWrite@$$V@@U?$EntityFactoryT@$$V@@@@@@UEBA_NXZ
    virtual bool isWorldBuilder() const;

    // vIndex: 9, symbol: ?isRiding@?$GetCollisionShapeEntityProxy@V?$StrictExecutionContext@U?$Filter@V?$FlagComponent@UCanStandOnSnowFlag@@@@V?$FlagComponent@UHasLightweightFamilyFlag@@@@@@U?$Read@UAABBShapeComponent@@UAbilitiesComponent@@UActorTypeComponent@@UFallDistanceComponent@@UPassengerComponent@@UActorGameTypeComponent@@USynchedActorDataComponent@@UVehicleComponent@@@@U?$Write@$$V@@U?$AddRemove@$$V@@U?$GlobalRead@UExternalDataComponent@@@@U?$GlobalWrite@$$V@@U?$EntityFactoryT@$$V@@@@@@UEBA_NXZ
    virtual bool isRiding() const;

    // symbol: ??0OwningGetCollisionShapeEntityProxy@@QEAA@AEBVEntityContext@@@Z
    MCAPI OwningGetCollisionShapeEntityProxy(class EntityContext const &);
