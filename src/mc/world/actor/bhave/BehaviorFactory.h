...
public:
    ...
    MCAPI void registerNodePair(std::string const &, std::function<std::unique_ptr<class BehaviorDefinition> (void)>, std::function<std::unique_ptr<class BehaviorNode> (void)>);
