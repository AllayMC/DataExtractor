...
public:
    ...
    MCAPI static void parse(class Json::Value const &, class SemVersion const &, ::ParticleType &, char const *, char const *);

    // symbol: ?parse@Parser@@SA_NAEBVValue@Json@@AEBVSemVersion@@AEAW4FilterSubject@@PEBD3@Z
    MCAPI static bool parse(class Json::Value const &, class SemVersion const &, ::FilterSubject &, char const *, char const *);
    ...
    MCAPI static void parse(class Json::Value const &, class SemVersion const &, std::vector<::LevelSoundEvent> &, char const *, char const *);
