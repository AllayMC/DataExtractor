...
public:
    ...
    MCAPI void initializeServerAnimationComponent(class Actor &, std::shared_ptr<class CommonResourceDefinitionMap>, std::function<void (class ActorAnimationPlayer &)>);
