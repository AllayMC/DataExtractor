...
public:
    ...
    public:
        // NOLINTBEGIN
        // symbol: ?toString@HistoryCache@PredictedMovementComponent@@QEAA?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@XZ
    ...
    public:
        // NOLINTBEGIN
        // symbol: ?toString@PredictionDbgData@PredictedMovementComponent@@QEBA?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@XZ
