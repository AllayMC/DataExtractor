...
public:
    ...
    VersionedActorDamageCause& operator=(VersionedActorDamageCause const &) = delete;
    VersionedActorDamageCause(VersionedActorDamageCause const &) = delete;
    VersionedActorDamageCause() = delete;
...
public:
    ...
    // symbol: ?getName@VersionedActorDamageCause@@QEBAAEBV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@XZ
