...
public:
    ...
    MCAPI static std::unordered_map<class AnimationComponentID,std::weak_ptr<class AnimationComponent>> & _getAllAnimationComponents(::AnimationComponentGroupType);
    ...
    MCAPI static std::shared_ptr<class AnimationComponent> getAnimationComponent(::AnimationComponentGroupType, class AnimationComponentID);
