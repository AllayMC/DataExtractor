...
public:
    ...
    // vIndex: 68, symbol: ?getShadowRadius@IronGolem@@UEBAMXZ
    ...
    // vIndex: 125, symbol: ?handleEntityEvent@IronGolem@@UEAAXW4ActorEvent@@H@Z
    ...
    // vIndex: 220, symbol: ?die@IronGolem@@UEAAXAEBVActorDamageSource@@@Z
    virtual void die(class ActorDamageSource const &);

    // vIndex: 233, symbol: ?updateEntitySpecificMolangVariables@IronGolem@@UEAAXAEAVRenderParams@@@Z
    virtual void updateEntitySpecificMolangVariables(class RenderParams &);

    // vIndex: 235, symbol: __unk_vfn_235
    virtual void __unk_vfn_235();

    // vIndex: 241, symbol: ?_playStepSound@IronGolem@@MEAAXAEBVBlockPos@@AEBVBlock@@@Z
    ...
    // vIndex: 256, symbol: ?hurtEffects@IronGolem@@UEAAXAEBVActorDamageSource@@M_N1@Z
    virtual void hurtEffects(class ActorDamageSource const &, float, bool, bool);

    // vIndex: 259, symbol: ?aiStep@IronGolem@@UEAAXXZ
    virtual void aiStep();

    // vIndex: 270, symbol: __unk_vfn_270
    virtual void __unk_vfn_270();

    // vIndex: 273, symbol: ?doHurtTarget@IronGolem@@UEAA_NPEAVActor@@AEBW4ActorDamageCause@@@Z
