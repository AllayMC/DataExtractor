...
public:
    ...
    // vIndex: 71, symbol: ?onTame@Cat@@UEAAXXZ
    virtual void onTame();

    // vIndex: 78, symbol: ?getAmbientSound@Cat@@UEBA?AW4LevelSoundEvent@@XZ
    ...
    // vIndex: 163, symbol: ?updateEntitySpecificMolangVariables@Cat@@UEAAXAEAVRenderParams@@@Z
    ...
    // vIndex: 181, symbol: ?aiStep@Cat@@UEAAXXZ
    virtual void aiStep();

    // vIndex: 212, symbol: ?_serverAiMobStep@Cat@@UEAAXXZ
