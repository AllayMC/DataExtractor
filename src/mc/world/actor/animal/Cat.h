...
public:
    ...
    // vIndex: 107, symbol: ?onTame@Cat@@UEAAXXZ
    virtual void onTame();

    // vIndex: 118, symbol: ?getAmbientSound@Cat@@UEBA?AW4LevelSoundEvent@@XZ
    ...
    // vIndex: 233, symbol: ?updateEntitySpecificMolangVariables@Cat@@UEAAXAEAVRenderParams@@@Z
    ...
    // vIndex: 259, symbol: ?aiStep@Cat@@UEAAXXZ
    virtual void aiStep();
    ...
    // vIndex: 313, symbol: ?_serverAiMobStep@Cat@@UEAAXXZ
