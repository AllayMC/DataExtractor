...
public:
    ...
    public:
        ...
        PlayerRideInLavaInOverworldAchievementTracker& operator=(PlayerRideInLavaInOverworldAchievementTracker const &) = delete;
...
public:
    ...
    // vIndex: 224, symbol: ?getNextStep@Strider@@MEAAMM@Z
    virtual float getNextStep(float);

    // vIndex: 234, symbol: ?shouldTryMakeStepSound@Strider@@MEAA_NXZ
    virtual bool shouldTryMakeStepSound();

    // vIndex: 235, symbol: __unk_vfn_235
    virtual void __unk_vfn_235();

    // vIndex: 241, symbol: ?_playStepSound@Strider@@MEAAXAEBVBlockPos@@AEBVBlock@@@Z
    ...
    // vIndex: 306, symbol: ?_getWalkTargetValue@Strider@@UEAAMAEBVBlockPos@@@Z
