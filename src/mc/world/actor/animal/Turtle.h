...
public:
    ...
    // vIndex: 68, symbol: ?getShadowRadius@Turtle@@UEBAMXZ
    ...
    // vIndex: 220, symbol: ?die@Turtle@@UEAAXAEBVActorDamageSource@@@Z
    ...
    // vIndex: 306, symbol: ?_getWalkTargetValue@Turtle@@UEAAMAEBVBlockPos@@@Z
