...
public:
    ...
    // vIndex: 42, symbol: ?getShadowRadius@Turtle@@UEBAMXZ
    ...
    // vIndex: 150, symbol: ?die@Turtle@@UEAAXAEBVActorDamageSource@@@Z
    ...
    // vIndex: 208, symbol: ?_getWalkTargetValue@Turtle@@UEAAMAEBVBlockPos@@@Z
