...
public:
    // NOLINTBEGIN
    // vIndex: 12, symbol: ?initializeComponents@Fish@@UEAAXW4InitializationMethod@Actor@@AEBVVariantParameterList@@@Z
    ...
    // vIndex: 46, symbol: ?startRiding@Fish@@UEAA_NAEAVActor@@@Z
    ...
    // vIndex: 233, symbol: ?updateEntitySpecificMolangVariables@Fish@@UEAAXAEAVRenderParams@@@Z
    ...
    // vIndex: 300, symbol: ?createAIGoals@Fish@@UEAA_NXZ
    virtual bool createAIGoals();

    // symbol: ??1Fish@@UEAA@XZ
    MCVAPI ~Fish();
