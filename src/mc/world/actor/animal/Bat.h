...
public:
    ...
    // vIndex: 165, symbol: ?checkFallDamage@Bat@@MEAAXM_N@Z
    ...
    // vIndex: 236, symbol: ?_hurt@Bat@@MEAA_NAEBVActorDamageSource@@M_N1@Z
    virtual bool _hurt(class ActorDamageSource const &, float, bool, bool);

    // vIndex: 239, symbol: ?readAdditionalSaveData@Bat@@UEAAXAEBVCompoundTag@@AEAVDataLoadHelper@@@Z
    virtual void readAdditionalSaveData(class CompoundTag const &, class DataLoadHelper &);

    // vIndex: 240, symbol: ?addAdditionalSaveData@Bat@@UEBAXAEAVCompoundTag@@@Z
    ...
    // vIndex: 260, symbol: ?pushActors@Bat@@UEAAXXZ
    ...
    // vIndex: 312, symbol: ?newServerAiStep@Bat@@MEAAXXZ
