...
public:
    ...
    // vIndex: 112, symbol: ?checkFallDamage@Bat@@MEAAXM_N0@Z
    ...
    // vIndex: 166, symbol: ?_hurt@Bat@@MEAA_NAEBVActorDamageSource@@M_N1@Z
    virtual bool _hurt(class ActorDamageSource const &, float, bool, bool);

    // vIndex: 167, symbol: ?readAdditionalSaveData@Bat@@UEAAXAEBVCompoundTag@@AEAVDataLoadHelper@@@Z
    virtual void readAdditionalSaveData(class CompoundTag const &, class DataLoadHelper &);

    // vIndex: 168, symbol: ?addAdditionalSaveData@Bat@@UEBAXAEAVCompoundTag@@@Z
    ...
    // vIndex: 182, symbol: ?pushActors@Bat@@UEAAXXZ
    virtual void pushActors();

    // vIndex: 211, symbol: ?newServerAiStep@Bat@@MEAAXXZ
