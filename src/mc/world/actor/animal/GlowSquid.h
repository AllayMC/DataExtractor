...
public:
    ...
    // vIndex: 125, symbol: ?handleEntityEvent@GlowSquid@@UEAAXW4ActorEvent@@H@Z
    ...
    // vIndex: 236, symbol: ?_hurt@GlowSquid@@MEAA_NAEBVActorDamageSource@@M_N1@Z
    ...
    // vIndex: 306, symbol: ?_getWalkTargetValue@GlowSquid@@UEAAMAEBVBlockPos@@@Z
    virtual float _getWalkTargetValue(class BlockPos const &);

    // vIndex: 318, symbol: ?_getInkSquirtSoundEvent@GlowSquid@@MEBA?AW4LevelSoundEvent@@XZ
