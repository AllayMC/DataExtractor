...
public:
    // NOLINTBEGIN
    // vIndex: 12, symbol: ?initializeComponents@Dolphin@@UEAAXW4InitializationMethod@Actor@@AEBVVariantParameterList@@@Z
    ...
    // vIndex: 172, symbol: ?canBePulledIntoVehicle@Dolphin@@UEBA_NXZ
    ...
    // vIndex: 259, symbol: ?aiStep@Dolphin@@UEAAXXZ
    virtual void aiStep();
    ...
    // vIndex: 300, symbol: ?createAIGoals@Dolphin@@UEAA_NXZ
    virtual bool createAIGoals();

    // vIndex: 306, symbol: ?_getWalkTargetValue@Dolphin@@UEAAMAEBVBlockPos@@@Z
