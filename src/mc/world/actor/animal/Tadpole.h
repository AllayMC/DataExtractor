...
public:
    // NOLINTBEGIN
    // vIndex: 12, symbol: ?initializeComponents@Tadpole@@UEAAXW4InitializationMethod@Actor@@AEBVVariantParameterList@@@Z
    ...
    // vIndex: 318, symbol: ?getFlopVerticalVelocityFactor@Tadpole@@UEBAMXZ
    virtual float getFlopVerticalVelocityFactor() const;

    // vIndex: 319, symbol: ?getFlopHorizontalVelocityFactor@Tadpole@@UEBAMXZ
