...
public:
    ...
    // vIndex: 167, symbol: ?readAdditionalSaveData@Allay@@UEAAXAEBVCompoundTag@@AEAVDataLoadHelper@@@Z
    virtual void readAdditionalSaveData(class CompoundTag const &, class DataLoadHelper &);

    // vIndex: 168, symbol: ?addAdditionalSaveData@Allay@@UEBAXAEAVCompoundTag@@@Z
    ...
    // vIndex: 181, symbol: ?aiStep@Allay@@UEAAXXZ
    virtual void aiStep();
