...
public:
    // NOLINTBEGIN
    // vIndex: 10, symbol: ?reloadHardcoded@Allay@@MEAAXW4InitializationMethod@Actor@@AEBVVariantParameterList@@@Z
    ...
    // vIndex: 239, symbol: ?readAdditionalSaveData@Allay@@UEAAXAEBVCompoundTag@@AEAVDataLoadHelper@@@Z
    virtual void readAdditionalSaveData(class CompoundTag const &, class DataLoadHelper &);

    // vIndex: 240, symbol: ?addAdditionalSaveData@Allay@@UEBAXAEAVCompoundTag@@@Z
    ...
    // vIndex: 259, symbol: ?aiStep@Allay@@UEAAXXZ
    virtual void aiStep();
