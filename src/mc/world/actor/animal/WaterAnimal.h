...
public:
    ...
    // vIndex: 262, symbol: ?checkSpawnRules@WaterAnimal@@UEAA_N_N@Z
    ...
    // vIndex: 318, symbol: ?getFlopVerticalVelocityFactor@WaterAnimal@@UEBAMXZ
    virtual float getFlopVerticalVelocityFactor() const;

    // vIndex: 319, symbol: ?getFlopHorizontalVelocityFactor@WaterAnimal@@UEBAMXZ
    virtual float getFlopHorizontalVelocityFactor() const;

    // symbol: ??1WaterAnimal@@UEAA@XZ
    MCVAPI ~WaterAnimal();
