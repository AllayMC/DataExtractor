...
public:
    // NOLINTBEGIN
    // vIndex: 11, symbol: ?reloadHardcodedClient@Bee@@UEAAXW4InitializationMethod@Actor@@AEBVVariantParameterList@@@Z
    ...
    // vIndex: 169, symbol: ?onSynchedDataUpdate@Bee@@UEAAXH@Z
