...
public:
    // NOLINTBEGIN
    // vIndex: 12, symbol: ?initializeComponents@TropicalFish@@UEAAXW4InitializationMethod@Actor@@AEBVVariantParameterList@@@Z
    ...
    // vIndex: 46, symbol: ?startRiding@TropicalFish@@UEAA_NAEAVActor@@@Z
    ...
    // vIndex: 169, symbol: ?onSynchedDataUpdate@TropicalFish@@UEAAXH@Z
    ...
    // vIndex: 233, symbol: ?updateEntitySpecificMolangVariables@TropicalFish@@UEAAXAEAVRenderParams@@@Z
    ...
    // vIndex: 300, symbol: ?createAIGoals@TropicalFish@@UEAA_NXZ
