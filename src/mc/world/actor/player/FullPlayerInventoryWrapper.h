...
public:
    ...
    MCAPI int32_t _clearSimpleContainerItem(class SimpleContainer &, ::ContainerID, int32_t);
    ...
    MCAPI int32_t _getSimpleContainerItemCount(class SimpleContainer &, int32_t, std::function<bool (class ItemStack const &)>);
    ...
    MCAPI int32_t _removeSimpleContainerItem(class SimpleContainer &, ::ContainerID, int32_t, class ItemStack const &, bool, int32_t);
