...
public:
    ...
    // symbol: ?findAttributeByName@ActorDefinitionDescriptor@@QEBA?AV?$optional@UActorDefinitionAttribute@@@std@@AEBV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@3@@Z
    ...
    MCAPI static void forceExecuteTriggerChain(class Actor &, class ActorDefinitionTrigger const &, std::vector<std::pair<std::string const, std::string const>> &, class VariantParameterList const &);

    // symbol: ?hasEvent@ActorDefinitionDescriptor@@SA_NAEBVActor@@AEBV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@Z
    ...
    MCAPI static bool _executeEvent(class Actor &, std::string const &, std::vector<std::pair<std::string const, std::string const>> &, class VariantParameterList const &);
    ...
    MCAPI static void _forceExecuteTrigger(class Actor &, class ActorDefinitionTrigger const &, std::vector<std::pair<std::string const, std::string const>> &, class VariantParameterList const &);
