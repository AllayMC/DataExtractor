...
public:
    ...
    MCAPI std::vector<std::pair<std::string, struct ActorDefinitionIdentifier const *>> buildSummonEntityTypeEnum(class Experiments const &) const;
    ...
    // symbol: ?loadActor@ActorFactory@@QEAA?AV?$OwnerPtrT@UEntityRefTraits@@@@PEAVCompoundTag@@AEAVDataLoadHelper@@AEBVDimensionHeightRange@@@Z
    MCAPI class OwnerPtrT<struct EntityRefTraits> loadActor(class CompoundTag *, class DataLoadHelper &, class DimensionHeightRange const &);
    ...
    MCAPI static void fillFactoryData(struct ActorDefinitionIdentifier const &, struct ActorDefinitionIdentifier const &, std::unordered_map<std::string,struct ActorFactoryData> const &, struct ActorFactoryData &);
    ...
    MCAPI void _buildSummonableActorList(class Experiments const &, std::function<void (std::string const &, struct ActorFactoryData const &)>) const;
