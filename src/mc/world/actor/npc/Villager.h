...
public:
    // NOLINTBEGIN
    // vIndex: 10, symbol: ?reloadHardcoded@Villager@@UEAAXW4InitializationMethod@Actor@@AEBVVariantParameterList@@@Z
    ...
    // vIndex: 180, symbol: ?buildDebugInfo@Villager@@UEBAXAEAV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@Z
