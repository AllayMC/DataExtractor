...
public:
    ...
    // vIndex: 100, symbol: ?getEntityTypeId@WanderingTrader@@UEBA?AW4ActorType@@XZ
    ...
    // vIndex: 163, symbol: ?updateEntitySpecificMolangVariables@WanderingTrader@@UEAAXAEAVRenderParams@@@Z
