...
public:
    ...
    // vIndex: 151, symbol: ?getEntityTypeId@WanderingTrader@@UEBA?AW4ActorType@@XZ
    ...
    // vIndex: 233, symbol: ?updateEntitySpecificMolangVariables@WanderingTrader@@UEAAXAEAVRenderParams@@@Z
