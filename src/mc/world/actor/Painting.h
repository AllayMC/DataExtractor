...
public:
    ...
    // vIndex: 28, symbol: ?tryCreateAddActorPacket@Painting@@UEAA?AV?$unique_ptr@VAddActorBasePacket@@U?$default_delete@VAddActorBasePacket@@@std@@@std@@XZ
    ...
    // vIndex: 42, symbol: ?getShadowRadius@Painting@@UEBAMXZ
    ...
    // vIndex: 167, symbol: ?readAdditionalSaveData@Painting@@MEAAXAEBVCompoundTag@@AEAVDataLoadHelper@@@Z
    virtual void readAdditionalSaveData(class CompoundTag const &, class DataLoadHelper &);

    // vIndex: 168, symbol: ?addAdditionalSaveData@Painting@@MEBAXAEAVCompoundTag@@@Z
