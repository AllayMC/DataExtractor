...
public:
    ...
    // vIndex: 5, symbol: ?reloadHardcodedClient@Minecart@@UEAAXW4InitializationMethod@Actor@@AEBVVariantParameterList@@@Z
    ...
    // vIndex: 174, symbol: ?getType@MinecartRideable@@UEAA?AW4MinecartType@@XZ
