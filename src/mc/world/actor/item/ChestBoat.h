...
public:
    ...
    // vIndex: 49, symbol: ?getEntityLocNameString@ChestBoat@@UEBA?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@XZ
    ...
    // vIndex: 219, symbol: ?kill@ChestBoat@@UEAAXXZ
    virtual void kill();
    ...
    // vIndex: 249, symbol: ?destroy@ChestBoat@@UEAAXPEAVActor@@@Z
