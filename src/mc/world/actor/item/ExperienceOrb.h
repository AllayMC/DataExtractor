...
public:
    // NOLINTBEGIN
    // vIndex: 4, symbol: ?reloadHardcoded@ExperienceOrb@@UEAAXW4InitializationMethod@Actor@@AEBVVariantParameterList@@@Z
    ...
    MCAPI static void spawnOrbs(class BlockSource &, class Vec3 const &, int32_t, int32_t, ::ExperienceOrb::DropType, class Player *);

    // symbol: ?spawnOrbs@ExperienceOrb@@SAXAEAVBlockSource@@AEBVVec3@@HW4DropType@1@PEAVPlayer@@@Z
    MCAPI static void spawnOrbs(class BlockSource &, class Vec3 const &, int32_t, ::ExperienceOrb::DropType, class Player *);
