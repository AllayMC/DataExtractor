...
public:
    // NOLINTBEGIN
    // vIndex: 10, symbol: ?reloadHardcoded@ExperienceOrb@@UEAAXW4InitializationMethod@Actor@@AEBVVariantParameterList@@@Z
    ...
    MCAPI static void spawnOrbs(class BlockSource &, class Vec3 const &, int, int, ::ExperienceOrb::DropType, class Player *);
