...
public:
    ...
    // vIndex: 249, symbol: ?destroy@MinecartHopper@@UEAAXAEBVActorDamageSource@@_N@Z
    virtual void destroy(class ActorDamageSource const &, bool);

    // vIndex: 250, symbol: ?getType@MinecartHopper@@UEAA?AW4MinecartType@@XZ
    virtual ::MinecartType getType();

    // vIndex: 251, symbol: ?getDefaultDisplayBlock@MinecartHopper@@UEBAPEBVBlock@@XZ
    virtual class Block const * getDefaultDisplayBlock() const;

    // vIndex: 252, symbol: __unk_vfn_252
    virtual void __unk_vfn_252();

    // vIndex: 253, symbol: ?getDefaultDisplayOffset@MinecartHopper@@UEBAHXZ
    virtual int getDefaultDisplayOffset() const;

    // vIndex: 254, symbol: ?applyNaturalSlowdown@MinecartHopper@@UEAAXAEAVBlockSource@@@Z
