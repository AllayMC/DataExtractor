...
public:
    ...
    // vIndex: 249, symbol: ?destroy@MinecartChest@@UEAAXAEBVActorDamageSource@@_N@Z
    ...
    // vIndex: 251, symbol: ?getDefaultDisplayBlock@MinecartChest@@UEBAPEBVBlock@@XZ
    virtual class Block const * getDefaultDisplayBlock() const;

    // vIndex: 252, symbol: __unk_vfn_252
    virtual void __unk_vfn_252();

    // vIndex: 254, symbol: ?applyNaturalSlowdown@MinecartChest@@UEAAXAEAVBlockSource@@@Z
