...
public:
    // NOLINTBEGIN
    // vIndex: 10, symbol: ?reloadHardcoded@Balloon@@UEAAXW4InitializationMethod@Actor@@AEBVVariantParameterList@@@Z
    virtual void reloadHardcoded(::Actor::InitializationMethod, class VariantParameterList const &);

    // vIndex: 16, symbol: __unk_vfn_16
    virtual void __unk_vfn_16();

    // vIndex: 19, symbol: ?remove@Balloon@@UEAAXXZ
    virtual void remove();
    ...
    // vIndex: 81, symbol: ?isPickable@Balloon@@UEAA_NXZ
    ...
    // vIndex: 236, symbol: ?_hurt@Balloon@@UEAA_NAEBVActorDamageSource@@M_N1@Z
