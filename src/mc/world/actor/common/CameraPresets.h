...
public:
    ...
    MCAPI static void _loadJsonFiles(class ResourcePackManager &, class Core::PathBuffer<class Core::StackString<char, 1024>> const &, std::function<void (std::string const &, class SemVersion const &, std::string const &)>);
