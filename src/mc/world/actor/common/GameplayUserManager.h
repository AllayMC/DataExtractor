...
public:
    ...
    MCAPI class Bedrock::PubSub::Subscription registerGameplayUserAddedCallback(std::function<void (class EntityContext &)>);
    ...
    MCAPI class Bedrock::PubSub::Subscription registerGameplayUserRemovedCallback(std::function<void (class EntityContext &)>);
    ...
    MCAPI class Bedrock::PubSub::Subscription registerGameplayUserResumedCallback(std::function<void (class EntityContext const &)>);
    ...
    MCAPI class Bedrock::PubSub::Subscription registerGameplayUserSuspendedCallback(std::function<void (class EntityContext const &)>);
