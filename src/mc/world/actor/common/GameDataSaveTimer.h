...
public:
    ...
    MCAPI std::chrono::steady_clock::time_point calculateNextGameDataSaveTime(std::chrono::steady_clock::time_point) const;
    ...
    MCAPI static std::chrono::steady_clock::time_point calculateNextStorageCheckTime(std::chrono::steady_clock::time_point);
