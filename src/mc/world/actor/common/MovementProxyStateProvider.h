...
namespace MovementProxyStateProvider {
    ...
    MCAPI std::unique_ptr<struct IMovementProxyStateProvider> create(class WeakRefT<struct EntityRefTraits>, entt::dispatcher &, gsl::not_null<class EntityRegistryBase *>);
    // NOLINTEND
