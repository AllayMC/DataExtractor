...
namespace MobMovementClimb {
    // NOLINTBEGIN
    // symbol: ?canAutoClimbNow@MobMovementClimb@@YA_NAEBUSynchedActorDataComponent@@AEBUAABBShapeComponent@@AEBUStateVectorComponent@@_NAEBVIConstBlockSource@@@Z
    MCAPI bool canAutoClimbNow(struct SynchedActorDataComponent const &, struct AABBShapeComponent const &, struct StateVectorComponent const &, bool, class IConstBlockSource const &);
    ...
    // symbol: ?getBlockAtFeet@MobMovementClimb@@YAAEBVBlockLegacy@@AEBUAABBShapeComponent@@AEBUStateVectorComponent@@AEBVIConstBlockSource@@@Z
    MCAPI class BlockLegacy const & getBlockAtFeet(struct AABBShapeComponent const &, struct StateVectorComponent const &, class IConstBlockSource const &);
