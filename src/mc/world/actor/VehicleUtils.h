...
public:
    ...
    MCAPI static auto getActivatorRailExitPatternStrategy(class BaseGameVersion const &) -> std::optional<class Vec3> (__cdecl *)(struct VehicleUtils::VehicleDirections const &, std::function<bool (class Vec3 const &, class Vec3 const &)>);
    ...
    MCAPI static auto getActorExitPatternStrategy(class BaseGameVersion const &) -> std::optional<class Vec3> (__cdecl *)(struct VehicleUtils::VehicleDirections const &, std::function<bool (class Vec3 const &, class Vec3 const &)>);
    ...
    MCAPI static std::optional<class Vec3> testPosFollowingEjectPattern(struct VehicleUtils::VehicleDirections const &, std::function<bool (class Vec3 const &, class Vec3 const &)>);
    ...
    MCAPI static std::optional<class Vec3> testPosFollowingLegacyActivatorRailPattern(struct VehicleUtils::VehicleDirections const &, std::function<bool (class Vec3 const &, class Vec3 const &)>);
    ...
    MCAPI static std::optional<class Vec3> testPosFollowingLegacyActorPattern(struct VehicleUtils::VehicleDirections const &, std::function<bool (class Vec3 const &, class Vec3 const &)>);
