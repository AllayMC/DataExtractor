...
public:
    ...
    // vIndex: 43, symbol: ?normalTick@EnderCrystal@@UEAAXXZ
    ...
    // vIndex: 68, symbol: ?getShadowRadius@EnderCrystal@@UEBAMXZ
    ...
    // vIndex: 81, symbol: ?isPickable@EnderCrystal@@UEAA_NXZ
    ...
    // vIndex: 119, symbol: ?isInvulnerableTo@EnderCrystal@@UEBA_NAEBVActorDamageSource@@@Z
    ...
    // vIndex: 236, symbol: ?_hurt@EnderCrystal@@MEAA_NAEBVActorDamageSource@@M_N1@Z
    virtual bool _hurt(class ActorDamageSource const &, float, bool, bool);

    // vIndex: 239, symbol: ?readAdditionalSaveData@EnderCrystal@@UEAAXAEBVCompoundTag@@AEAVDataLoadHelper@@@Z
    virtual void readAdditionalSaveData(class CompoundTag const &, class DataLoadHelper &);

    // vIndex: 240, symbol: ?addAdditionalSaveData@EnderCrystal@@UEBAXAEAVCompoundTag@@@Z
