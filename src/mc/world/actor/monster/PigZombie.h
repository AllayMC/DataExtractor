...
public:
    ...
    // vIndex: 43, symbol: ?normalTick@PigZombie@@UEAAXXZ
    ...
    // vIndex: 236, symbol: ?_hurt@PigZombie@@MEAA_NAEBVActorDamageSource@@M_N1@Z
    virtual bool _hurt(class ActorDamageSource const &, float, bool, bool);

    // vIndex: 239, symbol: ?readAdditionalSaveData@PigZombie@@MEAAXAEBVCompoundTag@@AEAVDataLoadHelper@@@Z
    virtual void readAdditionalSaveData(class CompoundTag const &, class DataLoadHelper &);

    // vIndex: 240, symbol: ?addAdditionalSaveData@PigZombie@@MEBAXAEAVCompoundTag@@@Z
    ...
    // vIndex: 262, symbol: ?checkSpawnRules@PigZombie@@UEAA_N_N@Z
    ...
    // vIndex: 305, symbol: ?getAttackTime@PigZombie@@UEAAHXZ
