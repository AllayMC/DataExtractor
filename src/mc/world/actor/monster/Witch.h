...
public:
    ...
    // vIndex: 25, symbol: ?getFiringPos@Witch@@UEBA?AVVec3@@XZ
    ...
    // vIndex: 99, symbol: ?canAttack@Witch@@UEBA_NPEAVActor@@_N@Z
    virtual bool canAttack(class Actor *, bool) const;

    // vIndex: 125, symbol: ?handleEntityEvent@Witch@@UEAAXW4ActorEvent@@H@Z
    ...
    // vIndex: 233, symbol: ?updateEntitySpecificMolangVariables@Witch@@UEAAXAEAVRenderParams@@@Z
    ...
    // vIndex: 247, symbol: ?_onSizeUpdated@Witch@@EEAAXXZ
    ...
    // vIndex: 297, symbol: ?getDamageAfterEnchantReduction@Witch@@MEBAMAEBVActorDamageSource@@M@Z
