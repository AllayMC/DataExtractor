...
public:
    ...
    // vIndex: 200, symbol: ?getDebugText@CaveSpider@@EEAAXAEAV?$vector@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@V?$allocator@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@2@@std@@@Z
    ...
    // vIndex: 319, symbol: ?getModelScale@CaveSpider@@UEBAMXZ
    virtual float getModelScale() const;

    // vIndex: 320, symbol: ?getSpiderType@CaveSpider@@UEBA?AW4Type@Spider@@XZ
