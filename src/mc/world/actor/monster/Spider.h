...
public:
    ...
    // vIndex: 68, symbol: ?getShadowRadius@Spider@@UEBAMXZ
    ...
    // vIndex: 116, symbol: ?shouldRender@Spider@@UEBA_NXZ
    ...
    // vIndex: 188, symbol: ?canBeAffected@Spider@@UEBA_NI@Z
    ...
    // vIndex: 241, symbol: ?_playStepSound@Spider@@MEAAXAEBVBlockPos@@AEBVBlock@@@Z
    ...
    // vIndex: 319, symbol: ?getModelScale@Spider@@UEBAMXZ
    virtual float getModelScale() const;

    // vIndex: 320, symbol: ?getSpiderType@Spider@@UEBA?AW4Type@1@XZ
