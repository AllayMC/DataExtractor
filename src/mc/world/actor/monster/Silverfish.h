...
public:
    ...
    // vIndex: 125, symbol: ?handleEntityEvent@Silverfish@@UEAAXW4ActorEvent@@H@Z
    ...
    // vIndex: 241, symbol: ?_playStepSound@Silverfish@@MEAAXAEBVBlockPos@@AEBVBlock@@@Z
    ...
    // vIndex: 250, symbol: ?spawnAnim@Silverfish@@UEAAXXZ
    virtual void spawnAnim();

    // vIndex: 262, symbol: ?checkSpawnRules@Silverfish@@UEAA_N_N@Z
    ...
    // vIndex: 306, symbol: ?_getWalkTargetValue@Silverfish@@UEAAMAEBVBlockPos@@@Z
    virtual float _getWalkTargetValue(class BlockPos const &);

    // vIndex: 318, symbol: ?isDarkEnoughToSpawn@Silverfish@@UEBA_NXZ
