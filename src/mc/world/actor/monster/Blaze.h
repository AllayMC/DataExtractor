...
public:
    // NOLINTBEGIN
    // vIndex: 11, symbol: ?reloadHardcodedClient@Blaze@@UEAAXW4InitializationMethod@Actor@@AEBVVariantParameterList@@@Z
    ...
    // vIndex: 43, symbol: ?normalTick@Blaze@@UEAAXXZ
    ...
    // vIndex: 75, symbol: ?getBrightness@Blaze@@UEBAMMAEBVIConstBlockSource@@@Z
    ...
    // vIndex: 90, symbol: ?isOnFire@Blaze@@UEBA_NXZ
    ...
    // vIndex: 259, symbol: ?aiStep@Blaze@@UEAAXXZ
    virtual void aiStep();
    ...
    // vIndex: 318, symbol: ?isDarkEnoughToSpawn@Blaze@@UEBA_NXZ
