...
public:
    // NOLINTBEGIN
    // vIndex: 10, symbol: ?reloadHardcoded@Ghast@@MEAAXW4InitializationMethod@Actor@@AEBVVariantParameterList@@@Z
    ...
    // vIndex: 233, symbol: ?updateEntitySpecificMolangVariables@Ghast@@UEAAXAEAVRenderParams@@@Z
    virtual void updateEntitySpecificMolangVariables(class RenderParams &);

    // vIndex: 235, symbol: __unk_vfn_235
    virtual void __unk_vfn_235();

    // vIndex: 236, symbol: ?_hurt@Ghast@@MEAA_NAEBVActorDamageSource@@M_N1@Z
    ...
    // vIndex: 306, symbol: ?_getWalkTargetValue@Ghast@@UEAAMAEBVBlockPos@@@Z
    virtual float _getWalkTargetValue(class BlockPos const &);

    // vIndex: 318, symbol: ?isDarkEnoughToSpawn@Ghast@@UEBA_NXZ
