...
public:
    // NOLINTBEGIN
    // vIndex: 10, symbol: ?reloadHardcoded@Vex@@UEAAXW4InitializationMethod@Actor@@AEBVVariantParameterList@@@Z
    virtual void reloadHardcoded(::Actor::InitializationMethod, class VariantParameterList const &);

    // vIndex: 12, symbol: ?initializeComponents@Vex@@UEAAXW4InitializationMethod@Actor@@AEBVVariantParameterList@@@Z
    ...
    // vIndex: 51, symbol: ?isInWall@Vex@@UEBA_NXZ
    ...
    // vIndex: 239, symbol: ?readAdditionalSaveData@Vex@@UEAAXAEBVCompoundTag@@AEAVDataLoadHelper@@@Z
    virtual void readAdditionalSaveData(class CompoundTag const &, class DataLoadHelper &);

    // vIndex: 240, symbol: ?addAdditionalSaveData@Vex@@UEBAXAEAVCompoundTag@@@Z
