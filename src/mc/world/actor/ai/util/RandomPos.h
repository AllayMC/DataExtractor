...
public:
    ...
    MCAPI static bool getPos(class Vec3 &, class Mob &, int32_t, int32_t, int32_t, ::SolidityCheckType);

    // symbol: ?getPosAvoid@RandomPos@@SA_NAEAVVec3@@AEAVMob@@HHAEBV2@W4SolidityCheckType@@H@Z
    MCAPI static bool getPosAvoid(class Vec3 &, class Mob &, int32_t, int32_t, class Vec3 const &, ::SolidityCheckType, int32_t);

    // symbol: ?getPosInDirection@RandomPos@@SA_NAEAVVec3@@AEAVMob@@HHH_N2PEAV2@AEBUIntRange@@HW4SolidityCheckType@@@Z
    MCAPI static bool getPosInDirection(class Vec3 &, class Mob &, int32_t, int32_t, int32_t, bool, bool, class Vec3 *, struct IntRange const &, int32_t, ::SolidityCheckType);
    ...
    MCAPI static bool generateRandomPos(class Vec3 &, class Mob &, int32_t, int32_t, class Vec3 const *, bool, bool, int32_t, ::SolidityCheckType);

    // symbol: ?generateRandomPos@RandomPos@@CA_NAEAVRandomize@@AEAVVec3@@AEAVMob@@HHHPEBV3@_N4AEBUIntRange@@HW4SolidityCheckType@@@Z
    MCAPI static bool generateRandomPos(class Randomize &, class Vec3 &, class Mob &, int32_t, int32_t, int32_t, class Vec3 const *, bool, bool, struct IntRange const &, int32_t, ::SolidityCheckType);
    ...
    MCAPI static bool snapToGround(class BlockPos &, class Mob &, int32_t, struct IntRange const &, ::SolidityCheckType);
