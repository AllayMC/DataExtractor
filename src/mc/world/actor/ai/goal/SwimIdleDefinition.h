...
public:
    ...
    SwimIdleDefinition& operator=(SwimIdleDefinition const &) = delete;
    SwimIdleDefinition(SwimIdleDefinition const &) = delete;
...
public:
    ...
    MCAPI static void buildSchema(std::string const &, std::shared_ptr<class JsonUtil::JsonSchemaObjectNode<class JsonUtil::EmptyClass, class SwimIdleDefinition>> &);
