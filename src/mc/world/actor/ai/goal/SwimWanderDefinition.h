...
public:
    ...
    SwimWanderDefinition& operator=(SwimWanderDefinition const &) = delete;
    SwimWanderDefinition(SwimWanderDefinition const &) = delete;
...
public:
    ...
    MCAPI static void buildSchema(std::string const &, std::shared_ptr<class JsonUtil::JsonSchemaObjectNode<class JsonUtil::EmptyClass, class SwimWanderDefinition>> &);
