...
public:
    ...
    TimerActorFlagBaseGoal& operator=(TimerActorFlagBaseGoal const &) = delete;
    TimerActorFlagBaseGoal(TimerActorFlagBaseGoal const &) = delete;
    TimerActorFlagBaseGoal() = delete;
...
public:
    ...
    // vIndex: 7, symbol: ?appendDebugInfo@TimerActorFlagBaseGoal@@UEBAXAEAV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@Z
