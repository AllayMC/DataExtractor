...
public:
    ...
    // vIndex: 7, symbol: ?appendDebugInfo@StompBlockGoal@@UEBAXAEAV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@Z
    ...
    MCAPI StompBlockGoal(class Block const *, class Mob &, float, int32_t, int32_t, float, int32_t);
