...
public:
    ...
    // vIndex: 7, symbol: ?appendDebugInfo@LayEggGoal@@UEBAXAEAV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@Z
    ...
    MCAPI LayEggGoal(class Mob &, float, int32_t, int32_t, float, std::vector<class ItemDescriptor> const &, std::vector<::MaterialType> const &, bool, bool, float, class ItemDescriptor const &, class ActorDefinitionTrigger const &, std::string const &);
