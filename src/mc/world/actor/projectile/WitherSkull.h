...
public:
    // NOLINTBEGIN
    // vIndex: 12, symbol: ?initializeComponents@WitherSkull@@UEAAXW4InitializationMethod@Actor@@AEBVVariantParameterList@@@Z
    ...
    // vIndex: 81, symbol: ?isPickable@WitherSkull@@UEAA_NXZ
    ...
    // vIndex: 90, symbol: ?isOnFire@WitherSkull@@UEBA_NXZ
    ...
    // vIndex: 206, symbol: ?canDestroyBlock@WitherSkull@@UEBA_NAEBVBlock@@@Z
    ...
    // vIndex: 236, symbol: ?_hurt@WitherSkull@@MEAA_NAEBVActorDamageSource@@M_N1@Z
    ...
    // vIndex: 249, symbol: ?getInertia@WitherSkull@@MEAAMXZ
