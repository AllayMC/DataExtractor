...
public:
    ...
    // vIndex: 81, symbol: ?isPickable@DragonFireball@@UEAA_NXZ
    ...
    // vIndex: 236, symbol: ?_hurt@DragonFireball@@MEAA_NAEBVActorDamageSource@@M_N1@Z
    ...
    // vIndex: 251, symbol: ?getTrailParticle@DragonFireball@@MEAA?AW4ParticleType@@XZ
