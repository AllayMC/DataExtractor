...
public:
    // NOLINTBEGIN
    // vIndex: 10, symbol: ?reloadHardcoded@ShulkerBullet@@UEAAXW4InitializationMethod@Actor@@AEBVVariantParameterList@@@Z
    ...
    // vIndex: 43, symbol: ?normalTick@ShulkerBullet@@UEAAXXZ
    ...
    // vIndex: 81, symbol: ?isPickable@ShulkerBullet@@UEAA_NXZ
    ...
    // vIndex: 90, symbol: ?isOnFire@ShulkerBullet@@UEBA_NXZ
    ...
    // vIndex: 153, symbol: ?getSourceUniqueID@ShulkerBullet@@UEBA?AUActorUniqueID@@XZ
    ...
    // vIndex: 239, symbol: ?readAdditionalSaveData@ShulkerBullet@@MEAAXAEBVCompoundTag@@AEAVDataLoadHelper@@@Z
    virtual void readAdditionalSaveData(class CompoundTag const &, class DataLoadHelper &);

    // vIndex: 240, symbol: ?addAdditionalSaveData@ShulkerBullet@@MEBAXAEAVCompoundTag@@@Z
