...
public:
    // NOLINTBEGIN
    // vIndex: 12, symbol: ?initializeComponents@ThrownPotion@@UEAAXW4InitializationMethod@Actor@@AEBVVariantParameterList@@@Z
    ...
    // vIndex: 152, symbol: ?queryEntityRenderer@ThrownPotion@@UEBAAEBVHashedString@@XZ
    ...
    // vIndex: 207, symbol: ?setAuxValue@ThrownPotion@@UEAAXH@Z
    ...
    // vIndex: 239, symbol: ?readAdditionalSaveData@ThrownPotion@@UEAAXAEBVCompoundTag@@AEAVDataLoadHelper@@@Z
    virtual void readAdditionalSaveData(class CompoundTag const &, class DataLoadHelper &);

    // vIndex: 240, symbol: ?addAdditionalSaveData@ThrownPotion@@UEBAXAEAVCompoundTag@@@Z
