...
public:
    ...
    // vIndex: 249, symbol: ?getThrowPower@ExperiencePotion@@MEAAMXZ
    virtual float getThrowPower();

    // vIndex: 250, symbol: __unk_vfn_250
    virtual void __unk_vfn_250();

    // vIndex: 251, symbol: ?getThrowUpAngleOffset@ExperiencePotion@@MEAAMXZ
    virtual float getThrowUpAngleOffset();

    // vIndex: 252, symbol: ?getGravity@ExperiencePotion@@MEAAMXZ
