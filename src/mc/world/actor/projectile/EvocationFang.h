...
public:
    ...
    // vIndex: 43, symbol: ?normalTick@EvocationFang@@UEAAXXZ
    ...
    // vIndex: 68, symbol: ?getShadowRadius@EvocationFang@@UEBAMXZ
    ...
    // vIndex: 125, symbol: ?handleEntityEvent@EvocationFang@@UEAAXW4ActorEvent@@H@Z
    virtual void handleEntityEvent(::ActorEvent, int);

    // vIndex: 153, symbol: ?getSourceUniqueID@EvocationFang@@UEBA?AUActorUniqueID@@XZ
