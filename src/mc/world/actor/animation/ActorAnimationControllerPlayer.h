...
public:
    ...
    // vIndex: 7, symbol: ?findAnimation@ActorAnimationControllerPlayer@@UEAA?AV?$shared_ptr@VActorAnimationPlayer@@@std@@AEBVHashedString@@@Z
    ...
    MCAPI ActorAnimationControllerPlayer(class HashedString const &, class ActorAnimationControllerPtr const &, class AnimationComponent &, class ExpressionNode const &, std::set<class HashedString, std::hash<class HashedString>, std::allocator<class HashedString>> &);
    ...
    MCAPI void applyStateAnimationToPose(class RenderParams &, std::unordered_map<::SkeletalHierarchyIndex,std::vector<class BoneOrientation>> &, float);
    ...
    MCAPI void blendViaShortestPath(std::unordered_map<::SkeletalHierarchyIndex,std::vector<class BoneOrientation>> &, std::unordered_map<::SkeletalHierarchyIndex,std::vector<class BoneOrientation>> &, std::unordered_map<::SkeletalHierarchyIndex,std::vector<class BoneOrientation>> &, float, float);
