...
namespace VanillaSystemsRegistration {
    ...
    MCAPI void registerVanillaServerTickingSystems(class EntitySystems &, gsl::not_null<class Bedrock::NonOwnerPointer<class ILevel const>>, struct VanillaSystemsRegistration::RegistrationOptions const &);
