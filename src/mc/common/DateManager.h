...
public:
    ...
    MCAPI static struct tm toDateTime(int64_t, ::DateManager::TimeZoneType);

    // symbol: ?toString@DateManager@@SA?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@AEB_JW4TimeZoneType@1@AEBV23@@Z
    MCAPI static std::string toString(int64_t const &, ::DateManager::TimeZoneType, std::string const &);
    ...
    MCAPI static std::string toString_DateTime(int64_t const &, ::DateManager::TimeZoneType);
