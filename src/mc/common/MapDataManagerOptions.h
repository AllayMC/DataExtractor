...
public:
    ...
    MapDataManagerOptions& operator=(MapDataManagerOptions const &) = delete;
    MapDataManagerOptions(MapDataManagerOptions const &) = delete;
    MapDataManagerOptions() = delete;
...
public:
    ...
    MCAPI MapDataManagerOptions(class LevelData &);
