...
public:
    ...
    // vIndex: 2, symbol: ?upgradeToNext@BlockLoot11910Upgrade@BlockLootVersioning@@UEBA_NAEAV?$GenericDocument@U?$UTF8@D@rapidjson@@V?$MemoryPoolAllocator@VCrtAllocator@rapidjson@@@2@VCrtAllocator@2@@rapidjson@@@Z
