...
public:
    ...
    MCAPI static void checkChatFilteringEventsAndSendToastIfClientWasMuted(std::vector<::Safety::TextFilteringEvent> const &, class gsl::not_null<class PacketSender *>, class NetworkIdentifier const &, ::SubClientId const &);
    ...
    MCAPI static bool checkChatFilteringEventsForFlooding(std::vector<::Safety::TextFilteringEvent> const &);
