...
public:
    ...
    MCAPI static void checkChatFilteringEventsAndSendToastIfClientWasMuted(std::vector<::Safety::TextFilteringEvent> const &, gsl::not_null<class PacketSender *>, class NetworkIdentifier const &, ::SubClientId const &);
