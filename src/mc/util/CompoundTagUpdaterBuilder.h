...
public:
    ...
    MCAPI class CompoundTagUpdaterBuilder & edit(std::string const &, std::function<void (class CompoundTagEditHelper &)> &&);
    ...
    MCAPI class CompoundTagUpdaterBuilder & matchInteger(std::string const &, int64);
    ...
    MCAPI class CompoundTagUpdaterBuilder & tryEdit(std::string const &, std::function<void (class CompoundTagEditHelper &)> &&);
