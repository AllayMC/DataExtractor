...
public:
    ...
    // vIndex: 1, symbol: ?forBlockPos@XoroshiroPositionalRandomFactory@@UEBA?AV?$unique_ptr@VIRandom@@U?$default_delete@VIRandom@@@std@@@std@@AEBVBlockPos@@@Z
    virtual std::unique_ptr<class IRandom> forBlockPos(class BlockPos const &) const;

    // vIndex: 2, symbol: ?forString@XoroshiroPositionalRandomFactory@@UEBA?AV?$unique_ptr@VIRandom@@U?$default_delete@VIRandom@@@std@@@std@@AEBV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@3@@Z
...
private:
    ...
    MCAPI static class Bedrock::Threading::ThreadLocalObject<class Crypto::Hash::md5, std::allocator<class Crypto::Hash::md5>> mThreadLocalDigest;
