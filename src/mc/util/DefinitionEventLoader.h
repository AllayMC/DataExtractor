...
public:
    ...
    MCAPI static class DefinitionEvent loadEvent(class Json::Value, class SemVersion const &, ::TypeExecutingEvent, class EventResponseFactory const *);
    ...
    MCAPI static void _loadCollection(class DefinitionEvent &, class Json::Value const &, class SemVersion const &, ::TypeExecutingEvent, class EventResponseFactory const *);
