...
namespace MobSpawnUtils {
    ...
    MCAPI class Mob * trySpawnMob(class BlockSource &, struct ActorDefinitionIdentifier const &, class BlockPos, int32_t, int32_t, int32_t, std::function<bool (class BlockPos)> const &, ::MobSpawnUtils::SurfaceDetectionType);
    // NOLINTEND
