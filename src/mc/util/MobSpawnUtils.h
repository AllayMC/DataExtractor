...
namespace MobSpawnUtils {
    ...
    MCAPI class Mob * trySpawnMob(class BlockSource &, struct ActorDefinitionIdentifier const &, class BlockPos, int, int, int, std::function<bool (class BlockPos)> const &, ::MobSpawnUtils::SurfaceDetectionType);
    // NOLINTEND
