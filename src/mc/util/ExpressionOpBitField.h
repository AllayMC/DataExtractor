...
public:
    ...
    MCAPI bool areBitsSet(::ExpressionOp, ::ExpressionOp, ::ExpressionOp, ::ExpressionOp, ::ExpressionOp, ::ExpressionOp, ::ExpressionOp, ::ExpressionOp) const;
    ...
    MCAPI bool areBitsSet(::ExpressionOp, ::ExpressionOp, ::ExpressionOp, ::ExpressionOp, ::ExpressionOp, ::ExpressionOp) const;
