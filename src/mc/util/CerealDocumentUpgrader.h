...
public:
    ...
    MCAPI bool upgradeJson(std::string &, class SemVersion &, class Core::Path const &, std::optional<class SemVersion>, std::function<bool (class SemVersion const &)>);
    ...
    MCAPI std::string _getVersion(rapidjson::GenericDocument<rapidjson::UTF8<char>, rapidjson::MemoryPoolAllocator<rapidjson::CrtAllocator>, rapidjson::CrtAllocator> &);
