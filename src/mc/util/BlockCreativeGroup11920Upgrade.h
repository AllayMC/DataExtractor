...
public:
    ...
    // vIndex: 1, symbol: ?previousSchema@BlockCreativeGroup11920Upgrade@BlockCreativeGroupVersioning@@UEBAXAEAVSchemaFactory@cereal@@@Z
    virtual void previousSchema(class cereal::SchemaFactory &) const;

    // vIndex: 2, symbol: ?upgradeToNext@BlockCreativeGroup11920Upgrade@BlockCreativeGroupVersioning@@UEBA_NAEAV?$GenericDocument@U?$UTF8@D@rapidjson@@V?$MemoryPoolAllocator@VCrtAllocator@rapidjson@@@2@VCrtAllocator@2@@rapidjson@@@Z
