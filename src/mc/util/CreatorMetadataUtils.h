...
namespace CreatorMetadataUtils {
    ...
    MCAPI class Json::Value _generateEntitiesMetadataJson(std::unordered_map<std::string,std::unique_ptr<class ActorDefinition>> const &);
    ...
    MCAPI std::unordered_map<std::string,std::string> _getPropertyToEntityNameMap(std::unordered_map<std::string,std::unique_ptr<class ActorDefinition>> const &);
    ...
    MCAPI void generateEntitiesDocumentation(class Core::Path const &, std::unordered_map<std::string,std::unique_ptr<class ActorDefinition>> const &);
    ...
    MCAPI void generateVanillaDataDocumentation(class Core::Path const &, class ItemRegistryRef, std::unordered_map<std::string,std::unique_ptr<class ActorDefinition>> const &, class CameraPresets const &);
