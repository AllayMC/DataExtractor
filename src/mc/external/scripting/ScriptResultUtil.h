...
namespace ScriptResultUtil {
    ...
    MCAPI class Scripting::Result<class Vec3, struct gametest::GameTestError> GametestResultToScriptingValueResult(std::variant<struct gametest::GameTestError, class Vec3> const &);
    ...
    MCAPI class Scripting::Result<class Vec3, struct gametest::GameTestError> GametestResultToScriptingValueResult(std::variant<struct gametest::GameTestError, class BlockPos> const &);
