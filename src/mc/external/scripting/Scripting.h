...
namespace Scripting {
    ...
    MCAPI void LogMessage(::Scripting::LogLevel, char const *, uint32_t, char const *, ...);
    ...
    MCAPI void defaultLogFunction(void *, ::Scripting::LogLevel, char const *, uint32_t, char const *);
