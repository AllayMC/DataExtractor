...
public:
    ...
    public:
        // NOLINTBEGIN
        // symbol: ??ARecordGroup@ImguiProfiler@@QEAAAEAUFullStackRecord@01@AEBV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@Z
        ...
        MCAPI bool isGreaterThan(struct ImguiProfiler::RecordGroup::FullStackRecord const &, struct ImguiProfiler::RecordGroup::FullStackRecord const &);
...
public:
    ...
    inline auto& $sProduceRecords() { return sProduceRecords; }
