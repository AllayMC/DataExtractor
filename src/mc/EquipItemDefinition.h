...
public:
    ...
    EquipItemDefinition& operator=(EquipItemDefinition const &) = delete;
    EquipItemDefinition(EquipItemDefinition const &) = delete;
...
public:
    ...
    MCAPI static void buildSchema(std::shared_ptr<class JsonUtil::JsonSchemaObjectNode<class JsonUtil::EmptyClass, class EquipItemDefinition>> &);
