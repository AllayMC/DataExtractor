...
public:
    ...
    MCAPI static std::unique_ptr<class Certificate> createWrappedCertificate(class PrivateKeyManager &, int64, int64, std::string const &, bool, class Json::Value const *, std::unique_ptr<class Certificate>);
    ...
    MCAPI static std::unique_ptr<class WebToken> createWebToken(class PrivateKeyManager &, int64, int64, std::string const &, bool, class Json::Value const *);
