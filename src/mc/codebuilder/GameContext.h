...
public:
    ...
    // symbol: ?create@GameContext@CodeBuilder@@SA?AV?$unique_ptr@VGameContext@CodeBuilder@@U?$default_delete@VGameContext@CodeBuilder@@@std@@@std@@V?$function@$$A6APEAVILevel@@XZ@4@@Z
