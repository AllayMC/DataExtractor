...
public:
    // NOLINTBEGIN
    // symbol: ??0ErrorMessage@CodeBuilder@@QEAA@AEBV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@UMCRESULT@@0@Z
    MCAPI ErrorMessage(std::string const &, struct MCRESULT, std::string const &);

    // symbol: ??0ErrorMessage@CodeBuilder@@QEAA@AEBV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@UMCRESULT@@@Z
