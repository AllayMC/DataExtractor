...
public:
    ...
    MCVAPI void blockBroken(class Player const *, class Block const &, int, int, ushort) const;

    // symbol: ?blockPlaced@Messenger@CodeBuilder@@UEBAXPEBVPlayer@@AEBVBlock@@_NG@Z
    MCVAPI void blockPlaced(class Player const *, class Block const &, bool, ushort) const;
    ...
    MCVAPI void entitySpawned(class Player const *, int, uint) const;

    // symbol: ?itemAcquired@Messenger@CodeBuilder@@UEBAXPEBVPlayer@@AEBVItemDescriptor@@HIH@Z
    MCVAPI void itemAcquired(class Player const *, class ItemDescriptor const &, int, uint, int) const;

    // symbol: ?itemCrafted@Messenger@CodeBuilder@@UEBAXPEBVPlayer@@_NAEBVItemInstance@@111HHH11@Z
    MCVAPI void itemCrafted(class Player const *, bool, class ItemInstance const &, bool, bool, bool, int, int, int, bool, bool) const;
    ...
    MCVAPI void mobInteracted(class Player const *, int, int, int, uchar) const;
    ...
    MCVAPI void mobKilled(class Player const *, class Actor *, class Mob &, uint, std::string const &, int) const;
    ...
    MCVAPI void tradeCompleted(class Player const *, class Actor *, class ItemDescriptor const &, class ItemDescriptor const &, class ItemInstance const &, int) const;
