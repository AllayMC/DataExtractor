...
public:
    ...
    // vIndex: 8, symbol: ?print@CompoundTag@@UEBAXAEBV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@AEAVPrintStream@@@Z
    ...
    MCAPI std::_Tree_const_iterator<std::_Tree_val<std::_Tree_simple_types<std::pair<std::string const, class CompoundTagVariant>>>> begin() const;
    ...
    MCAPI std::_Tree_const_iterator<std::_Tree_val<std::_Tree_simple_types<std::pair<std::string const, class CompoundTagVariant>>>> end() const;
    ...
    MCAPI std::map<std::string, class CompoundTagVariant, std::less<void>, std::allocator<std::pair<std::string const, class CompoundTagVariant>>> const & rawView() const;
