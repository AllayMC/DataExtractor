...
public:
    ...
    // vIndex: 4, symbol: ?asBool@NBTSchemaReader@@UEAA?AV?$Result@_NVerror_code@std@@@Bedrock@@AEBUSerializerTraits@cereal@@@Z
    virtual class Bedrock::Result<bool, std::error_code> asBool(struct cereal::SerializerTraits const &);

    // vIndex: 5, symbol: ?asInt8@NBTSchemaReader@@UEAA?AV?$Result@CVerror_code@std@@@Bedrock@@AEBUSerializerTraits@cereal@@@Z
    virtual class Bedrock::Result<int8_t, std::error_code> asInt8(struct cereal::SerializerTraits const &);

    // vIndex: 6, symbol: ?asUInt8@NBTSchemaReader@@UEAA?AV?$Result@EVerror_code@std@@@Bedrock@@AEBUSerializerTraits@cereal@@@Z
    virtual class Bedrock::Result<uint8_t, std::error_code> asUInt8(struct cereal::SerializerTraits const &);

    // vIndex: 7, symbol: ?asInt16@NBTSchemaReader@@UEAA?AV?$Result@FVerror_code@std@@@Bedrock@@AEBUSerializerTraits@cereal@@@Z
    virtual class Bedrock::Result<int16_t, std::error_code> asInt16(struct cereal::SerializerTraits const &);

    // vIndex: 8, symbol: ?asUInt16@NBTSchemaReader@@UEAA?AV?$Result@GVerror_code@std@@@Bedrock@@AEBUSerializerTraits@cereal@@@Z
    virtual class Bedrock::Result<uint16_t, std::error_code> asUInt16(struct cereal::SerializerTraits const &);

    // vIndex: 9, symbol: ?asInt32@NBTSchemaReader@@UEAA?AV?$Result@HVerror_code@std@@@Bedrock@@AEBUSerializerTraits@cereal@@@Z
    virtual class Bedrock::Result<int32_t, std::error_code> asInt32(struct cereal::SerializerTraits const &);

    // vIndex: 10, symbol: ?asUInt32@NBTSchemaReader@@UEAA?AV?$Result@IVerror_code@std@@@Bedrock@@AEBUSerializerTraits@cereal@@@Z
    virtual class Bedrock::Result<uint32_t, std::error_code> asUInt32(struct cereal::SerializerTraits const &);

    // vIndex: 11, symbol: ?asInt64@NBTSchemaReader@@UEAA?AV?$Result@_JVerror_code@std@@@Bedrock@@AEBUSerializerTraits@cereal@@@Z
    virtual class Bedrock::Result<int64_t, std::error_code> asInt64(struct cereal::SerializerTraits const &);

    // vIndex: 12, symbol: ?asUInt64@NBTSchemaReader@@UEAA?AV?$Result@_KVerror_code@std@@@Bedrock@@AEBUSerializerTraits@cereal@@@Z
    virtual class Bedrock::Result<uint64_t, std::error_code> asUInt64(struct cereal::SerializerTraits const &);

    // vIndex: 13, symbol: ?asFloat@NBTSchemaReader@@UEAA?AV?$Result@MVerror_code@std@@@Bedrock@@AEBUSerializerTraits@cereal@@@Z
    virtual class Bedrock::Result<float, std::error_code> asFloat(struct cereal::SerializerTraits const &);

    // vIndex: 14, symbol: ?asDouble@NBTSchemaReader@@UEAA?AV?$Result@NVerror_code@std@@@Bedrock@@AEBUSerializerTraits@cereal@@@Z
    virtual class Bedrock::Result<double, std::error_code> asDouble(struct cereal::SerializerTraits const &);

    // vIndex: 15, symbol: ?asString@NBTSchemaReader@@UEAA?AV?$Result@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@Verror_code@2@@Bedrock@@AEBUSerializerTraits@cereal@@@Z
    ...
    virtual uint64_t members(struct cereal::SerializerTraits const &);

    // vIndex: 17, symbol: ?length@NBTSchemaReader@@UEAA_KAEBUSerializerTraits@cereal@@@Z
    virtual uint64_t length(struct cereal::SerializerTraits const &);

    // vIndex: 18, symbol: ?pushMember@NBTSchemaReader@@UEAA_NAEBV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@AEBUSerializerTraits@cereal@@@Z
    virtual bool pushMember(std::string const &, struct cereal::SerializerTraits const &);

    // vIndex: 19, symbol: ?pushMember@NBTSchemaReader@@UEAA?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@_KAEBUSerializerTraits@cereal@@@Z
