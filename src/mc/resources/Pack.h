...
public:
    ...
    MCAPI static std::unique_ptr<class Pack> createPack(class ResourceLocation const &, ::PackType, ::PackOrigin, class IPackManifestFactory &, gsl::not_null<class Bedrock::NonOwnerPointer<class IContentKeyProvider const>> const &, class PackSourceReport *);
