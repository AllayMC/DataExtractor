...
public:
    ...
    virtual class PackSourceReport load(class IPackManifestFactory &, Bedrock::NotNullNonOwnerPtr<class IContentKeyProvider const> const &) = 0;
    ...
    MCAPI void resolveUpgradeDependencies(class Pack &, Bedrock::NotNullNonOwnerPtr<class IContentKeyProvider const> const &);
