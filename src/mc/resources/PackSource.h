...
public:
    ...
    // vIndex: 5, symbol: ?load@WorldTemplatePackSource@@UEAA?AVPackSourceReport@@AEAVIPackManifestFactory@@AEBV?$not_null@V?$NonOwnerPointer@$$CBVIContentKeyProvider@@@Bedrock@@@gsl@@@Z
    virtual class PackSourceReport load(class IPackManifestFactory &, gsl::not_null<class Bedrock::NonOwnerPointer<class IContentKeyProvider const>> const &) = 0;
    ...
    MCAPI void resolveUpgradeDependencies(class Pack &, gsl::not_null<class Bedrock::NonOwnerPointer<class IContentKeyProvider const>> const &);
