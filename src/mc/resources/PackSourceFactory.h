...
public:
    ...
    virtual class WorldTemplatePackSource & createWorldTemplatePackSource(class gsl::not_null<class Bedrock::NonOwnerPointer<class WorldTemplateManager const>> const &, class mce::UUID const &, ::PackType, ::PackOrigin);
    ...
    // vIndex: 3, symbol: ?createDirectoryPackSource@PackSourceFactory@@UEAAAEAVDirectoryPackSource@@AEBVPath@Core@@W4PackType@@W4PackOrigin@@_N@Z
    virtual class DirectoryPackSource & createDirectoryPackSource(class Core::Path const &, ::PackType, ::PackOrigin, bool);

    // vIndex: 4, symbol: ?getDirectoryPackSource@PackSourceFactory@@UEBAPEAVDirectoryPackSource@@AEBVPath@Core@@W4PackType@@@Z
    ...
    // vIndex: 7, symbol: ?createWorldHistoryPackSource@PackSourceFactory@@UEAAAEAVWorldHistoryPackSource@@AEBVPath@Core@@W4PackType@@@Z
    virtual class WorldHistoryPackSource & createWorldHistoryPackSource(class Core::Path const &, ::PackType);

    // vIndex: 8, symbol: ?getWorldHistoryPackSource@PackSourceFactory@@UEBAPEAVWorldHistoryPackSource@@AEBVPath@Core@@W4PackType@@@Z
    virtual class WorldHistoryPackSource * getWorldHistoryPackSource(class Core::Path const &, ::PackType) const;

    // vIndex: 9, symbol: ?getDirectoryPackSourceContaining@PackSourceFactory@@UEBAPEAVDirectoryPackSource@@AEBUPackIdVersion@@@Z
    ...
    // vIndex: 11, symbol: ?createDynamicPackagePackSource@PackSourceFactory@@UEAAAEAVInPackagePackSource@@W4PackType@@@Z
    ...
    // vIndex: 13, symbol: ?setDynamicPackagePacks@PackSourceFactory@@UEAAXAEBV?$shared_ptr@VIDynamicPackagePacks@@@std@@@Z
    virtual void setDynamicPackagePacks(std::shared_ptr<class IDynamicPackagePacks> const &);

    // vIndex: 14, symbol: ?setDynamicPackageRoot@PackSourceFactory@@UEAAXV?$PathBuffer@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@Core@@@Z
