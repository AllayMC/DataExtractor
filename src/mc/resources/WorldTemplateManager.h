...
public:
    ...
    MCAPI WorldTemplateManager(class PackManifestFactory &, gsl::not_null<class Bedrock::NonOwnerPointer<class IContentKeyProvider const>> const &, class PackSourceFactory &, gsl::not_null<class Bedrock::NonOwnerPointer<class Core::FilePathManager>> const &, bool);
