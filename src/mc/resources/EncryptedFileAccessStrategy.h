...
public:
    ...
    MCAPI EncryptedFileAccessStrategy(class ResourceLocation const &, class ContentIdentity const &, Bedrock::NotNullNonOwnerPtr<class IContentKeyProvider const> const &, bool, std::optional<std::unordered_map<class Core::PathBuffer<std::string>,std::string>>);
