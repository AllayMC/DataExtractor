...
public:
    ...
    MCAPI EncryptedFileAccessStrategy(class ResourceLocation const &, class ContentIdentity const &, gsl::not_null<class Bedrock::NonOwnerPointer<class IContentKeyProvider const>> const &, bool, std::optional<std::unordered_map<class Core::PathBuffer<std::string>,std::string>>);
