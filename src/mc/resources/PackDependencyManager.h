...
namespace PackDependencyManager {
    ...
    MCAPI std::vector<struct PackIdVersion> getMissingDependencyIdentities(gsl::not_null<class PackSource const *>, class PackManifest const &);

    // symbol: ?hasMissingDependencies@PackDependencyManager@@YA_NV?$not_null@PEBVPackSource@@@gsl@@AEBVPackManifest@@@Z
    MCAPI bool hasMissingDependencies(gsl::not_null<class PackSource const *>, class PackManifest const &);
