...
public:
    ...
    MCAPI std::function<void (class Option &)> _getDisabledIfOptionExpectationsNotMetSetupCallback(std::vector<::FeatureOptionID>, std::vector<::FeatureOptionID>);
    ...
    MCAPI std::function<void (class Option &)> _getDisabledIfOtherOptionsEnabledSetupCallback(std::vector<::FeatureOptionID>);
    ...
    MCAPI std::function<void (bool &)> _getLockIfInGameOrOptionExpectationsNotMetLockCallback(std::vector<::FeatureOptionID>, std::vector<::FeatureOptionID>);
    ...
    MCAPI void _registerFeature(::FeatureOptionTabID, ::FeatureOptionID, std::string const &, std::string const &, bool, ::FeatureOptionID, std::function<void (class Option &)>, std::function<void (bool &)>);
