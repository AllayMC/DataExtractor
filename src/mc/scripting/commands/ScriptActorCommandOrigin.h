...
public:
    ...
    ScriptActorCommandOrigin& operator=(ScriptActorCommandOrigin const &) = delete;
    ScriptActorCommandOrigin(ScriptActorCommandOrigin const &) = delete;
    ScriptActorCommandOrigin() = delete;
