...
public:
    ...
    // vIndex: 1, symbol: ?onInfo@ScriptPrintLogger@@UEBAXUContextId@Scripting@@AEBV?$basic_string_view@DU?$char_traits@D@std@@@std@@@Z
    virtual void onInfo(struct Scripting::ContextId, std::string_view const &) const;

    // vIndex: 2, symbol: ?onWarn@ScriptPrintLogger@@UEBAXUContextId@Scripting@@AEBV?$basic_string_view@DU?$char_traits@D@std@@@std@@@Z
    virtual void onWarn(struct Scripting::ContextId, std::string_view const &) const;

    // vIndex: 3, symbol: ?onError@ScriptPrintLogger@@UEBAXUContextId@Scripting@@AEBV?$basic_string_view@DU?$char_traits@D@std@@@std@@@Z
