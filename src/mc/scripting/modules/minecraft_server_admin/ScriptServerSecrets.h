...
public:
    ...
    // symbol: ?getAllSecretNames@ScriptServerSecrets@ScriptModuleMinecraftServerAdmin@@QEBA?AV?$vector@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@V?$allocator@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@2@@std@@XZ
    MCAPI std::vector<std::string> getAllSecretNames() const;

    // symbol: ?bind@ScriptServerSecrets@ScriptModuleMinecraftServerAdmin@@SA?AV?$ClassBindingBuilder@VScriptServerSecrets@ScriptModuleMinecraftServerAdmin@@@Scripting@@XZ
    MCAPI static class Scripting::ClassBindingBuilder<class ScriptModuleMinecraftServerAdmin::ScriptServerSecrets> bind();
