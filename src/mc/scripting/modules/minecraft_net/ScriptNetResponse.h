...
public:
    ...
    MCAPI struct ScriptModuleMinecraftNet::ScriptNetResponse & operator=(struct ScriptModuleMinecraftNet::ScriptNetResponse &&);

    // symbol: ??1ScriptNetResponse@ScriptModuleMinecraftNet@@QEAA@XZ
    MCAPI ~ScriptNetResponse();

    // symbol: ?bind@ScriptNetResponse@ScriptModuleMinecraftNet@@SA?AV?$ClassBindingBuilder@UScriptNetResponse@ScriptModuleMinecraftNet@@@Scripting@@XZ
