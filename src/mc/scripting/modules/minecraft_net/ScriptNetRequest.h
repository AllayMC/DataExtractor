...
public:
    ...
    MCAPI class Scripting::StrongTypedObjectHandle<struct ScriptModuleMinecraftNet::ScriptNetRequest> addHeader(std::string const &, std::variant<std::string, class ScriptModuleMinecraftServerAdmin::ScriptSecretString> const &);

    // symbol: ??4ScriptNetRequest@ScriptModuleMinecraftNet@@QEAAAEAU01@$$QEAU01@@Z
    MCAPI struct ScriptModuleMinecraftNet::ScriptNetRequest & operator=(struct ScriptModuleMinecraftNet::ScriptNetRequest &&);

    // symbol: ?setBody@ScriptNetRequest@ScriptModuleMinecraftNet@@QEAA?AV?$StrongTypedObjectHandle@UScriptNetRequest@ScriptModuleMinecraftNet@@@Scripting@@AEBV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@Z
    MCAPI class Scripting::StrongTypedObjectHandle<struct ScriptModuleMinecraftNet::ScriptNetRequest> setBody(std::string const &);

    // symbol: ?setHeaders@ScriptNetRequest@ScriptModuleMinecraftNet@@QEAA?AV?$StrongTypedObjectHandle@UScriptNetRequest@ScriptModuleMinecraftNet@@@Scripting@@AEBV?$vector@UScriptNetHeader@ScriptModuleMinecraftNet@@V?$allocator@UScriptNetHeader@ScriptModuleMinecraftNet@@@std@@@std@@@Z
    MCAPI class Scripting::StrongTypedObjectHandle<struct ScriptModuleMinecraftNet::ScriptNetRequest> setHeaders(std::vector<struct ScriptModuleMinecraftNet::ScriptNetHeader> const &);

    // symbol: ?setMethod@ScriptNetRequest@ScriptModuleMinecraftNet@@QEAA?AV?$StrongTypedObjectHandle@UScriptNetRequest@ScriptModuleMinecraftNet@@@Scripting@@VMethod@Http@Bedrock@@@Z
    ...
    // symbol: ?bind@ScriptNetRequest@ScriptModuleMinecraftNet@@SA?AV?$ClassBindingBuilder@UScriptNetRequest@ScriptModuleMinecraftNet@@@Scripting@@XZ
