...
public:
    // NOLINTBEGIN
    // symbol: ?bind@ScriptNetRequestMethod@ScriptModuleMinecraftNet@@SA?AV?$EnumBindingBuilder@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@VMethod@Http@Bedrock@@@Scripting@@XZ
