...
public:
    ...
    MCAPI struct ScriptModuleMinecraftNet::ScriptNetHeader & operator=(struct ScriptModuleMinecraftNet::ScriptNetHeader const &);

    // symbol: ??4ScriptNetHeader@ScriptModuleMinecraftNet@@QEAAAEAU01@$$QEAU01@@Z
    MCAPI struct ScriptModuleMinecraftNet::ScriptNetHeader & operator=(struct ScriptModuleMinecraftNet::ScriptNetHeader &&);

    // symbol: ??1ScriptNetHeader@ScriptModuleMinecraftNet@@QEAA@XZ
    MCAPI ~ScriptNetHeader();

    // symbol: ?bind@ScriptNetHeader@ScriptModuleMinecraftNet@@SA?AV?$ClassBindingBuilder@UScriptNetHeader@ScriptModuleMinecraftNet@@@Scripting@@XZ
