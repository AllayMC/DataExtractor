...
public:
    ...
    ScriptActorHurtAfterEvent() = delete;
...
public:
    ...
    MCAPI struct ScriptModuleMinecraft::ScriptActorHurtAfterEvent & operator=(struct ScriptModuleMinecraft::ScriptActorHurtAfterEvent &&);

    // symbol: ??1ScriptActorHurtAfterEvent@ScriptModuleMinecraft@@QEAA@XZ
    MCAPI ~ScriptActorHurtAfterEvent();

    // symbol: ?bind@ScriptActorHurtAfterEvent@ScriptModuleMinecraft@@SA?AV?$ClassBindingBuilder@UScriptActorHurtAfterEvent@ScriptModuleMinecraft@@@Scripting@@XZ
    MCAPI static class Scripting::ClassBindingBuilder<struct ScriptModuleMinecraft::ScriptActorHurtAfterEvent> bind();

    // symbol: ?bindV010@ScriptActorHurtAfterEvent@ScriptModuleMinecraft@@SA?AV?$ClassBindingBuilder@UScriptActorHurtAfterEvent@ScriptModuleMinecraft@@@Scripting@@XZ
    MCAPI static class Scripting::ClassBindingBuilder<struct ScriptModuleMinecraft::ScriptActorHurtAfterEvent> bindV010();
