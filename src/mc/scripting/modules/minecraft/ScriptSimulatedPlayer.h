...
public:
    ...
    // vIndex: 2, symbol: ?clearVelocity@ScriptSimulatedPlayer@ScriptModuleGameTest@@UEAA?AV?$Result@X$$V@Scripting@@AEAVActor@@@Z
    virtual class Scripting::Result<void> clearVelocity(class Actor &);

    // vIndex: 7, symbol: ?applyImpulse@ScriptSimulatedPlayer@ScriptModuleGameTest@@UEAA?AV?$Result@X$$V@Scripting@@AEAVActor@@AEBVVec3@@@Z
    virtual class Scripting::Result<void> applyImpulse(class Actor &, class Vec3 const &);

    // vIndex: 8, symbol: ?remove@ScriptSimulatedPlayer@ScriptModuleGameTest@@UEAA?AV?$Result@X$$V@Scripting@@AEAVActor@@@Z
    ...
    // symbol: ?attackEntity@ScriptSimulatedPlayer@ScriptModuleGameTest@@QEBA?AV?$Result@_N$$V@Scripting@@AEBVScriptActor@ScriptModuleMinecraft@@@Z
    MCAPI class Scripting::Result<bool> attackEntity(class ScriptModuleMinecraft::ScriptActor const &) const;

    // symbol: ?breakBlock@ScriptSimulatedPlayer@ScriptModuleGameTest@@QEBA?AV?$Result@_N$$V@Scripting@@AEBVVec3@@W4ScriptFacing@ScriptModuleMinecraft@@@Z
    MCAPI class Scripting::Result<bool> breakBlock(class Vec3 const &, ::ScriptModuleMinecraft::ScriptFacing) const;

    // symbol: ?chat@ScriptSimulatedPlayer@ScriptModuleGameTest@@QEBA?AV?$Result@X$$V@Scripting@@AEBV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@Z
    ...
    // symbol: ?giveItem@ScriptSimulatedPlayer@ScriptModuleGameTest@@QEBA?AV?$Result@_N$$V@Scripting@@AEBVScriptItemStack@ScriptModuleMinecraft@@_N@Z
    ...
    // symbol: ?interactWithBlock@ScriptSimulatedPlayer@ScriptModuleGameTest@@QEBA?AV?$Result@_N$$V@Scripting@@AEBVVec3@@W4ScriptFacing@ScriptModuleMinecraft@@@Z
    MCAPI class Scripting::Result<bool> interactWithBlock(class Vec3 const &, ::ScriptModuleMinecraft::ScriptFacing) const;

    // symbol: ?interactWithEntity@ScriptSimulatedPlayer@ScriptModuleGameTest@@QEBA?AV?$Result@_N$$V@Scripting@@AEBVScriptActor@ScriptModuleMinecraft@@@Z
    ...
    // symbol: ?lookAtEntity@ScriptSimulatedPlayer@ScriptModuleGameTest@@QEBA?AV?$Result@X$$V@Scripting@@AEBVScriptActor@ScriptModuleMinecraft@@@Z
    ...
    // symbol: ?navigateToBlock@ScriptSimulatedPlayer@ScriptModuleGameTest@@QEBA?AV?$Result@UScriptNavigationResult@ScriptModuleMinecraft@@$$V@Scripting@@AEBVVec3@@M@Z
    MCAPI class Scripting::Result<struct ScriptModuleMinecraft::ScriptNavigationResult> navigateToBlock(class Vec3 const &, float) const;

    // symbol: ?navigateToEntity@ScriptSimulatedPlayer@ScriptModuleGameTest@@QEBA?AV?$Result@UScriptNavigationResult@ScriptModuleMinecraft@@$$V@Scripting@@AEBVScriptActor@ScriptModuleMinecraft@@M@Z
    MCAPI class Scripting::Result<struct ScriptModuleMinecraft::ScriptNavigationResult> navigateToEntity(class ScriptModuleMinecraft::ScriptActor const &, float) const;

    // symbol: ?navigateToLocation@ScriptSimulatedPlayer@ScriptModuleGameTest@@QEBA?AV?$Result@UScriptNavigationResult@ScriptModuleMinecraft@@$$V@Scripting@@AEBVVec3@@M@Z
    MCAPI class Scripting::Result<struct ScriptModuleMinecraft::ScriptNavigationResult> navigateToLocation(class Vec3 const &, float) const;

    // symbol: ?navigateToLocations@ScriptSimulatedPlayer@ScriptModuleGameTest@@QEBA?AV?$Result@X$$V@Scripting@@AEBV?$vector@VVec3@@V?$allocator@VVec3@@@std@@@std@@M@Z
    ...
    // symbol: ?useItem@ScriptSimulatedPlayer@ScriptModuleGameTest@@QEBA?AV?$Result@_N$$V@Scripting@@AEBVScriptItemStack@ScriptModuleMinecraft@@@Z
    ...
    // symbol: ?bind@ScriptSimulatedPlayer@ScriptModuleGameTest@@SA?AV?$ClassBindingBuilder@VScriptSimulatedPlayer@ScriptModuleGameTest@@@Scripting@@XZ
    ...
    // private:
    // NOLINTBEGIN
    // symbol: ?_getHelper@ScriptSimulatedPlayer@ScriptModuleGameTest@@CAPEBVBaseGameTestHelper@gametest@@AEBVSimulatedPlayer@@@Z
