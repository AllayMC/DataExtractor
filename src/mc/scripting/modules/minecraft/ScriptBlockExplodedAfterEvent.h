...
public:
    ...
    MCAPI struct ScriptModuleMinecraft::ScriptBlockExplodedAfterEvent & operator=(struct ScriptModuleMinecraft::ScriptBlockExplodedAfterEvent &&);

    // symbol: ??1ScriptBlockExplodedAfterEvent@ScriptModuleMinecraft@@QEAA@XZ
    MCAPI ~ScriptBlockExplodedAfterEvent();

    // symbol: ?bind@ScriptBlockExplodedAfterEvent@ScriptModuleMinecraft@@SA?AV?$ClassBindingBuilder@UScriptBlockExplodedAfterEvent@ScriptModuleMinecraft@@@Scripting@@XZ
    MCAPI static class Scripting::ClassBindingBuilder<struct ScriptModuleMinecraft::ScriptBlockExplodedAfterEvent> bind();
