...
public:
    ...
    // vIndex: 3, symbol: ?setCurrent@ScriptHealthComponent@ScriptModuleMinecraft@@UEBA?AV?$Result@_N$$V@Scripting@@AEBM@Z
    virtual class Scripting::Result<bool> setCurrent(float const &) const;

    // vIndex: 7, symbol: ?resetToMinValue@ScriptHealthComponent@ScriptModuleMinecraft@@UEBA?AV?$Result@X$$V@Scripting@@XZ
    virtual class Scripting::Result<void> resetToMinValue() const;

    // vIndex: 8, symbol: ?resetToMaxValue@ScriptHealthComponent@ScriptModuleMinecraft@@UEBA?AV?$Result@X$$V@Scripting@@XZ
    virtual class Scripting::Result<void> resetToMaxValue() const;

    // vIndex: 9, symbol: ?resetToDefaultValue@ScriptHealthComponent@ScriptModuleMinecraft@@UEBA?AV?$Result@X$$V@Scripting@@XZ
    ...
    // symbol: ?bind@ScriptHealthComponent@ScriptModuleMinecraft@@SA?AV?$ClassBindingBuilder@VScriptHealthComponent@ScriptModuleMinecraft@@@Scripting@@XZ
