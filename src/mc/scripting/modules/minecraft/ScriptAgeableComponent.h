...
public:
    ...
    // symbol: ??0ScriptAgeableComponent@ScriptModuleMinecraft@@QEAA@AEBVWeakEntityRef@@AEBVWeakLifetimeScope@Scripting@@AEBV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@Z
    MCAPI ScriptAgeableComponent(class WeakEntityRef const &, class Scripting::WeakLifetimeScope const &, std::string const &);

    // symbol: ?getDropItems@ScriptAgeableComponent@ScriptModuleMinecraft@@QEBA?AV?$Result@V?$vector@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@V?$allocator@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@2@@std@@$$V@Scripting@@XZ
    ...
    // symbol: ?getFeedItems@ScriptAgeableComponent@ScriptModuleMinecraft@@QEBA?AV?$Result@V?$vector@UActorDefinitionFeedItem@@V?$allocator@UActorDefinitionFeedItem@@@std@@@std@@$$V@Scripting@@XZ
    MCAPI class Scripting::Result<std::vector<struct ActorDefinitionFeedItem>> getFeedItems() const;

    // symbol: ?getGrowUp@ScriptAgeableComponent@ScriptModuleMinecraft@@QEBA?AV?$Result@VActorDefinitionTrigger@@$$V@Scripting@@XZ
    MCAPI class Scripting::Result<class ActorDefinitionTrigger> getGrowUp() const;

    // symbol: ?bind@ScriptAgeableComponent@ScriptModuleMinecraft@@SA?AV?$ClassBindingBuilder@VScriptAgeableComponent@ScriptModuleMinecraft@@@Scripting@@XZ
