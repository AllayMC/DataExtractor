...
public:
    ...
    MCAPI class ScriptModuleMinecraft::ScriptBlockLocationIterator & operator=(class ScriptModuleMinecraft::ScriptBlockLocationIterator &&);

    // symbol: ?bind@ScriptBlockLocationIterator@ScriptModuleMinecraft@@SA?AV?$ClassBindingBuilder@VScriptBlockLocationIterator@ScriptModuleMinecraft@@@Scripting@@XZ
