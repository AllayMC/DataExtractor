...
public:
    ...
    // symbol: ?getLore@ScriptContainerSlot@ScriptModuleMinecraft@@QEBA?AV?$Result@V?$vector@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@V?$allocator@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@2@@std@@$$V@Scripting@@XZ
    ...
    // symbol: ?getTags@ScriptContainerSlot@ScriptModuleMinecraft@@QEBA?AV?$Result@V?$vector@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@V?$allocator@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@2@@std@@$$V@Scripting@@XZ
    MCAPI class Scripting::Result<std::vector<std::string>> getTags() const;

    // symbol: ?getType@ScriptContainerSlot@ScriptModuleMinecraft@@QEBA?AV?$Result@V?$StrongTypedObjectHandle@VScriptItemType@ScriptModuleMinecraft@@@Scripting@@$$V@Scripting@@XZ
    MCAPI class Scripting::Result<class Scripting::StrongTypedObjectHandle<class ScriptModuleMinecraft::ScriptItemType>> getType() const;

    // symbol: ?getTypeId@ScriptContainerSlot@ScriptModuleMinecraft@@QEBA?AV?$Result@V?$optional@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@std@@$$V@Scripting@@XZ
    MCAPI class Scripting::Result<std::optional<std::string>> getTypeId() const;

    // symbol: ?hasTag@ScriptContainerSlot@ScriptModuleMinecraft@@QEBA?AV?$Result@_N$$V@Scripting@@AEBV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@Z
    ...
    // symbol: ?isStackableWith@ScriptContainerSlot@ScriptModuleMinecraft@@QEBA?AV?$Result@_N$$V@Scripting@@AEBVScriptItemStack@2@@Z
    ...
    // symbol: ?setCanPlaceOn@ScriptContainerSlot@ScriptModuleMinecraft@@QEAA?AV?$Result@X$$V@Scripting@@AEBV?$optional@V?$vector@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@V?$allocator@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@2@@std@@@std@@@Z
    MCAPI class Scripting::Result<void> setCanPlaceOn(std::optional<std::vector<std::string>> const &);

    // symbol: ?setItem@ScriptContainerSlot@ScriptModuleMinecraft@@QEAA?AV?$Result@X$$V@Scripting@@AEBV?$optional@VScriptItemStack@ScriptModuleMinecraft@@@std@@@Z
    ...
    // symbol: ?setLockMode@ScriptContainerSlot@ScriptModuleMinecraft@@QEAA?AV?$Result@X$$V@Scripting@@W4ItemLockMode@@@Z
    MCAPI class Scripting::Result<void> setLockMode(::ItemLockMode);

    // symbol: ?setLore@ScriptContainerSlot@ScriptModuleMinecraft@@QEAA?AV?$Result@X$$V@Scripting@@AEBV?$optional@V?$vector@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@V?$allocator@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@2@@std@@@std@@@Z
