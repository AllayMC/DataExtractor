...
public:
    // NOLINTBEGIN
    // symbol: ?bind@ScriptDyeColor@ScriptModuleMinecraft@@SA?AV?$EnumBindingBuilder@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@W4ItemColor@@@Scripting@@XZ
