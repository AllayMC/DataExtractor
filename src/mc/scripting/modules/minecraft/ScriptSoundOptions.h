...
public:
    ...
    MCAPI struct ScriptModuleMinecraft::ScriptSoundOptions & operator=(struct ScriptModuleMinecraft::ScriptSoundOptions &&);

    // symbol: ??4ScriptSoundOptions@ScriptModuleMinecraft@@QEAAAEAU01@AEBU01@@Z
    MCAPI struct ScriptModuleMinecraft::ScriptSoundOptions & operator=(struct ScriptModuleMinecraft::ScriptSoundOptions const &);

    // symbol: ?bindV010@ScriptSoundOptions@ScriptModuleMinecraft@@SA?AV?$ClassBindingBuilder@UScriptSoundOptions@ScriptModuleMinecraft@@@Scripting@@XZ
