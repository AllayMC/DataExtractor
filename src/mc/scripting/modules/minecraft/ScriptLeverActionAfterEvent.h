...
public:
    ...
    // symbol: ?bind@ScriptLeverActionAfterEvent@ScriptModuleMinecraft@@SA?AV?$ClassBindingBuilder@UScriptLeverActionAfterEvent@ScriptModuleMinecraft@@@Scripting@@XZ
