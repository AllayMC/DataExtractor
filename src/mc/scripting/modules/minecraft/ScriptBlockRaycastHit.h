...
public:
    ...
    MCAPI class ScriptModuleMinecraft::ScriptBlockRaycastHit & operator=(class ScriptModuleMinecraft::ScriptBlockRaycastHit const &);

    // symbol: ??4ScriptBlockRaycastHit@ScriptModuleMinecraft@@QEAAAEAV01@$$QEAV01@@Z
    MCAPI class ScriptModuleMinecraft::ScriptBlockRaycastHit & operator=(class ScriptModuleMinecraft::ScriptBlockRaycastHit &&);

    // symbol: ??1ScriptBlockRaycastHit@ScriptModuleMinecraft@@QEAA@XZ
    MCAPI ~ScriptBlockRaycastHit();

    // symbol: ?bind@ScriptBlockRaycastHit@ScriptModuleMinecraft@@SA?AV?$InterfaceBindingBuilder@VScriptBlockRaycastHit@ScriptModuleMinecraft@@@Scripting@@XZ
