...
public:
    ...
    // vIndex: 1, symbol: ?createComponent@ScriptMovementGenericComponentFactory@ScriptModuleMinecraft@@UEAA?AV?$StrongTypedObjectHandle@VScriptActorComponent@ScriptModuleMinecraft@@@Scripting@@VWeakEntityRef@@AEBVWeakLifetimeScope@4@AEBV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@Z
    ...
    // vIndex: 2, symbol: ?hasComponent@ScriptMovementGenericComponentFactory@ScriptModuleMinecraft@@UEBA_NVWeakEntityRef@@@Z
