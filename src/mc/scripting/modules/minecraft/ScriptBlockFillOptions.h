...
public:
    ...
    MCAPI struct ScriptModuleMinecraft::ScriptBlockFillOptions & operator=(struct ScriptModuleMinecraft::ScriptBlockFillOptions &&);

    // symbol: ??4ScriptBlockFillOptions@ScriptModuleMinecraft@@QEAAAEAU01@AEBU01@@Z
    MCAPI struct ScriptModuleMinecraft::ScriptBlockFillOptions & operator=(struct ScriptModuleMinecraft::ScriptBlockFillOptions const &);

    // symbol: ??1ScriptBlockFillOptions@ScriptModuleMinecraft@@QEAA@XZ
    MCAPI ~ScriptBlockFillOptions();

    // symbol: ?bind@ScriptBlockFillOptions@ScriptModuleMinecraft@@SA?AV?$InterfaceBindingBuilder@UScriptBlockFillOptions@ScriptModuleMinecraft@@@Scripting@@XZ
