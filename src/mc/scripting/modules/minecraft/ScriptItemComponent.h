...
public:
    ...
    // symbol: ??0ScriptItemComponent@ScriptModuleMinecraft@@QEAA@V?$WeakTypedObjectHandle@VScriptItemStack@ScriptModuleMinecraft@@@Scripting@@AEBVWeakLifetimeScope@3@AEBV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@Z
    MCAPI ScriptItemComponent(class Scripting::WeakTypedObjectHandle<class ScriptModuleMinecraft::ScriptItemStack>, class Scripting::WeakLifetimeScope const &, std::string const &);
    ...
    MCAPI class ScriptModuleMinecraft::ScriptItemComponent & operator=(class ScriptModuleMinecraft::ScriptItemComponent const &);

    // symbol: ?bind@ScriptItemComponent@ScriptModuleMinecraft@@SA?AV?$ClassBindingBuilder@VScriptItemComponent@ScriptModuleMinecraft@@@Scripting@@XZ
