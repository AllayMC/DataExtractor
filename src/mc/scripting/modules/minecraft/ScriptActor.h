...
public:
    ...
    // vIndex: 2, symbol: ?clearVelocity@ScriptActor@ScriptModuleMinecraft@@UEAA?AV?$Result@X$$V@Scripting@@AEAVActor@@@Z
    virtual class Scripting::Result<void> clearVelocity(class Actor &);

    // vIndex: 3, symbol: ?getNameTag@ScriptActor@ScriptModuleMinecraft@@UEBA?AV?$Result@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@$$V@Scripting@@AEBVActor@@@Z
    virtual class Scripting::Result<std::string> getNameTag(class Actor const &) const;

    // vIndex: 4, symbol: ?setNameTag@ScriptActor@ScriptModuleMinecraft@@UEAA?AV?$Result@X$$V@Scripting@@AEAVActor@@AEBV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@Z
    ...
    // vIndex: 6, symbol: ?setSneaking@ScriptActor@ScriptModuleMinecraft@@UEAA?AV?$Result@X$$V@Scripting@@AEAVActor@@_N@Z
    virtual class Scripting::Result<void> setSneaking(class Actor &, bool);

    // vIndex: 7, symbol: ?applyImpulse@ScriptActor@ScriptModuleMinecraft@@UEAA?AV?$Result@X$$V@Scripting@@AEAVActor@@AEBVVec3@@@Z
    ...
    // symbol: ?addTag_010@ScriptActor@ScriptModuleMinecraft@@QEAA?AV?$Result@_N$$V@Scripting@@AEAVActor@@AEBV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@Z
    MCAPI class Scripting::Result<bool> addTag_010(class Actor &, std::string const &);

    // symbol: ?applyDamage@ScriptActor@ScriptModuleMinecraft@@QEAA?AV?$Result@_N$$V@Scripting@@AEAVActor@@MAEBV?$optional@V?$variant@UScriptActorApplyDamageOptions@ScriptModuleMinecraft@@UScriptActorApplyDamageByProjectileOptions@2@@std@@@std@@@Z
    MCAPI class Scripting::Result<bool> applyDamage(class Actor &, float, std::optional<std::variant<struct ScriptModuleMinecraft::ScriptActorApplyDamageOptions, struct ScriptModuleMinecraft::ScriptActorApplyDamageByProjectileOptions>> const &);
    ...
    // symbol: ?getBlockFromViewDirection@ScriptActor@ScriptModuleMinecraft@@QEBA?AV?$Result@V?$optional@VScriptBlockRaycastHit@ScriptModuleMinecraft@@@std@@$$V@Scripting@@AEBVActor@@VWeakLifetimeScope@4@AEBV?$optional@UScriptBlockRaycastOptions@ScriptModuleMinecraft@@@std@@@Z
    MCAPI class Scripting::Result<std::optional<class ScriptModuleMinecraft::ScriptBlockRaycastHit>> getBlockFromViewDirection(class Actor const &, class Scripting::WeakLifetimeScope, std::optional<struct ScriptModuleMinecraft::ScriptBlockRaycastOptions> const &) const;

    // symbol: ?getBlockFromViewVector_010@ScriptActor@ScriptModuleMinecraft@@QEBA?AV?$Result@V?$optional@V?$StrongTypedObjectHandle@VScriptBlock@ScriptModuleMinecraft@@@Scripting@@@std@@$$V@Scripting@@AEBVActor@@VWeakLifetimeScope@4@AEBV?$optional@UScriptBlockRaycastOptions@ScriptModuleMinecraft@@@std@@@Z
    MCAPI class Scripting::Result<std::optional<class Scripting::StrongTypedObjectHandle<class ScriptModuleMinecraft::ScriptBlock>>> getBlockFromViewVector_010(class Actor const &, class Scripting::WeakLifetimeScope, std::optional<struct ScriptModuleMinecraft::ScriptBlockRaycastOptions> const &) const;
    ...
    MCAPI std::optional<class Scripting::StrongTypedObjectHandle<class ScriptModuleMinecraft::ScriptActorComponent>> getComponent(class Scripting::WeakLifetimeScope, std::unordered_map<std::string,std::unique_ptr<class ScriptModuleMinecraft::IComponentFactory>> const &, std::string const &);
    ...
    // symbol: ?getEffect_V010@ScriptActor@ScriptModuleMinecraft@@QEBA?AV?$Result@V?$optional@V?$StrongTypedObjectHandle@VScriptMobEffectInstance@ScriptModuleMinecraft@@@Scripting@@@std@@$$V@Scripting@@AEBVActor@@AEBVScriptEffectType@2@@Z
    MCAPI class Scripting::Result<std::optional<class Scripting::StrongTypedObjectHandle<class ScriptModuleMinecraft::ScriptMobEffectInstance>>> getEffect_V010(class Actor const &, class ScriptModuleMinecraft::ScriptEffectType const &) const;

    // symbol: ?getEffects@ScriptActor@ScriptModuleMinecraft@@QEBA?AV?$Result@V?$vector@V?$StrongTypedObjectHandle@VScriptMobEffectInstance@ScriptModuleMinecraft@@@Scripting@@V?$allocator@V?$StrongTypedObjectHandle@VScriptMobEffectInstance@ScriptModuleMinecraft@@@Scripting@@@std@@@std@@$$V@Scripting@@AEBVActor@@@Z
    MCAPI class Scripting::Result<std::vector<class Scripting::StrongTypedObjectHandle<class ScriptModuleMinecraft::ScriptMobEffectInstance>>> getEffects(class Actor const &) const;
    ...
    MCAPI class Scripting::Result<std::vector<class ScriptModuleMinecraft::ScriptEntityRaycastHit>> getEntitiesFromViewDirection(class Actor const &, class Scripting::WeakLifetimeScope, std::optional<struct ScriptModuleMinecraft::ScriptEntityRaycastOptions> const &) const;
    ...
    MCAPI class Scripting::Result<std::vector<class Scripting::StrongTypedObjectHandle<class ScriptModuleMinecraft::ScriptActor>>> getEntitiesFromViewVector_010(class Actor const &, class Scripting::WeakLifetimeScope, std::optional<struct ScriptModuleMinecraft::ScriptEntityRaycastOptions> const &) const;
    ...
    // symbol: ?getHeadLocation_010@ScriptActor@ScriptModuleMinecraft@@QEBA?AV?$Result@VVec3@@$$V@Scripting@@AEBVActor@@@Z
    MCAPI class Scripting::Result<class Vec3> getHeadLocation_010(class Actor const &) const;

    // symbol: ?getId@ScriptActor@ScriptModuleMinecraft@@QEBA?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@XZ
    MCAPI std::string getId() const;

    // symbol: ?getId_010@ScriptActor@ScriptModuleMinecraft@@QEBA?AV?$Result@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@$$V@Scripting@@AEBVActor@@@Z
    ...
    // symbol: ?getProperty@ScriptActor@ScriptModuleMinecraft@@QEBA?AV?$Result@V?$optional@V?$variant@M_NV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@std@@@std@@$$V@Scripting@@AEBVActor@@AEBV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@Z
    MCAPI class Scripting::Result<std::optional<std::variant<float, bool, std::string>>> getProperty(class Actor const &, std::string const &) const;
    ...
    // symbol: ?getRotation_V010@ScriptActor@ScriptModuleMinecraft@@QEBA?AV?$Result@UScriptXYRotation@ScriptModuleMinecraft@@$$V@Scripting@@AEBVActor@@@Z
    MCAPI class Scripting::Result<struct ScriptModuleMinecraft::ScriptXYRotation> getRotation_V010(class Actor const &) const;

    // symbol: ?getScoreboardIdentity@ScriptActor@ScriptModuleMinecraft@@QEAA?AV?$optional@V?$StrongTypedObjectHandle@VScriptScoreboardIdentity@ScriptModuleMinecraft@@@Scripting@@@std@@XZ
    MCAPI std::optional<class Scripting::StrongTypedObjectHandle<class ScriptModuleMinecraft::ScriptScoreboardIdentity>> getScoreboardIdentity();

    // symbol: ?getTags@ScriptActor@ScriptModuleMinecraft@@QEBA?AV?$Result@V?$vector@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@V?$allocator@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@2@@std@@$$V@Scripting@@AEBVActor@@@Z
    MCAPI class Scripting::Result<std::vector<std::string>> getTags(class Actor const &) const;

    // symbol: ?getTarget@ScriptActor@ScriptModuleMinecraft@@QEBA?AV?$Result@V?$StrongTypedObjectHandle@VScriptActor@ScriptModuleMinecraft@@@Scripting@@$$V@Scripting@@AEBVActor@@@Z
    MCAPI class Scripting::Result<class Scripting::StrongTypedObjectHandle<class ScriptModuleMinecraft::ScriptActor>> getTarget(class Actor const &) const;

    // symbol: ?getTypeId@ScriptActor@ScriptModuleMinecraft@@QEBA?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@XZ
    ...
    // symbol: ?getVelocity_010@ScriptActor@ScriptModuleMinecraft@@QEBA?AV?$Result@VScriptVector@ScriptModuleMinecraft@@$$V@Scripting@@AEBVActor@@@Z
    ...
    // symbol: ?getViewVector_010@ScriptActor@ScriptModuleMinecraft@@QEBA?AV?$Result@VScriptVector@ScriptModuleMinecraft@@$$V@Scripting@@AEBVActor@@@Z
    MCAPI class Scripting::Result<class ScriptModuleMinecraft::ScriptVector> getViewVector_010(class Actor const &) const;
    ...
    // symbol: ?hasTag@ScriptActor@ScriptModuleMinecraft@@QEBA?AV?$Result@_N$$V@Scripting@@AEBVActor@@AEBV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@Z
    ...
    MCAPI class Scripting::Result<class Scripting::Promise<class Scripting::StrongTypedObjectHandle<struct ScriptModuleMinecraft::ScriptCommandResult>, struct ScriptModuleMinecraft::ScriptCommandError, void>> runCommandAsync(class Actor &, struct Scripting::ContextConfig const &, class Scripting::ScriptObjectFactory &, std::string const &);
    ...
    // symbol: ?setVelocity_010@ScriptActor@ScriptModuleMinecraft@@QEAA?AV?$Result@X$$V@Scripting@@AEAVActor@@AEBVScriptVector@2@@Z
    MCAPI class Scripting::Result<void> setVelocity_010(class Actor &, class ScriptModuleMinecraft::ScriptVector const &);

    // symbol: ?teleport@ScriptActor@ScriptModuleMinecraft@@QEAA?AV?$Result@X$$V@Scripting@@AEAVActor@@AEBVVec3@@AEBV?$optional@UScriptTeleportOptions@ScriptModuleMinecraft@@@std@@@Z
    MCAPI class Scripting::Result<void> teleport(class Actor &, class Vec3 const &, std::optional<struct ScriptModuleMinecraft::ScriptTeleportOptions> const &);

    // symbol: ?teleportFacing_V010@ScriptActor@ScriptModuleMinecraft@@QEAA?AV?$Result@X$$V@Scripting@@AEAVActor@@AEBVVec3@@AEAVScriptDimension@2@1_N@Z
    MCAPI class Scripting::Result<void> teleportFacing_V010(class Actor &, class Vec3 const &, class ScriptModuleMinecraft::ScriptDimension &, class Vec3 const &, bool);

    // symbol: ?teleport_V010@ScriptActor@ScriptModuleMinecraft@@QEAA?AV?$Result@X$$V@Scripting@@AEAVActor@@AEBVVec3@@AEAVScriptDimension@2@MM_N@Z
    MCAPI class Scripting::Result<void> teleport_V010(class Actor &, class Vec3 const &, class ScriptModuleMinecraft::ScriptDimension &, float, float, bool);

    // symbol: ?triggerEvent@ScriptActor@ScriptModuleMinecraft@@QEAA?AV?$Result@X$$V@Scripting@@AEAVActor@@AEBV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@Z
    MCAPI class Scripting::Result<void> triggerEvent(class Actor &, std::string const &);

    // symbol: ?triggerEvent_V010@ScriptActor@ScriptModuleMinecraft@@QEAA?AV?$Result@X$$V@Scripting@@AEAVActor@@AEBV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@Z
    ...
    // symbol: ?tryTeleport@ScriptActor@ScriptModuleMinecraft@@QEAA?AV?$Result@_N$$V@Scripting@@AEAVActor@@AEBVVec3@@AEBV?$optional@UScriptTeleportOptions@ScriptModuleMinecraft@@@std@@@Z
    MCAPI class Scripting::Result<bool> tryTeleport(class Actor &, class Vec3 const &, std::optional<struct ScriptModuleMinecraft::ScriptTeleportOptions> const &);
    ...
    MCAPI static class Scripting::ClassBindingBuilder<class ScriptModuleMinecraft::ScriptActor> bind(std::unordered_map<std::string,std::unique_ptr<class ScriptModuleMinecraft::IComponentFactory>> &);

    // symbol: ?getHandle@ScriptActor@ScriptModuleMinecraft@@SA?AV?$StrongTypedObjectHandle@VScriptActor@ScriptModuleMinecraft@@@Scripting@@PEBVActor@@AEBVWeakLifetimeScope@4@@Z
    MCAPI static class Scripting::StrongTypedObjectHandle<class ScriptModuleMinecraft::ScriptActor> getHandle(class Actor const *, class Scripting::WeakLifetimeScope const &);

    // symbol: ?getHandle@ScriptActor@ScriptModuleMinecraft@@SA?AV?$StrongTypedObjectHandle@VScriptActor@ScriptModuleMinecraft@@@Scripting@@VWeakEntityRef@@AEBVWeakLifetimeScope@4@@Z
    MCAPI static class Scripting::StrongTypedObjectHandle<class ScriptModuleMinecraft::ScriptActor> getHandle(class WeakEntityRef, class Scripting::WeakLifetimeScope const &);

    // symbol: ?getHandle@ScriptActor@ScriptModuleMinecraft@@SA?AV?$StrongTypedObjectHandle@VScriptActor@ScriptModuleMinecraft@@@Scripting@@V?$StackRefResultT@UEntityRefTraits@@@@AEBVWeakLifetimeScope@4@@Z
    MCAPI static class Scripting::StrongTypedObjectHandle<class ScriptModuleMinecraft::ScriptActor> getHandle(class StackRefResultT<struct EntityRefTraits>, class Scripting::WeakLifetimeScope const &);

    // symbol: ?tryGetActor@ScriptActor@ScriptModuleMinecraft@@SAPEAVActor@@AEBU?$TypedObjectHandle@VScriptActor@ScriptModuleMinecraft@@@Scripting@@AEBVWeakLifetimeScope@5@@Z
    MCAPI static class Actor * tryGetActor(struct Scripting::TypedObjectHandle<class ScriptModuleMinecraft::ScriptActor> const &, class Scripting::WeakLifetimeScope const &);

    // NOLINTEND

    // protected:
    // NOLINTBEGIN
    // symbol: ?_applyDamage@ScriptActor@ScriptModuleMinecraft@@IEAA?AV?$Result@_N$$V@Scripting@@AEAVActor@@MAEBUScriptActorApplyDamageOptions@2@@Z
    MCAPI class Scripting::Result<bool> _applyDamage(class Actor &, float, struct ScriptModuleMinecraft::ScriptActorApplyDamageOptions const &);

    // symbol: ?_applyProjectileDamage@ScriptActor@ScriptModuleMinecraft@@IEAA?AV?$Result@_N$$V@Scripting@@AEAVActor@@MAEBUScriptActorApplyDamageByProjectileOptions@2@@Z
    MCAPI class Scripting::Result<bool> _applyProjectileDamage(class Actor &, float, struct ScriptModuleMinecraft::ScriptActorApplyDamageByProjectileOptions const &);

    // symbol: ?_getDynamicPropertyDefinition@ScriptActor@ScriptModuleMinecraft@@IEBAPEBUDynamicPropertyDefinition@@AEAVActor@@AEBV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@Z
    MCAPI struct DynamicPropertyDefinition const * _getDynamicPropertyDefinition(class Actor &, std::string const &) const;

    // symbol: ?_getEffectHelper@ScriptActor@ScriptModuleMinecraft@@IEBAPEBVMobEffect@@AEBV?$variant@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@V?$StrongTypedObjectHandle@VScriptEffectType@ScriptModuleMinecraft@@@Scripting@@@std@@@Z
    MCAPI class MobEffect const * _getEffectHelper(std::variant<std::string, class Scripting::StrongTypedObjectHandle<class ScriptModuleMinecraft::ScriptEffectType>> const &) const;
