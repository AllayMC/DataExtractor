...
public:
    ...
    MCAPI class ScriptModuleMinecraft::BaseScriptBlockComponent & operator=(class ScriptModuleMinecraft::BaseScriptBlockComponent const &);

    // symbol: ?bind@BaseScriptBlockComponent@ScriptModuleMinecraft@@SA?AV?$ClassBindingBuilder@VBaseScriptBlockComponent@ScriptModuleMinecraft@@@Scripting@@XZ
