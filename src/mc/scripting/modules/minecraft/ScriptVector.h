...
public:
    ...
    // symbol: ?bind@ScriptVector@ScriptModuleMinecraft@@SA?AV?$ClassBindingBuilder@VScriptVector@ScriptModuleMinecraft@@@Scripting@@XZ
    ...
    // symbol: ?divide@ScriptVector@ScriptModuleMinecraft@@SA?AV?$Result@VScriptVector@ScriptModuleMinecraft@@$$V@Scripting@@AEBVVec3@@AEBV?$variant@MVVec3@@@std@@@Z
    MCAPI static class Scripting::Result<class ScriptModuleMinecraft::ScriptVector> divide(class Vec3 const &, std::variant<float, class Vec3> const &);
    ...
    MCAPI static class ScriptModuleMinecraft::ScriptVector multiply(class Vec3 const &, std::variant<float, class Vec3> const &);
