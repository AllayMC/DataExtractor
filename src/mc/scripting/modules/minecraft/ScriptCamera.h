...
public:
    ...
    ScriptCamera& operator=(ScriptCamera const &) = delete;
    ScriptCamera(ScriptCamera const &) = delete;
    ScriptCamera() = delete;

public:
    // NOLINTBEGIN
    // symbol: ??0ScriptCamera@ScriptModuleMinecraft@@QEAA@AEBVPlayer@@@Z
    MCAPI ScriptCamera(class Player const &);

    // symbol: ?cameraFade@ScriptCamera@ScriptModuleMinecraft@@QEBA?AV?$Result@X$$V@Scripting@@V?$optional@UScriptCameraFadeOptions@ScriptModuleMinecraft@@@std@@@Z
    MCAPI class Scripting::Result<void> cameraFade(std::optional<struct ScriptModuleMinecraft::ScriptCameraFadeOptions>) const;
    ...
    MCAPI class Scripting::Result<void> setCamera(std::string const &, std::optional<std::optional<std::variant<struct ScriptModuleMinecraft::ScriptCameraSetFacingOptions, struct ScriptModuleMinecraft::ScriptCameraSetPositionOptions, struct ScriptModuleMinecraft::ScriptCameraSetRotationOptions, struct ScriptModuleMinecraft::ScriptCameraSetLocationOptions, struct ScriptModuleMinecraft::ScriptCameraDefaultOptions>>>) const;

    // symbol: ?bind@ScriptCamera@ScriptModuleMinecraft@@SA?AV?$ClassBindingBuilder@UScriptCamera@ScriptModuleMinecraft@@@Scripting@@XZ
