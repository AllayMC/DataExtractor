...
public:
    ...
    ScriptRidingComponentFactory& operator=(ScriptRidingComponentFactory const &) = delete;
    ScriptRidingComponentFactory(ScriptRidingComponentFactory const &) = delete;
    ScriptRidingComponentFactory() = delete;
...
public:
    ...
    // vIndex: 1, symbol: ?createComponent@ScriptRidingComponentFactory@ScriptModuleMinecraft@@UEAA?AV?$StrongTypedObjectHandle@VScriptActorComponent@ScriptModuleMinecraft@@@Scripting@@VWeakEntityRef@@AEBVWeakLifetimeScope@4@AEBV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@Z
