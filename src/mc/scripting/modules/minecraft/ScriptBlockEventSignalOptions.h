...
public:
    ...
    ScriptBlockEventSignalOptions& operator=(ScriptBlockEventSignalOptions const &) = delete;
    ScriptBlockEventSignalOptions() = delete;
...
public:
    ...
    MCAPI struct ScriptModuleMinecraft::ScriptBlockEventSignalOptions & operator=(struct ScriptModuleMinecraft::ScriptBlockEventSignalOptions &&);
