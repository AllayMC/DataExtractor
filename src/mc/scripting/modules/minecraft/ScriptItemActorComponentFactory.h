...
public:
    ...
    ScriptItemActorComponentFactory& operator=(ScriptItemActorComponentFactory const &) = delete;
    ScriptItemActorComponentFactory(ScriptItemActorComponentFactory const &) = delete;
...
public:
    ...
    // vIndex: 1, symbol: ?createComponent@ScriptItemActorComponentFactory@ScriptModuleMinecraft@@UEAA?AV?$StrongTypedObjectHandle@VScriptActorComponent@ScriptModuleMinecraft@@@Scripting@@VWeakEntityRef@@AEBVWeakLifetimeScope@4@AEBV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@Z
