...
public:
    ...
    // symbol: ?canAddEnchantment@ScriptItemEnchantments@ScriptModuleMinecraft@@QEAA_NAEBUScriptItemEnchantmentInstance@2@@Z
    MCAPI bool canAddEnchantment(struct ScriptModuleMinecraft::ScriptItemEnchantmentInstance const &);

    // symbol: ?getAllEnchantments@ScriptItemEnchantments@ScriptModuleMinecraft@@QEBA?AV?$vector@V?$StrongTypedObjectHandle@UScriptItemEnchantmentInstance@ScriptModuleMinecraft@@@Scripting@@V?$allocator@V?$StrongTypedObjectHandle@UScriptItemEnchantmentInstance@ScriptModuleMinecraft@@@Scripting@@@std@@@std@@XZ
    MCAPI std::vector<class Scripting::StrongTypedObjectHandle<struct ScriptModuleMinecraft::ScriptItemEnchantmentInstance>> getAllEnchantments() const;

    // symbol: ?getEnchantment@ScriptItemEnchantments@ScriptModuleMinecraft@@QEAA?AV?$Result@V?$optional@V?$StrongTypedObjectHandle@UScriptItemEnchantmentInstance@ScriptModuleMinecraft@@@Scripting@@@std@@$$V@Scripting@@V?$variant@UScriptItemEnchantmentType@ScriptModuleMinecraft@@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@std@@@Z
