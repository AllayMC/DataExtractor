...
public:
    ...
    MCAPI struct ScriptModuleMinecraft::ScriptPlayAnimationOptions & operator=(struct ScriptModuleMinecraft::ScriptPlayAnimationOptions const &);

    // symbol: ??4ScriptPlayAnimationOptions@ScriptModuleMinecraft@@QEAAAEAU01@$$QEAU01@@Z
    MCAPI struct ScriptModuleMinecraft::ScriptPlayAnimationOptions & operator=(struct ScriptModuleMinecraft::ScriptPlayAnimationOptions &&);

    // symbol: ??1ScriptPlayAnimationOptions@ScriptModuleMinecraft@@QEAA@XZ
    MCAPI ~ScriptPlayAnimationOptions();

    // symbol: ?bind@ScriptPlayAnimationOptions@ScriptModuleMinecraft@@SA?AV?$InterfaceBindingBuilder@UScriptPlayAnimationOptions@ScriptModuleMinecraft@@@Scripting@@XZ
    MCAPI static class Scripting::InterfaceBindingBuilder<struct ScriptModuleMinecraft::ScriptPlayAnimationOptions> bind();
