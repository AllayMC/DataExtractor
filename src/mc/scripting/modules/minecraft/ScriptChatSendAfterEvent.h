...
public:
    ...
    // symbol: ?bind@ScriptChatSendAfterEvent@ScriptModuleMinecraft@@SA?AV?$ClassBindingBuilder@UScriptChatSendAfterEvent@ScriptModuleMinecraft@@@Scripting@@XZ
    MCAPI static class Scripting::ClassBindingBuilder<struct ScriptModuleMinecraft::ScriptChatSendAfterEvent> bind();

    // symbol: ?bindV010@ScriptChatSendAfterEvent@ScriptModuleMinecraft@@SA?AV?$ClassBindingBuilder@UScriptChatSendAfterEvent@ScriptModuleMinecraft@@@Scripting@@XZ
    MCAPI static class Scripting::ClassBindingBuilder<struct ScriptModuleMinecraft::ScriptChatSendAfterEvent> bindV010();
