...
public:
    ...
    MCAPI struct ScriptModuleMinecraft::ScriptExplosionStartedBeforeEvent & operator=(struct ScriptModuleMinecraft::ScriptExplosionStartedBeforeEvent &&);

    // symbol: ?setImpactedBlocks@ScriptExplosionStartedBeforeEvent@ScriptModuleMinecraft@@QEAAXAEBV?$vector@VVec3@@V?$allocator@VVec3@@@std@@@std@@@Z
