...
public:
    // NOLINTBEGIN
    // symbol: ?bind@ScriptBoundingBoxUtils@ScriptModuleMinecraft@@SA?AV?$ClassBindingBuilder@VScriptBoundingBoxUtils@ScriptModuleMinecraft@@@Scripting@@XZ
    ...
    // symbol: ?getIntersection@ScriptBoundingBoxUtils@ScriptModuleMinecraft@@SA?AV?$optional@VBoundingBox@@@std@@AEBVBoundingBox@@0@Z
    MCAPI static std::optional<class BoundingBox> getIntersection(class BoundingBox const &, class BoundingBox const &);
