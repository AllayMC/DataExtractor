...
public:
    // NOLINTBEGIN
    // symbol: ??0ScriptPistonActionAfterEvent@ScriptModuleMinecraft@@QEAA@AEBUPistonActionEvent@@AEAVBlockSourceHandle@@AEAV?$StrongTypedObjectHandle@VScriptBlockPistonComponent@ScriptModuleMinecraft@@@Scripting@@AEBVWeakLifetimeScope@5@@Z
    MCAPI ScriptPistonActionAfterEvent(struct PistonActionEvent const &, class BlockSourceHandle &, class Scripting::StrongTypedObjectHandle<class ScriptModuleMinecraft::ScriptBlockPistonComponent> &, class Scripting::WeakLifetimeScope const &);
