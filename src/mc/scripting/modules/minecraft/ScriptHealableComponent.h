...
public:
    ...
    // symbol: ??0ScriptHealableComponent@ScriptModuleMinecraft@@QEAA@AEBVWeakEntityRef@@AEBVWeakLifetimeScope@Scripting@@AEBV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@Z
    MCAPI ScriptHealableComponent(class WeakEntityRef const &, class Scripting::WeakLifetimeScope const &, std::string const &);

    // symbol: ?getFilters@ScriptHealableComponent@ScriptModuleMinecraft@@QEBA?AV?$Result@VActorFilterGroup@@$$V@Scripting@@XZ
    ...
    // symbol: ?getItems@ScriptHealableComponent@ScriptModuleMinecraft@@QEBA?AV?$Result@V?$vector@UFeedItem@@V?$allocator@UFeedItem@@@std@@@std@@$$V@Scripting@@XZ
    MCAPI class Scripting::Result<std::vector<struct FeedItem>> getItems() const;

    // symbol: ?bind@ScriptHealableComponent@ScriptModuleMinecraft@@SA?AV?$ClassBindingBuilder@VScriptHealableComponent@ScriptModuleMinecraft@@@Scripting@@XZ
