...
public:
    ...
    // symbol: ?setRecord@ScriptBlockRecordPlayerComponent@ScriptModuleMinecraft@@IEAA?AV?$Result@X$$V@Scripting@@AEBV?$variant@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@VScriptItemType@ScriptModuleMinecraft@@@std@@@Z
    MCAPI class Scripting::Result<void> setRecord(std::variant<std::string, class ScriptModuleMinecraft::ScriptItemType> const &);
