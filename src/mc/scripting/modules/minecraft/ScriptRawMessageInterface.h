...
public:
    ...
    MCAPI struct ScriptModuleMinecraft::ScriptRawMessageInterface & operator=(struct ScriptModuleMinecraft::ScriptRawMessageInterface &&);

    // symbol: ??4ScriptRawMessageInterface@ScriptModuleMinecraft@@QEAAAEAU01@AEBU01@@Z
    MCAPI struct ScriptModuleMinecraft::ScriptRawMessageInterface & operator=(struct ScriptModuleMinecraft::ScriptRawMessageInterface const &);
    ...
    // symbol: ?resolveAsJsonString@ScriptRawMessageInterface@ScriptModuleMinecraft@@QEBA?AV?$Result@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@$$V@Scripting@@AEAVActor@@W4CurrentCmdVersion@@@Z
    ...
    // symbol: ?bind@ScriptRawMessageInterface@ScriptModuleMinecraft@@SA?AV?$InterfaceBindingBuilder@UScriptRawMessageInterface@ScriptModuleMinecraft@@@Scripting@@XZ
    MCAPI static class Scripting::InterfaceBindingBuilder<struct ScriptModuleMinecraft::ScriptRawMessageInterface> bind();
    ...
    // symbol: ?fromString@ScriptRawMessageInterface@ScriptModuleMinecraft@@SA?AU12@AEBV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@Z
    ...
    MCAPI static std::vector<struct ScriptModuleMinecraft::ScriptRawMessageInterface> rawTextStringsToRawText(std::vector<std::variant<std::string, struct ScriptModuleMinecraft::ScriptRawMessageInterface>> const &);
