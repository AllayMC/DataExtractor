...
public:
    ...
    virtual class Scripting::Result<void> setItem(int, std::optional<class ScriptModuleMinecraft::ScriptItemStack> const &) const;
    ...
    virtual class Scripting::Result<std::optional<class Scripting::StrongTypedObjectHandle<class ScriptModuleMinecraft::ScriptItemStack>>> getItem(int) const;
    ...
    virtual class Scripting::Result<bool> transferItemV010(int, int, class ScriptModuleMinecraft::ScriptContainer &) const;
    ...
    virtual class Scripting::Result<void> moveItem(int, int, class ScriptModuleMinecraft::ScriptContainerWrapper &) const;
    ...
    virtual class Scripting::Result<void> swapItems(int, int, class ScriptModuleMinecraft::ScriptContainerWrapper &) const;
    ...
    virtual class Scripting::Result<class Scripting::StrongTypedObjectHandle<class ScriptModuleMinecraft::ScriptContainerSlot>> getSlot(int) const;
    ...
    // symbol: ?addItem@ScriptContainer@ScriptModuleMinecraft@@QEBA?AV?$Result@V?$StrongTypedObjectHandle@VScriptItemStack@ScriptModuleMinecraft@@@Scripting@@$$V@Scripting@@AEBVScriptItemStack@2@@Z
    ...
    // symbol: ?transferItem@ScriptContainer@ScriptModuleMinecraft@@QEBA?AV?$Result@V?$StrongTypedObjectHandle@VScriptItemStack@ScriptModuleMinecraft@@@Scripting@@$$V@Scripting@@HAEAVScriptContainerWrapper@2@@Z
