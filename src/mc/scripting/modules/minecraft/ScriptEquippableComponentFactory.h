...
public:
    ...
    ScriptEquippableComponentFactory& operator=(ScriptEquippableComponentFactory const &) = delete;
    ScriptEquippableComponentFactory(ScriptEquippableComponentFactory const &) = delete;
    ScriptEquippableComponentFactory() = delete;
...
public:
    ...
    // vIndex: 1, symbol: ?createComponent@ScriptEquippableComponentFactory@ScriptModuleMinecraft@@UEAA?AV?$StrongTypedObjectHandle@VScriptActorComponent@ScriptModuleMinecraft@@@Scripting@@VWeakEntityRef@@AEBVWeakLifetimeScope@4@AEBV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@Z
