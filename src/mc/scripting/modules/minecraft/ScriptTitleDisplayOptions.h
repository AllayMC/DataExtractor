...
public:
    ...
    MCAPI struct ScriptModuleMinecraft::ScriptTitleDisplayOptions & operator=(struct ScriptModuleMinecraft::ScriptTitleDisplayOptions &&);

    // symbol: ??4ScriptTitleDisplayOptions@ScriptModuleMinecraft@@QEAAAEAU01@AEBU01@@Z
    MCAPI struct ScriptModuleMinecraft::ScriptTitleDisplayOptions & operator=(struct ScriptModuleMinecraft::ScriptTitleDisplayOptions const &);

    // symbol: ??1ScriptTitleDisplayOptions@ScriptModuleMinecraft@@QEAA@XZ
    MCAPI ~ScriptTitleDisplayOptions();

    // symbol: ?bind@ScriptTitleDisplayOptions@ScriptModuleMinecraft@@SA?AV?$InterfaceBindingBuilder@UScriptTitleDisplayOptions@ScriptModuleMinecraft@@@Scripting@@XZ
    MCAPI static class Scripting::InterfaceBindingBuilder<struct ScriptModuleMinecraft::ScriptTitleDisplayOptions> bind();
