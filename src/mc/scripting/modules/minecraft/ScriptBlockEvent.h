...
public:
    ...
    MCAPI struct ScriptModuleMinecraft::ScriptBlockEvent & operator=(struct ScriptModuleMinecraft::ScriptBlockEvent const &);

    // symbol: ??1ScriptBlockEvent@ScriptModuleMinecraft@@QEAA@XZ
    MCAPI ~ScriptBlockEvent();

    // symbol: ?bind@ScriptBlockEvent@ScriptModuleMinecraft@@SA?AV?$ClassBindingBuilder@UScriptBlockEvent@ScriptModuleMinecraft@@@Scripting@@XZ
