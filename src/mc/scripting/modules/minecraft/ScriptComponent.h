...
public:
    ...
    // symbol: ??0ScriptComponent@ScriptModuleMinecraft@@QEAA@AEBVWeakLifetimeScope@Scripting@@AEBV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@Z
    ...
    // symbol: ?bind@ScriptComponent@ScriptModuleMinecraft@@SA?AV?$ClassBindingBuilder@VScriptComponent@ScriptModuleMinecraft@@@Scripting@@XZ
