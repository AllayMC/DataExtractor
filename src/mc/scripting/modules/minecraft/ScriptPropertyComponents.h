...
namespace ScriptModuleMinecraft::ScriptPropertyComponents {
    // NOLINTBEGIN
    // symbol: ?GetComponentRegistration@ScriptPropertyComponents@ScriptModuleMinecraft@@YA?AV?$vector@UPropertyComponentRegistration@ScriptPropertyComponents@ScriptModuleMinecraft@@V?$allocator@UPropertyComponentRegistration@ScriptPropertyComponents@ScriptModuleMinecraft@@@std@@@std@@XZ
    MCAPI std::vector<struct ScriptModuleMinecraft::ScriptPropertyComponents::PropertyComponentRegistration> GetComponentRegistration();

    // symbol: ?bind@ScriptPropertyComponents@ScriptModuleMinecraft@@YAXAEAVModuleBindingBuilder@Scripting@@@Z
    MCAPI void bind(class Scripting::ModuleBindingBuilder &);
    ...
    MCAPI void registerScriptPropertyComponentFactories(std::unordered_map<std::string,std::unique_ptr<class ScriptModuleMinecraft::IComponentFactory>> &);
    // NOLINTEND
