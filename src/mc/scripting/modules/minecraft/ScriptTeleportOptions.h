...
public:
    ...
    MCAPI struct ScriptModuleMinecraft::ScriptTeleportOptions & operator=(struct ScriptModuleMinecraft::ScriptTeleportOptions const &);

    // symbol: ??4ScriptTeleportOptions@ScriptModuleMinecraft@@QEAAAEAU01@$$QEAU01@@Z
    MCAPI struct ScriptModuleMinecraft::ScriptTeleportOptions & operator=(struct ScriptModuleMinecraft::ScriptTeleportOptions &&);

    // symbol: ??1ScriptTeleportOptions@ScriptModuleMinecraft@@QEAA@XZ
    MCAPI ~ScriptTeleportOptions();

    // symbol: ?bind@ScriptTeleportOptions@ScriptModuleMinecraft@@SA?AV?$InterfaceBindingBuilder@UScriptTeleportOptions@ScriptModuleMinecraft@@@Scripting@@XZ
