...
struct ScriptItemUseAfterEvent : public ::ScriptModuleMinecraft::ScriptItemEvent {
public:
...
public:
    ...
    MCAPI struct ScriptModuleMinecraft::ScriptItemUseAfterEvent & operator=(struct ScriptModuleMinecraft::ScriptItemUseAfterEvent &&);

    // symbol: ?bind@ScriptItemUseAfterEvent@ScriptModuleMinecraft@@SA?AV?$ClassBindingBuilder@UScriptItemUseAfterEvent@ScriptModuleMinecraft@@@Scripting@@XZ
    MCAPI static class Scripting::ClassBindingBuilder<struct ScriptModuleMinecraft::ScriptItemUseAfterEvent> bind();

    // symbol: ?bindV010@ScriptItemUseAfterEvent@ScriptModuleMinecraft@@SA?AV?$ClassBindingBuilder@UScriptItemUseAfterEvent@ScriptModuleMinecraft@@@Scripting@@XZ
