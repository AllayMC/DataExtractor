...
public:
    ...
    MCAPI struct ScriptModuleMinecraft::ScriptItemDefinitionBeforeEvent & operator=(struct ScriptModuleMinecraft::ScriptItemDefinitionBeforeEvent &&);

    // symbol: ?bind@ScriptItemDefinitionBeforeEvent@ScriptModuleMinecraft@@SA?AV?$ClassBindingBuilder@UScriptItemDefinitionBeforeEvent@ScriptModuleMinecraft@@@Scripting@@XZ
    MCAPI static class Scripting::ClassBindingBuilder<struct ScriptModuleMinecraft::ScriptItemDefinitionBeforeEvent> bind();
