...
public:
    ...
    MCAPI struct ScriptModuleMinecraft::ScriptRawMessageScoreInterface & operator=(struct ScriptModuleMinecraft::ScriptRawMessageScoreInterface const &);

    // symbol: ??4ScriptRawMessageScoreInterface@ScriptModuleMinecraft@@QEAAAEAU01@$$QEAU01@@Z
    MCAPI struct ScriptModuleMinecraft::ScriptRawMessageScoreInterface & operator=(struct ScriptModuleMinecraft::ScriptRawMessageScoreInterface &&);
    ...
    // symbol: ?bind@ScriptRawMessageScoreInterface@ScriptModuleMinecraft@@SA?AV?$InterfaceBindingBuilder@UScriptRawMessageScoreInterface@ScriptModuleMinecraft@@@Scripting@@XZ
    MCAPI static class Scripting::InterfaceBindingBuilder<struct ScriptModuleMinecraft::ScriptRawMessageScoreInterface> bind();
