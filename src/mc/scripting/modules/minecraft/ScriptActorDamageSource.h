...
public:
    ...
    MCAPI struct ScriptModuleMinecraft::ScriptActorDamageSource & operator=(struct ScriptModuleMinecraft::ScriptActorDamageSource &&);

    // symbol: ??1ScriptActorDamageSource@ScriptModuleMinecraft@@QEAA@XZ
    MCAPI ~ScriptActorDamageSource();

    // symbol: ?bind@ScriptActorDamageSource@ScriptModuleMinecraft@@SA?AV?$InterfaceBindingBuilder@UScriptActorDamageSource@ScriptModuleMinecraft@@@Scripting@@XZ
