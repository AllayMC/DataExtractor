...
public:
    ...
    // symbol: ?getName@ScriptItemEnchantmentType@ScriptModuleMinecraft@@QEBA?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@XZ
    MCAPI std::string getName() const;

    // symbol: ??4ScriptItemEnchantmentType@ScriptModuleMinecraft@@QEAAAEAU01@AEBU01@@Z
    MCAPI struct ScriptModuleMinecraft::ScriptItemEnchantmentType & operator=(struct ScriptModuleMinecraft::ScriptItemEnchantmentType const &);
    ...
    // symbol: ?bind@ScriptItemEnchantmentType@ScriptModuleMinecraft@@SA?AV?$ClassBindingBuilder@UScriptItemEnchantmentType@ScriptModuleMinecraft@@@Scripting@@XZ
