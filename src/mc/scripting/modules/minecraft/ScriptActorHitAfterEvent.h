...
public:
    ...
    MCAPI struct ScriptModuleMinecraft::ScriptActorHitAfterEvent & operator=(struct ScriptModuleMinecraft::ScriptActorHitAfterEvent &&);

    // symbol: ??1ScriptActorHitAfterEvent@ScriptModuleMinecraft@@QEAA@XZ
    MCAPI ~ScriptActorHitAfterEvent();

    // symbol: ?bindV010@ScriptActorHitAfterEvent@ScriptModuleMinecraft@@SA?AV?$ClassBindingBuilder@UScriptActorHitAfterEvent@ScriptModuleMinecraft@@@Scripting@@XZ
    MCAPI static class Scripting::ClassBindingBuilder<struct ScriptModuleMinecraft::ScriptActorHitAfterEvent> bindV010();
