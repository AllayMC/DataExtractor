...
public:
    // NOLINTBEGIN
    // symbol: ??0ScriptSystemBeforeEvents@ScriptModuleMinecraft@@QEAA@AEBVWeakLifetimeScope@Scripting@@V?$not_null@PEAVServerLevel@@@gsl@@@Z
    ...
    // symbol: ?onBeforeWatchdogTerminate@ScriptSystemBeforeEvents@ScriptModuleMinecraft@@QEAAXV?$WeakTypedObjectHandle@UScriptWatchdogTerminateBeforeEvent@ScriptModuleMinecraft@@@Scripting@@@Z
    MCAPI void onBeforeWatchdogTerminate(class Scripting::WeakTypedObjectHandle<struct ScriptModuleMinecraft::ScriptWatchdogTerminateBeforeEvent>);

    // symbol: ??4ScriptSystemBeforeEvents@ScriptModuleMinecraft@@QEAAAEAV01@$$QEAV01@@Z
    MCAPI class ScriptModuleMinecraft::ScriptSystemBeforeEvents & operator=(class ScriptModuleMinecraft::ScriptSystemBeforeEvents &&);

    // symbol: ?registerHandler@ScriptSystemBeforeEvents@ScriptModuleMinecraft@@QEAAXU?$TypedObjectHandle@VScriptSystemBeforeEvents@ScriptModuleMinecraft@@@Scripting@@@Z
    MCAPI void registerHandler(struct Scripting::TypedObjectHandle<class ScriptModuleMinecraft::ScriptSystemBeforeEvents>);
