...
public:
    ...
    MCAPI struct ScriptModuleMinecraft::ScriptEventCommandMessageAfterEvent & operator=(struct ScriptModuleMinecraft::ScriptEventCommandMessageAfterEvent const &);

    // symbol: ??4ScriptEventCommandMessageAfterEvent@ScriptModuleMinecraft@@QEAAAEAU01@$$QEAU01@@Z
    MCAPI struct ScriptModuleMinecraft::ScriptEventCommandMessageAfterEvent & operator=(struct ScriptModuleMinecraft::ScriptEventCommandMessageAfterEvent &&);

    // symbol: ??1ScriptEventCommandMessageAfterEvent@ScriptModuleMinecraft@@QEAA@XZ
    MCAPI ~ScriptEventCommandMessageAfterEvent();

    // symbol: ?bind@ScriptEventCommandMessageAfterEvent@ScriptModuleMinecraft@@SA?AV?$ClassBindingBuilder@UScriptEventCommandMessageAfterEvent@ScriptModuleMinecraft@@@Scripting@@XZ
    MCAPI static class Scripting::ClassBindingBuilder<struct ScriptModuleMinecraft::ScriptEventCommandMessageAfterEvent> bind();
