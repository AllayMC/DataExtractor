...
public:
    ...
    // symbol: ?bind@ScriptServerMessageAfterEvent@ScriptModuleMinecraft@@SA?AV?$ClassBindingBuilder@UScriptServerMessageAfterEvent@ScriptModuleMinecraft@@@Scripting@@XZ
    MCAPI static class Scripting::ClassBindingBuilder<struct ScriptModuleMinecraft::ScriptServerMessageAfterEvent> bind();
