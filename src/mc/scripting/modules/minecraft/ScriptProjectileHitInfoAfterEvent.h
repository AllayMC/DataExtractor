...
public:
    ...
    ScriptProjectileHitInfoAfterEvent() = delete;

public:
    // NOLINTBEGIN
    // symbol: ??0ScriptProjectileHitInfoAfterEvent@ScriptModuleMinecraft@@QEAA@AEBUProjectileHitEvent@@AEBVWeakLifetimeScope@Scripting@@@Z
    MCAPI ScriptProjectileHitInfoAfterEvent(struct ProjectileHitEvent const &, class Scripting::WeakLifetimeScope const &);
    ...
    MCAPI struct ScriptModuleMinecraft::ScriptProjectileHitInfoAfterEvent & operator=(struct ScriptModuleMinecraft::ScriptProjectileHitInfoAfterEvent &&);

    // symbol: ??4ScriptProjectileHitInfoAfterEvent@ScriptModuleMinecraft@@QEAAAEAU01@AEBU01@@Z
    MCAPI struct ScriptModuleMinecraft::ScriptProjectileHitInfoAfterEvent & operator=(struct ScriptModuleMinecraft::ScriptProjectileHitInfoAfterEvent const &);
