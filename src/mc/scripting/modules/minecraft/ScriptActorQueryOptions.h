...
public:
    ...
    MCAPI struct ScriptModuleMinecraft::ScriptActorQueryOptions & operator=(struct ScriptModuleMinecraft::ScriptActorQueryOptions &&);

    // symbol: ??4ScriptActorQueryOptions@ScriptModuleMinecraft@@QEAAAEAU01@AEBU01@@Z
    MCAPI struct ScriptModuleMinecraft::ScriptActorQueryOptions & operator=(struct ScriptModuleMinecraft::ScriptActorQueryOptions const &);

    // symbol: ??1ScriptActorQueryOptions@ScriptModuleMinecraft@@QEAA@XZ
    MCAPI ~ScriptActorQueryOptions();

    // symbol: ?bindV010@ScriptActorQueryOptions@ScriptModuleMinecraft@@SA?AV?$ClassBindingBuilder@UScriptActorQueryOptions@ScriptModuleMinecraft@@@Scripting@@XZ
    MCAPI static class Scripting::ClassBindingBuilder<struct ScriptModuleMinecraft::ScriptActorQueryOptions> bindV010();

    // symbol: ?bindV1@ScriptActorQueryOptions@ScriptModuleMinecraft@@SA?AV?$InterfaceBindingBuilder@UScriptActorQueryOptions@ScriptModuleMinecraft@@@Scripting@@XZ
    MCAPI static class Scripting::InterfaceBindingBuilder<struct ScriptModuleMinecraft::ScriptActorQueryOptions> bindV1();
