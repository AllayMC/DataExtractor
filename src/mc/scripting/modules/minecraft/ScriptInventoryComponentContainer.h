...
public:
    ...
    // symbol: ??0ScriptInventoryComponentContainer@ScriptModuleMinecraft@@QEAA@AEBVWeakEntityRef@@AEBVWeakLifetimeScope@Scripting@@@Z
    ...
    MCAPI class ScriptModuleMinecraft::ScriptInventoryComponentContainer & operator=(class ScriptModuleMinecraft::ScriptInventoryComponentContainer const &);

    // symbol: ?bindV010@ScriptInventoryComponentContainer@ScriptModuleMinecraft@@SA?AV?$ClassBindingBuilder@VScriptInventoryComponentContainer@ScriptModuleMinecraft@@@Scripting@@XZ
    MCAPI static class Scripting::ClassBindingBuilder<class ScriptModuleMinecraft::ScriptInventoryComponentContainer> bindV010();
