...
public:
    ...
    // vIndex: 1, symbol: ?createComponent@ScriptNavigationFloatComponentFactory@ScriptModuleMinecraft@@UEAA?AV?$StrongTypedObjectHandle@VScriptActorComponent@ScriptModuleMinecraft@@@Scripting@@VWeakEntityRef@@AEBVWeakLifetimeScope@4@AEBV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@Z
    ...
    // vIndex: 2, symbol: ?hasComponent@ScriptNavigationFloatComponentFactory@ScriptModuleMinecraft@@UEBA_NVWeakEntityRef@@@Z
