...
public:
    // NOLINTBEGIN
    // symbol: ?bindV010@ScriptExplosionOptions@ScriptModuleMinecraft@@SA?AV?$ClassBindingBuilder@UScriptExplosionOptions@ScriptModuleMinecraft@@@Scripting@@XZ
    MCAPI static class Scripting::ClassBindingBuilder<struct ScriptModuleMinecraft::ScriptExplosionOptions> bindV010();

    // symbol: ?bindV1@ScriptExplosionOptions@ScriptModuleMinecraft@@SA?AV?$InterfaceBindingBuilder@UScriptExplosionOptions@ScriptModuleMinecraft@@@Scripting@@XZ
    MCAPI static class Scripting::InterfaceBindingBuilder<struct ScriptModuleMinecraft::ScriptExplosionOptions> bindV1();
