...
public:
    ...
    MCAPI ScriptIntBlockProperty(std::string, class BlockState const &, std::vector<int>, class Scripting::StrongTypedObjectHandle<class ScriptModuleMinecraft::ScriptBlockPermutation>);
