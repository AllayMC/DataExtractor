...
public:
    ...
    MCAPI struct ScriptModuleMinecraft::ScriptRawTextInterface & operator=(struct ScriptModuleMinecraft::ScriptRawTextInterface &&);
    ...
    // symbol: ?bind@ScriptRawTextInterface@ScriptModuleMinecraft@@SA?AV?$InterfaceBindingBuilder@UScriptRawTextInterface@ScriptModuleMinecraft@@@Scripting@@XZ
