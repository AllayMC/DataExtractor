...
public:
    ...
    // symbol: ?getUsingConvertsToItem@ScriptFoodComponent@ScriptModuleMinecraft@@QEAA?AV?$Result@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@$$V@Scripting@@XZ
    ...
    MCAPI class ScriptModuleMinecraft::ScriptFoodComponent & operator=(class ScriptModuleMinecraft::ScriptFoodComponent const &);

    // symbol: ?bind@ScriptFoodComponent@ScriptModuleMinecraft@@SA?AV?$ClassBindingBuilder@VScriptFoodComponent@ScriptModuleMinecraft@@@Scripting@@XZ
