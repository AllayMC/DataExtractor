...
public:
    ...
    ScriptRGB& operator=(ScriptRGB const &) = delete;
    ScriptRGB(ScriptRGB const &) = delete;
    ScriptRGB() = delete;
...
public:
    ...
    // symbol: ?bind@ScriptRGB@ScriptModuleMinecraft@@SA?AV?$InterfaceBindingBuilder@VScriptRGB@ScriptModuleMinecraft@@@Scripting@@XZ
