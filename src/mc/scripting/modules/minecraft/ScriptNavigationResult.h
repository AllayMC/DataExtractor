...
public:
    // NOLINTBEGIN
    // symbol: ?getPath@ScriptNavigationResult@ScriptModuleMinecraft@@QEBA?AV?$vector@VVec3@@V?$allocator@VVec3@@@std@@@std@@XZ
    ...
    // symbol: ?bind@ScriptNavigationResult@ScriptModuleMinecraft@@SA?AV?$ClassBindingBuilder@UScriptNavigationResult@ScriptModuleMinecraft@@@Scripting@@XZ
