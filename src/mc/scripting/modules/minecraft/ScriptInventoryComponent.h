...
public:
    ...
    // symbol: ?getContainerType@ScriptInventoryComponent@ScriptModuleMinecraft@@QEBA?AV?$Result@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@$$V@Scripting@@XZ
    ...
    // symbol: ?getOrCreateContainerV010@ScriptInventoryComponent@ScriptModuleMinecraft@@QEAA?AV?$Result@V?$WeakTypedObjectHandle@VScriptInventoryComponentContainer@ScriptModuleMinecraft@@@Scripting@@$$V@Scripting@@XZ
    MCAPI class Scripting::Result<class Scripting::WeakTypedObjectHandle<class ScriptModuleMinecraft::ScriptInventoryComponentContainer>> getOrCreateContainerV010();
    ...
    MCAPI class ScriptModuleMinecraft::ScriptInventoryComponent & operator=(class ScriptModuleMinecraft::ScriptInventoryComponent &&);

    // symbol: ?bind@ScriptInventoryComponent@ScriptModuleMinecraft@@SA?AV?$ClassBindingBuilder@VScriptInventoryComponent@ScriptModuleMinecraft@@@Scripting@@XZ
