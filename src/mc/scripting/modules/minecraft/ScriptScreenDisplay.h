...
public:
    ...
    MCAPI class Scripting::Result<void> setActionBar(std::variant<std::string, struct ScriptModuleMinecraft::ScriptRawMessageInterface, std::vector<std::variant<std::string, struct ScriptModuleMinecraft::ScriptRawMessageInterface>>> const &) const;
    ...
    MCAPI class Scripting::Result<void> setTitle(std::variant<std::string, struct ScriptModuleMinecraft::ScriptRawMessageInterface, std::vector<std::variant<std::string, struct ScriptModuleMinecraft::ScriptRawMessageInterface>>> const &, std::optional<struct ScriptModuleMinecraft::ScriptTitleDisplayOptions>) const;
    ...
    MCAPI class Scripting::Result<void> updateSubtitle(std::variant<std::string, struct ScriptModuleMinecraft::ScriptRawMessageInterface, std::vector<std::variant<std::string, struct ScriptModuleMinecraft::ScriptRawMessageInterface>>> const &) const;

    // symbol: ?bind@ScriptScreenDisplay@ScriptModuleMinecraft@@SA?AV?$ClassBindingBuilder@UScriptScreenDisplay@ScriptModuleMinecraft@@@Scripting@@XZ
    ...
    MCAPI class Scripting::Result<std::string> _getJsonString(class Player &, std::variant<std::string, struct ScriptModuleMinecraft::ScriptRawMessageInterface, std::vector<std::variant<std::string, struct ScriptModuleMinecraft::ScriptRawMessageInterface>>> const &) const;
