...
namespace ScriptModuleMinecraft {
    ...
    MCAPI class Scripting::EnumBindingBuilder<::ScriptModuleMinecraft::ScriptFacing, ::ScriptModuleMinecraft::ScriptFacing> bindFacingEnumV010();
    ...
    MCAPI class Scripting::EnumBindingBuilder<std::string, ::ScriptModuleMinecraft::ScriptDisplayObjectiveSlotId> bindScriptDisplayObjectiveSlotId();
    ...
    MCAPI class Scripting::EnumBindingBuilder<std::string, ::ScriptModuleMinecraft::ScriptEventSource> bindScriptEventSource();
    ...
    MCAPI class Scripting::EnumBindingBuilder<::ScriptModuleMinecraft::ScriptTimeOfDay, ::ScriptModuleMinecraft::ScriptTimeOfDay> bindTimeOfDay();
    ...
    MCAPI std::string getScriptScoreboardParticipantName(std::variant<class Scripting::StrongTypedObjectHandle<class ScriptModuleMinecraft::ScriptScoreboardIdentity>, class Scripting::StrongTypedObjectHandle<class ScriptModuleMinecraft::ScriptActor>, std::string> const &);
    ...
    MCAPI class Json::Value rawMessageOrStringToJson(std::variant<std::string, struct ScriptModuleMinecraft::ScriptRawMessageInterface> const &);
    // NOLINTEND
