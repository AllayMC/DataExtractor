...
public:
    ...
    ScriptMovementComponentFactory& operator=(ScriptMovementComponentFactory const &) = delete;
    ScriptMovementComponentFactory(ScriptMovementComponentFactory const &) = delete;
...
public:
    ...
    // vIndex: 1, symbol: ?createComponent@ScriptMovementComponentFactory@ScriptModuleMinecraft@@UEAA?AV?$StrongTypedObjectHandle@VScriptActorComponent@ScriptModuleMinecraft@@@Scripting@@VWeakEntityRef@@AEBVWeakLifetimeScope@4@AEBV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@Z
