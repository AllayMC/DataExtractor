...
public:
    ...
    // symbol: ?bind@ScriptEntityHitInformation@ScriptModuleMinecraft@@SA?AV?$InterfaceBindingBuilder@UScriptEntityHitInformation@ScriptModuleMinecraft@@@Scripting@@XZ
    MCAPI static class Scripting::InterfaceBindingBuilder<struct ScriptModuleMinecraft::ScriptEntityHitInformation> bind();
