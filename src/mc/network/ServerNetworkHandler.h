...
public:
    ...
    public:
        // prevent constructor by default
        HandlerToggles& operator=(HandlerToggles const &) = delete;
        HandlerToggles(HandlerToggles const &) = delete;
        HandlerToggles() = delete;
...
public:
    ...
    // symbol: ?handle@ServerNetworkHandler@@UEAAXAEBVNetworkIdentifier@@V?$shared_ptr@VInventoryTransactionPacket@@@std@@@Z
    ...
    // symbol: ?onDisconnect@ServerNetworkHandler@@UEAAXAEBVNetworkIdentifier@@W4DisconnectFailReason@Connection@@AEBV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@_N2@Z
    MCVAPI void onDisconnect(class NetworkIdentifier const &, ::Connection::DisconnectFailReason, std::string const &, bool, std::string const &);
    ...
    MCAPI ServerNetworkHandler(class GameCallbacks &, class Bedrock::NonOwnerPointer<class ILevel> const &, class ServerNetworkSystem &, class PrivateKeyManager &, class ServerLocator &, class PacketSender &, class AllowList &, class PermissionsFile *, class mce::UUID const &, int32_t, std::vector<std::string> const &, std::string, int32_t, class MinecraftCommands &, class IMinecraftApp &, std::unordered_map<struct PackIdVersion,std::string> const &, class Scheduler &, class Bedrock::NonOwnerPointer<class TextFilteringProcessor>, class optional_ref<class MinecraftGameTest>, class ServiceReference<class AppConfigs>, class ServiceReference<class Social::MultiplayerServiceManager>, struct NetworkPermissions const &, struct ServerNetworkHandler::HandlerToggles const &);
    ...
    // symbol: ?disconnectClient@ServerNetworkHandler@@QEAAXAEBVNetworkIdentifier@@W4DisconnectFailReason@Connection@@AEBV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@_N@Z
    MCAPI void disconnectClient(class NetworkIdentifier const &, ::Connection::DisconnectFailReason, std::string const &, bool);

    // symbol: ?disconnectClient@ServerNetworkHandler@@QEAAXAEBVNetworkIdentifier@@W4SubClientId@@W4DisconnectFailReason@Connection@@AEBV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@_N@Z
    MCAPI void disconnectClient(class NetworkIdentifier const &, ::SubClientId, ::Connection::DisconnectFailReason, std::string const &, bool);
    ...
    // symbol: ?getGlobalMultiplayerCorrelationId@ServerNetworkHandler@@QEBA?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@XZ
    ...
    // symbol: ?sendSubClientLoginMessageLocal@ServerNetworkHandler@@QEAAXAEBVNetworkIdentifier@@AEBVSubClientConnectionRequest@@W4SubClientId@@@Z
    MCAPI void sendSubClientLoginMessageLocal(class NetworkIdentifier const &, class SubClientConnectionRequest const &, ::SubClientId);
    ...
    MCAPI void _buildSubChunkPacketData(class NetworkIdentifier const &, class ServerPlayer const *, class SubChunkRequestPacket const &, class SubChunkPacket &, uint32_t, bool);
    ...
    MCAPI class ServerPlayer & _createNewPlayer(class NetworkIdentifier const &, class SubClientConnectionRequest const &, ::SubClientId);
