...
public:
    ...
    public:
        ...
        // vIndex: 1, symbol: ?sendPacket@RakNetNetworkPeer@RakNetConnector@@UEAAXAEBV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@W4Reliability@NetworkPeer@@W4Compressibility@@@Z
        virtual void sendPacket(std::string const &, ::NetworkPeer::Reliability, ::Compressibility);
    
        // vIndex: 2, symbol: ?receivePacket@RakNetNetworkPeer@RakNetConnector@@UEAA?AW4DataStatus@NetworkPeer@@AEAV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@AEBV?$shared_ptr@V?$time_point@Usteady_clock@chrono@std@@V?$duration@_JU?$ratio@$00$0DLJKMKAA@@std@@@23@@chrono@std@@@6@@Z
        virtual ::NetworkPeer::DataStatus receivePacket(std::string &, std::shared_ptr<std::chrono::steady_clock::time_point> const &);
        ...
        // symbol: ?newData@RakNetNetworkPeer@RakNetConnector@@QEAAXV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@Z
