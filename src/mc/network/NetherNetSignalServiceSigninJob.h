...
public:
    ...
    MCAPI NetherNetSignalServiceSigninJob(Bedrock::NotNullNonOwnerPtr<struct NetherNetConnector> &&, std::function<void (bool)> &&, std::function<void (void)> &&, Bedrock::NotNullNonOwnerPtr<class DisconnectionRequestHandler>, Bedrock::NotNullNonOwnerPtr<class ServicesManager>, Bedrock::NotNullNonOwnerPtr<class IMinecraftEventing>, bool);
