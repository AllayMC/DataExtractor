...
public:
    ...
    public:
        // NOLINTBEGIN
        // symbol: ?getConfigAsync@ConfigListener@NetherNetSignalServiceSigninJob@Network@@QEAA?AV?$shared_ptr@V?$IAsyncResult@V?$tuple@UUrl@NetherNetSignalServiceSigninJob@Network@@UToken@23@@std@@@Threading@Bedrock@@@std@@XZ
        MCAPI std::shared_ptr<class Bedrock::Threading::IAsyncResult<std::tuple<struct Network::NetherNetSignalServiceSigninJob::Url, struct Network::NetherNetSignalServiceSigninJob::Token>>> getConfigAsync();
...
public:
    // NOLINTBEGIN
    // symbol: ?signin@NetherNetSignalServiceSigninJob@Network@@UEAAX_NV?$optional@V?$duration@_JU?$ratio@$00$00@std@@@chrono@std@@@std@@@Z
    ...
    // symbol: ??0NetherNetSignalServiceSigninJob@Network@@QEAA@$$QEAV?$not_null@V?$NonOwnerPointer@UNetherNetConnector@@@Bedrock@@@gsl@@$$QEAV?$function@$$A6AX_N@Z@std@@$$QEAV?$function@$$A6AXXZ@5@V?$not_null@V?$NonOwnerPointer@VDisconnectionRequestHandler@@@Bedrock@@@3@V?$not_null@V?$NonOwnerPointer@VServicesManager@@@Bedrock@@@3@V?$not_null@V?$NonOwnerPointer@VIMinecraftEventing@@@Bedrock@@@3@_N@Z
    MCAPI NetherNetSignalServiceSigninJob(gsl::not_null<class Bedrock::NonOwnerPointer<struct NetherNetConnector>> &&, std::function<void (bool)> &&, std::function<void (void)> &&, gsl::not_null<class Bedrock::NonOwnerPointer<class DisconnectionRequestHandler>>, gsl::not_null<class Bedrock::NonOwnerPointer<class ServicesManager>>, gsl::not_null<class Bedrock::NonOwnerPointer<class IMinecraftEventing>>, bool);
    ...
    MCAPI void _signin(struct Network::NetherNetSignalServiceSigninJob::Url const &, struct Network::NetherNetSignalServiceSigninJob::Token const &, bool);
