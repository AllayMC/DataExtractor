...
public:
    // NOLINTBEGIN
    // symbol: ?onLevelDestruction@AutomationClient@Automation@@UEAAXAEBV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@Z
    ...
    // symbol: ?getDefaultSession@AutomationClient@Automation@@QEAA?AV?$shared_ptr@VAutomationSession@Automation@@@std@@XZ
    MCAPI std::shared_ptr<class Automation::AutomationSession> getDefaultSession();

    // symbol: ?getSessionForCommand@AutomationClient@Automation@@QEAA?AV?$shared_ptr@VAutomationSession@Automation@@@std@@AEBVCommandOrigin@@@Z
    ...
    // private:
    // NOLINTBEGIN
    // symbol: ?_forEachSession@AutomationClient@Automation@@AEAAXAEBV?$function@$$A6A_NAEAVAutomationSession@Automation@@@Z@std@@@Z
