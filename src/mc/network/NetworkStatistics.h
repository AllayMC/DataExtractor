...
public:
    ...
    // vIndex: 4, symbol: ?dataReceivedFrom@NetworkStatistics@@UEAAXAEBVNetworkIdentifier@@AEBV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@Z
    ...
    MCAPI NetworkStatistics(gsl::not_null<class Bedrock::NonOwnerPointer<class NetworkSystem>>, ::TrackerType, std::function<bool (struct RakNet::RakNetStatistics &)> &&, gsl::not_null<class Bedrock::NonOwnerPointer<class NetworkDebugManager>>);
