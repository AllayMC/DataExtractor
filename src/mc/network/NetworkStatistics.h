...
public:
    ...
    MCAPI NetworkStatistics(Bedrock::NotNullNonOwnerPtr<class NetworkSystem>, ::TrackerType, std::function<bool (struct RakNet::RakNetStatistics &)> &&, Bedrock::NotNullNonOwnerPtr<class NetworkDebugManager>);
