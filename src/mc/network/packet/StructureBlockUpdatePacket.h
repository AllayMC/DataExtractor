...
public:
    ...
    // vIndex: 2, symbol: ?getName@StructureBlockUpdatePacket@@UEBA?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@XZ
    virtual std::string getName() const;

    // vIndex: 3, symbol: ?write@StructureBlockUpdatePacket@@UEBAXAEAVBinaryStream@@@Z
