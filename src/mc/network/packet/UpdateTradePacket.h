...
public:
    ...
    MCAPI UpdateTradePacket(::ContainerID, ::ContainerType, int, std::string const &, class CompoundTag &&, struct ActorUniqueID const &, struct ActorUniqueID const &, int, bool, bool);
