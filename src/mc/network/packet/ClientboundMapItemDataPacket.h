...
public:
    ...
    MCAPI ClientboundMapItemDataPacket(struct ActorUniqueID, schar, std::vector<std::pair<struct MapItemTrackedActor::UniqueId, std::shared_ptr<class MapDecoration>>> const &, class buffer_span<uint>, int, int, int, int, class AutomaticID<class Dimension, int>, bool, class BlockPos const &);
