...
public:
    ...
    MCAPI ClientboundMapItemDataPacket(struct ActorUniqueID, schar, std::vector<std::pair<struct MapItemTrackedActor::UniqueId, std::shared_ptr<class MapDecoration>>> const &, class buffer_span<uint>, int, int, int, int, DimensionType, bool, class BlockPos const &);
