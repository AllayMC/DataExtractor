...
public:
    ...
    public:
        ...
        NewIncomingConnectionEvent& operator=(NewIncomingConnectionEvent const &) = delete;
        NewIncomingConnectionEvent(NewIncomingConnectionEvent const &) = delete;
        NewIncomingConnectionEvent() = delete;
    ...
    public:
        // prevent constructor by default
        NewOutgoingConnectionEvent& operator=(NewOutgoingConnectionEvent const &) = delete;
        NewOutgoingConnectionEvent(NewOutgoingConnectionEvent const &) = delete;
        NewOutgoingConnectionEvent() = delete;
...
public:
    ...
    MCAPI gsl::not_null<std::shared_ptr<class WebRTCNetworkPeer>> _getOrCreatePeer(uint64, class Bedrock::Threading::UniqueLock<std::mutex> const &);
