...
public:
    ...
    WebRTCClientErrorCategory& operator=(WebRTCClientErrorCategory const &) = delete;
    WebRTCClientErrorCategory(WebRTCClientErrorCategory const &) = delete;
    WebRTCClientErrorCategory() = delete;
...
public:
    ...
    // vIndex: 2, symbol: ?message@WebRTCClientErrorCategory@Network@@UEBA?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@H@Z
