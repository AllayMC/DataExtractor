...
public:
    // NOLINTBEGIN
    // symbol: ?registerParser@LoaderBase@internal@Puv@@QEAAXV?$unique_ptr@VParserBase@Puv@@U?$default_delete@VParserBase@Puv@@@std@@@std@@@Z
    MCAPI void registerParser(std::unique_ptr<class Puv::ParserBase>);

    // symbol: ?registerUpgrader@LoaderBase@internal@Puv@@QEAAXV?$unique_ptr@VUpgrader@Puv@@U?$default_delete@VUpgrader@Puv@@@std@@@std@@@Z
    ...
    // protected:
    // NOLINTBEGIN
    // symbol: ?doLoad@LoaderBase@internal@Puv@@IEBA?AVLoadResultAny@3@AEBV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@AEBVSemVersion@@@Z
