...
public:
    ...
    // symbol: ??0VersionParser@Puv@@QEAA@V?$vector@U?$pair@VSemVersion@@V1@@std@@V?$allocator@U?$pair@VSemVersion@@V1@@std@@@2@@std@@@Z
    MCAPI VersionParser(std::vector<std::pair<class SemVersion, class SemVersion>>);
