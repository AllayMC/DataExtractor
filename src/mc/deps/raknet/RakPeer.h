...
public:
    ...
    MCVAPI void CloseConnection(struct RakNet::AddressOrGUID, bool, uint8_t, ::PacketPriority);

    // symbol: ?Connect@RakPeer@RakNet@@UEAA?AW4ConnectionAttemptResult@2@PEBDG0HPEAUPublicKey@2@IIII@Z
    MCVAPI ::RakNet::ConnectionAttemptResult Connect(char const *, uint16_t, char const *, int32_t, struct RakNet::PublicKey *, uint32_t, uint32_t, uint32_t, uint32_t);
    ...
    MCVAPI ::RakNet::ConnectionAttemptResult ConnectWithSocket(char const *, uint16_t, char const *, int32_t, class RakNet::RakNetSocket2 *, struct RakNet::PublicKey *, uint32_t, uint32_t, uint32_t);
    ...
    MCVAPI uint32_t Send(char const *, int32_t, ::PacketPriority, ::PacketReliability, char, struct RakNet::AddressOrGUID, bool, uint32_t);

    // symbol: ?Send@RakPeer@RakNet@@UEAAIPEBVBitStream@2@W4PacketPriority@@W4PacketReliability@@DUAddressOrGUID@2@_NI@Z
    MCVAPI uint32_t Send(class RakNet::BitStream const *, ::PacketPriority, ::PacketReliability, char, struct RakNet::AddressOrGUID, bool, uint32_t);

    // symbol: ?SendList@RakPeer@RakNet@@UEAAIPEAPEBDPEBHHW4PacketPriority@@W4PacketReliability@@DUAddressOrGUID@2@_NI@Z
    MCVAPI uint32_t SendList(char const **, int32_t const *, int32_t, ::PacketPriority, ::PacketReliability, char, struct RakNet::AddressOrGUID, bool, uint32_t);
    ...
    MCVAPI void Shutdown(uint32_t, uint8_t, ::PacketPriority);

    // symbol: ?Startup@RakPeer@RakNet@@UEAA?AW4StartupResult@2@IPEAUSocketDescriptor@2@IH@Z
    MCVAPI ::RakNet::StartupResult Startup(uint32_t, struct RakNet::SocketDescriptor *, uint32_t, int32_t);
    ...
    MCAPI struct RakNet::RakPeer::RemoteSystemStruct * AssignSystemAddressToRemoteSystemList(struct RakNet::SystemAddress, ::RakNet::RakPeer::RemoteSystemStruct::ConnectMode, class RakNet::RakNetSocket2 *, bool *, struct RakNet::SystemAddress, int32_t, struct RakNet::RakNetGUID, bool);
    ...
    MCAPI void CloseConnectionInternal(struct RakNet::AddressOrGUID const &, bool, bool, uint8_t, ::PacketPriority);
    ...
    MCAPI void NotifyAndFlagForShutdown(struct RakNet::SystemAddress, bool, uint8_t, ::PacketPriority);
    ...
    MCAPI void SendBuffered(char const *, uint32_t, ::PacketPriority, ::PacketReliability, char, struct RakNet::AddressOrGUID, bool, ::RakNet::RakPeer::RemoteSystemStruct::ConnectMode, uint32_t);
    ...
    MCAPI void SendBufferedList(char const **, int32_t const *, int32_t, ::PacketPriority, ::PacketReliability, char, struct RakNet::AddressOrGUID, bool, ::RakNet::RakPeer::RemoteSystemStruct::ConnectMode, uint32_t);

    // symbol: ?SendConnectionRequest@RakPeer@RakNet@@IEAA?AW4ConnectionAttemptResult@2@PEBDG0HPEAUPublicKey@2@IIIII@Z
    MCAPI ::RakNet::ConnectionAttemptResult SendConnectionRequest(char const *, uint16_t, char const *, int32_t, struct RakNet::PublicKey *, uint32_t, uint32_t, uint32_t, uint32_t, uint32_t);
    ...
    MCAPI ::RakNet::ConnectionAttemptResult SendConnectionRequest(char const *, uint16_t, char const *, int32_t, struct RakNet::PublicKey *, uint32_t, uint32_t, uint32_t, uint32_t, uint32_t, class RakNet::RakNetSocket2 *);

    // symbol: ?SendImmediate@RakPeer@RakNet@@IEAA_NPEADIW4PacketPriority@@W4PacketReliability@@DUAddressOrGUID@2@_N4_KI@Z
    MCAPI bool SendImmediate(char *, uint32_t, ::PacketPriority, ::PacketReliability, char, struct RakNet::AddressOrGUID, bool, bool, uint64_t, uint32_t);
