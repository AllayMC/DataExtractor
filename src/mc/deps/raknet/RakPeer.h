...
public:
    ...
    MCVAPI ::RakNet::ConnectionAttemptResult Connect(char const *, ushort, char const *, int, struct RakNet::PublicKey *, uint, uint, uint, uint);
    ...
    MCVAPI ::RakNet::ConnectionAttemptResult ConnectWithSocket(char const *, ushort, char const *, int, class RakNet::RakNetSocket2 *, struct RakNet::PublicKey *, uint, uint, uint);
    ...
    MCAPI struct RakNet::RakPeer::RemoteSystemStruct * AssignSystemAddressToRemoteSystemList(struct RakNet::SystemAddress, ::RakNet::RakPeer::RemoteSystemStruct::ConnectMode, class RakNet::RakNetSocket2 *, bool *, struct RakNet::SystemAddress, int, struct RakNet::RakNetGUID, bool);
    ...
    MCAPI void ParseConnectionRequestPacket(struct RakNet::RakPeer::RemoteSystemStruct *, struct RakNet::SystemAddress const &, char const *, int);
    ...
    MCAPI void SendBuffered(char const *, uint, ::PacketPriority, ::PacketReliability, char, struct RakNet::AddressOrGUID, bool, ::RakNet::RakPeer::RemoteSystemStruct::ConnectMode, uint);
