...
public:
    ...
    MCAPI bool HandleSocketReceiveFromConnectedPlayer(char const *, uint, struct RakNet::SystemAddress &, class DataStructures::List<class RakNet::PluginInterface2 *> &, int, class RakNet::RakNetSocket2 *, class RakNet::RakNetRandom *, uint64, class RakNet::BitStream &);
    ...
    MCAPI void Update(class RakNet::RakNetSocket2 *, struct RakNet::SystemAddress &, int, uint64, uint, class DataStructures::List<class RakNet::PluginInterface2 *> &, class RakNet::RakNetRandom *, class RakNet::BitStream &);
    ...
    MCAPI struct RakNet::InternalPacket * BuildPacketFromSplitPacketList(ushort, uint64, class RakNet::RakNetSocket2 *, struct RakNet::SystemAddress &, class RakNet::RakNetRandom *, class RakNet::BitStream &);
    ...
    MCAPI struct RakNet::ReliabilityLayer::MessageNumberNode * GetMessageNumberNodeByDatagramIndex(struct RakNet::uint24_t, uint64 *);
    ...
    MCAPI uint RemovePacketFromResendListAndDeleteOlderReliableSequenced(struct RakNet::uint24_t, uint64, class DataStructures::List<class RakNet::PluginInterface2 *> &, struct RakNet::SystemAddress const &);
    ...
    MCAPI void SendACKs(class RakNet::RakNetSocket2 *, struct RakNet::SystemAddress &, uint64, class RakNet::RakNetRandom *, class RakNet::BitStream &);
    ...
    MCAPI void SendBitStream(class RakNet::RakNetSocket2 *, struct RakNet::SystemAddress &, class RakNet::BitStream *, class RakNet::RakNetRandom *, uint64);
    ...
    MCAPI uint WriteToBitStreamFromInternalPacket(class RakNet::BitStream *, struct RakNet::InternalPacket const *const, uint64);
