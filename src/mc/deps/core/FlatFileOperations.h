...
public:
    // NOLINTBEGIN
    // symbol: ?copyFlatFile@FlatFileOperations@Core@@SA?AVResult@2@PEAVFileSystemImpl@2@AEBVPath@2@01AEBV?$vector@UExcludedPath@Core@@V?$allocator@UExcludedPath@Core@@@std@@@std@@2@Z
    MCAPI static class Core::Result copyFlatFile(class Core::FileSystemImpl *, class Core::Path const &, class Core::FileSystemImpl *, class Core::Path const &, std::vector<struct Core::ExcludedPath> const &, std::vector<struct Core::ExcludedPath> const &);

    // symbol: ?createFlatFile@FlatFileOperations@Core@@SA?AVResult@2@PEAVFileSystemImpl@2@AEBVPath@2@01AEBV?$vector@UExcludedPath@Core@@V?$allocator@UExcludedPath@Core@@@std@@@std@@_N@Z
    MCAPI static class Core::Result createFlatFile(class Core::FileSystemImpl *, class Core::Path const &, class Core::FileSystemImpl *, class Core::Path const &, std::vector<struct Core::ExcludedPath> const &, bool);

    // symbol: ?replaceFlatFileManifest@FlatFileOperations@Core@@SA?AVResult@2@AEAVFileSystemImpl@2@AEBVPath@2@AEBV?$vector@VFlatFileManifestInfo@Core@@V?$allocator@VFlatFileManifestInfo@Core@@@std@@@std@@_N@Z
    MCAPI static class Core::Result replaceFlatFileManifest(class Core::FileSystemImpl &, class Core::Path const &, std::vector<class Core::FlatFileManifestInfo> const &, bool);
