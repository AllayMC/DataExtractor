...
public:
    ...
    // vIndex: 2, symbol: ?createTransaction@?$BasicDirectoryStorageArea@VFileSystem_windows@Core@@@Core@@UEAA?AV?$unique_ptr@VFileSystemImpl@Core@@U?$default_delete@VFileSystemImpl@Core@@@std@@@std@@W4FileAccessType@2@@Z
    ...
    virtual class Core::Result getUsedSize(uint64_t &);

    // vIndex: 6, symbol: ?setUsedSizeOverride@StorageArea_windows@Core@@UEAAX_K@Z
    virtual void setUsedSizeOverride(uint64_t);
    ...
    // vIndex: 31, symbol: ?getStorageAreaSpaceInfo@StorageArea_windows@Core@@UEAA?AUStorageAreaSpaceInfo@FileStorageArea@2@XZ
