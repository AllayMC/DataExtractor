...
public:
    ...
    // symbol: ?generateRotationAroundPivotMat@MathUtility@mce@@SA?AU?$mat@$03$03M$0A@@glm@@AEBU34@AEBU?$vec@$02M$0A@@4@@Z
    MCAPI static struct glm::mat<4, 4, float, 0> generateRotationAroundPivotMat(struct glm::mat<4, 4, float, 0> const &, struct glm::vec<3, float, 0> const &);
