...
public:
    ...
    public:
        // NOLINTBEGIN
        // vIndex: 0, symbol: ?getData@StorageSystem@FileSecureStorage@@UEAA_NAEAV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@VPath@Core@@@Z
        virtual bool getData(std::string &, class Core::Path);
    
        // vIndex: 1, symbol: ?setData@StorageSystem@FileSecureStorage@@UEAAXAEBV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@VPath@Core@@@Z
    ...
    public:
        // NOLINTBEGIN
        // vIndex: 0, symbol: ?getData@FileStorageSystem@FileSecureStorage@@UEAA_NAEAV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@VPath@Core@@@Z
        virtual bool getData(std::string &, class Core::Path);
    
        // vIndex: 1, symbol: ?setData@FileStorageSystem@FileSecureStorage@@UEAAXAEBV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@VPath@Core@@@Z
        virtual void setData(std::string const &, class Core::Path);
...
public:
    ...
    // vIndex: 1, symbol: ?add@FileSecureStorage@@UEAA_NAEBV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@0@Z
    virtual bool add(std::string const &, std::string const &);

    // vIndex: 2, symbol: ?addOrUpdate@FileSecureStorage@@UEAA_NAEBV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@0@Z
    virtual bool addOrUpdate(std::string const &, std::string const &);

    // vIndex: 3, symbol: ?remove@FileSecureStorage@@UEAA_NAEBV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@Z
    virtual bool remove(std::string const &);

    // vIndex: 4, symbol: ?get@FileSecureStorage@@UEAA_NAEBV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@AEAV23@@Z
