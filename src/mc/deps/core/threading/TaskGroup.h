...
public:
    ...
    // vIndex: 1, symbol: ?queue@TaskGroup@@UEAA?AV?$shared_ptr@V?$IAsyncResult@X@Threading@Bedrock@@@std@@AEBU?$TaskStartInfoEx@X@@$$QEAV?$function@$$A6A?AVTaskResult@@XZ@3@$$QEAV?$function@$$A6AXXZ@3@@Z
    virtual std::shared_ptr<class Bedrock::Threading::IAsyncResult<void>> queue(struct TaskStartInfoEx<void> const &, std::function<class TaskResult (void)> &&, std::function<void (void)> &&);

    // vIndex: 2, symbol: ?queueSync@TaskGroup@@UEAA?AV?$shared_ptr@V?$IAsyncResult@X@Threading@Bedrock@@@std@@AEBU?$TaskStartInfoEx@X@@$$QEAV?$function@$$A6A?AVTaskResult@@XZ@3@@Z
    virtual std::shared_ptr<class Bedrock::Threading::IAsyncResult<void>> queueSync(struct TaskStartInfoEx<void> const &, std::function<class TaskResult (void)> &&);
    ...
    // symbol: ?queue@TaskGroup@@QEAA?AV?$shared_ptr@V?$IAsyncResult@X@Threading@Bedrock@@@std@@V?$basic_string_view@DU?$char_traits@D@std@@@3@$$QEAV?$function@$$A6A?AVTaskResult@@XZ@3@$$QEAV?$function@$$A6AXXZ@3@@Z
    MCAPI std::shared_ptr<class Bedrock::Threading::IAsyncResult<void>> queue(std::string_view, std::function<class TaskResult (void)> &&, std::function<void (void)> &&);

    // symbol: ?queueSync@TaskGroup@@QEAA?AV?$shared_ptr@V?$IAsyncResult@X@Threading@Bedrock@@@std@@V?$basic_string_view@DU?$char_traits@D@std@@@3@$$QEAV?$function@$$A6A?AVTaskResult@@XZ@3@@Z
    MCAPI std::shared_ptr<class Bedrock::Threading::IAsyncResult<void>> queueSync(std::string_view, std::function<class TaskResult (void)> &&);
    ...
    MCAPI static std::shared_ptr<class Bedrock::Threading::IAsyncResult<void>> queueChildSync_DEPRECATED(struct TaskStartInfoEx<void> const &, std::function<class TaskResult (void)> &&);
    ...
    MCAPI static std::shared_ptr<class Bedrock::Threading::IAsyncResult<void>> queueChild_DEPRECATED(struct TaskStartInfoEx<void> const &, std::function<class TaskResult (void)> &&, std::function<void (void)> &&);

    // NOLINTEND

    // private:
    // NOLINTBEGIN
    // symbol: ?_forAllTasks@TaskGroup@@AEAAXAEAV?$UniqueLock@VMutex@Threading@Bedrock@@@Threading@Bedrock@@V?$function@$$A6AXAEBV?$shared_ptr@VBackgroundTaskBase@@@std@@@Z@std@@@Z
    MCAPI void _forAllTasks(class Bedrock::Threading::UniqueLock<class Bedrock::Threading::Mutex> &, std::function<void (std::shared_ptr<class BackgroundTaskBase> const &)>);
