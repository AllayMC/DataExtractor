...
public:
    ...
    MCAPI ResourceInformation(std::string const &, class SemVersion const &, class mce::UUID const &, ::ResourceInformation::ResourceType, std::string const &, std::string const &);
