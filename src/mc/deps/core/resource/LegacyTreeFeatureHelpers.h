...
namespace LegacyTreeFeatureHelpers {
    ...
    MCAPI void _placeTrees(class IBlockWorldGenAPI &, class BlockPos const &, class Random &, int32_t, class RenderParams &, class WeakRefT<struct FeatureRefTraits>, std::function<class WeakRefT<struct FeatureRefTraits> (class Random &)> const &);

    // symbol: ?_setupForestCount@LegacyTreeFeatureHelpers@@YAXMAEAHAEAVRandom@@@Z
    MCAPI void _setupForestCount(float, int32_t &, class Random &);
    // NOLINTEND
