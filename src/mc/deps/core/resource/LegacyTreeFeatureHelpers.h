...
namespace LegacyTreeFeatureHelpers {
    ...
    MCAPI void _placeTrees(class IBlockWorldGenAPI &, class BlockPos const &, class Random &, int, class RenderParams &, class WeakRefT<struct FeatureRefTraits>, std::function<class WeakRefT<struct FeatureRefTraits> (class Random &)> const &);
