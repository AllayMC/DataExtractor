...
public:
    ...
    MCAPI class Bedrock::Result<int64_t, std::error_code> getSignedInt64();
    ...
    MCAPI class Bedrock::Result<uint64_t, std::error_code> getUnsignedInt64();
    ...
    MCAPI class Bedrock::Result<uint64_t, std::error_code> getUnsignedVarInt64();
    ...
    MCAPI class Bedrock::Result<int64_t, std::error_code> getVarInt64();
