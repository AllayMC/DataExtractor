...
namespace Util::Url {
    // NOLINTBEGIN
    // symbol: ?EMPTY_QUERY_PARAMETERS@Url@Util@@3V?$vector@U?$pair@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@V12@@std@@V?$allocator@U?$pair@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@V12@@std@@@2@@std@@B
    ...
    // symbol: ?addUrlSchemeIfNotPresent@Url@Util@@YA?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@AEBV34@0@Z
