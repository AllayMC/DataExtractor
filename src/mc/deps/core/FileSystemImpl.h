...
public:
    ...
    // vIndex: 26, symbol: ?_getDirectoryFiles@FileSystemImpl@Core@@MEAA?AVResult@2@AEAV?$vector@V?$PathBuffer@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@Core@@V?$allocator@V?$PathBuffer@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@Core@@@std@@@std@@AEBVPath@2@@Z
    virtual class Core::Result _getDirectoryFiles(std::vector<class Core::PathBuffer<std::string>> &, class Core::Path const &);

    // vIndex: 27, symbol: ?_getDirectoryFilesRecursively@FileSystemImpl@Core@@MEAA?AVResult@2@AEAV?$vector@V?$PathBuffer@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@Core@@V?$allocator@V?$PathBuffer@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@Core@@@std@@@std@@AEBVPath@2@@Z
    ...
    // vIndex: 39, symbol: ?_flatFileIterateOverDirectory@FileSystemImpl@Core@@MEAA?AVResult@2@AEBVPath@2@0W4DirectoryIterationFlags@2@V?$function@$$A6A?AVResult@Core@@AEBUDirectoryIterationItem@2@@Z@std@@@Z
    virtual class Core::Result _flatFileIterateOverDirectory(class Core::Path const &, class Core::Path const &, ::Core::DirectoryIterationFlags, std::function<class Core::Result (struct Core::DirectoryIterationItem const &)>);
    ...
    // vIndex: 41, symbol: ?_copyFlatFile@FileSystemImpl@Core@@MEAA?AVResult@2@AEBVPath@2@0AEBV?$vector@UExcludedPath@Core@@V?$allocator@UExcludedPath@Core@@@std@@@std@@1@Z
    virtual class Core::Result _copyFlatFile(class Core::Path const &, class Core::Path const &, std::vector<struct Core::ExcludedPath> const &, std::vector<struct Core::ExcludedPath> const &);
    ...
    // symbol: ?requestFlush@FileSystemImpl@Core@@UEAAXAEBV?$vector@UPendingWrite@Core@@V?$allocator@UPendingWrite@Core@@@std@@@std@@@Z
    ...
    // symbol: ??0FileSystemImpl@Core@@QEAA@W4FileAccessType@1@V?$shared_ptr@VFileStorageArea@Core@@@std@@W4TransactionFlags@1@V?$shared_ptr@VFlatFileManifestTracker@Core@@@4@@Z
    MCAPI FileSystemImpl(::Core::FileAccessType, std::shared_ptr<class Core::FileStorageArea>, ::Core::TransactionFlags, std::shared_ptr<class Core::FlatFileManifestTracker>);
    ...
    // symbol: ?getDirectoryFiles@FileSystemImpl@Core@@QEAA?AVResult@2@AEAV?$vector@V?$PathBuffer@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@Core@@V?$allocator@V?$PathBuffer@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@Core@@@std@@@std@@AEBVPath@2@@Z
    MCAPI class Core::Result getDirectoryFiles(std::vector<class Core::PathBuffer<std::string>> &, class Core::Path const &);

    // symbol: ?getDirectoryFilesRecursively@FileSystemImpl@Core@@QEAA?AVResult@2@AEAV?$vector@V?$PathBuffer@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@Core@@V?$allocator@V?$PathBuffer@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@Core@@@std@@@std@@AEBVPath@2@@Z
    ...
    // symbol: ?iterateOverDirectory@FileSystemImpl@Core@@QEAA?AVResult@2@AEBVPath@2@W4DirectoryIterationFlags@2@V?$function@$$A6A?AVResult@Core@@AEBUDirectoryIterationItem@2@@Z@std@@@Z
    MCAPI class Core::Result iterateOverDirectory(class Core::Path const &, ::Core::DirectoryIterationFlags, std::function<class Core::Result (struct Core::DirectoryIterationItem const &)>);

    // symbol: ?openFile@FileSystemImpl@Core@@QEAA?AVResult@2@AEAV?$unique_ptr@VFileImpl@Core@@U?$default_delete@VFileImpl@Core@@@std@@@std@@AEBVPath@2@VFileOpenMode@2@W4FileBufferingMode@2@@Z
    ...
    // private:
    // NOLINTBEGIN
    // symbol: ?_flatFileOpenFlatFile@FileSystemImpl@Core@@AEAA?AVResult@2@AEAV?$unique_ptr@VFileImpl@Core@@U?$default_delete@VFileImpl@Core@@@std@@@std@@AEBVPath@2@1VFileOpenMode@2@W4FileBufferingMode@2@@Z
    MCAPI class Core::Result _flatFileOpenFlatFile(std::unique_ptr<class Core::FileImpl> &, class Core::Path const &, class Core::Path const &, class Core::FileOpenMode, ::Core::FileBufferingMode);
