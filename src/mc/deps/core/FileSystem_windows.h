...
public:
    ...
    // vIndex: 7, symbol: ?_openFile@FileSystem_windows@Core@@MEAA?AVResult@2@AEAV?$unique_ptr@VFileImpl@Core@@U?$default_delete@VFileImpl@Core@@@std@@@std@@AEBVPath@2@VFileOpenMode@2@W4FileBufferingMode@2@@Z
    virtual class Core::Result _openFile(std::unique_ptr<class Core::FileImpl> &, class Core::Path const &, class Core::FileOpenMode, ::Core::FileBufferingMode);
    ...
    virtual class Core::Result _getFileSize(class Core::Path const &, uint64_t *);
    ...
    // vIndex: 25, symbol: ?_iterateOverDirectory@FileSystem_windows@Core@@MEAA?AVResult@2@AEBVPath@2@W4DirectoryIterationFlags@2@V?$function@$$A6A?AVResult@Core@@AEBUDirectoryIterationItem@2@@Z@std@@@Z
    virtual class Core::Result _iterateOverDirectory(class Core::Path const &, ::Core::DirectoryIterationFlags, std::function<class Core::Result (struct Core::DirectoryIterationItem const &)>);
    ...
    virtual class Core::Result _getLastModificationTime(class Core::Path const &, int64_t *);
    ...
    // private:
    // NOLINTBEGIN
    // symbol: ??0FileSystem_windows@Core@@AEAA@W4FileAccessType@1@V?$shared_ptr@VFileStorageArea@Core@@@std@@V?$shared_ptr@VFlatFileManifestTracker@Core@@@4@@Z
    MCAPI FileSystem_windows(::Core::FileAccessType, std::shared_ptr<class Core::FileStorageArea>, std::shared_ptr<class Core::FlatFileManifestTracker>);

    // symbol: ?_iterateOverDirectoryWide@FileSystem_windows@Core@@AEAA?AVResult@2@AEBV?$basic_string@_WU?$char_traits@_W@std@@V?$allocator@_W@2@@std@@W4DirectoryIterationFlags@2@V?$function@$$A6A?AVResult@Core@@AEBUDirectoryIterationItem@2@@Z@5@@Z
    MCAPI class Core::Result _iterateOverDirectoryWide(std::basic_string<wchar_t, std::char_traits<wchar_t>, std::allocator<wchar_t>> const &, ::Core::DirectoryIterationFlags, std::function<class Core::Result (struct Core::DirectoryIterationItem const &)>);
