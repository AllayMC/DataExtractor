...
public:
    ...
    MCVAPI std::shared_ptr<class Bedrock::Threading::IAsyncResult<void>> queue(struct TaskStartInfoEx<void> const &, std::function<class TaskResult (void)> &&, std::function<void (void)> &&);
    ...
    MCVAPI std::shared_ptr<class Bedrock::Threading::IAsyncResult<void>> queueSync(struct TaskStartInfoEx<void> const &, std::function<class TaskResult (void)> &&);
