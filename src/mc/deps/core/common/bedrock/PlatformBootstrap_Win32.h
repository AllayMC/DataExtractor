...
public:
    ...
    // vIndex: 2, symbol: ?getAssetRoot@PlatformBootstrap_Win32@Bedrock@@UEAA?AV?$basic_string_view@DU?$char_traits@D@std@@@std@@XZ
    virtual std::string_view getAssetRoot();

    // vIndex: 3, symbol: ?getSaveDataRoot@PlatformBootstrap_Win32@Bedrock@@UEAA?AV?$basic_string_view@DU?$char_traits@D@std@@@std@@XZ
