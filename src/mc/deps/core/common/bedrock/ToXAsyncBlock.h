...
public:
    ...
    // vIndex: 3, symbol: ?getException@?$AsyncResultBase@PEAUXAsyncBlock@@@Threading@Bedrock@@UEBA?AVexception_ptr@std@@XZ
    ...
    // vIndex: 6, symbol: ?addOnComplete@?$AsyncResultBase@PEAUXAsyncBlock@@@Threading@Bedrock@@UEAAXV?$function@$$A6AXAEBV?$IAsyncResult@PEAUXAsyncBlock@@@Threading@Bedrock@@@Z@std@@@Z
    virtual void addOnComplete(std::function<void (class Bedrock::Threading::IAsyncResult<struct XAsyncBlock *> const &)>);

    // symbol: ?create@ToXAsyncBlock@AsyncResult@Threading@Bedrock@@SA?AV?$shared_ptr@VToXAsyncBlock@AsyncResult@Threading@Bedrock@@@std@@PEAUXTaskQueueObject@@@Z
