...
public:
    ...
    public:
        ...
        // vIndex: 1, symbol: ?getStatus@?$AsyncResultBase@VResponse@Http@Bedrock@@@Threading@Bedrock@@UEBA?AW4AsyncStatus@23@XZ
        virtual ::Bedrock::Threading::AsyncStatus getStatus() const;
    
        // vIndex: 2, symbol: ?getError@?$AsyncResultBase@VResponse@Http@Bedrock@@@Threading@Bedrock@@UEBA?AVerror_code@std@@XZ
        virtual std::error_code getError() const;
    
        // vIndex: 3, symbol: ?getException@?$AsyncResultBase@VResponse@Http@Bedrock@@@Threading@Bedrock@@UEBA?AVexception_ptr@std@@XZ
        virtual std::exception_ptr getException() const;
    
        // vIndex: 4, symbol: ?getResult@?$AsyncResultBase@VResponse@Http@Bedrock@@@Threading@Bedrock@@UEBA?AVResponse@Http@3@XZ
        ...
        // vIndex: 6, symbol: ?addOnComplete@?$AsyncResultBase@VResponse@Http@Bedrock@@@Threading@Bedrock@@UEAAXV?$function@$$A6AXAEBV?$IAsyncResult@VResponse@Http@Bedrock@@@Threading@Bedrock@@@Z@std@@@Z
        virtual void addOnComplete(std::function<void (class Bedrock::Threading::IAsyncResult<class Bedrock::Http::Response> const &)>);
...
public:
    ...
    // vIndex: 1, symbol: ?send@DispatchQueue@Http@Bedrock@@UEAA?AV?$shared_ptr@V?$IAsyncResult@VResponse@Http@Bedrock@@@Threading@Bedrock@@@std@@$$QEAVRequest@23@@Z
    ...
    // private:
    // NOLINTBEGIN
    // symbol: ?_addNewRequest@DispatchQueue@Http@Bedrock@@AEAA?AV?$shared_ptr@V?$IAsyncResult@VResponse@Http@Bedrock@@@Threading@Bedrock@@@std@@$$QEAVRequest@23@@Z
    MCAPI std::shared_ptr<class Bedrock::Threading::IAsyncResult<class Bedrock::Http::Response>> _addNewRequest(class Bedrock::Http::Request &&);
