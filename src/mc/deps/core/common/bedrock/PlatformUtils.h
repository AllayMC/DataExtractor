...
namespace Bedrock::PlatformUtils {
    // NOLINTBEGIN
    // symbol: ?getExternalStoragePath@PlatformUtils@Bedrock@@YAAEBV?$PathBuffer@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@Core@@XZ
    MCAPI class Core::PathBuffer<std::string> const & getExternalStoragePath();

    // symbol: ?getPackageFamilyName@PlatformUtils@Bedrock@@YAAEBV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@XZ
