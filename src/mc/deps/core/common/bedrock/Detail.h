...
namespace Bedrock::Detail {
    ...
    // symbol: ?createContext@Detail@Bedrock@@YA?AUContext@CallStack@2@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@Z
    ...
    // symbol: ?defaultDataStoreLoad@Detail@Bedrock@@YA?AV?$optional@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@std@@AEBVPath@Core@@@Z
