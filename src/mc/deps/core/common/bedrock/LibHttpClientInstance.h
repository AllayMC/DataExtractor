...
public:
    ...
    // private:
    // NOLINTBEGIN
    // symbol: ?_getSharedInstance@LibHttpClientInstance@Http@Bedrock@@CA?AV?$shared_ptr@VLibHttpClientInstance@Http@Bedrock@@@std@@XZ
...
private:
    ...
    // symbol: ?sWeakInstance@LibHttpClientInstance@Http@Bedrock@@0V?$weak_ptr@VLibHttpClientInstance@Http@Bedrock@@@std@@A
