...
public:
    ...
    // vIndex: 1, symbol: ?create@DimensionFactory@@UEBA?AV?$OwnerPtrT@U?$SharePtrRefTraits@VDimension@@@@@@AEBV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@Z
    ...
    MCAPI DimensionFactory(gsl::not_null<class Bedrock::NonOwnerPointer<class ILevel>>, gsl::not_null<class Bedrock::NonOwnerPointer<class Scheduler>>);
