...
public:
    ...
    MCAPI void playSoundForPlayerInDimension(DimensionType, ::LevelSoundEvent, class Vec3 const &, int, struct ActorDefinitionIdentifier const &, bool, bool, class Player *);
