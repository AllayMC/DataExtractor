...
public:
    ...
    MCAPI LevelSoundManager(gsl::not_null<class Bedrock::NonOwnerPointer<class SoundPlayerInterface>> const &, bool, bool);
    ...
    MCAPI void broadcastSoundEvent(class IDimension &, ::LevelSoundEvent, class Vec3 const &, int, struct ActorDefinitionIdentifier const &, bool, bool, class Player *);
    ...
    MCAPI void playPredictiveSynchronizedSound(class IDimension &, ::LevelSoundEvent, class Vec3 const &, class Player *, int, struct ActorDefinitionIdentifier const &, bool, bool);

    // symbol: ?playSound@LevelSoundManager@@QEAAXW4LevelSoundEvent@@AEBVVec3@@HAEBUActorDefinitionIdentifier@@_N3@Z
    MCAPI void playSound(::LevelSoundEvent, class Vec3 const &, int, struct ActorDefinitionIdentifier const &, bool, bool);
    ...
    MCAPI void playSoundForPlayerInDimension(class AutomaticID<class Dimension, int>, ::LevelSoundEvent, class Vec3 const &, int, struct ActorDefinitionIdentifier const &, bool, bool, class Player *);
    ...
    MCAPI void playSynchronizedSound_DEPRECATED(class IDimension &, ::LevelSoundEvent, class Vec3 const &, class Player *, int, struct ActorDefinitionIdentifier const &, bool, bool);
    ...
    MCAPI class Bedrock::PubSub::Subscription registerOnLevelSoundEventCallback(std::function<void (::LevelSoundEvent, class Vec3 const &, int, struct ActorDefinitionIdentifier const &, bool, bool)>);
