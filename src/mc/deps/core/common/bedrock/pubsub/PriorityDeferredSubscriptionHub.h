...
public:
    ...
    // vIndex: 8, symbol: ?getHubType@PriorityDeferredSubscriptionHub@PubSub@Bedrock@@UEBA?AW4HubType@DeferredSubscriptionHub@23@XZ
    ...
    // vIndex: 12, symbol: ?_runDequeuedEntry@PriorityDeferredSubscriptionHub@PubSub@Bedrock@@MEAAXAEBUDequeuedEntry@123@@Z
