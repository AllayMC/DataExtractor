...
public:
    ...
    // symbol: ?deleteActorEntityFromWorldAndTakeEntity@ActorManager@@QEAA?AV?$OwnerPtrT@UEntityRefTraits@@@@VWeakEntityRef@@@Z
    ...
    MCAPI void initializeWithActorGarbageCollector(gsl::not_null<class Bedrock::NonOwnerPointer<class ActorGarbageCollector>>);
    ...
    MCAPI class Bedrock::PubSub::Subscription registerPostReloadActor(std::function<void (class Actor &, ::InitializationMethod)>);
