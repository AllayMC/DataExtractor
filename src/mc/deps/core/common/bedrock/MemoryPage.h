...
public:
    ...
    MCAPI MemoryPage(class gsl::not_null<class Bedrock::JSONObject::Document *>, class Bedrock::JSONObject::MemoryPage *, uint32_t, uint32_t);
    ...
    MCAPI void * _allocate(uint64_t (__cdecl Bedrock::JSONObject::MemoryPage::*)(uint64_t, uint64_t), void * (__cdecl Bedrock::JSONObject::MemoryPage::*)(uint64_t, uint64_t), uint64_t, uint64_t);
