...
public:
    ...
    // symbol: ?name@SerializerTraits@cereal@@QEAAAEAU12@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@Z
    MCAPI struct cereal::SerializerTraits & name(std::string);

    // symbol: ?setEnumDocumentation@SerializerTraits@cereal@@QEAAXV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@Z
