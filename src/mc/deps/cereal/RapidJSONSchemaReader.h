...
public:
    ...
    // vIndex: 15, symbol: ?asString@RapidJSONSchemaReader@cereal@@UEAA?AV?$optional@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@std@@AEBUSerializerTraits@2@@Z
    ...
    MCAPI RapidJSONSchemaReader(rapidjson::GenericValue<rapidjson::UTF8<char>, rapidjson::MemoryPoolAllocator<rapidjson::CrtAllocator>> const &);
