...
public:
    ...
    public:
        ...
        MCAPI class JsonValidator::Property & addConditionalProperty(class Json::Value const &, class JsonValidator::Property const &);
    
        // symbol: ?addType@Property@JsonValidator@@QEAAAEAV12@W4ValueType@Json@@@Z
        MCAPI class JsonValidator::Property & addType(::Json::ValueType);
    
        // symbol: ?description@Property@JsonValidator@@QEAAAEAV12@AEBV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@Z
        ...
        // symbol: ??AProperty@JsonValidator@@QEAAAEAV01@AEBV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@Z
