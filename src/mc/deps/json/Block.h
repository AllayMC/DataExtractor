...
namespace RapidJsonDataFixers::Block {
    ...
    MCAPI bool applyLambdaToComponentObject(class rapidjson::GenericDocument<struct rapidjson::UTF8<char>, class rapidjson::MemoryPoolAllocator<class rapidjson::CrtAllocator>, class rapidjson::CrtAllocator> &, std::string const &, std::function<void (class rapidjson::GenericValue<struct rapidjson::UTF8<char>, class rapidjson::MemoryPoolAllocator<class rapidjson::CrtAllocator>> &)> const &);
    ...
    MCAPI void legacyFindIfMissingFieldAndRemoveComponent(class rapidjson::GenericMemberIterator<0, struct rapidjson::UTF8<char>, class rapidjson::MemoryPoolAllocator<class rapidjson::CrtAllocator>>, std::string const &, std::string const &);
    ...
    MCAPI void legacyRemoveComponentIfMissingField(class rapidjson::GenericDocument<struct rapidjson::UTF8<char>, class rapidjson::MemoryPoolAllocator<class rapidjson::CrtAllocator>, class rapidjson::CrtAllocator> &, std::string const &, std::string const &);
    ...
    MCAPI void removeComponent(class rapidjson::GenericDocument<struct rapidjson::UTF8<char>, class rapidjson::MemoryPoolAllocator<class rapidjson::CrtAllocator>, class rapidjson::CrtAllocator> &, std::string const &, bool, std::string const &);
    ...
    MCAPI void removeComponentField(class rapidjson::GenericDocument<struct rapidjson::UTF8<char>, class rapidjson::MemoryPoolAllocator<class rapidjson::CrtAllocator>, class rapidjson::CrtAllocator> &, std::string const &, std::string const &);
    ...
    MCAPI void removeDuplicateComponents(class rapidjson::GenericDocument<struct rapidjson::UTF8<char>, class rapidjson::MemoryPoolAllocator<class rapidjson::CrtAllocator>, class rapidjson::CrtAllocator> &);
    ...
    MCAPI void removeDuplicateComponentsInComponentsSection(class rapidjson::GenericMemberIterator<0, struct rapidjson::UTF8<char>, class rapidjson::MemoryPoolAllocator<class rapidjson::CrtAllocator>> &);
    ...
    MCAPI void renameComponent(class rapidjson::GenericDocument<struct rapidjson::UTF8<char>, class rapidjson::MemoryPoolAllocator<class rapidjson::CrtAllocator>, class rapidjson::CrtAllocator> &, std::string const &, std::string const &);
    ...
    MCAPI void renameComponentField(class rapidjson::GenericDocument<struct rapidjson::UTF8<char>, class rapidjson::MemoryPoolAllocator<class rapidjson::CrtAllocator>, class rapidjson::CrtAllocator> &, std::string const &, std::string const &, std::string const &);
    ...
    MCAPI void replaceComponentObjectWithFieldValue(class rapidjson::GenericDocument<struct rapidjson::UTF8<char>, class rapidjson::MemoryPoolAllocator<class rapidjson::CrtAllocator>, class rapidjson::CrtAllocator> &, std::string const &, std::string const &);
    // NOLINTEND
