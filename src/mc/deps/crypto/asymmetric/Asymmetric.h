...
public:
    ...
    // vIndex: 1, symbol: ?generateKeyPair@Asymmetric@1Crypto@@UEAA_NAEAV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@0@Z
    virtual bool generateKeyPair(std::string &, std::string &);

    // vIndex: 2, symbol: ?encryptData@Asymmetric@1Crypto@@UEAA?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@AEBV34@0W4Padding@12@W4PubKeyFormat@12@@Z
    ...
    // vIndex: 3, symbol: ?decryptData@Asymmetric@1Crypto@@UEAA?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@AEBV34@0W4Padding@12@@Z
    virtual std::string decryptData(std::string const &, std::string const &, ::Crypto::Asymmetric::Padding);

    // vIndex: 4, symbol: ?signData@Asymmetric@1Crypto@@UEAA?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@AEBV34@0W4HashType@Hash@2@@Z
    virtual std::string signData(std::string const &, std::string const &, ::Crypto::Hash::HashType);

    // vIndex: 5, symbol: ?verifyData@Asymmetric@1Crypto@@UEAA_NAEBV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@00W4HashType@Hash@2@@Z
    virtual bool verifyData(std::string const &, std::string const &, std::string const &, ::Crypto::Hash::HashType);

    // vIndex: 6, symbol: ?computeSharedSecret@Asymmetric@1Crypto@@UEAA?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@AEBV34@0@Z
