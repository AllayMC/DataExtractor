...
namespace Crypto::Hash {
    // NOLINTBEGIN
    // symbol: ?generateUUID@Hash@Crypto@@YA?AVUUID@mce@@AEBV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@W4HashType@12@@Z
