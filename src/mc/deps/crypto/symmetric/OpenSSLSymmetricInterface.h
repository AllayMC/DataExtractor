...
public:
    ...
    // vIndex: 1, symbol: ?init@OpenSSLSymmetricInterface@Symmetric@Crypto@@UEAAXAEBV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@0@Z
    virtual void init(std::string const &, std::string const &);

    // vIndex: 2, symbol: ?encrypt@OpenSSLSymmetricInterface@Symmetric@Crypto@@UEAAXAEBV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@AEAV45@@Z
    virtual void encrypt(std::string const &, std::string &);

    // vIndex: 3, symbol: ?decrypt@OpenSSLSymmetricInterface@Symmetric@Crypto@@UEAAXAEBV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@AEAV45@@Z
    ...
    // vIndex: 7, symbol: ?encryptToBuffer@OpenSSLSymmetricInterface@Symmetric@Crypto@@UEAA_NV?$span@$$CBD$0?0@gsl@@V?$span@D$0?0@5@AEA_K@Z
