...
namespace xbox::httpclient {
    ...
    MCAPI long WebSocketppSendBinaryMessageAsync(struct HC_WEBSOCKET_OBSERVER *, uchar const *, uint, struct XAsyncBlock *, void *);
    ...
    MCAPI http_wstring flatten_http_headers(std::map<http_string, http_string, struct xbox::httpclient::HeaderCompare, class http_stl_allocator<std::pair<http_string const, http_string>>> const &);
