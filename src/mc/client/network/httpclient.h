...
namespace xbox::httpclient {
    // NOLINTBEGIN
    // symbol: ?BasicAsciiLowercase@httpclient@xbox@@YAXAEAV?$basic_string@DU?$char_traits@D@std@@V?$http_stl_allocator@D@@@std@@@Z
    ...
    // symbol: ?WebSocketppConnectAsync@httpclient@xbox@@YAJPEBD0PEAUHC_WEBSOCKET_OBSERVER@@PEAUXAsyncBlock@@PEAXPEAUHC_PERFORM_ENV@@@Z
    MCAPI long WebSocketppConnectAsync(char const *, char const *, struct HC_WEBSOCKET_OBSERVER *, struct XAsyncBlock *, void *, struct HC_PERFORM_ENV *);
    ...
    // symbol: ?WebSocketppSendBinaryMessageAsync@httpclient@xbox@@YAJPEAUHC_WEBSOCKET_OBSERVER@@PEBEIPEAUXAsyncBlock@@PEAX@Z
    MCAPI long WebSocketppSendBinaryMessageAsync(struct HC_WEBSOCKET_OBSERVER *, uint8_t const *, uint32_t, struct XAsyncBlock *, void *);
    ...
    MCAPI std::basic_string<wchar_t, std::char_traits<wchar_t>, class http_stl_allocator<wchar_t>> flatten_http_headers(std::map<std::basic_string<char, std::char_traits<char>, class http_stl_allocator<char>>, std::basic_string<char, std::char_traits<char>, class http_stl_allocator<char>>, struct xbox::httpclient::HeaderCompare, class http_stl_allocator<std::pair<std::basic_string<char, std::char_traits<char>, class http_stl_allocator<char>> const, std::basic_string<char, std::char_traits<char>, class http_stl_allocator<char>>>>> const &);
    ...
    MCAPI ::xbox::httpclient::proxy_type get_ie_proxy_info(::xbox::httpclient::proxy_protocol, class xbox::httpclient::Uri &);

    // symbol: ?trim_whitespace@httpclient@xbox@@YAXAEAV?$basic_string@_WU?$char_traits@_W@std@@V?$http_stl_allocator@_W@@@std@@@Z
    MCAPI void trim_whitespace(std::basic_string<wchar_t, std::char_traits<wchar_t>, class http_stl_allocator<wchar_t>> &);

    // symbol: ?verify_cert_chain_platform_specific@httpclient@xbox@@YA_NAEAVverify_context@ssl@asio@@AEBV?$basic_string@DU?$char_traits@D@std@@V?$http_stl_allocator@D@@@std@@@Z
    MCAPI bool verify_cert_chain_platform_specific(class asio::ssl::verify_context &, std::basic_string<char, std::char_traits<char>, class http_stl_allocator<char>> const &);
    // NOLINTEND
