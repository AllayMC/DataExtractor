...
public:
    ...
    // symbol: ?HttpCallPerformAsyncHandler@WinHttpProvider@httpclient@xbox@@SAXPEAUHC_CALL@@PEAUXAsyncBlock@@PEAXPEAUHC_PERFORM_ENV@@@Z
    MCAPI static void HttpCallPerformAsyncHandler(struct HC_CALL *, struct XAsyncBlock *, void *, struct HC_PERFORM_ENV *);

    // symbol: ?Initialize@WinHttpProvider@httpclient@xbox@@SA?AV?$Result@V?$shared_ptr@VWinHttpProvider@httpclient@xbox@@@std@@@@XZ
    MCAPI static class Result<std::shared_ptr<class xbox::httpclient::WinHttpProvider>> Initialize();

    // symbol: ?WebSocketConnectAsyncHandler@WinHttpProvider@httpclient@xbox@@SAJPEBD0PEAUHC_WEBSOCKET_OBSERVER@@PEAUXAsyncBlock@@PEAXPEAUHC_PERFORM_ENV@@@Z
    MCAPI static long WebSocketConnectAsyncHandler(char const *, char const *, struct HC_WEBSOCKET_OBSERVER *, struct XAsyncBlock *, void *, struct HC_PERFORM_ENV *);

    // symbol: ?WebSocketDisconnectHandler@WinHttpProvider@httpclient@xbox@@SAJPEAUHC_WEBSOCKET_OBSERVER@@W4HCWebSocketCloseStatus@@PEAX@Z
    MCAPI static long WebSocketDisconnectHandler(struct HC_WEBSOCKET_OBSERVER *, ::HCWebSocketCloseStatus, void *);

    // symbol: ?WebSocketSendAsyncHandler@WinHttpProvider@httpclient@xbox@@SAJPEAUHC_WEBSOCKET_OBSERVER@@PEBDPEAUXAsyncBlock@@PEAX@Z
    ...
    // symbol: ?WebSocketConnectAsync@WinHttpProvider@httpclient@xbox@@AEAAJPEBD0PEAUHC_WEBSOCKET_OBSERVER@@PEAUXAsyncBlock@@@Z
