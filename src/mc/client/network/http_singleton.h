...
public:
    ...
    // private:
    // NOLINTBEGIN
    // symbol: ?singleton_access@http_singleton@httpclient@xbox@@CAJW4singleton_access_mode@123@PEAUHCInitArgs@@AEAV?$shared_ptr@Uhttp_singleton@httpclient@xbox@@@std@@@Z
    MCAPI static long singleton_access(::xbox::httpclient::http_singleton::singleton_access_mode, struct HCInitArgs *, std::shared_ptr<struct xbox::httpclient::http_singleton> &);
