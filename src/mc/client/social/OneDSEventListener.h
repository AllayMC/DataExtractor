...
public:
    ...
    // protected:
    // NOLINTBEGIN
    // symbol: ?_buildEventPayloads@OneDSEventListener@Events@Social@@IEAA?AV?$vector@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@V?$allocator@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@2@@std@@V?$vector@VEvent@Events@Social@@V?$allocator@VEvent@Events@Social@@@std@@@5@V?$function@$$A6AXAEBV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@0@Z@5@@Z
    MCAPI std::vector<std::string> _buildEventPayloads(std::vector<class Social::Events::Event>, std::function<void (std::string const &, std::string const &)>);

    // NOLINTEND

    // private:
    // NOLINTBEGIN
    // symbol: ?AddPartA@OneDSEventListener@Events@Social@@AEAAXAEBV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@AEAVValue@Json@@_N@Z
    ...
    // symbol: ?_sendEvents@OneDSEventListener@Events@Social@@AEAAXAEBV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@0@Z
...
private:
    // NOLINTBEGIN
    // symbol: ?ENDPOINT_IDENTIFIER@OneDSEventListener@Events@Social@@0V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@B
    MCAPI static std::string const ENDPOINT_IDENTIFIER;

    // symbol: ?ONEDS_URL@OneDSEventListener@Events@Social@@0V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@B
    MCAPI static std::string const ONEDS_URL;

    // symbol: ?PARTA_IDENTIFIER@OneDSEventListener@Events@Social@@0V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@B
    MCAPI static std::string const PARTA_IDENTIFIER;

    // symbol: ?SAFETY_ENDPOINT_IDENTIFIER@OneDSEventListener@Events@Social@@0V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@B
    MCAPI static std::string const SAFETY_ENDPOINT_IDENTIFIER;

    // symbol: ?SAFETY_PARTA_IDENTIFIER@OneDSEventListener@Events@Social@@0V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@B
