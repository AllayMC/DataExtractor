...
public:
    ...
    public:
        ...
        MCAPI struct DynamicProperties::PropertyCollection & operator=(struct DynamicProperties::PropertyCollection const &);
        ...
        MCAPI static void fromVariantMap(struct DynamicProperties::PropertyCollection &, std::unordered_map<std::string,std::variant<double, float, bool, std::string, class Vec3>> const &);
        ...
        MCAPI static std::unordered_map<std::string,std::variant<double, float, bool, std::string, class Vec3>> toVariantMap(struct DynamicProperties::PropertyCollection const &);
...
public:
    ...
    // symbol: ?clearCollection@DynamicProperties@@QEAAXAEBV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@Z
    ...
    // symbol: ?getDynamicPropertyIds@DynamicProperties@@QEAA?AV?$vector@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@V?$allocator@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@2@@std@@AEBV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@3@@Z
    ...
    // symbol: ?setDynamicProperty@DynamicProperties@@QEAAXAEBV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@AEBV?$variant@NM_NV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@VVec3@@@3@0@Z
    MCAPI void setDynamicProperty(std::string const &, std::variant<double, float, bool, std::string, class Vec3> const &, std::string const &);
    ...
    // symbol: ?validateDynamicProperty@DynamicProperties@@SA?AV?$optional@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@std@@AEBV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@3@PEBV?$variant@NM_NV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@VVec3@@@3@@Z
    MCAPI static std::optional<std::string> validateDynamicProperty(std::string const &, std::variant<double, float, bool, std::string, class Vec3> const *);

    // symbol: ?validateDynamicProperty_V010@DynamicProperties@@SA?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@PEBUDynamicPropertyDefinition@@AEBV23@PEBV?$variant@NM_NV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@VVec3@@@3@@Z
    MCAPI static std::string validateDynamicProperty_V010(struct DynamicPropertyDefinition const *, std::string const &, std::variant<double, float, bool, std::string, class Vec3> const *);
