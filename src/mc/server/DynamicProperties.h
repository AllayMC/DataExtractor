...
public:
    ...
    MCAPI std::variant<float, bool, std::string, class Vec3> * getDynamicProperty(std::string const &, std::string const &);
    ...
    MCAPI void setDynamicProperty(std::string const &, std::variant<float, bool, std::string, class Vec3> const &, std::string const &);
    ...
    MCAPI static std::string validateDynamicProperty(struct DynamicPropertyDefinition const *, std::string const &, std::variant<float, bool, std::string, class Vec3> const *);
