...
public:
    ...
    MCAPI static std::vector<class Vec2> createInitialPositions(class Random &, int32_t, class Vec2 const &, class Vec2 const &);
    ...
    MCAPI static bool spreadPositions(class CommandOutput &, class Random &, class CommandOrigin const &, class Vec2 const &, float, class Vec2 const &, class Vec2 const &, std::vector<class Vec2> &, std::map<class ChunkPos,std::unique_ptr<class CommandArea>> &, int32_t);
    ...
    MCAPI static bool _checkPositionValid(class CommandOrigin const &, class BlockPos const &, std::map<class ChunkPos,std::unique_ptr<class CommandArea>> &, int32_t);
    ...
    MCAPI static float _setPlayerPositions(class CommandSelectorResults<class Actor> &, std::vector<class Vec2> &, std::map<class ChunkPos,std::unique_ptr<class CommandArea>> &);
    ...
    MCAPI static bool _spreadEntities(class CommandOutput &, class CommandSelectorResults<class Actor> &, class CommandOrigin const &, class Vec2 const &, float, float, int32_t);
