...
public:
    ...
    MCAPI static bool spreadPositions(class CommandOutput &, class Random &, class CommandOrigin const &, class Vec2 const &, float, class Vec2 const &, class Vec2 const &, std::vector<class Vec2> &, std::map<class ChunkPos,std::unique_ptr<class CommandArea>> &, int);
    ...
    MCAPI static bool _checkPositionValid(class CommandOrigin const &, class BlockPos const &, std::map<class ChunkPos,std::unique_ptr<class CommandArea>> &, int);
