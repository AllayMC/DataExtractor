...
public:
    ...
    public:
        ...
        // vIndex: 1, symbol: ?getCommandName@ExecuteChainedSubcommand@NewExecuteCommand@@UEBA?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@XZ
        virtual std::string getCommandName() const;
    
        // symbol: ?getSubcommandName@ExecuteChainedSubcommand@NewExecuteCommand@@SA?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@W4Subcommand@12@@Z
...
public:
    ...
    MCAPI bool _detectConditionSubcommand(class CommandOrigin const &, class CommandOutput &, std::optional<int32_t> &) const;
    ...
    MCAPI std::optional<struct ScoreInfo> _getScoreFromSelectorOnObjective(class Scoreboard const &, class CommandSelector<class Actor> const &, std::string const &, class CommandOrigin const &, class CommandOutput &) const;
    ...
    MCAPI std::optional<struct ScoreboardId> _getScoreboardIdForSelector(class Scoreboard const &, class CommandSelector<class Actor> const &, class CommandOrigin const &, class CommandOutput &) const;
