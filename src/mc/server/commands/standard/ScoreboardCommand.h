...
public:
    ...
    MCAPI void addPlayerScore(class Scoreboard &, ::PlayerScoreSetFunction, struct ScoreboardId const &, class Objective &, std::function<std::string const & (struct ActorUniqueID)> const &, class CommandOutput &, struct ScoreboardCommand::SetScoreOutput &) const;
    ...
    MCAPI bool applyPlayerOperation(class Scoreboard &, std::function<std::string const & (struct ActorUniqueID)> const &, struct ScoreboardId const &, class Objective &, class Objective &, class CommandOrigin const &, class CommandOutput &, struct ScoreboardCommand::SetScoreOutput &) const;
    ...
    MCAPI void listPlayers(class Scoreboard &, struct ScoreboardId const &, std::function<std::string const & (struct ActorUniqueID)> const &, class CommandOutput &) const;
    ...
    MCAPI void resetPlayer(class Scoreboard &, struct ScoreboardId const &, class Objective *, std::function<std::string const & (struct ActorUniqueID)> const &, class CommandOutput &) const;
    ...
    MCAPI void setDisplayObjective(class Scoreboard &, std::string const &, std::string const &, ::ObjectiveSortOrder, class CommandOutput &) const;
    ...
    MCAPI bool setPlayerRandomScore(class Scoreboard &, struct ScoreboardId const &, class Objective &, std::function<std::string const & (struct ActorUniqueID)> const &, class CommandOutput &, struct ScoreboardCommand::SetScoreOutput &) const;
    ...
    MCAPI void testPlayerScore(struct ScoreboardId const &, class Objective &, std::function<std::string const & (struct ActorUniqueID)> const &, class CommandOutput &) const;
