...
public:
    ...
    MCAPI class Command * compileCommand(class HashedString const &, class CommandOrigin &, ::CurrentCmdVersion, std::function<void (std::string const &)>);
    ...
    MCAPI void enqueueDeferredCommand(std::unique_ptr<class CommandContext>, bool, bool, std::function<void (struct MCRESULT)>);
