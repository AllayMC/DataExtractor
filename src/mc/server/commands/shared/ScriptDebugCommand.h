...
public:
    ...
    MCAPI void _handleDebuggerAttach(class IScriptDebugger *, std::string const &, ::ScriptDebugCommand::DebuggerAction, std::string const &, uint16_t, class CommandOutput &) const;
    ...
    MCAPI void _handleProfilerAction(class IScriptDebugger *, std::string const &, ::ScriptDebugCommand::ProfilerAction, class CommandOutput &) const;
    ...
    MCAPI void _handleWatchdogAction(class IScriptDebugger *, std::string const &, ::ScriptDebugCommand::WatchdogAction, class CommandOutput &) const;
