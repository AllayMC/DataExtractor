...
public:
    ...
    MCAPI void _handleDebuggerAttach(class IScriptDebugger *, std::string const &, ::ScriptDebugCommand::DebuggerAction, std::string const &, ushort, class CommandOutput &) const;
