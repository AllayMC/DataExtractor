...
public:
    ...
    // symbol: ?getFunctionNameFromPath@FunctionManager@@SA?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@AEBVPath@Core@@@Z
    ...
    MCAPI void _processFunctionEntry(std::string const &, std::vector<std::string> const &, std::vector<std::string> &, ::CurrentCmdVersion, class CommandRegistry const &);
