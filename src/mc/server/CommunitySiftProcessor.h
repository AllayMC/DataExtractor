...
public:
    ...
    // vIndex: 1, symbol: ?processAnonymousMessages@CommunitySiftProcessor@@UEAA?AVCallbackToken@@PEAVIMinecraftEventing@@W4TextProcessingEventOrigin@@AEBV?$vector@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@V?$allocator@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@2@@std@@V?$function@$$A6AXAEBV?$vector@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@V?$allocator@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@2@@std@@AEBV?$vector@W4TextFilteringEvent@Safety@@V?$allocator@W4TextFilteringEvent@Safety@@@std@@@2@@Z@6@@Z
    virtual class CallbackToken processAnonymousMessages(class IMinecraftEventing *, ::TextProcessingEventOrigin, std::vector<std::string> const &, std::function<void (std::vector<std::string> const &, std::vector<::Safety::TextFilteringEvent> const &)>);

    // vIndex: 2, symbol: ?processMessages@CommunitySiftProcessor@@UEAA?AVCallbackToken@@AEBVPlayer@@W4TextProcessingEventOrigin@@AEBV?$vector@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@V?$allocator@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@2@@std@@V?$function@$$A6AXAEBV?$vector@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@V?$allocator@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@2@@std@@AEBV?$vector@W4TextFilteringEvent@Safety@@V?$allocator@W4TextFilteringEvent@Safety@@@std@@@2@@Z@6@@Z
    virtual class CallbackToken processMessages(class Player const &, ::TextProcessingEventOrigin, std::vector<std::string> const &, std::function<void (std::vector<std::string> const &, std::vector<::Safety::TextFilteringEvent> const &)>);

    // vIndex: 3, symbol: ?processAnonymousNonChatText@CommunitySiftProcessor@@UEAA?AVCallbackToken@@PEAVIMinecraftEventing@@W4TextProcessingEventOrigin@@AEBV?$vector@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@V?$allocator@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@2@@std@@V?$function@$$A6AXAEBV?$vector@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@V?$allocator@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@2@@std@@AEBV?$vector@W4TextFilteringEvent@Safety@@V?$allocator@W4TextFilteringEvent@Safety@@@std@@@2@@Z@6@@Z
    virtual class CallbackToken processAnonymousNonChatText(class IMinecraftEventing *, ::TextProcessingEventOrigin, std::vector<std::string> const &, std::function<void (std::vector<std::string> const &, std::vector<::Safety::TextFilteringEvent> const &)>);

    // vIndex: 4, symbol: ?processNonChatText@CommunitySiftProcessor@@UEAA?AVCallbackToken@@AEBVPlayer@@W4TextProcessingEventOrigin@@AEBV?$vector@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@V?$allocator@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@2@@std@@V?$function@$$A6AXAEBV?$vector@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@V?$allocator@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@2@@std@@AEBV?$vector@W4TextFilteringEvent@Safety@@V?$allocator@W4TextFilteringEvent@Safety@@@std@@@2@@Z@6@@Z
    virtual class CallbackToken processNonChatText(class Player const &, ::TextProcessingEventOrigin, std::vector<std::string> const &, std::function<void (std::vector<std::string> const &, std::vector<::Safety::TextFilteringEvent> const &)>);
    ...
    MCAPI std::shared_ptr<class Bedrock::Threading::IAsyncResult<void>> _createRequest(std::string const &, std::string const &, class IMinecraftEventing *, std::string const &, ::TextProcessingEventOrigin, std::shared_ptr<std::vector<std::pair<int32_t, std::string>>>, std::shared_ptr<std::vector<::Safety::TextFilteringEvent>>, bool, std::string const &, int32_t);
    ...
    MCAPI class CallbackToken _processMessages(std::string, std::string, class IMinecraftEventing *, bool, ::TextProcessingEventOrigin, std::vector<std::string> const &, std::string const &, std::function<void (std::vector<std::string> const &, std::vector<::Safety::TextFilteringEvent> const &)>);
    ...
    // symbol: ?_processJsonEvents@CommunitySiftProcessor@@CA?BV?$vector@W4TextFilteringEvent@Safety@@V?$allocator@W4TextFilteringEvent@Safety@@@std@@@std@@AEBV?$vector@VValue@Json@@V?$allocator@VValue@Json@@@std@@@3@MW4ChatFloodingAction@Safety@@@Z
    MCAPI static std::vector<::Safety::TextFilteringEvent> const _processJsonEvents(std::vector<class Json::Value> const &, float, ::Safety::ChatFloodingAction);
