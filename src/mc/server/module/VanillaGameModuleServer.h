...
public:
    ...
    virtual void initializeBehaviorStack(class Experiments const &, Bedrock::NotNullNonOwnerPtr<class IResourcePackRepository> const &, class ResourcePackStack &, class BaseGameVersion const &);
    ...
    virtual void configureLevel(Bedrock::NotNullNonOwnerPtr<class Level> const &, class Experiments const &, class ResourcePackManager &, class BaseGameVersion const &);
    ...
    virtual void configureServerNetworkHandler(class ServerInstance &, Bedrock::NotNullNonOwnerPtr<class ServerNetworkHandler>);
    ...
    MCAPI void _configureEntitySystems(Bedrock::NotNullNonOwnerPtr<class Level> const &, class ResourcePackManager &, class Experiments const &, struct VanillaSystemsRegistration::RegistrationOptions const &);
