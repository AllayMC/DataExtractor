...
public:
    ...
    // vIndex: 1, symbol: ?init@VanillaGameModuleServer@@UEAAXAEAVServerInstance@@AEBV?$not_null@V?$NonOwnerPointer@VLevel@@@Bedrock@@@gsl@@@Z
    virtual void init(class ServerInstance &, gsl::not_null<class Bedrock::NonOwnerPointer<class Level>> const &);

    // vIndex: 2, symbol: ?initializeBehaviorStack@VanillaGameModuleServer@@UEAAXAEBVExperiments@@AEBV?$not_null@V?$NonOwnerPointer@VIResourcePackRepository@@@Bedrock@@@gsl@@AEAVResourcePackStack@@AEBVBaseGameVersion@@@Z
    virtual void initializeBehaviorStack(class Experiments const &, gsl::not_null<class Bedrock::NonOwnerPointer<class IResourcePackRepository>> const &, class ResourcePackStack &, class BaseGameVersion const &);

    // vIndex: 3, symbol: ?configureLevel@VanillaGameModuleServer@@UEAAXAEBV?$not_null@V?$NonOwnerPointer@VLevel@@@Bedrock@@@gsl@@AEBVExperiments@@AEAVResourcePackManager@@AEBVBaseGameVersion@@@Z
    virtual void configureLevel(gsl::not_null<class Bedrock::NonOwnerPointer<class Level>> const &, class Experiments const &, class ResourcePackManager &, class BaseGameVersion const &);

    // vIndex: 4, symbol: __unk_vfn_4
    virtual void __unk_vfn_4();

    // vIndex: 5, symbol: ?configureDocumentation@VanillaGameModuleServer@@UEAAXAEAVIGameModuleDocumentation@@VItemRegistryRef@@@Z
    ...
    // vIndex: 8, symbol: ?configureServerNetworkHandler@VanillaGameModuleServer@@UEAAXAEAVServerInstance@@V?$not_null@V?$NonOwnerPointer@VServerNetworkHandler@@@Bedrock@@@gsl@@@Z
    virtual void configureServerNetworkHandler(class ServerInstance &, gsl::not_null<class Bedrock::NonOwnerPointer<class ServerNetworkHandler>>);
    ...
    MCAPI void _configureEntitySystems(gsl::not_null<class Bedrock::NonOwnerPointer<class Level>> const &, class ResourcePackManager &, class Experiments const &, struct VanillaSystemsRegistration::RegistrationOptions const &);
