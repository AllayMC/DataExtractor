...
public:
    ...
    MCAPI ServerInstance(class IMinecraftApp &, gsl::not_null<class Bedrock::NonOwnerPointer<class ServerInstanceEventCoordinator>> const &);
