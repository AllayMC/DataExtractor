...
public:
    ...
    DynamicPropertiesManager& operator=(DynamicPropertiesManager const &) = delete;
    DynamicPropertiesManager(DynamicPropertiesManager const &) = delete;
...
public:
    ...
    // symbol: ?registerLevelStorageManagerListener@DynamicPropertiesManager@@QEAAXAEAVLevelStorageManager@@AEBUReflectionCtx@cereal@@@Z
