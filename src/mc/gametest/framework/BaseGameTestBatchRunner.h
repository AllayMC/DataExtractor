...
public:
    ...
    virtual std::shared_ptr<class gametest::BaseGameTestInstance> _createGameTestInstance(class gametest::BaseGameTestFunction &) = 0;
    ...
    // symbol: ??0BaseGameTestBatchRunner@gametest@@QEAA@$$QEAV?$vector@VGameTestBatch@gametest@@V?$allocator@VGameTestBatch@gametest@@@std@@@std@@AEAVGameTestTicker@1@$$QEAUTestParameters@1@@Z
    MCAPI BaseGameTestBatchRunner(std::vector<class gametest::GameTestBatch> &&, class gametest::GameTestTicker &, struct gametest::TestParameters &&);
    ...
    // private:
    // NOLINTBEGIN
    // symbol: ?_addTestInstanceWithRotation@BaseGameTestBatchRunner@gametest@@AEAAXAEAV?$vector@V?$shared_ptr@VBaseGameTestInstance@gametest@@@std@@V?$allocator@V?$shared_ptr@VBaseGameTestInstance@gametest@@@std@@@2@@std@@V?$shared_ptr@VBaseGameTestFunction@gametest@@@4@W4Rotation@@@Z
    MCAPI void _addTestInstanceWithRotation(std::vector<std::shared_ptr<class gametest::BaseGameTestInstance>> &, std::shared_ptr<class gametest::BaseGameTestFunction>, ::Rotation);
