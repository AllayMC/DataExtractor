...
public:
    ...
    MCAPI static void appendLanguageStringsFromPack(class PackManifest const &, std::multimap<std::string, std::pair<std::string, std::string>, std::less<std::string>, std::allocator<std::pair<std::string const, std::pair<std::string, std::string>>>> const &);
    ...
    MCAPI static void _findAvailableLanguageNames(class Json::Value const &, std::unordered_map<std::string,std::string> &);
