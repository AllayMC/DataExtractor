...
public:
    ...
    // symbol: ?addInventoryTransactionPacket@ServerPlayerMovementComponent@@QEAA_NV?$shared_ptr@VInventoryTransactionPacket@@@std@@@Z
    ...
    // symbol: ?getOrCreate@ServerPlayerMovementComponent@@QEAA?AV?$optional_ref@UMovementPackets@@@@AEBV?$function@$$A6A_NAEAUMovementPackets@@@Z@std@@@Z
    MCAPI class optional_ref<struct MovementPackets> getOrCreate(std::function<bool (struct MovementPackets &)> const &);

    // symbol: ?getQueue@ServerPlayerMovementComponent@@QEBAAEBV?$deque@UMovementPackets@@V?$allocator@UMovementPackets@@@std@@@std@@XZ
