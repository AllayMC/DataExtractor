...
public:
    // NOLINTBEGIN
    // symbol: ?_tickPortalTransition@DimensionTransitionSystem@@SAXV?$ViewT@VStrictEntityContext@@VEntityRegistryBase@@U?$Exclude@UPassengerComponent@@UVehicleComponent@@@@VActorOwnerComponent@@$$CBUDimensionTransitionComponent@@@@V?$EntityModifierT@VEntityRegistryBase@@VStrictEntityContext@@UDimensionTransitionComponent@@@@@Z
