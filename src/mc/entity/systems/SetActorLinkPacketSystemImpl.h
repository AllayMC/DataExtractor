...
namespace SetActorLinkPacketSystemImpl {
    ...
    // symbol: ?tickSendActorLinkPacket@SetActorLinkPacketSystemImpl@@YAXV?$ViewT@VStrictEntityContext@@VEntityRegistryBase@@$$CBUActorUniqueIDComponent@@URemovePassengersComponent@@@@V?$ViewT@VStrictEntityContext@@VEntityRegistryBase@@U?$Exclude@V?$FlagComponent@USwitchingVehiclesFlag@@@@@@$$CBUActorUniqueIDComponent@@V?$Optional@$$CBV?$FlagComponent@UActorIsBeingDestroyedFlag@@@@@@V?$Optional@$$CBV?$FlagComponent@UExitFromPassengerFlag@@@@@@@@V?$EntityModifierT@VEntityRegistryBase@@VStrictEntityContext@@USendPacketsComponent@@@@@Z
    MCAPI void tickSendActorLinkPacket(class ViewT<class StrictEntityContext, class EntityRegistryBase, struct ActorUniqueIDComponent const, struct RemovePassengersComponent>, class ViewT<class StrictEntityContext, class EntityRegistryBase, struct Exclude<class FlagComponent<struct SwitchingVehiclesFlag>>, struct ActorUniqueIDComponent const, class Optional<class FlagComponent<struct ActorIsBeingDestroyedFlag> const>, class Optional<class FlagComponent<struct ExitFromPassengerFlag> const>>, class EntityModifierT<class EntityRegistryBase, class StrictEntityContext, struct SendPacketsComponent>);
    // NOLINTEND
