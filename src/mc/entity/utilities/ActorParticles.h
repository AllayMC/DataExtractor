...
namespace ActorParticles {
    ...
    MCAPI uint calculateDustParticleNumberFromFall(float);
    ...
    MCAPI void spawnBalloonPopParticles(uint, class AABB, ::PaletteColor, class ILevel &, class Random &);
    ...
    MCAPI void spawnDustParticlesFromFalling(uint, class Vec3, class ILevel &, class Block const &, class BlockPos);

    // symbol: ?spawnParticlesInArea@ActorParticles@@YAXAEAVILevel@@IW4ParticleType@@AEBVVec3@@AEBVVec2@@AEAVRandom@@@Z
    MCAPI void spawnParticlesInArea(class ILevel &, uint, ::ParticleType, class Vec3 const &, class Vec2 const &, class Random &);

    // symbol: ?spawnPukeParticles@ActorParticles@@YAXIIVVec3@@0AEAVILevel@@AEAVRandom@@@Z
    MCAPI void spawnPukeParticles(uint, uint, class Vec3, class Vec3, class ILevel &, class Random &);

    // symbol: ?spawnTreasureHuntingParticles@ActorParticles@@YAXIVVec3@@0VVec2@@AEAVILevel@@AEAVRandom@@@Z
    MCAPI void spawnTreasureHuntingParticles(uint, class Vec3, class Vec3, class Vec2, class ILevel &, class Random &);
    // NOLINTEND
