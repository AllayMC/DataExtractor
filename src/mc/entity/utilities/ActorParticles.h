...
namespace ActorParticles {
    ...
    MCAPI void spawnBalloonPopParticles(uint32_t, class AABB, ::PaletteColor, class ILevel &, class Random &);
    ...
    MCAPI void spawnParticlesInArea(class ILevel &, uint32_t, ::ParticleType, class Vec3 const &, class Vec2 const &, class Random &);
