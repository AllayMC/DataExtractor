...
namespace ActorMobilityUtils {
    ...
    MCAPI ::ActorShouldCallOnSetSize actorSetSize(class StrictEntityContext const &, class Vec2 const &, struct SynchedActorDataComponent &, struct AABBShapeComponent &, struct StateVectorComponent const &, class EntityModifierT<class EntityRegistryBase, class StrictEntityContext, class FlagComponent<struct WasPenetratingLastFrameFlag>> &, class ViewT<class StrictEntityContext, class EntityRegistryBase, struct Include<class FlagComponent<struct PlayerComponentFlag>>, struct OffsetsComponent>);

    // symbol: ?applyFinalFriction@ActorMobilityUtils@@YAXPEBUCurrentLocalMoveVelocityComponent@@PEBV?$FlagComponent@UVexFlag@@@@PEBUAbilitiesComponent@@AEBUSynchedActorDataComponent@@AEAUStateVectorComponent@@M_N5@Z
    MCAPI void applyFinalFriction(struct CurrentLocalMoveVelocityComponent const *, class FlagComponent<struct VexFlag> const *, struct AbilitiesComponent const *, struct SynchedActorDataComponent const &, struct StateVectorComponent &, float, bool, bool);

    // symbol: ?canActivateElytra@ActorMobilityUtils@@YA_NAEBUMoveInputComponent@@AEBUVanillaClientGameplayComponent@@AEBUSynchedActorDataComponent@@AEBUAbilitiesComponent@@@Z
    MCAPI bool canActivateElytra(struct MoveInputComponent const &, struct VanillaClientGameplayComponent const &, struct SynchedActorDataComponent const &, struct AbilitiesComponent const &);
    ...
    // symbol: ?canJump@ActorMobilityUtils@@YA_NAEBUSynchedActorDataComponent@@AEBVIConstBlockSource@@AEBUStateVectorComponent@@AEBUAABBShapeComponent@@AEBVGetCollisionShapeInterface@@@Z
    MCAPI bool canJump(struct SynchedActorDataComponent const &, class IConstBlockSource const &, struct StateVectorComponent const &, struct AABBShapeComponent const &, class GetCollisionShapeInterface const &);
    ...
    // symbol: ?getBlockWhenClimbing@ActorMobilityUtils@@YAAEBVBlock@@AEBUAABBShapeComponent@@AEBVIConstBlockSource@@AEBUStateVectorComponent@@@Z
    MCAPI class Block const & getBlockWhenClimbing(struct AABBShapeComponent const &, class IConstBlockSource const &, struct StateVectorComponent const &);
    ...
    // symbol: ?getSpeed@ActorMobilityUtils@@YAMAEBVStrictEntityContext@@AEBV?$ViewT@VStrictEntityContext@@VEntityRegistryBase@@$$CBUAttributesComponent@@$$CBUMovementSpeedComponent@@@@AEBV?$ViewT@VStrictEntityContext@@VEntityRegistryBase@@U?$Include@V?$FlagComponent@UPlayerComponentFlag@@@@@@@@@Z
    MCAPI float getSpeed(class StrictEntityContext const &, class ViewT<class StrictEntityContext, class EntityRegistryBase, struct AttributesComponent const, struct MovementSpeedComponent const> const &, class ViewT<class StrictEntityContext, class EntityRegistryBase, struct Include<class FlagComponent<struct PlayerComponentFlag>>> const &);
    ...
    // symbol: ?setSpeed@ActorMobilityUtils@@YAXAEBVStrictEntityContext@@MAEBV?$ViewT@VStrictEntityContext@@VEntityRegistryBase@@UMovementSpeedComponent@@ULocalMoveVelocityComponent@@@@AEBV?$ViewT@VStrictEntityContext@@VEntityRegistryBase@@U?$Include@V?$FlagComponent@UPlayerComponentFlag@@@@@@@@@Z
    MCAPI void setSpeed(class StrictEntityContext const &, float, class ViewT<class StrictEntityContext, class EntityRegistryBase, struct MovementSpeedComponent, struct LocalMoveVelocityComponent> const &, class ViewT<class StrictEntityContext, class EntityRegistryBase, struct Include<class FlagComponent<struct PlayerComponentFlag>>> const &);
