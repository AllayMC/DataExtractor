...
public:
    ...
    MCAPI static std::optional<struct SoundEventRequest> tryPlaySound(class AutomaticID<class Dimension, int>, class SynchedActorData const &, struct ActorDefinitionIdentifier const &, ::LevelSoundEvent, class Vec3 const &, int);
