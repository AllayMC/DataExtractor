...
public:
    ...
    MCAPI void _eraseGoals(bool ( *)(std::pair<ushort, class PrioritizedGoal> &));
    ...
    MCAPI std::_Vector_const_iterator<std::_Vector_val<std::_Simple_types<std::pair<ushort, class PrioritizedGoal>>>> _findGoalByKey(ushort) const;
