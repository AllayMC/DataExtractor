...
public:
    ...
    MCAPI void serializeComponentDefinitions(class DefinitionInstanceGroup &, rapidjson::GenericValue<rapidjson::UTF8<char>, rapidjson::MemoryPoolAllocator<rapidjson::CrtAllocator>> const &, class SemVersion const &) const;
