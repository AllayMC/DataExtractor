...
public:
    ...
    MCAPI StructureDataLoadHelper(class BlockPos const &, class BlockPos const &, class Vec3 const &, struct ActorUniqueID, ::Rotation, ::Mirror, class Level &);
