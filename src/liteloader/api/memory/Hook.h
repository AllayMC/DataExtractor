 ...
 * @details The lower priority, the memory will be executed earlier
 */
...
/**
 * @brief Register a memory for a typed static function.
 * @param DEF_TYPE The name of the memory definition.
 * @param TYPE The type which the function belongs to.
 * @param PRIORITY ll::memory::HookPriority The priority of the memory.
 * @param IDENTIFIER The identifier of the memory. It can be a function pointer, symbol, address or a signature.
 * @param RET_TYPE The return type of the memory.
 * @param ... The parameters of the memory.
 *
 * @note register or unregister by calling DEF_TYPE::memory() and DEF_TYPE::unhook().
 */
...
/**
 * @brief Register a memory for a static function.
 * @param DEF_TYPE The name of the memory definition.
 * @param PRIORITY ll::memory::HookPriority The priority of the memory.
 * @param IDENTIFIER The identifier of the memory. It can be a function pointer, symbol, address or a signature.
 * @param RET_TYPE The return type of the memory.
...
/**
 * @brief Register a memory for a typed static function.
 * @details The memory will be automatically registered and unregistered.
...
/**
 * @brief Register a memory for a typed instance function.
 * @param DEF_TYPE The name of the memory definition.
 * @param TYPE The type which the function belongs to.
 * @param PRIORITY ll::memory::HookPriority The priority of the memory.
 * @param IDENTIFIER The identifier of the memory. It can be a function pointer, symbol, address or a signature.
...
/**
 * @brief Register a memory for a instance function.
 * @param DEF_TYPE The name of the memory definition.
 * @param PRIORITY ll::memory::HookPriority The priority of the memory.
 * @param IDENTIFIER The identifier of the memory. It can be a function pointer, symbol, address or a signature.
 * @param RET_TYPE The return type of the memory.
